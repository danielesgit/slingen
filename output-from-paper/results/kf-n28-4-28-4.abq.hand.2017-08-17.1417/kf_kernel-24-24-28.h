...
static __attribute__((noinline)) void kernel(double const * F, double const * B, double const * u, double const * Q, double const * z, double const * H, double const * R, double * y, double * x, double * M0, double * P, double * Y, double * v0, double * M1, double * M2, double * M3)
{
  ...
  // Generating : y[28,1] = ( ( Sum_{i0} ( S(h(1, 28, i0), ( ( G(h(1, 28, i0), F[28,28],h(1, 28, 0)) Kro G(h(1, 28, 0), x[28,1],h(1, 1, 0)) ) + ( G(h(1, 28, i0), B[28,24],h(1, 24, 0)) Kro G(h(1, 24, 0), u[24,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), F[28,28],h(1, 28, k2)) Kro G(h(1, 28, k2), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{k3} ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), B[28,24],h(1, 24, k3)) Kro G(h(1, 24, k3), u[24,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int k3 = 1; k3 <= 23; k3++ ) {

    for( int i0 = 0; i0 <= 27; i0++ ) {

      // 1-BLAC: 1x1 Kro 1x1
      kr110[0] = B[24*i0 + k3] * u[k3];
  ...
  // Generating : v0[24,1] = ( Sum_{k2} ( S(h(1, 24, k2), ( G(h(1, 24, k2), z[24,1],h(1, 1, 0)) - ( G(h(1, 24, k2), H[24,28],h(1, 28, 0)) Kro G(h(1, 28, 0), y[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k3} ( Sum_{k2} ( -$(h(1, 24, k2), ( G(h(1, 24, k2), H[24,28],h(1, 28, k3)) Kro G(h(1, 28, k3), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : M1[24,28] = ( ( ( ( Sum_{i0} ( S(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, 0)) Kro G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) ),h(1, 28, 0)) ) + Sum_{k2} ( Sum_{i0} ( S(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, 0)) Kro G(h(1, 28, 0), Y[28,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) + Sum_{k3} ( ( ( Sum_{k2} ( Sum_{i0} ( $(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, k3)) Kro T( G(h(1, 28, k2), Y[28,28],h(1, 28, k3)) ) ),h(1, 28, k2)) ) ) + Sum_{i0} ( $(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, k3)) Kro G(h(1, 28, k3), Y[28,28],h(1, 28, k3)) ),h(1, 28, k3)) ) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, k3)) Kro G(h(1, 28, k3), Y[28,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) ) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, 27)) Kro T( G(h(1, 28, k2), Y[28,28],h(1, 28, 27)) ) ),h(1, 28, k2)) ) ) ) + Sum_{i0} ( $(h(1, 24, i0), ( G(h(1, 24, i0), H[24,28],h(1, 28, 27)) Kro G(h(1, 28, 27), Y[28,28],h(1, 28, 27)) ),h(1, 28, 27)) ) )
  ...
  // Generating : M2[28,24] = ( ( Sum_{k2} ( ( S(h(1, 28, 0), ( G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, 0)) ) ),h(1, 24, k2)) + Sum_{i0} ( S(h(1, 28, i0), ( T( G(h(1, 28, 0), Y[28,28],h(1, 28, i0)) ) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, 0)) ) ),h(1, 24, k2)) ) ) ) + Sum_{k3} ( Sum_{k2} ( ( ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, k3)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, k3)) ) ),h(1, 24, k2)) ) + $(h(1, 28, k3), ( G(h(1, 28, k3), Y[28,28],h(1, 28, k3)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, k3)) ) ),h(1, 24, k2)) ) + Sum_{i0} ( $(h(1, 28, i0), ( T( G(h(1, 28, k3), Y[28,28],h(1, 28, i0)) ) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, k3)) ) ),h(1, 24, k2)) ) ) ) ) ) + Sum_{k2} ( ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, 27)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, 27)) ) ),h(1, 24, k2)) ) + $(h(1, 28, 27), ( G(h(1, 28, 27), Y[28,28],h(1, 28, 27)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, 27)) ) ),h(1, 24, k2)) ) ) )
  ...
  for( int k3 = 1; k3 <= 26; k3++ ) {
    ...
    for( int k2 = 0; k2 <= 23; k2++ ) {
      ...
      for( int i0 = 0; i0 <= k3 - 1; i0++ ) {
        ...
        // 1-BLAC: 1x1 + 1x1
        M2[24*i0 + k2] = M2[24*i0 + k2] + kr281[0];
      }
      ...
      // 1-BLAC: 1x1 + 1x1
      M2[k2 + 24*k3] = M2[k2 + 24*k3] + kr286[0];
      ...
      for( int i0 = k3 + 1; i0 <= 27; i0++ ) {
        ...
        // 1-BLAC: 1x1 + 1x1
        M2[24*i0 + k2] = M2[24*i0 + k2] + kr290[0];
      }
    }
  }
  ...
  for( int k2 = 0; k2 <= 23; k2++ ) {
    ...
    for( int i0 = 0; i0 <= 26; i0++ ) {
      ...
      // 1-BLAC: 1x1 + 1x1
      M2[24*i0 + k2] = M2[24*i0 + k2] + kr299[0];
    }
    ...
    // 1-BLAC: 1x1 + 1x1
    M2[k2 + 648] = M2[k2 + 648] + kr304[0];
  }


  // Generating : M3[24,24] = ( ( S(h(1, 24, 0), ( ( G(h(1, 24, 0), M1[24,28],h(1, 28, 0)) Kro T( G(h(1, 24, 0), H[24,28],h(1, 28, 0)) ) ) + G(h(1, 24, 0), R[24,24],h(1, 24, 0)) ),h(1, 24, 0)) + Sum_{k2} ( ( Sum_{i0} ( S(h(1, 24, i0), ( ( G(h(1, 24, i0), M1[24,28],h(1, 28, 0)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, 0)) ) ) + G(h(1, 24, i0), R[24,24],h(1, 24, k2)) ),h(1, 24, k2)) ) + S(h(1, 24, k2), ( ( G(h(1, 24, k2), M1[24,28],h(1, 28, 0)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, 0)) ) ) + G(h(1, 24, k2), R[24,24],h(1, 24, k2)) ),h(1, 24, k2)) ) ) ) + Sum_{k3} ( ( $(h(1, 24, 0), ( G(h(1, 24, 0), M1[24,28],h(1, 28, k3)) Kro T( G(h(1, 24, 0), H[24,28],h(1, 28, k3)) ) ),h(1, 24, 0)) + Sum_{k2} ( ( Sum_{i0} ( $(h(1, 24, i0), ( G(h(1, 24, i0), M1[24,28],h(1, 28, k3)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, k3)) ) ),h(1, 24, k2)) ) + $(h(1, 24, k2), ( G(h(1, 24, k2), M1[24,28],h(1, 28, k3)) Kro T( G(h(1, 24, k2), H[24,28],h(1, 28, k3)) ) ),h(1, 24, k2)) ) ) ) ) )
  ...
  for( int k2 = 1; k2 <= 23; k2++ ) {
    ...
    for( int i0 = 0; i0 <= k2 - 1; i0++ ) {
      ...
      // 1-BLAC: 1x1 + 1x1
      M3[24*i0 + k2] = kr319[0] + R[24*i0 + k2];
    }
  ...
  for( int k3 = 1; k3 <= 27; k3++ ) {
    ...
    for( int k2 = 1; k2 <= 23; k2++ ) {
      ...
      for( int i0 = 0; i0 <= k2 - 1; i0++ ) {
        ...
        // 1-BLAC: 1x1 + 1x1
        M3[24*i0 + k2] = M3[24*i0 + k2] + kr338[0];
      }
      ...
      // 1-BLAC: 1x1 + 1x1
      M3[25*k2] = M3[25*k2] + kr343[0];
    }
  }


  // Generating : U[24,24] = S(h(1, 24, 0), Sqrt( G(h(1, 24, 0), U[24,24],h(1, 24, 0)) ),h(1, 24, 0))

  // 1-BLAC: sqrt(1x1)
  M3[0] = sqrt(M3[0]);

  // Generating : U[24,24] = S(h(1, 24, 0), ( G(h(1, 24, 0), U[24,24],h(1, 24, 1)) Div G(h(1, 24, 0), U[24,24],h(1, 24, 0)) ),h(1, 24, 1))

  // 1-BLAC: 1x1 / 1x1
  M3[1] = M3[1] / M3[0];

  // Generating : U[24,24] = S(h(1, 24, 1), ( G(h(1, 24, 1), M4[24,24],h(1, 24, 1)) - ( T( G(h(1, 24, 0), U[24,24],h(1, 24, 1)) ) Kro G(h(1, 24, 0), U[24,24],h(1, 24, 1)) ) ),h(1, 24, 1))
  ...
  // Generating : U[24,24] = S(h(1, 24, 1), Sqrt( G(h(1, 24, 1), U[24,24],h(1, 24, 1)) ),h(1, 24, 1))

  // 1-BLAC: sqrt(1x1)
  M3[25] = sqrt(M3[25]);


  for( int fi35 = 2; fi35 <= 23; fi35++ ) {

    for( int fi60 = 0; fi60 <= fi35 - 2; fi60++ ) {

      // Generating : U[24,24] = S(h(1, 24, fi60), ( G(h(1, 24, fi60), U[24,24],h(1, 24, fi35)) Div G(h(1, 24, fi60), U[24,24],h(1, 24, fi60)) ),h(1, 24, fi35))

      // 1-BLAC: 1x1 / 1x1
      M3[fi35 + 24*fi60] = M3[fi35 + 24*fi60] / M3[25*fi60];

      // Generating : U[24,24] = Sum_{k3} ( S(h(1, 24, fi60 + k3 + 1), ( G(h(1, 24, fi60 + k3 + 1), U[24,24],h(1, 24, fi35)) - ( T( G(h(1, 24, fi60), U[24,24],h(1, 24, fi60 + k3 + 1)) ) Kro G(h(1, 24, fi60), U[24,24],h(1, 24, fi35)) ) ),h(1, 24, fi35)) )

      for( int k3 = 0; k3 <= fi35 - fi60 - 2; k3++ ) {

        // 1-BLAC: (1x1)^T
        trg392[0] = M3[25*fi60 + k3 + 1];

        // 1-BLAC: 1x1 Kro 1x1
        kr395[0] = trg392[0] * M3[fi35 + 24*fi60];

        // 1-BLAC: 1x1 - 1x1
        M3[fi35 + 24*fi60 + 24*k3 + 24] = M3[fi35 + 24*fi60 + 24*k3 + 24] - kr395[0];
      }
    }

    // Generating : U[24,24] = S(h(1, 24, Max(0, fi35 - 1)), ( G(h(1, 24, Max(0, fi35 - 1)), U[24,24],h(1, 24, fi35)) Div G(h(1, 24, Max(0, fi35 - 1)), U[24,24],h(1, 24, Max(0, fi35 - 1))) ),h(1, 24, fi35))

    // 1-BLAC: 1x1 / 1x1
    M3[fi35 + 24*Max(0, fi35 - 1)] = M3[fi35 + 24*Max(0, fi35 - 1)] / M3[25*Max(0, fi35 - 1)];

    // Generating : U[24,24] = ( S(h(1, 24, fi35), ( G(h(1, 24, fi35), M4[24,24],h(1, 24, fi35)) - ( T( G(h(1, 24, 0), U[24,24],h(1, 24, fi35)) ) Kro G(h(1, 24, 0), U[24,24],h(1, 24, fi35)) ) ),h(1, 24, fi35)) + Sum_{k3} ( -$(h(1, 24, fi35), ( T( G(h(1, 24, k3), U[24,24],h(1, 24, fi35)) ) Kro G(h(1, 24, k3), U[24,24],h(1, 24, fi35)) ),h(1, 24, fi35)) ) )
    ...
    // 1-BLAC: 1x1 - 1x1
    M3[25*fi35] = M3[25*fi35] - kr415[0];

    for( int k3 = 1; k3 <= fi35 - 1; k3++ ) {

      // 1-BLAC: (1x1)^T
      trg420[0] = M3[fi35 + 24*k3];

      // 1-BLAC: 1x1 Kro 1x1
      kr423[0] = trg420[0] * M3[fi35 + 24*k3];

      // 1-BLAC: 1x1 - 1x1
      M3[25*fi35] = M3[25*fi35] - kr423[0];
    }

    // Generating : U[24,24] = S(h(1, 24, fi35), Sqrt( G(h(1, 24, fi35), U[24,24],h(1, 24, fi35)) ),h(1, 24, fi35))

    // 1-BLAC: sqrt(1x1)
    M3[25*fi35] = sqrt(M3[25*fi35]);
  }


  for( int fi35 = 0; fi35 <= 22; fi35++ ) {

    // Generating : v2[24,1] = S(h(1, 24, fi35), ( G(h(1, 24, fi35), v2[24,1],h(1, 1, 0)) Div G(h(1, 24, fi35), U0[24,24],h(1, 24, fi35)) ),h(1, 1, 0))

    // 1-BLAC: 1x1 / 1x1
    v0[fi35] = v0[fi35] / M3[25*fi35];

    // Generating : v2[24,1] = Sum_{k3} ( S(h(1, 24, fi35 + k3 + 1), ( G(h(1, 24, fi35 + k3 + 1), v2[24,1],h(1, 1, 0)) - ( T( G(h(1, 24, fi35), U0[24,24],h(1, 24, fi35 + k3 + 1)) ) Kro G(h(1, 24, fi35), v2[24,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    for( int k3 = 0; k3 <= -fi35 + 22; k3++ ) {

      // 1-BLAC: (1x1)^T
      trg446[0] = M3[25*fi35 + k3 + 1];
  ...
  // Generating : v2[24,1] = S(h(1, 24, 23), ( G(h(1, 24, 23), v2[24,1],h(1, 1, 0)) Div G(h(1, 24, 23), U0[24,24],h(1, 24, 23)) ),h(1, 1, 0))
  ...
  for( int fi35 = 0; fi35 <= 22; fi35++ ) {
    ...
    // Generating : v4[24,1] = S(h(1, 24, -fi35 + 23), ( G(h(1, 24, -fi35 + 23), v4[24,1],h(1, 1, 0)) Div G(h(1, 24, -fi35 + 23), U0[24,24],h(1, 24, -fi35 + 23)) ),h(1, 1, 0))

    // 1-BLAC: 1x1 / 1x1
    v0[-fi35 + 23] = v0[-fi35 + 23] / M3[-25*fi35 + 575];

    // Generating : v4[24,1] = Sum_{k3} ( S(h(1, 24, k3), ( G(h(1, 24, k3), v4[24,1],h(1, 1, 0)) - ( G(h(1, 24, k3), U0[24,24],h(1, 24, -fi35 + 23)) Kro G(h(1, 24, -fi35 + 23), v4[24,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    for( int k3 = 0; k3 <= -fi35 + 22; k3++ ) {

      // 1-BLAC: 1x1 Kro 1x1
      kr477[0] = M3[-fi35 + 24*k3 + 23] * v0[-fi35 + 23];
  ...
  // Generating : v4[24,1] = S(h(1, 24, 0), ( G(h(1, 24, 0), v4[24,1],h(1, 1, 0)) Div G(h(1, 24, 0), U0[24,24],h(1, 24, 0)) ),h(1, 1, 0))
  ...
  for( int fi35 = 0; fi35 <= 22; fi35++ ) {
    ...
    for( int fi60 = 0; fi60 <= 27; fi60++ ) {
      ...
      // Generating : M6[24,28] = S(h(1, 24, fi35), ( G(h(1, 24, fi35), M6[24,28],h(1, 28, fi60)) Div G(h(1, 24, fi35), U0[24,24],h(1, 24, fi35)) ),h(1, 28, fi60))

      // 1-BLAC: 1x1 / 1x1
      M1[28*fi35 + fi60] = M1[28*fi35 + fi60] / M3[25*fi35];
    }

    // Generating : M6[24,28] = Sum_{k3} ( Sum_{k2} ( S(h(1, 24, fi35 + k2 + 1), ( G(h(1, 24, fi35 + k2 + 1), M6[24,28],h(1, 28, k3)) - ( T( G(h(1, 24, fi35), U0[24,24],h(1, 24, fi35 + k2 + 1)) ) Kro G(h(1, 24, fi35), M6[24,28],h(1, 28, k3)) ) ),h(1, 28, k3)) ) )

    for( int k3 = 0; k3 <= 27; k3++ ) {

      for( int k2 = 0; k2 <= -fi35 + 22; k2++ ) {

        // 1-BLAC: (1x1)^T
        trg502[0] = M3[25*fi35 + k2 + 1];
  ...
  for( int fi35 = 0; fi35 <= 27; fi35++ ) {
    ...
    // Generating : M6[24,28] = S(h(1, 24, 23), ( G(h(1, 24, 23), M6[24,28],h(1, 28, fi35)) Div G(h(1, 24, 23), U0[24,24],h(1, 24, 23)) ),h(1, 28, fi35))

    // 1-BLAC: 1x1 / 1x1
    M1[fi35 + 644] = M1[fi35 + 644] / M3[575];
  }
  ...
  for( int fi35 = 0; fi35 <= 22; fi35++ ) {
    ...
    for( int fi60 = 0; fi60 <= 27; fi60++ ) {
      ...
      // Generating : M8[24,28] = S(h(1, 24, -fi35 + 23), ( G(h(1, 24, -fi35 + 23), M8[24,28],h(1, 28, fi60)) Div G(h(1, 24, -fi35 + 23), U0[24,24],h(1, 24, -fi35 + 23)) ),h(1, 28, fi60))

      // 1-BLAC: 1x1 / 1x1
      M1[-28*fi35 + fi60 + 644] = M1[-28*fi35 + fi60 + 644] / M3[-25*fi35 + 575];
    }

    // Generating : M8[24,28] = Sum_{k3} ( Sum_{k2} ( S(h(1, 24, k2), ( G(h(1, 24, k2), M8[24,28],h(1, 28, k3)) - ( G(h(1, 24, k2), U0[24,24],h(1, 24, -fi35 + 23)) Kro G(h(1, 24, -fi35 + 23), M8[24,28],h(1, 28, k3)) ) ),h(1, 28, k3)) ) )
    ...
    for( int k3 = 0; k3 <= 27; k3++ ) {
      ...
      for( int k2 = 0; k2 <= -fi35 + 22; k2++ ) {
        ...
        // 1-BLAC: 1x1 Kro 1x1
        kr534[0] = M3[-fi35 + 24*k2 + 23] * M1[-28*fi35 + k3 + 644];
  ...
  for( int fi35 = 0; fi35 <= 27; fi35++ ) {
    ...
    // Generating : M8[24,28] = S(h(1, 24, 0), ( G(h(1, 24, 0), M8[24,28],h(1, 28, fi35)) Div G(h(1, 24, 0), U0[24,24],h(1, 24, 0)) ),h(1, 28, fi35))
  ...
  // Generating : x[28,1] = ( Sum_{k2} ( S(h(1, 28, k2), ( G(h(1, 28, k2), y[28,1],h(1, 1, 0)) + ( G(h(1, 28, k2), M2[28,24],h(1, 24, 0)) Kro G(h(1, 24, 0), v0[24,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k3} ( Sum_{k2} ( $(h(1, 28, k2), ( G(h(1, 28, k2), M2[28,24],h(1, 24, k3)) Kro G(h(1, 24, k3), v0[24,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )


  for( int k2 = 0; k2 <= 27; k2++ ) {

    // 1-BLAC: 1x1 Kro 1x1
    kr552[0] = M2[24*k2] * v0[0];
  ...
  // Generating : P[28,28] = ( ( S(h(1, 28, 0), ( G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) - ( G(h(1, 28, 0), M2[28,24],h(1, 24, 0)) Kro G(h(1, 24, 0), M1[24,28],h(1, 28, 0)) ) ),h(1, 28, 0)) + Sum_{k2} ( ( Sum_{i0} ( S(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, k2)) - ( G(h(1, 28, i0), M2[28,24],h(1, 24, 0)) Kro G(h(1, 24, 0), M1[24,28],h(1, 28, k2)) ) ),h(1, 28, k2)) ) + S(h(1, 28, k2), ( G(h(1, 28, k2), Y[28,28],h(1, 28, k2)) - ( G(h(1, 28, k2), M2[28,24],h(1, 24, 0)) Kro G(h(1, 24, 0), M1[24,28],h(1, 28, k2)) ) ),h(1, 28, k2)) ) ) ) + Sum_{k3} ( ( -$(h(1, 28, 0), ( G(h(1, 28, 0), M2[28,24],h(1, 24, k3)) Kro G(h(1, 24, k3), M1[24,28],h(1, 28, 0)) ),h(1, 28, 0)) + Sum_{k2} ( ( Sum_{i0} ( -$(h(1, 28, i0), ( G(h(1, 28, i0), M2[28,24],h(1, 24, k3)) Kro G(h(1, 24, k3), M1[24,28],h(1, 28, k2)) ),h(1, 28, k2)) ) + -$(h(1, 28, k2), ( G(h(1, 28, k2), M2[28,24],h(1, 24, k3)) Kro G(h(1, 24, k3), M1[24,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) ) )
  ...
  for( int k3 = 1; k3 <= 23; k3++ ) {
    ...
    for( int k2 = 1; k2 <= 27; k2++ ) {
      ...
      for( int i0 = 0; i0 <= k2 - 1; i0++ ) {
        ...
        // 1-BLAC: 1x1 Kro 1x1
        kr592[0] = M2[24*i0 + k3] * M1[k2 + 28*k3];
      ...
      // 1-BLAC: 1x1 Kro 1x1
      kr598[0] = M2[24*k2 + k3] * M1[k2 + 28*k3];
