...
dlmwrite(strcat(execpath, '/v0-out.txt'), v0, 'precision', '%.14f');
dlmwrite(strcat(execpath, '/v1-out.txt'), v1, 'precision', '%.14f');
dlmwrite(strcat(execpath, '/v2-out.txt'), v2, 'precision', '%.14f');
dlmwrite(strcat(execpath, '/M2-out.txt'), M2, 'precision', '%.14f');
dlmwrite(strcat(execpath, '/U-out.txt'), U, 'precision', '%.14f');
