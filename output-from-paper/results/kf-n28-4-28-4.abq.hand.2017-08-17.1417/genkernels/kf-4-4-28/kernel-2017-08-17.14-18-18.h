...
static __attribute__((noinline)) void kernel(double const * F, double const * B, double const * u, double const * Q, double const * z, double const * H, double const * R, double * y, double * x, double * M0, double * P, double * Y, double * v0, double * M1, double * M2, double * M3)
{
  ...
  // Generating : y[28,1] = ( ( Sum_{i0} ( S(h(1, 28, i0), ( ( G(h(1, 28, i0), F[28,28],h(1, 28, 0)) Kro G(h(1, 28, 0), x[28,1],h(1, 1, 0)) ) + ( G(h(1, 28, i0), B[28,4],h(1, 4, 0)) Kro G(h(1, 4, 0), u[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), F[28,28],h(1, 28, k2)) Kro G(h(1, 28, k2), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{k3} ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), B[28,4],h(1, 4, k3)) Kro G(h(1, 4, k3), u[4,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : v0[4,1] = ( Sum_{k2} ( S(h(1, 4, k2), ( G(h(1, 4, k2), z[4,1],h(1, 1, 0)) - ( G(h(1, 4, k2), H[4,28],h(1, 28, 0)) Kro G(h(1, 28, 0), y[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k3} ( Sum_{k2} ( -$(h(1, 4, k2), ( G(h(1, 4, k2), H[4,28],h(1, 28, k3)) Kro G(h(1, 28, k3), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : M1[4,28] = ( ( ( ( Sum_{i0} ( S(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, 0)) Kro G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) ),h(1, 28, 0)) ) + Sum_{k2} ( Sum_{i0} ( S(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, 0)) Kro G(h(1, 28, 0), Y[28,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) + Sum_{k3} ( ( ( Sum_{k2} ( Sum_{i0} ( $(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, k3)) Kro T( G(h(1, 28, k2), Y[28,28],h(1, 28, k3)) ) ),h(1, 28, k2)) ) ) + Sum_{i0} ( $(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, k3)) Kro G(h(1, 28, k3), Y[28,28],h(1, 28, k3)) ),h(1, 28, k3)) ) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, k3)) Kro G(h(1, 28, k3), Y[28,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) ) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, 27)) Kro T( G(h(1, 28, k2), Y[28,28],h(1, 28, 27)) ) ),h(1, 28, k2)) ) ) ) + Sum_{i0} ( $(h(1, 4, i0), ( G(h(1, 4, i0), H[4,28],h(1, 28, 27)) Kro G(h(1, 28, 27), Y[28,28],h(1, 28, 27)) ),h(1, 28, 27)) ) )
  ...
  // Generating : M2[28,4] = ( ( Sum_{k2} ( ( S(h(1, 28, 0), ( G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, 0)) ) ),h(1, 4, k2)) + Sum_{i0} ( S(h(1, 28, i0), ( T( G(h(1, 28, 0), Y[28,28],h(1, 28, i0)) ) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, 0)) ) ),h(1, 4, k2)) ) ) ) + Sum_{k3} ( Sum_{k2} ( ( ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, k3)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, k3)) ) ),h(1, 4, k2)) ) + $(h(1, 28, k3), ( G(h(1, 28, k3), Y[28,28],h(1, 28, k3)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, k3)) ) ),h(1, 4, k2)) ) + Sum_{i0} ( $(h(1, 28, i0), ( T( G(h(1, 28, k3), Y[28,28],h(1, 28, i0)) ) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, k3)) ) ),h(1, 4, k2)) ) ) ) ) ) + Sum_{k2} ( ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, 27)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, 27)) ) ),h(1, 4, k2)) ) + $(h(1, 28, 27), ( G(h(1, 28, 27), Y[28,28],h(1, 28, 27)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, 27)) ) ),h(1, 4, k2)) ) ) )
  ...
  for( int k2 = 0; k2 <= 3; k2++ ) {
    ...
    // 1-BLAC: 1x1 + 1x1
    M2[k2 + 108] = M2[k2 + 108] + kr304[0];
  }


  // Generating : M3[4,4] = ( ( S(h(1, 4, 0), ( ( G(h(1, 4, 0), M1[4,28],h(1, 28, 0)) Kro T( G(h(1, 4, 0), H[4,28],h(1, 28, 0)) ) ) + G(h(1, 4, 0), R[4,4],h(1, 4, 0)) ),h(1, 4, 0)) + Sum_{k2} ( ( Sum_{i0} ( S(h(1, 4, i0), ( ( G(h(1, 4, i0), M1[4,28],h(1, 28, 0)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, 0)) ) ) + G(h(1, 4, i0), R[4,4],h(1, 4, k2)) ),h(1, 4, k2)) ) + S(h(1, 4, k2), ( ( G(h(1, 4, k2), M1[4,28],h(1, 28, 0)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, 0)) ) ) + G(h(1, 4, k2), R[4,4],h(1, 4, k2)) ),h(1, 4, k2)) ) ) ) + Sum_{k3} ( ( $(h(1, 4, 0), ( G(h(1, 4, 0), M1[4,28],h(1, 28, k3)) Kro T( G(h(1, 4, 0), H[4,28],h(1, 28, k3)) ) ),h(1, 4, 0)) + Sum_{k2} ( ( Sum_{i0} ( $(h(1, 4, i0), ( G(h(1, 4, i0), M1[4,28],h(1, 28, k3)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, k3)) ) ),h(1, 4, k2)) ) + $(h(1, 4, k2), ( G(h(1, 4, k2), M1[4,28],h(1, 28, k3)) Kro T( G(h(1, 4, k2), H[4,28],h(1, 28, k3)) ) ),h(1, 4, k2)) ) ) ) ) )
  ...
  for( int fi35 = 0; fi35 <= 2; fi35++ ) {
    ...
    for( int fi60 = 0; fi60 <= 27; fi60++ ) {
      ...
      // Generating : M6[4,28] = S(h(1, 4, fi35), ( G(h(1, 4, fi35), M6[4,28],h(1, 28, fi60)) Div G(h(1, 4, fi35), U0[4,4],h(1, 4, fi35)) ),h(1, 28, fi60))

      // 1-BLAC: 1x1 / 1x1
      M1[28*fi35 + fi60] = M1[28*fi35 + fi60] / M3[5*fi35];
    }

    // Generating : M6[4,28] = Sum_{k3} ( Sum_{k2} ( S(h(1, 4, fi35 + k2 + 1), ( G(h(1, 4, fi35 + k2 + 1), M6[4,28],h(1, 28, k3)) - ( T( G(h(1, 4, fi35), U0[4,4],h(1, 4, fi35 + k2 + 1)) ) Kro G(h(1, 4, fi35), M6[4,28],h(1, 28, k3)) ) ),h(1, 28, k3)) ) )
  ...
  for( int fi35 = 0; fi35 <= 27; fi35++ ) {
    ...
    // Generating : M6[4,28] = S(h(1, 4, 3), ( G(h(1, 4, 3), M6[4,28],h(1, 28, fi35)) Div G(h(1, 4, 3), U0[4,4],h(1, 4, 3)) ),h(1, 28, fi35))

    // 1-BLAC: 1x1 / 1x1
    M1[fi35 + 84] = M1[fi35 + 84] / M3[15];
  }
  ...
  for( int fi35 = 0; fi35 <= 2; fi35++ ) {
    ...
    for( int fi60 = 0; fi60 <= 27; fi60++ ) {
      ...
      // Generating : M8[4,28] = S(h(1, 4, -fi35 + 3), ( G(h(1, 4, -fi35 + 3), M8[4,28],h(1, 28, fi60)) Div G(h(1, 4, -fi35 + 3), U0[4,4],h(1, 4, -fi35 + 3)) ),h(1, 28, fi60))

      // 1-BLAC: 1x1 / 1x1
      M1[-28*fi35 + fi60 + 84] = M1[-28*fi35 + fi60 + 84] / M3[-5*fi35 + 15];
    }

    // Generating : M8[4,28] = Sum_{k3} ( Sum_{k2} ( S(h(1, 4, k2), ( G(h(1, 4, k2), M8[4,28],h(1, 28, k3)) - ( G(h(1, 4, k2), U0[4,4],h(1, 4, -fi35 + 3)) Kro G(h(1, 4, -fi35 + 3), M8[4,28],h(1, 28, k3)) ) ),h(1, 28, k3)) ) )
    ...
    for( int k3 = 0; k3 <= 27; k3++ ) {
      ...
      for( int k2 = 0; k2 <= -fi35 + 2; k2++ ) {
        ...
        // 1-BLAC: 1x1 Kro 1x1
        kr534[0] = M3[-fi35 + 4*k2 + 3] * M1[-28*fi35 + k3 + 84];
  ...
  for( int fi35 = 0; fi35 <= 27; fi35++ ) {
    ...
    // Generating : M8[4,28] = S(h(1, 4, 0), ( G(h(1, 4, 0), M8[4,28],h(1, 28, fi35)) Div G(h(1, 4, 0), U0[4,4],h(1, 4, 0)) ),h(1, 28, fi35))
  ...
  // Generating : x[28,1] = ( Sum_{k2} ( S(h(1, 28, k2), ( G(h(1, 28, k2), y[28,1],h(1, 1, 0)) + ( G(h(1, 28, k2), M2[28,4],h(1, 4, 0)) Kro G(h(1, 4, 0), v0[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k3} ( Sum_{k2} ( $(h(1, 28, k2), ( G(h(1, 28, k2), M2[28,4],h(1, 4, k3)) Kro G(h(1, 4, k3), v0[4,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : P[28,28] = ( ( S(h(1, 28, 0), ( G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) - ( G(h(1, 28, 0), M2[28,4],h(1, 4, 0)) Kro G(h(1, 4, 0), M1[4,28],h(1, 28, 0)) ) ),h(1, 28, 0)) + Sum_{k2} ( ( Sum_{i0} ( S(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, k2)) - ( G(h(1, 28, i0), M2[28,4],h(1, 4, 0)) Kro G(h(1, 4, 0), M1[4,28],h(1, 28, k2)) ) ),h(1, 28, k2)) ) + S(h(1, 28, k2), ( G(h(1, 28, k2), Y[28,28],h(1, 28, k2)) - ( G(h(1, 28, k2), M2[28,4],h(1, 4, 0)) Kro G(h(1, 4, 0), M1[4,28],h(1, 28, k2)) ) ),h(1, 28, k2)) ) ) ) + Sum_{k3} ( ( -$(h(1, 28, 0), ( G(h(1, 28, 0), M2[28,4],h(1, 4, k3)) Kro G(h(1, 4, k3), M1[4,28],h(1, 28, 0)) ),h(1, 28, 0)) + Sum_{k2} ( ( Sum_{i0} ( -$(h(1, 28, i0), ( G(h(1, 28, i0), M2[28,4],h(1, 4, k3)) Kro G(h(1, 4, k3), M1[4,28],h(1, 28, k2)) ),h(1, 28, k2)) ) + -$(h(1, 28, k2), ( G(h(1, 28, k2), M2[28,4],h(1, 4, k3)) Kro G(h(1, 4, k3), M1[4,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) ) )
  ...
  for( int k3 = 1; k3 <= 3; k3++ ) {
    ...
    for( int k2 = 1; k2 <= 27; k2++ ) {
      ...
      for( int i0 = 0; i0 <= k2 - 1; i0++ ) {
        ...
        // 1-BLAC: 1x1 Kro 1x1
        kr592[0] = M2[4*i0 + k3] * M1[k2 + 28*k3];
      ...
      // 1-BLAC: 1x1 Kro 1x1
      kr598[0] = M2[4*k2 + k3] * M1[k2 + 28*k3];
