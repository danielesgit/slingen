...
static __attribute__((noinline)) void kernel(double const * F, double const * B, double const * u, double const * Q, double const * z, double const * H, double const * R, double * y, double * x, double * M0, double * P, double * Y, double * v0, double * M1, double * M2, double * M3)
{
  ...
  // Generating : y[28,1] = ( ( Sum_{i0} ( S(h(1, 28, i0), ( ( G(h(1, 28, i0), F[28,28],h(1, 28, 0)) Kro G(h(1, 28, 0), x[28,1],h(1, 1, 0)) ) + ( G(h(1, 28, i0), B[28,20],h(1, 20, 0)) Kro G(h(1, 20, 0), u[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), F[28,28],h(1, 28, k2)) Kro G(h(1, 28, k2), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{k3} ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), B[28,20],h(1, 20, k3)) Kro G(h(1, 20, k3), u[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : v0[20,1] = ( Sum_{k2} ( S(h(1, 20, k2), ( G(h(1, 20, k2), z[20,1],h(1, 1, 0)) - ( G(h(1, 20, k2), H[20,28],h(1, 28, 0)) Kro G(h(1, 28, 0), y[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k3} ( Sum_{k2} ( -$(h(1, 20, k2), ( G(h(1, 20, k2), H[20,28],h(1, 28, k3)) Kro G(h(1, 28, k3), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : M1[20,28] = ( ( ( ( Sum_{i0} ( S(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, 0)) Kro G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) ),h(1, 28, 0)) ) + Sum_{k2} ( Sum_{i0} ( S(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, 0)) Kro G(h(1, 28, 0), Y[28,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) + Sum_{k3} ( ( ( Sum_{k2} ( Sum_{i0} ( $(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, k3)) Kro T( G(h(1, 28, k2), Y[28,28],h(1, 28, k3)) ) ),h(1, 28, k2)) ) ) + Sum_{i0} ( $(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, k3)) Kro G(h(1, 28, k3), Y[28,28],h(1, 28, k3)) ),h(1, 28, k3)) ) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, k3)) Kro G(h(1, 28, k3), Y[28,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) ) ) + Sum_{k2} ( Sum_{i0} ( $(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, 27)) Kro T( G(h(1, 28, k2), Y[28,28],h(1, 28, 27)) ) ),h(1, 28, k2)) ) ) ) + Sum_{i0} ( $(h(1, 20, i0), ( G(h(1, 20, i0), H[20,28],h(1, 28, 27)) Kro G(h(1, 28, 27), Y[28,28],h(1, 28, 27)) ),h(1, 28, 27)) ) )
  ...
  // Generating : M2[28,20] = ( ( Sum_{k2} ( ( S(h(1, 28, 0), ( G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, 0)) ) ),h(1, 20, k2)) + Sum_{i0} ( S(h(1, 28, i0), ( T( G(h(1, 28, 0), Y[28,28],h(1, 28, i0)) ) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, 0)) ) ),h(1, 20, k2)) ) ) ) + Sum_{k3} ( Sum_{k2} ( ( ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, k3)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, k3)) ) ),h(1, 20, k2)) ) + $(h(1, 28, k3), ( G(h(1, 28, k3), Y[28,28],h(1, 28, k3)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, k3)) ) ),h(1, 20, k2)) ) + Sum_{i0} ( $(h(1, 28, i0), ( T( G(h(1, 28, k3), Y[28,28],h(1, 28, i0)) ) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, k3)) ) ),h(1, 20, k2)) ) ) ) ) ) + Sum_{k2} ( ( Sum_{i0} ( $(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, 27)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, 27)) ) ),h(1, 20, k2)) ) + $(h(1, 28, 27), ( G(h(1, 28, 27), Y[28,28],h(1, 28, 27)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, 27)) ) ),h(1, 20, k2)) ) ) )
  ...
  for( int k2 = 0; k2 <= 19; k2++ ) {
    ...
    // 1-BLAC: 1x1 + 1x1
    M2[k2 + 540] = M2[k2 + 540] + kr304[0];
  }


  // Generating : M3[20,20] = ( ( S(h(1, 20, 0), ( ( G(h(1, 20, 0), M1[20,28],h(1, 28, 0)) Kro T( G(h(1, 20, 0), H[20,28],h(1, 28, 0)) ) ) + G(h(1, 20, 0), R[20,20],h(1, 20, 0)) ),h(1, 20, 0)) + Sum_{k2} ( ( Sum_{i0} ( S(h(1, 20, i0), ( ( G(h(1, 20, i0), M1[20,28],h(1, 28, 0)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, 0)) ) ) + G(h(1, 20, i0), R[20,20],h(1, 20, k2)) ),h(1, 20, k2)) ) + S(h(1, 20, k2), ( ( G(h(1, 20, k2), M1[20,28],h(1, 28, 0)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, 0)) ) ) + G(h(1, 20, k2), R[20,20],h(1, 20, k2)) ),h(1, 20, k2)) ) ) ) + Sum_{k3} ( ( $(h(1, 20, 0), ( G(h(1, 20, 0), M1[20,28],h(1, 28, k3)) Kro T( G(h(1, 20, 0), H[20,28],h(1, 28, k3)) ) ),h(1, 20, 0)) + Sum_{k2} ( ( Sum_{i0} ( $(h(1, 20, i0), ( G(h(1, 20, i0), M1[20,28],h(1, 28, k3)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, k3)) ) ),h(1, 20, k2)) ) + $(h(1, 20, k2), ( G(h(1, 20, k2), M1[20,28],h(1, 28, k3)) Kro T( G(h(1, 20, k2), H[20,28],h(1, 28, k3)) ) ),h(1, 20, k2)) ) ) ) ) )
  ...
  for( int fi35 = 0; fi35 <= 18; fi35++ ) {
    ...
    for( int fi60 = 0; fi60 <= 27; fi60++ ) {
      ...
      // Generating : M6[20,28] = S(h(1, 20, fi35), ( G(h(1, 20, fi35), M6[20,28],h(1, 28, fi60)) Div G(h(1, 20, fi35), U0[20,20],h(1, 20, fi35)) ),h(1, 28, fi60))

      // 1-BLAC: 1x1 / 1x1
      M1[28*fi35 + fi60] = M1[28*fi35 + fi60] / M3[21*fi35];
    }

    // Generating : M6[20,28] = Sum_{k3} ( Sum_{k2} ( S(h(1, 20, fi35 + k2 + 1), ( G(h(1, 20, fi35 + k2 + 1), M6[20,28],h(1, 28, k3)) - ( T( G(h(1, 20, fi35), U0[20,20],h(1, 20, fi35 + k2 + 1)) ) Kro G(h(1, 20, fi35), M6[20,28],h(1, 28, k3)) ) ),h(1, 28, k3)) ) )
  ...
  for( int fi35 = 0; fi35 <= 27; fi35++ ) {
    ...
    // Generating : M6[20,28] = S(h(1, 20, 19), ( G(h(1, 20, 19), M6[20,28],h(1, 28, fi35)) Div G(h(1, 20, 19), U0[20,20],h(1, 20, 19)) ),h(1, 28, fi35))

    // 1-BLAC: 1x1 / 1x1
    M1[fi35 + 532] = M1[fi35 + 532] / M3[399];
  }
  ...
  for( int fi35 = 0; fi35 <= 18; fi35++ ) {
    ...
    for( int fi60 = 0; fi60 <= 27; fi60++ ) {
      ...
      // Generating : M8[20,28] = S(h(1, 20, -fi35 + 19), ( G(h(1, 20, -fi35 + 19), M8[20,28],h(1, 28, fi60)) Div G(h(1, 20, -fi35 + 19), U0[20,20],h(1, 20, -fi35 + 19)) ),h(1, 28, fi60))

      // 1-BLAC: 1x1 / 1x1
      M1[-28*fi35 + fi60 + 532] = M1[-28*fi35 + fi60 + 532] / M3[-21*fi35 + 399];
    }

    // Generating : M8[20,28] = Sum_{k3} ( Sum_{k2} ( S(h(1, 20, k2), ( G(h(1, 20, k2), M8[20,28],h(1, 28, k3)) - ( G(h(1, 20, k2), U0[20,20],h(1, 20, -fi35 + 19)) Kro G(h(1, 20, -fi35 + 19), M8[20,28],h(1, 28, k3)) ) ),h(1, 28, k3)) ) )
    ...
    for( int k3 = 0; k3 <= 27; k3++ ) {
      ...
      for( int k2 = 0; k2 <= -fi35 + 18; k2++ ) {
        ...
        // 1-BLAC: 1x1 Kro 1x1
        kr534[0] = M3[-fi35 + 20*k2 + 19] * M1[-28*fi35 + k3 + 532];
  ...
  for( int fi35 = 0; fi35 <= 27; fi35++ ) {
    ...
    // Generating : M8[20,28] = S(h(1, 20, 0), ( G(h(1, 20, 0), M8[20,28],h(1, 28, fi35)) Div G(h(1, 20, 0), U0[20,20],h(1, 20, 0)) ),h(1, 28, fi35))
  ...
  // Generating : x[28,1] = ( Sum_{k2} ( S(h(1, 28, k2), ( G(h(1, 28, k2), y[28,1],h(1, 1, 0)) + ( G(h(1, 28, k2), M2[28,20],h(1, 20, 0)) Kro G(h(1, 20, 0), v0[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{k3} ( Sum_{k2} ( $(h(1, 28, k2), ( G(h(1, 28, k2), M2[28,20],h(1, 20, k3)) Kro G(h(1, 20, k3), v0[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : P[28,28] = ( ( S(h(1, 28, 0), ( G(h(1, 28, 0), Y[28,28],h(1, 28, 0)) - ( G(h(1, 28, 0), M2[28,20],h(1, 20, 0)) Kro G(h(1, 20, 0), M1[20,28],h(1, 28, 0)) ) ),h(1, 28, 0)) + Sum_{k2} ( ( Sum_{i0} ( S(h(1, 28, i0), ( G(h(1, 28, i0), Y[28,28],h(1, 28, k2)) - ( G(h(1, 28, i0), M2[28,20],h(1, 20, 0)) Kro G(h(1, 20, 0), M1[20,28],h(1, 28, k2)) ) ),h(1, 28, k2)) ) + S(h(1, 28, k2), ( G(h(1, 28, k2), Y[28,28],h(1, 28, k2)) - ( G(h(1, 28, k2), M2[28,20],h(1, 20, 0)) Kro G(h(1, 20, 0), M1[20,28],h(1, 28, k2)) ) ),h(1, 28, k2)) ) ) ) + Sum_{k3} ( ( -$(h(1, 28, 0), ( G(h(1, 28, 0), M2[28,20],h(1, 20, k3)) Kro G(h(1, 20, k3), M1[20,28],h(1, 28, 0)) ),h(1, 28, 0)) + Sum_{k2} ( ( Sum_{i0} ( -$(h(1, 28, i0), ( G(h(1, 28, i0), M2[28,20],h(1, 20, k3)) Kro G(h(1, 20, k3), M1[20,28],h(1, 28, k2)) ),h(1, 28, k2)) ) + -$(h(1, 28, k2), ( G(h(1, 28, k2), M2[28,20],h(1, 20, k3)) Kro G(h(1, 20, k3), M1[20,28],h(1, 28, k2)) ),h(1, 28, k2)) ) ) ) ) )
  ...
  for( int k3 = 1; k3 <= 19; k3++ ) {
    ...
    for( int k2 = 1; k2 <= 27; k2++ ) {
      ...
      for( int i0 = 0; i0 <= k2 - 1; i0++ ) {
        ...
        // 1-BLAC: 1x1 Kro 1x1
        kr592[0] = M2[20*i0 + k3] * M1[k2 + 28*k3];
      ...
      // 1-BLAC: 1x1 Kro 1x1
      kr598[0] = M2[20*k2 + k3] * M1[k2 + 28*k3];
