...
static __attribute__((noinline)) void kernel(double a, double t, double const * W, double const * A, double const * x0, double b, double const * y, double * y1, double * v1, double * z1, double * y2, double * v2, double * z2, double * x1, double * x)
{
  ...
  // Generating : y1[4,1] = Sum_{i0} ( S(h(1, 4, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), v1[4,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), z1[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : y2[4,1] = Sum_{i0} ( S(h(1, 4, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), v2[4,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), z2[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : x1[4,1] = ( ( Sum_{k15} ( S(h(1, 4, k15), ( ( T( G(h(1, 4, 0), W[4,4],h(1, 4, k15)) ) Kro G(h(1, 4, 0), y1[4,1],h(1, 1, 0)) ) - ( T( G(h(1, 4, 0), A[4,4],h(1, 4, k15)) ) Kro G(h(1, 4, 0), y2[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i6} ( Sum_{k15} ( $(h(1, 4, k15), ( T( G(h(1, 4, i6), W[4,4],h(1, 4, k15)) ) Kro G(h(1, 4, i6), y1[4,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{i0} ( Sum_{k15} ( -$(h(1, 4, k15), ( T( G(h(1, 4, i0), A[4,4],h(1, 4, k15)) ) Kro G(h(1, 4, i0), y2[4,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : x[4,1] = Sum_{i0} ( S(h(1, 4, i0), ( G(h(1, 4, i0), x0[4,1],h(1, 1, 0)) + ( G(h(1, 1, 0), b[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), x1[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : z1[4,1] = ( Sum_{i6} ( S(h(1, 4, i6), ( G(h(1, 4, i6), y1[4,1],h(1, 1, 0)) - ( G(h(1, 4, i6), W[4,4],h(1, 4, 0)) Kro G(h(1, 4, 0), x[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( -$(h(1, 4, i6), ( G(h(1, 4, i6), W[4,4],h(1, 4, i0)) Kro G(h(1, 4, i0), x[4,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : z2[4,1] = ( Sum_{i6} ( S(h(1, 4, i6), ( G(h(1, 4, i6), y2[4,1],h(1, 1, 0)) - ( G(h(1, 4, i6), y[4,1],h(1, 1, 0)) - ( G(h(1, 4, i6), A[4,4],h(1, 4, 0)) Kro G(h(1, 4, 0), x[4,1],h(1, 1, 0)) ) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( $(h(1, 4, i6), ( G(h(1, 4, i6), A[4,4],h(1, 4, i0)) Kro G(h(1, 4, i0), x[4,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  // Generating : v1[4,1] = Sum_{i0} ( S(h(1, 4, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), v1[4,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), z1[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : v2[4,1] = Sum_{i0} ( S(h(1, 4, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), v2[4,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(1, 4, i0), z2[4,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
