 ...
 * kf_kernel.h
 *
Decl { {u'B': SquaredMatrix[B, (12, 12), GenMatAccess], u'F': SquaredMatrix[F, (12, 12), GenMatAccess], u'H': SquaredMatrix[H, (12, 12), GenMatAccess], 'T2401': Matrix[T2401, (1, 12), GenMatAccess], u'U0': UpperTriangular[U0, (12, 12), GenMatAccess], u'M5': SquaredMatrix[M5, (12, 12), GenMatAccess], u'P': Symmetric[P, (12, 12), USMatAccess], u'M7': SquaredMatrix[M7, (12, 12), GenMatAccess], u'M6': SquaredMatrix[M6, (12, 12), GenMatAccess], u'v4': Matrix[v4, (12, 1), GenMatAccess], u'M0': SquaredMatrix[M0, (12, 12), GenMatAccess], u'M3': Symmetric[M3, (12, 12), USMatAccess], u'M2': SquaredMatrix[M2, (12, 12), GenMatAccess], u'Y': Symmetric[Y, (12, 12), USMatAccess], u'R': Symmetric[R, (12, 12), USMatAccess], u'U': UpperTriangular[U, (12, 12), GenMatAccess], u'M8': SquaredMatrix[M8, (12, 12), GenMatAccess], u'v0': Matrix[v0, (12, 1), GenMatAccess], u'u': Matrix[u, (12, 1), GenMatAccess], u'M4': Symmetric[M4, (12, 12), USMatAccess], u'v2': Matrix[v2, (12, 1), GenMatAccess], u'v1': Matrix[v1, (12, 1), GenMatAccess], u'v3': Matrix[v3, (12, 1), GenMatAccess], u'Q': Symmetric[Q, (12, 12), USMatAccess], u'x': Matrix[x, (12, 1), GenMatAccess], u'y': Matrix[y, (12, 1), GenMatAccess], u'M1': SquaredMatrix[M1, (12, 12), GenMatAccess], u'z': Matrix[z, (12, 1), GenMatAccess], 'T2338': Matrix[T2338, (1, 12), GenMatAccess]} }
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 0)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 0), U[12,12],h(1, 12, 0)) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(3, 12, 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(3, 12, 1)) ) ) )
Eq.ann: {}
Entry 10:
...
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(1, 12, 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(2, 12, 2)) ) ) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 1), U[12,12],h(1, 12, 1)) ) )
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ) ) )
Eq.ann: {}
Entry 15:
...
Eq.ann: {}
Entry 17:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), U[12,12],h(1, 12, 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), U[12,12],h(1, 12, 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 0), U[12,12],h(1, 12, 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 0), U[12,12],h(1, 12, 3)) ) ) ) )
Eq.ann: {}
Entry 18:
...
Eq.ann: {}
Entry 21:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 2), U[12,12],h(1, 12, 2)) ) )
Eq.ann: {}
Entry 22:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 3), U[12,12],h(1, 12, 3)) ) )
Eq.ann: {}
Entry 23:
For_{fi1304;0;4;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(4, 12, fi1304 + 4)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(3, 12, 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U[12,12],h(4, 12, fi1304 + 4)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), U[12,12],h(4, 12, fi1304 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), U[12,12],h(1, 12, 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), U[12,12],h(4, 12, fi1304 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), U[12,12],h(4, 12, fi1304 + 4)) ) ) )
Eq.ann: {}
 )Entry 24:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 4), U[12,12],h(4, 12, 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 4), M4[12,12],h(4, 12, 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 0), U[12,12],h(4, 12, 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 0), U[12,12],h(4, 12, 4)) ) ) ) )
Eq.ann: {}
Entry 25:
Eq: Tile( (1, 1), G(h(1, 12, 4), U[12,12],h(1, 12, 4)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 4), U[12,12],h(1, 12, 4)) ) )
Eq.ann: {}
Entry 26:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 4)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 4), U[12,12],h(1, 12, 4)) ) )
Eq.ann: {}
Entry 27:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(3, 12, 5)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 4)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(3, 12, 5)) ) ) )
Eq.ann: {}
Entry 28:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(1, 12, 5)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(1, 12, 5)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(1, 12, 5)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(1, 12, 5)) ) ) ) )
Eq.ann: {}
Entry 29:
Eq: Tile( (1, 1), G(h(1, 12, 5), U[12,12],h(1, 12, 5)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 5), U[12,12],h(1, 12, 5)) ) )
Eq.ann: {}
Entry 30:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(2, 12, 6)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(2, 12, 6)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(1, 12, 5)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(2, 12, 6)) ) ) ) )
Eq.ann: {}
Entry 31:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 5)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 5), U[12,12],h(1, 12, 5)) ) )
Eq.ann: {}
Entry 32:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(2, 12, 6)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 5)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(2, 12, 6)) ) ) )
Eq.ann: {}
Entry 33:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 4), U[12,12],h(1, 12, 6)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 4), U[12,12],h(1, 12, 6)) ) ) ) )
Eq.ann: {}
Entry 34:
Eq: Tile( (1, 1), G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ) )
Eq.ann: {}
Entry 35:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(1, 12, 7)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(1, 12, 7)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 4), U[12,12],h(1, 12, 6)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 4), U[12,12],h(1, 12, 7)) ) ) ) )
Eq.ann: {}
Entry 36:
Eq: Tile( (1, 1), G(h(1, 12, 6), U[12,12],h(1, 12, 7)) ) = ( Tile( (1, 1), G(h(1, 12, 6), U[12,12],h(1, 12, 7)) ) Div Tile( (1, 1), G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ) )
Eq.ann: {}
Entry 37:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 7), U[12,12],h(1, 12, 7)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 7), U[12,12],h(1, 12, 7)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 4), U[12,12],h(1, 12, 7)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 4), U[12,12],h(1, 12, 7)) ) ) ) )
Eq.ann: {}
Entry 38:
Eq: Tile( (1, 1), G(h(1, 12, 7), U[12,12],h(1, 12, 7)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 7), U[12,12],h(1, 12, 7)) ) )
Eq.ann: {}
Entry 39:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 4), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 4), M4[12,12],h(4, 12, 8)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 0), U[12,12],h(4, 12, 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 0), U[12,12],h(4, 12, 8)) ) ) ) )
Eq.ann: {}
Entry 40:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 4)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(4, 12, 8)) ) ) )
Eq.ann: {}
Entry 41:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 5), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 5), U[12,12],h(4, 12, 8)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(3, 12, 5)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 4), U[12,12],h(4, 12, 8)) ) ) ) )
Eq.ann: {}
Entry 42:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 5)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(4, 12, 8)) ) ) )
Eq.ann: {}
Entry 43:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 6), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 6), U[12,12],h(4, 12, 8)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(2, 12, 6)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 5), U[12,12],h(4, 12, 8)) ) ) ) )
Eq.ann: {}
Entry 44:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 6)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ) )
Eq.ann: {}
Entry 45:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 6)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(4, 12, 8)) ) ) )
Eq.ann: {}
Entry 46:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 7), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 7), U[12,12],h(4, 12, 8)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(1, 12, 7)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 6), U[12,12],h(4, 12, 8)) ) ) ) )
Eq.ann: {}
Entry 47:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 7)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 7), U[12,12],h(1, 12, 7)) ) )
Eq.ann: {}
Entry 48:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 7), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 7)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 7), U[12,12],h(4, 12, 8)) ) ) )
Eq.ann: {}
Entry 49:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 8), U[12,12],h(4, 12, 8)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, 8), M4[12,12],h(4, 12, 8)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(8, 12, 0), U[12,12],h(4, 12, 8)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(8, 12, 0), U[12,12],h(4, 12, 8)) ) ) ) )
Eq.ann: {}
Entry 50:
Eq: Tile( (1, 1), G(h(1, 12, 8), U[12,12],h(1, 12, 8)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 8), U[12,12],h(1, 12, 8)) ) )
Eq.ann: {}
Entry 51:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 8)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 8), U[12,12],h(1, 12, 8)) ) )
Eq.ann: {}
Entry 52:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U[12,12],h(3, 12, 9)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 8)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U[12,12],h(3, 12, 9)) ) ) )
Eq.ann: {}
Entry 53:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U[12,12],h(1, 12, 9)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U[12,12],h(1, 12, 9)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U[12,12],h(1, 12, 9)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U[12,12],h(1, 12, 9)) ) ) ) )
Eq.ann: {}
Entry 54:
Eq: Tile( (1, 1), G(h(1, 12, 9), U[12,12],h(1, 12, 9)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 9), U[12,12],h(1, 12, 9)) ) )
Eq.ann: {}
Entry 55:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U[12,12],h(2, 12, 10)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U[12,12],h(2, 12, 10)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U[12,12],h(1, 12, 9)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U[12,12],h(2, 12, 10)) ) ) ) )
Eq.ann: {}
Entry 56:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2338[1,12],h(1, 12, 9)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 9), U[12,12],h(1, 12, 9)) ) )
Eq.ann: {}
Entry 57:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U[12,12],h(2, 12, 10)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2338[1,12],h(1, 12, 9)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U[12,12],h(2, 12, 10)) ) ) )
Eq.ann: {}
Entry 58:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), U[12,12],h(1, 12, 10)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), U[12,12],h(1, 12, 10)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 8), U[12,12],h(1, 12, 10)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 8), U[12,12],h(1, 12, 10)) ) ) ) )
Eq.ann: {}
Entry 59:
Eq: Tile( (1, 1), G(h(1, 12, 10), U[12,12],h(1, 12, 10)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 10), U[12,12],h(1, 12, 10)) ) )
Eq.ann: {}
Entry 60:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), U[12,12],h(1, 12, 11)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), U[12,12],h(1, 12, 11)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 8), U[12,12],h(1, 12, 10)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 8), U[12,12],h(1, 12, 11)) ) ) ) )
Eq.ann: {}
Entry 61:
...
Eq.ann: {}
Entry 62:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 11), U[12,12],h(1, 12, 11)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 11), U[12,12],h(1, 12, 11)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 8), U[12,12],h(1, 12, 11)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 8), U[12,12],h(1, 12, 11)) ) ) ) )
Eq.ann: {}
Entry 63:
Eq: Tile( (1, 1), G(h(1, 12, 11), U[12,12],h(1, 12, 11)) ) = Sqrt( Tile( (1, 1), G(h(1, 12, 11), U[12,12],h(1, 12, 11)) ) )
Eq.ann: {}
Entry 64:
For_{fi1548;0;7;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 12, fi1548), v2[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, fi1548), v2[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, fi1548), U0[12,12],h(1, 12, fi1548)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, fi1548 + 1), v2[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, fi1548 + 1), v2[12,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548), U0[12,12],h(3, 12, fi1548 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548), v2[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 12, fi1548 + 1), v2[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, fi1548 + 1), v2[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, fi1548 + 1), U0[12,12],h(1, 12, fi1548 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, fi1548 + 2), v2[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, fi1548 + 2), v2[12,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548 + 1), U0[12,12],h(2, 12, fi1548 + 2)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548 + 1), v2[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 12, fi1548 + 2), v2[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, fi1548 + 2), v2[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, fi1548 + 2), U0[12,12],h(1, 12, fi1548 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548 + 3), v2[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548 + 3), v2[12,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548 + 2), U0[12,12],h(1, 12, fi1548 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1548 + 2), v2[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 12, fi1548 + 3), v2[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, fi1548 + 3), v2[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, fi1548 + 3), U0[12,12],h(1, 12, fi1548 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi1548 + 8, 12, fi1548 + 4), v2[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi1548 + 8, 12, fi1548 + 4), v2[12,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, fi1548), U0[12,12],h(-fi1548 + 8, 12, fi1548 + 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 12, fi1548), v2[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 65:
...
Eq.ann: {}
Entry 72:
For_{fi1625;0;7;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 12, -fi1625 + 11), v4[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, -fi1625 + 11), v4[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, -fi1625 + 11), U0[12,12],h(1, 12, -fi1625 + 11)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, -fi1625 + 8), U0[12,12],h(1, 12, -fi1625 + 11)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1625 + 11), v4[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 12, -fi1625 + 10), v4[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, -fi1625 + 10), v4[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, -fi1625 + 10), U0[12,12],h(1, 12, -fi1625 + 10)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, -fi1625 + 8), U0[12,12],h(1, 12, -fi1625 + 10)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1625 + 10), v4[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 12, -fi1625 + 9), v4[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, -fi1625 + 9), v4[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, -fi1625 + 9), U0[12,12],h(1, 12, -fi1625 + 9)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1625 + 8), U0[12,12],h(1, 12, -fi1625 + 9)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1625 + 9), v4[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 12, -fi1625 + 8), U0[12,12],h(1, 12, -fi1625 + 8)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi1625 + 8, 12, 0), v4[12,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi1625 + 8, 12, 0), v4[12,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi1625 + 8, 12, 0), U0[12,12],h(4, 12, -fi1625 + 8)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 12, -fi1625 + 8), v4[12,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 73:
...
Eq.ann: {}
Entry 80:
For_{fi1702;0;7;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, fi1702), U0[12,12],h(1, 12, fi1702)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, fi1702 + 1), U0[12,12],h(1, 12, fi1702 + 1)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702 + 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, fi1702 + 2), U0[12,12],h(1, 12, fi1702 + 2)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702 + 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, fi1702 + 3), U0[12,12],h(1, 12, fi1702 + 3)) ) )
Eq.ann: {}
Entry 4:
For_{fi1721;0;8;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702), M6[12,12],h(4, 12, fi1721)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, fi1702 + 1), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, fi1702 + 1), M6[12,12],h(4, 12, fi1721)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702), U0[12,12],h(3, 12, fi1702 + 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702), M6[12,12],h(4, 12, fi1721)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 1), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 1), M6[12,12],h(4, 12, fi1721)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, fi1702 + 2), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, fi1702 + 2), M6[12,12],h(4, 12, fi1721)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 1), U0[12,12],h(2, 12, fi1702 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 1), M6[12,12],h(4, 12, fi1721)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 2), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 2), M6[12,12],h(4, 12, fi1721)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 3), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 3), M6[12,12],h(4, 12, fi1721)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 2), U0[12,12],h(1, 12, fi1702 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 2), M6[12,12],h(4, 12, fi1721)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 3), M6[12,12],h(4, 12, fi1721)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1702 + 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, fi1702 + 3), M6[12,12],h(4, 12, fi1721)) ) ) )
Eq.ann: {}
 )Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi1702 + 8, 12, fi1702 + 4), M6[12,12],h(12, 12, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi1702 + 8, 12, fi1702 + 4), M6[12,12],h(12, 12, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 12, fi1702), U0[12,12],h(-fi1702 + 8, 12, fi1702 + 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 12, fi1702), M6[12,12],h(12, 12, 0)) ) ) ) )
Eq.ann: {}
 )Entry 81:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 8)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 8), U0[12,12],h(1, 12, 8)) ) )
Eq.ann: {}
Entry 82:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 9)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 9), U0[12,12],h(1, 12, 9)) ) )
Eq.ann: {}
Entry 83:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 10)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 10), U0[12,12],h(1, 12, 10)) ) )
Eq.ann: {}
Entry 84:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 11)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 11), U0[12,12],h(1, 12, 11)) ) )
Eq.ann: {}
Entry 85:
For_{fi1768;0;8;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 8)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), M6[12,12],h(4, 12, fi1768)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 9), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 9), M6[12,12],h(4, 12, fi1768)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), U0[12,12],h(3, 12, 9)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 8), M6[12,12],h(4, 12, fi1768)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 9)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), M6[12,12],h(4, 12, fi1768)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 10), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 10), M6[12,12],h(4, 12, fi1768)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), U0[12,12],h(2, 12, 10)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 9), M6[12,12],h(4, 12, fi1768)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 10)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), M6[12,12],h(4, 12, fi1768)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 11), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 11), M6[12,12],h(4, 12, fi1768)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), U0[12,12],h(1, 12, 11)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 10), M6[12,12],h(4, 12, fi1768)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 11), M6[12,12],h(4, 12, fi1768)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 11)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 11), M6[12,12],h(4, 12, fi1768)) ) ) )
Eq.ann: {}
 )Entry 86:
For_{fi1815;0;7;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 11)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, -fi1815 + 11), U0[12,12],h(1, 12, -fi1815 + 11)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 10)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, -fi1815 + 10), U0[12,12],h(1, 12, -fi1815 + 10)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 9)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, -fi1815 + 9), U0[12,12],h(1, 12, -fi1815 + 9)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 8)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, -fi1815 + 8), U0[12,12],h(1, 12, -fi1815 + 8)) ) )
Eq.ann: {}
Entry 4:
For_{fi1834;0;8;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 11), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 11)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 11), M8[12,12],h(4, 12, fi1834)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, -fi1815 + 8), U0[12,12],h(1, 12, -fi1815 + 11)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 11), M8[12,12],h(4, 12, fi1834)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 10), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 10)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 10), M8[12,12],h(4, 12, fi1834)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, -fi1815 + 8), U0[12,12],h(1, 12, -fi1815 + 10)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 10), M8[12,12],h(4, 12, fi1834)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 9), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 9)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 9), M8[12,12],h(4, 12, fi1834)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 8), U0[12,12],h(1, 12, -fi1815 + 9)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 9), M8[12,12],h(4, 12, fi1834)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1815 + 8)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, -fi1815 + 8), M8[12,12],h(4, 12, fi1834)) ) ) )
Eq.ann: {}
 )Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi1815 + 8, 12, 0), M8[12,12],h(12, 12, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi1815 + 8, 12, 0), M8[12,12],h(12, 12, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi1815 + 8, 12, 0), U0[12,12],h(4, 12, -fi1815 + 8)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 12, -fi1815 + 8), M8[12,12],h(12, 12, 0)) ) ) ) )
Eq.ann: {}
 )Entry 87:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 3), U0[12,12],h(1, 12, 3)) ) )
Eq.ann: {}
Entry 88:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 2), U0[12,12],h(1, 12, 2)) ) )
Eq.ann: {}
Entry 89:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 1), U0[12,12],h(1, 12, 1)) ) )
Eq.ann: {}
Entry 90:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2401[1,12],h(1, 12, 0)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 12, 0), U0[12,12],h(1, 12, 0)) ) )
Eq.ann: {}
Entry 91:
For_{fi1881;0;8;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), M8[12,12],h(4, 12, fi1881)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 12, 0), U0[12,12],h(1, 12, 3)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 3), M8[12,12],h(4, 12, fi1881)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), M8[12,12],h(4, 12, fi1881)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 12, 0), U0[12,12],h(1, 12, 2)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 2), M8[12,12],h(4, 12, fi1881)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), M8[12,12],h(4, 12, fi1881)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), U0[12,12],h(1, 12, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 1), M8[12,12],h(4, 12, fi1881)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2401[1,12],h(1, 12, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 12, 0), M8[12,12],h(4, 12, fi1881)) ) ) )
Eq.ann: {}
 )Entry 92:
...
static __attribute__((noinline)) void kernel(double const * F, double const * B, double const * u, double const * Q, double const * z, double const * H, double const * R, double * y, double * x, double * M0, double * P, double * Y, double * v0, double * M1, double * M2, double * M3)
{
  ...
  _t45_4 = _mm256_maskload_pd(M3 + 14, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t45_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[26])));
  _t45_7 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[27])));
  _t45_8 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[39])));
  _t45_41 = _asm256_loadu_pd(M3 + 4);
  _t45_42 = _asm256_loadu_pd(M3 + 8);
  _t45_11 = _asm256_loadu_pd(M3 + 16);
  _t45_14 = _asm256_loadu_pd(M3 + 20);
  _t45_12 = _asm256_loadu_pd(M3 + 28);
  _t45_15 = _asm256_loadu_pd(M3 + 32);
  _t45_13 = _asm256_loadu_pd(M3 + 40);
  _t45_16 = _asm256_loadu_pd(M3 + 44);
  ...
  _t45_65 = _asm256_loadu_pd(M3 + 56);
  _t45_66 = _asm256_loadu_pd(M3 + 68);
  _t45_67 = _asm256_loadu_pd(M3 + 80);
  _t45_68 = _asm256_loadu_pd(M3 + 92);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_74 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_73)));

  // AVX Storer:
  _t45_0 = _t45_74;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 0), U[12,12],h(1, 12, 0)) ),h(1, 12, 0))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_75 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_77 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_75), _mm256_castpd256_pd128(_t45_76)));

  // AVX Storer:
  _t45_1 = _t45_77;

  // Generating : U[12,12] = S(h(1, 12, 0), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 0)) Kro G(h(1, 12, 0), U[12,12],h(3, 12, 1)) ),h(3, 12, 1))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_78 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_1, _t45_1, 32), _mm256_permute2f128_pd(_t45_1, _t45_1, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_80 = _mm256_mul_pd(_t45_78, _t45_79);
  ...
  // 1x1 -> 1x4
  _t45_82 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_2, 1);
  ...
  // 1x1 -> 1x4
  _t45_84 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_2, 1);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_85 = _mm256_mul_pd(_t45_83, _t45_84);

  // 4-BLAC: 1x4 - 1x4
  _t45_86 = _mm256_sub_pd(_t45_81, _t45_85);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_88 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_87)));

  // AVX Storer:
  _t45_3 = _t45_88;

  // Generating : U[12,12] = S(h(1, 12, 1), ( G(h(1, 12, 1), U[12,12],h(2, 12, 2)) - ( T( G(h(1, 12, 0), U[12,12],h(1, 12, 1)) ) Kro G(h(1, 12, 0), U[12,12],h(2, 12, 2)) ) ),h(2, 12, 2))
  ...
  // 1x1 -> 1x4
  _t45_90 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_2, _t45_2, 32), _mm256_permute2f128_pd(_t45_2, _t45_2, 32), 0);
  ...
  // 1x2 -> 1x4
  _t45_92 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t45_2, 6), _mm256_permute2f128_pd(_t45_2, _t45_2, 129), 5);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_93 = _mm256_mul_pd(_t45_91, _t45_92);

  // 4-BLAC: 1x4 - 1x4
  _t45_94 = _mm256_sub_pd(_t45_89, _t45_93);

  // AVX Storer:
  _t45_4 = _t45_94;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 1), U[12,12],h(1, 12, 1)) ),h(1, 12, 1))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_95 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_97 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_95), _mm256_castpd256_pd128(_t45_96)));

  // AVX Storer:
  _t45_5 = _t45_97;

  // Generating : U[12,12] = S(h(1, 12, 1), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 1)) Kro G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ),h(2, 12, 2))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_98 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_5, _t45_5, 32), _mm256_permute2f128_pd(_t45_5, _t45_5, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_100 = _mm256_mul_pd(_t45_98, _t45_99);
  ...
  // 2x1 -> 4x1
  _t45_102 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_2, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_4, _mm256_setzero_pd(), 12), 1);
  ...
  // 2x1 -> 4x1
  _t45_104 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_2, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_4, _mm256_setzero_pd(), 12), 1);

  // 4-BLAC: 1x4 * 4x1
  _t45_105 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_103, _t45_104), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_103, _t45_104), _mm256_mul_pd(_t45_103, _t45_104), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_103, _t45_104), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_103, _t45_104), _mm256_mul_pd(_t45_103, _t45_104), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_103, _t45_104), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_103, _t45_104), _mm256_mul_pd(_t45_103, _t45_104), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_106 = _mm256_sub_pd(_t45_101, _t45_105);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_108 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_107)));

  // AVX Storer:
  _t45_6 = _t45_108;

  // Generating : U[12,12] = S(h(1, 12, 2), ( G(h(1, 12, 2), U[12,12],h(1, 12, 3)) - ( T( G(h(2, 12, 0), U[12,12],h(1, 12, 2)) ) * G(h(2, 12, 0), U[12,12],h(1, 12, 3)) ) ),h(1, 12, 3))
  ...
  // 2x1 -> 4x1
  _t45_112 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_2, _t45_2, 129), _t45_4, 2);

  // 4-BLAC: 1x4 * 4x1
  _t45_113 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_111, _t45_112), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_111, _t45_112), _mm256_mul_pd(_t45_111, _t45_112), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_111, _t45_112), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_111, _t45_112), _mm256_mul_pd(_t45_111, _t45_112), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_111, _t45_112), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_111, _t45_112), _mm256_mul_pd(_t45_111, _t45_112), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_114 = _mm256_sub_pd(_t45_109, _t45_113);
  ...
  // 3x1 -> 4x1
  _t45_119 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_2, _t45_7, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_4, 2), 10);
  ...
  // 3x1 -> 4x1
  _t45_121 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_2, _t45_7, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_4, 2), 10);

  // 4-BLAC: 1x4 * 4x1
  _t45_122 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_120, _t45_121), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_120, _t45_121), _mm256_mul_pd(_t45_120, _t45_121), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_120, _t45_121), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_120, _t45_121), _mm256_mul_pd(_t45_120, _t45_121), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_120, _t45_121), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_120, _t45_121), _mm256_mul_pd(_t45_120, _t45_121), 129)), 1));
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_125 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_124)));

  // AVX Storer:
  _t45_8 = _t45_125;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 2), U[12,12],h(1, 12, 2)) ),h(1, 12, 2))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_126 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_128 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_126), _mm256_castpd256_pd128(_t45_127)));

  // AVX Storer:
  _t45_9 = _t45_128;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 3), U[12,12],h(1, 12, 3)) ),h(1, 12, 3))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_129 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_131 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_129), _mm256_castpd256_pd128(_t45_130)));

  // AVX Storer:
  _t45_10 = _t45_131;

  // Generating : U[12,12] = S(h(1, 12, 0), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 0)) Kro G(h(1, 12, 0), U[12,12],h(4, 12, fi1304 + 4)) ),h(4, 12, fi1304 + 4))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_132 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_1, _t45_1, 32), _mm256_permute2f128_pd(_t45_1, _t45_1, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_41 = _mm256_mul_pd(_t45_132, _t45_41);

  // AVX Storer:

  // Generating : U[12,12] = S(h(3, 12, 1), ( G(h(3, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) - ( T( G(h(1, 12, 0), U[12,12],h(3, 12, 1)) ) * G(h(1, 12, 0), U[12,12],h(4, 12, fi1304 + 4)) ) ),h(4, 12, fi1304 + 4))
  ...
  // 4-BLAC: 4x1 * 1x4
  _t45_139 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 32), _mm256_permute2f128_pd(_t45_138, _t45_138, 32), 0), _t45_41);
  _t45_140 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 32), _mm256_permute2f128_pd(_t45_138, _t45_138, 32), 15), _t45_41);
  _t45_141 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 49), _mm256_permute2f128_pd(_t45_138, _t45_138, 49), 0), _t45_41);
  _t45_142 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 49), _mm256_permute2f128_pd(_t45_138, _t45_138, 49), 15), _t45_41);

  // 4-BLAC: 4x4 - 4x4
  _t45_143 = _mm256_sub_pd(_t45_133, _t45_139);
  _t45_144 = _mm256_sub_pd(_t45_134, _t45_140);
  _t45_145 = _mm256_sub_pd(_t45_135, _t45_141);
  _t45_146 = _mm256_sub_pd(_t45_136, _t45_142);
  ...
  // Generating : U[12,12] = S(h(1, 12, 1), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 1)) Kro G(h(1, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ),h(4, 12, fi1304 + 4))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_147 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_5, _t45_5, 32), _mm256_permute2f128_pd(_t45_5, _t45_5, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_11 = _mm256_mul_pd(_t45_147, _t45_11);

  // AVX Storer:

  // Generating : U[12,12] = S(h(2, 12, 2), ( G(h(2, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) - ( T( G(h(1, 12, 1), U[12,12],h(2, 12, 2)) ) * G(h(1, 12, 1), U[12,12],h(4, 12, fi1304 + 4)) ) ),h(4, 12, fi1304 + 4))
  ...
  // 4-BLAC: 4x1 * 1x4
  _t45_154 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 32), _mm256_permute2f128_pd(_t45_153, _t45_153, 32), 0), _t45_11);
  _t45_155 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 32), _mm256_permute2f128_pd(_t45_153, _t45_153, 32), 15), _t45_11);
  _t45_156 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 49), _mm256_permute2f128_pd(_t45_153, _t45_153, 49), 0), _t45_11);
  _t45_157 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 49), _mm256_permute2f128_pd(_t45_153, _t45_153, 49), 15), _t45_11);
  ...
  // Generating : U[12,12] = S(h(1, 12, 2), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 2)) Kro G(h(1, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ),h(4, 12, fi1304 + 4))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_162 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_9, _t45_9, 32), _mm256_permute2f128_pd(_t45_9, _t45_9, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_12 = _mm256_mul_pd(_t45_162, _t45_12);

  // AVX Storer:

  // Generating : U[12,12] = S(h(1, 12, 3), ( G(h(1, 12, 3), U[12,12],h(4, 12, fi1304 + 4)) - ( T( G(h(1, 12, 2), U[12,12],h(1, 12, 3)) ) Kro G(h(1, 12, 2), U[12,12],h(4, 12, fi1304 + 4)) ) ),h(4, 12, fi1304 + 4))
  ...
  // 1x1 -> 1x4
  _t45_163 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_7, _t45_7, 32), _mm256_permute2f128_pd(_t45_7, _t45_7, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_43 = _mm256_mul_pd(_t45_164, _t45_12);

  // 4-BLAC: 1x4 - 1x4
  _t45_13 = _mm256_sub_pd(_t45_13, _t45_43);

  // AVX Storer:

  // Generating : U[12,12] = S(h(1, 12, 3), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 3)) Kro G(h(1, 12, 3), U[12,12],h(4, 12, fi1304 + 4)) ),h(4, 12, fi1304 + 4))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_165 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_10, _t45_10, 32), _mm256_permute2f128_pd(_t45_10, _t45_10, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_13 = _mm256_mul_pd(_t45_165, _t45_13);
  ...
  // 1x1 -> 1x4
  _t45_166 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_1, _t45_1, 32), _mm256_permute2f128_pd(_t45_1, _t45_1, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_42 = _mm256_mul_pd(_t45_166, _t45_42);
  ...
  // 4-BLAC: 4x1 * 1x4
  _t45_139 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 32), _mm256_permute2f128_pd(_t45_138, _t45_138, 32), 0), _t45_42);
  _t45_140 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 32), _mm256_permute2f128_pd(_t45_138, _t45_138, 32), 15), _t45_42);
  _t45_141 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 49), _mm256_permute2f128_pd(_t45_138, _t45_138, 49), 0), _t45_42);
  _t45_142 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_138, _t45_138, 49), _mm256_permute2f128_pd(_t45_138, _t45_138, 49), 15), _t45_42);

  // 4-BLAC: 4x4 - 4x4
  _t45_172 = _mm256_sub_pd(_t45_167, _t45_139);
  _t45_173 = _mm256_sub_pd(_t45_168, _t45_140);
  _t45_174 = _mm256_sub_pd(_t45_169, _t45_141);
  _t45_175 = _mm256_sub_pd(_t45_170, _t45_142);
  ...
  // 1x1 -> 1x4
  _t45_176 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_5, _t45_5, 32), _mm256_permute2f128_pd(_t45_5, _t45_5, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_14 = _mm256_mul_pd(_t45_176, _t45_14);
  ...
  _t45_177 = _t45_15;
  _t45_178 = _t45_16;
  _t45_179 = _mm256_setzero_pd();
  _t45_180 = _mm256_setzero_pd();
  ...
  // 4-BLAC: 4x1 * 1x4
  _t45_154 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 32), _mm256_permute2f128_pd(_t45_153, _t45_153, 32), 0), _t45_14);
  _t45_155 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 32), _mm256_permute2f128_pd(_t45_153, _t45_153, 32), 15), _t45_14);
  _t45_156 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 49), _mm256_permute2f128_pd(_t45_153, _t45_153, 49), 0), _t45_14);
  _t45_157 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_153, _t45_153, 49), _mm256_permute2f128_pd(_t45_153, _t45_153, 49), 15), _t45_14);

  // 4-BLAC: 4x4 - 4x4
  _t45_182 = _mm256_sub_pd(_t45_177, _t45_154);
  _t45_183 = _mm256_sub_pd(_t45_178, _t45_155);
  _t45_184 = _mm256_sub_pd(_t45_179, _t45_156);
  _t45_185 = _mm256_sub_pd(_t45_180, _t45_157);
  ...
  // 1x1 -> 1x4
  _t45_186 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_9, _t45_9, 32), _mm256_permute2f128_pd(_t45_9, _t45_9, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_15 = _mm256_mul_pd(_t45_186, _t45_15);
  ...
  // 1x1 -> 1x4
  _t45_187 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_7, _t45_7, 32), _mm256_permute2f128_pd(_t45_7, _t45_7, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_43 = _mm256_mul_pd(_t45_164, _t45_15);

  // 4-BLAC: 1x4 - 1x4
  _t45_16 = _mm256_sub_pd(_t45_16, _t45_43);
  ...
  // 1x1 -> 1x4
  _t45_188 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_10, _t45_10, 32), _mm256_permute2f128_pd(_t45_10, _t45_10, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_16 = _mm256_mul_pd(_t45_188, _t45_16);
  ...
  // 4x4 -> 4x4 - UpSymm
  _t45_189 = _t45_17;
  _t45_190 = _mm256_blend_pd(_mm256_shuffle_pd(_t45_17, _t45_18, 3), _t45_18, 12);
  _t45_191 = _mm256_permute2f128_pd(_mm256_shuffle_pd(_t45_17, _t45_18, 0), _t45_19, 49);
  _t45_192 = _mm256_permute2f128_pd(_mm256_shuffle_pd(_t45_17, _t45_18, 12), _mm256_shuffle_pd(_t45_19, _t45_20, 12), 49);

  // AVX Loader:

  // 4-BLAC: (4x4)^T
  _t45_347 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_41, _t45_11), _mm256_unpacklo_pd(_t45_12, _t45_13), 32);
  _t45_348 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_41, _t45_11), _mm256_unpackhi_pd(_t45_12, _t45_13), 32);
  _t45_349 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_41, _t45_11), _mm256_unpacklo_pd(_t45_12, _t45_13), 49);
  _t45_350 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_41, _t45_11), _mm256_unpackhi_pd(_t45_12, _t45_13), 49);

  // AVX Loader:

  // 4-BLAC: 4x4 * 4x4
  _t45_45 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_347, _t45_347, 32), _mm256_permute2f128_pd(_t45_347, _t45_347, 32), 0), _t45_41), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_347, _t45_347, 32), _mm256_permute2f128_pd(_t45_347, _t45_347, 32), 15), _t45_11)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_347, _t45_347, 49), _mm256_permute2f128_pd(_t45_347, _t45_347, 49), 0), _t45_12), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_347, _t45_347, 49), _mm256_permute2f128_pd(_t45_347, _t45_347, 49), 15), _t45_13)));
  _t45_46 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_348, _t45_348, 32), _mm256_permute2f128_pd(_t45_348, _t45_348, 32), 0), _t45_41), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_348, _t45_348, 32), _mm256_permute2f128_pd(_t45_348, _t45_348, 32), 15), _t45_11)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_348, _t45_348, 49), _mm256_permute2f128_pd(_t45_348, _t45_348, 49), 0), _t45_12), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_348, _t45_348, 49), _mm256_permute2f128_pd(_t45_348, _t45_348, 49), 15), _t45_13)));
  _t45_47 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_349, _t45_349, 32), _mm256_permute2f128_pd(_t45_349, _t45_349, 32), 0), _t45_41), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_349, _t45_349, 32), _mm256_permute2f128_pd(_t45_349, _t45_349, 32), 15), _t45_11)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_349, _t45_349, 49), _mm256_permute2f128_pd(_t45_349, _t45_349, 49), 0), _t45_12), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_349, _t45_349, 49), _mm256_permute2f128_pd(_t45_349, _t45_349, 49), 15), _t45_13)));
  _t45_48 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_350, _t45_350, 32), _mm256_permute2f128_pd(_t45_350, _t45_350, 32), 0), _t45_41), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_350, _t45_350, 32), _mm256_permute2f128_pd(_t45_350, _t45_350, 32), 15), _t45_11)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_350, _t45_350, 49), _mm256_permute2f128_pd(_t45_350, _t45_350, 49), 0), _t45_12), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_350, _t45_350, 49), _mm256_permute2f128_pd(_t45_350, _t45_350, 49), 15), _t45_13)));

  // 4-BLAC: 4x4 - 4x4
  _t45_61 = _mm256_sub_pd(_t45_189, _t45_45);
  _t45_62 = _mm256_sub_pd(_t45_190, _t45_46);
  _t45_63 = _mm256_sub_pd(_t45_191, _t45_47);
  _t45_64 = _mm256_sub_pd(_t45_192, _t45_48);
  ...
  // 1x1 -> 1x4
  _t45_193 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_17, 1);

  // 4-BLAC: sqrt(1x4)
  _t45_194 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_193)));

  // AVX Storer:
  _t45_21 = _t45_194;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 4), U[12,12],h(1, 12, 4)) ),h(1, 12, 4))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_195 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_197 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_195), _mm256_castpd256_pd128(_t45_196)));

  // AVX Storer:
  _t45_22 = _t45_197;

  // Generating : U[12,12] = S(h(1, 12, 4), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 4)) Kro G(h(1, 12, 4), U[12,12],h(3, 12, 5)) ),h(3, 12, 5))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_198 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_22, _t45_22, 32), _mm256_permute2f128_pd(_t45_22, _t45_22, 32), 0);

  // AVX Loader:

  // 1x3 -> 1x4
  _t45_199 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t45_17, 14), _mm256_permute2f128_pd(_t45_17, _t45_17, 129), 5);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_200 = _mm256_mul_pd(_t45_198, _t45_199);
  ...
  // 1x1 -> 1x4
  _t45_201 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t45_18, 2), _mm256_setzero_pd());

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_202 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_23, 1);
  ...
  // 1x1 -> 1x4
  _t45_204 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_23, 1);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_205 = _mm256_mul_pd(_t45_203, _t45_204);

  // 4-BLAC: 1x4 - 1x4
  _t45_206 = _mm256_sub_pd(_t45_201, _t45_205);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_208 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_207)));

  // AVX Storer:
  _t45_24 = _t45_208;

  // Generating : U[12,12] = S(h(1, 12, 5), ( G(h(1, 12, 5), U[12,12],h(2, 12, 6)) - ( T( G(h(1, 12, 4), U[12,12],h(1, 12, 5)) ) Kro G(h(1, 12, 4), U[12,12],h(2, 12, 6)) ) ),h(2, 12, 6))

  // AVX Loader:

  // 1x2 -> 1x4
  _t45_209 = _mm256_permute2f128_pd(_t45_18, _t45_18, 129);

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_210 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_23, _t45_23, 32), _mm256_permute2f128_pd(_t45_23, _t45_23, 32), 0);
  ...
  // 1x2 -> 1x4
  _t45_212 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t45_23, 6), _mm256_permute2f128_pd(_t45_23, _t45_23, 129), 5);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_213 = _mm256_mul_pd(_t45_211, _t45_212);

  // 4-BLAC: 1x4 - 1x4
  _t45_214 = _mm256_sub_pd(_t45_209, _t45_213);

  // AVX Storer:
  _t45_25 = _t45_214;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 5), U[12,12],h(1, 12, 5)) ),h(1, 12, 5))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_215 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_217 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_215), _mm256_castpd256_pd128(_t45_216)));

  // AVX Storer:
  _t45_26 = _t45_217;

  // Generating : U[12,12] = S(h(1, 12, 5), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 5)) Kro G(h(1, 12, 5), U[12,12],h(2, 12, 6)) ),h(2, 12, 6))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_218 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_26, _t45_26, 32), _mm256_permute2f128_pd(_t45_26, _t45_26, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_220 = _mm256_mul_pd(_t45_218, _t45_219);
  ...
  // 1x1 -> 1x4
  _t45_221 = _mm256_permute2f128_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t45_19, 4), _mm256_blend_pd(_mm256_setzero_pd(), _t45_19, 4), 129);
  ...
  // 2x1 -> 4x1
  _t45_224 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_23, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_25, _mm256_setzero_pd(), 12), 1);

  // 4-BLAC: 1x4 * 4x1
  _t45_225 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_223, _t45_224), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_223, _t45_224), _mm256_mul_pd(_t45_223, _t45_224), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_223, _t45_224), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_223, _t45_224), _mm256_mul_pd(_t45_223, _t45_224), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_223, _t45_224), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_223, _t45_224), _mm256_mul_pd(_t45_223, _t45_224), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_226 = _mm256_sub_pd(_t45_221, _t45_225);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_228 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_227)));

  // AVX Storer:
  _t45_27 = _t45_228;

  // Generating : U[12,12] = S(h(1, 12, 6), ( G(h(1, 12, 6), U[12,12],h(1, 12, 7)) - ( T( G(h(2, 12, 4), U[12,12],h(1, 12, 6)) ) * G(h(2, 12, 4), U[12,12],h(1, 12, 7)) ) ),h(1, 12, 7))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_229 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t45_19, _t45_19, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 2x1 -> 4x1
  _t45_230 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_23, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_25, _mm256_setzero_pd(), 12), 1);
  ...
  // 2x1 -> 4x1
  _t45_232 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_23, _t45_23, 129), _t45_25, 2);

  // 4-BLAC: 1x4 * 4x1
  _t45_233 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_231, _t45_232), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_231, _t45_232), _mm256_mul_pd(_t45_231, _t45_232), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_231, _t45_232), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_231, _t45_232), _mm256_mul_pd(_t45_231, _t45_232), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_231, _t45_232), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_231, _t45_232), _mm256_mul_pd(_t45_231, _t45_232), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_234 = _mm256_sub_pd(_t45_229, _t45_233);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_237 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_235), _mm256_castpd256_pd128(_t45_236)));
  ...
  // 1x1 -> 1x4
  _t45_238 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t45_20, _t45_20, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 3x1 -> 4x1
  _t45_239 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_23, _t45_28, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_25, 2), 10);
  ...
  // 3x1 -> 4x1
  _t45_241 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_23, _t45_28, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_25, 2), 10);

  // 4-BLAC: 1x4 * 4x1
  _t45_242 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_240, _t45_241), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_240, _t45_241), _mm256_mul_pd(_t45_240, _t45_241), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_240, _t45_241), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_240, _t45_241), _mm256_mul_pd(_t45_240, _t45_241), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_240, _t45_241), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_240, _t45_241), _mm256_mul_pd(_t45_240, _t45_241), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_243 = _mm256_sub_pd(_t45_238, _t45_242);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_245 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_244)));

  // AVX Storer:
  _t45_29 = _t45_245;

  // Generating : U[12,12] = S(h(4, 12, 4), ( G(h(4, 12, 4), M4[12,12],h(4, 12, 8)) - ( T( G(h(4, 12, 0), U[12,12],h(4, 12, 4)) ) * G(h(4, 12, 0), U[12,12],h(4, 12, 8)) ) ),h(4, 12, 8))
  ...
  // 4-BLAC: (4x4)^T
  _t45_351 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_41, _t45_11), _mm256_unpacklo_pd(_t45_12, _t45_13), 32);
  _t45_352 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_41, _t45_11), _mm256_unpackhi_pd(_t45_12, _t45_13), 32);
  _t45_353 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_41, _t45_11), _mm256_unpacklo_pd(_t45_12, _t45_13), 49);
  _t45_354 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_41, _t45_11), _mm256_unpackhi_pd(_t45_12, _t45_13), 49);

  // AVX Loader:

  // 4-BLAC: 4x4 * 4x4
  _t45_49 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_351, _t45_351, 32), _mm256_permute2f128_pd(_t45_351, _t45_351, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_351, _t45_351, 32), _mm256_permute2f128_pd(_t45_351, _t45_351, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_351, _t45_351, 49), _mm256_permute2f128_pd(_t45_351, _t45_351, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_351, _t45_351, 49), _mm256_permute2f128_pd(_t45_351, _t45_351, 49), 15), _t45_16)));
  _t45_50 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_352, _t45_352, 32), _mm256_permute2f128_pd(_t45_352, _t45_352, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_352, _t45_352, 32), _mm256_permute2f128_pd(_t45_352, _t45_352, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_352, _t45_352, 49), _mm256_permute2f128_pd(_t45_352, _t45_352, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_352, _t45_352, 49), _mm256_permute2f128_pd(_t45_352, _t45_352, 49), 15), _t45_16)));
  _t45_51 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_353, _t45_353, 32), _mm256_permute2f128_pd(_t45_353, _t45_353, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_353, _t45_353, 32), _mm256_permute2f128_pd(_t45_353, _t45_353, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_353, _t45_353, 49), _mm256_permute2f128_pd(_t45_353, _t45_353, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_353, _t45_353, 49), _mm256_permute2f128_pd(_t45_353, _t45_353, 49), 15), _t45_16)));
  _t45_52 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_354, _t45_354, 32), _mm256_permute2f128_pd(_t45_354, _t45_354, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_354, _t45_354, 32), _mm256_permute2f128_pd(_t45_354, _t45_354, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_354, _t45_354, 49), _mm256_permute2f128_pd(_t45_354, _t45_354, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_354, _t45_354, 49), _mm256_permute2f128_pd(_t45_354, _t45_354, 49), 15), _t45_16)));

  // 4-BLAC: 4x4 - 4x4
  _t45_65 = _mm256_sub_pd(_t45_65, _t45_49);
  _t45_66 = _mm256_sub_pd(_t45_66, _t45_50);
  _t45_67 = _mm256_sub_pd(_t45_67, _t45_51);
  _t45_68 = _mm256_sub_pd(_t45_68, _t45_52);

  // AVX Storer:

  // Generating : U[12,12] = S(h(1, 12, 4), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 4)) Kro G(h(1, 12, 4), U[12,12],h(4, 12, 8)) ),h(4, 12, 8))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_246 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_22, _t45_22, 32), _mm256_permute2f128_pd(_t45_22, _t45_22, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_65 = _mm256_mul_pd(_t45_246, _t45_65);
  ...
  // 4-BLAC: 4x1 * 1x4
  _t45_253 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_252, _t45_252, 32), _mm256_permute2f128_pd(_t45_252, _t45_252, 32), 0), _t45_65);
  _t45_254 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_252, _t45_252, 32), _mm256_permute2f128_pd(_t45_252, _t45_252, 32), 15), _t45_65);
  _t45_255 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_252, _t45_252, 49), _mm256_permute2f128_pd(_t45_252, _t45_252, 49), 0), _t45_65);
  _t45_256 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_252, _t45_252, 49), _mm256_permute2f128_pd(_t45_252, _t45_252, 49), 15), _t45_65);

  // 4-BLAC: 4x4 - 4x4
  _t45_257 = _mm256_sub_pd(_t45_247, _t45_253);
  _t45_258 = _mm256_sub_pd(_t45_248, _t45_254);
  _t45_259 = _mm256_sub_pd(_t45_249, _t45_255);
  _t45_260 = _mm256_sub_pd(_t45_250, _t45_256);
  ...
  // Generating : U[12,12] = S(h(1, 12, 5), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 5)) Kro G(h(1, 12, 5), U[12,12],h(4, 12, 8)) ),h(4, 12, 8))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_261 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_26, _t45_26, 32), _mm256_permute2f128_pd(_t45_26, _t45_26, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_66 = _mm256_mul_pd(_t45_261, _t45_66);
  ...
  _t45_262 = _t45_67;
  _t45_263 = _t45_68;
  _t45_264 = _mm256_setzero_pd();
  _t45_265 = _mm256_setzero_pd();
  ...
  // 4-BLAC: 4x1 * 1x4
  _t45_268 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_267, _t45_267, 32), _mm256_permute2f128_pd(_t45_267, _t45_267, 32), 0), _t45_66);
  _t45_269 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_267, _t45_267, 32), _mm256_permute2f128_pd(_t45_267, _t45_267, 32), 15), _t45_66);
  _t45_270 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_267, _t45_267, 49), _mm256_permute2f128_pd(_t45_267, _t45_267, 49), 0), _t45_66);
  _t45_271 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_267, _t45_267, 49), _mm256_permute2f128_pd(_t45_267, _t45_267, 49), 15), _t45_66);

  // 4-BLAC: 4x4 - 4x4
  _t45_272 = _mm256_sub_pd(_t45_262, _t45_268);
  _t45_273 = _mm256_sub_pd(_t45_263, _t45_269);
  _t45_274 = _mm256_sub_pd(_t45_264, _t45_270);
  _t45_275 = _mm256_sub_pd(_t45_265, _t45_271);

  // AVX Storer:
  _t45_67 = _t45_272;
  _t45_68 = _t45_273;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 6), U[12,12],h(1, 12, 6)) ),h(1, 12, 6))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_276 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_278 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_276), _mm256_castpd256_pd128(_t45_277)));

  // AVX Storer:
  _t45_30 = _t45_278;

  // Generating : U[12,12] = S(h(1, 12, 6), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 6)) Kro G(h(1, 12, 6), U[12,12],h(4, 12, 8)) ),h(4, 12, 8))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_279 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_30, _t45_30, 32), _mm256_permute2f128_pd(_t45_30, _t45_30, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_67 = _mm256_mul_pd(_t45_279, _t45_67);
  ...
  // 1x1 -> 1x4
  _t45_280 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_28, _t45_28, 32), _mm256_permute2f128_pd(_t45_28, _t45_28, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_44 = _mm256_mul_pd(_t45_281, _t45_67);

  // 4-BLAC: 1x4 - 1x4
  _t45_68 = _mm256_sub_pd(_t45_68, _t45_44);

  // AVX Storer:

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 7), U[12,12],h(1, 12, 7)) ),h(1, 12, 7))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_282 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_284 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_282), _mm256_castpd256_pd128(_t45_283)));

  // AVX Storer:
  _t45_31 = _t45_284;

  // Generating : U[12,12] = S(h(1, 12, 7), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 7)) Kro G(h(1, 12, 7), U[12,12],h(4, 12, 8)) ),h(4, 12, 8))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_285 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_31, _t45_31, 32), _mm256_permute2f128_pd(_t45_31, _t45_31, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t45_68 = _mm256_mul_pd(_t45_285, _t45_68);
  ...
  // 4x4 -> 4x4 - UpSymm
  _t45_286 = _t41_28;
  _t45_287 = _mm256_blend_pd(_mm256_shuffle_pd(_t41_28, _t41_29, 3), _t41_29, 12);
  _t45_288 = _mm256_permute2f128_pd(_mm256_shuffle_pd(_t41_28, _t41_29, 0), _t41_30, 49);
  _t45_289 = _mm256_permute2f128_pd(_mm256_shuffle_pd(_t41_28, _t41_29, 12), _mm256_shuffle_pd(_t41_30, _t41_31, 12), 49);

  // AVX Loader:

  // 4-BLAC: (4x4)^T
  _t45_355 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_42, _t45_14), _mm256_unpacklo_pd(_t45_15, _t45_16), 32);
  _t45_356 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_42, _t45_14), _mm256_unpackhi_pd(_t45_15, _t45_16), 32);
  _t45_357 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_42, _t45_14), _mm256_unpacklo_pd(_t45_15, _t45_16), 49);
  _t45_358 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_42, _t45_14), _mm256_unpackhi_pd(_t45_15, _t45_16), 49);

  // AVX Loader:

  // 4-BLAC: 4x4 * 4x4
  _t45_53 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_355, _t45_355, 32), _mm256_permute2f128_pd(_t45_355, _t45_355, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_355, _t45_355, 32), _mm256_permute2f128_pd(_t45_355, _t45_355, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_355, _t45_355, 49), _mm256_permute2f128_pd(_t45_355, _t45_355, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_355, _t45_355, 49), _mm256_permute2f128_pd(_t45_355, _t45_355, 49), 15), _t45_16)));
  _t45_54 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_356, _t45_356, 32), _mm256_permute2f128_pd(_t45_356, _t45_356, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_356, _t45_356, 32), _mm256_permute2f128_pd(_t45_356, _t45_356, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_356, _t45_356, 49), _mm256_permute2f128_pd(_t45_356, _t45_356, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_356, _t45_356, 49), _mm256_permute2f128_pd(_t45_356, _t45_356, 49), 15), _t45_16)));
  _t45_55 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_357, _t45_357, 32), _mm256_permute2f128_pd(_t45_357, _t45_357, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_357, _t45_357, 32), _mm256_permute2f128_pd(_t45_357, _t45_357, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_357, _t45_357, 49), _mm256_permute2f128_pd(_t45_357, _t45_357, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_357, _t45_357, 49), _mm256_permute2f128_pd(_t45_357, _t45_357, 49), 15), _t45_16)));
  _t45_56 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_358, _t45_358, 32), _mm256_permute2f128_pd(_t45_358, _t45_358, 32), 0), _t45_42), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_358, _t45_358, 32), _mm256_permute2f128_pd(_t45_358, _t45_358, 32), 15), _t45_14)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_358, _t45_358, 49), _mm256_permute2f128_pd(_t45_358, _t45_358, 49), 0), _t45_15), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_358, _t45_358, 49), _mm256_permute2f128_pd(_t45_358, _t45_358, 49), 15), _t45_16)));

  // 4-BLAC: 4x4 - 4x4
  _t45_69 = _mm256_sub_pd(_t45_286, _t45_53);
  _t45_70 = _mm256_sub_pd(_t45_287, _t45_54);
  _t45_71 = _mm256_sub_pd(_t45_288, _t45_55);
  _t45_72 = _mm256_sub_pd(_t45_289, _t45_56);
  ...
  // 4-BLAC: (4x4)^T
  _t45_359 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_65, _t45_66), _mm256_unpacklo_pd(_t45_67, _t45_68), 32);
  _t45_360 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_65, _t45_66), _mm256_unpackhi_pd(_t45_67, _t45_68), 32);
  _t45_361 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t45_65, _t45_66), _mm256_unpacklo_pd(_t45_67, _t45_68), 49);
  _t45_362 = _mm256_permute2f128_pd(_mm256_unpackhi_pd(_t45_65, _t45_66), _mm256_unpackhi_pd(_t45_67, _t45_68), 49);

  // AVX Loader:

  // 4-BLAC: 4x4 * 4x4
  _t45_57 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_359, _t45_359, 32), _mm256_permute2f128_pd(_t45_359, _t45_359, 32), 0), _t45_65), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_359, _t45_359, 32), _mm256_permute2f128_pd(_t45_359, _t45_359, 32), 15), _t45_66)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_359, _t45_359, 49), _mm256_permute2f128_pd(_t45_359, _t45_359, 49), 0), _t45_67), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_359, _t45_359, 49), _mm256_permute2f128_pd(_t45_359, _t45_359, 49), 15), _t45_68)));
  _t45_58 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_360, _t45_360, 32), _mm256_permute2f128_pd(_t45_360, _t45_360, 32), 0), _t45_65), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_360, _t45_360, 32), _mm256_permute2f128_pd(_t45_360, _t45_360, 32), 15), _t45_66)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_360, _t45_360, 49), _mm256_permute2f128_pd(_t45_360, _t45_360, 49), 0), _t45_67), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_360, _t45_360, 49), _mm256_permute2f128_pd(_t45_360, _t45_360, 49), 15), _t45_68)));
  _t45_59 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_361, _t45_361, 32), _mm256_permute2f128_pd(_t45_361, _t45_361, 32), 0), _t45_65), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_361, _t45_361, 32), _mm256_permute2f128_pd(_t45_361, _t45_361, 32), 15), _t45_66)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_361, _t45_361, 49), _mm256_permute2f128_pd(_t45_361, _t45_361, 49), 0), _t45_67), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_361, _t45_361, 49), _mm256_permute2f128_pd(_t45_361, _t45_361, 49), 15), _t45_68)));
  _t45_60 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_362, _t45_362, 32), _mm256_permute2f128_pd(_t45_362, _t45_362, 32), 0), _t45_65), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_362, _t45_362, 32), _mm256_permute2f128_pd(_t45_362, _t45_362, 32), 15), _t45_66)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_362, _t45_362, 49), _mm256_permute2f128_pd(_t45_362, _t45_362, 49), 0), _t45_67), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_362, _t45_362, 49), _mm256_permute2f128_pd(_t45_362, _t45_362, 49), 15), _t45_68)));
  ...
  // 4-BLAC: 4x4 - 4x4
  _t45_290 = _mm256_sub_pd(_t45_290, _t45_57);
  _t45_291 = _mm256_sub_pd(_t45_291, _t45_58);
  _t45_292 = _mm256_sub_pd(_t45_292, _t45_59);
  _t45_293 = _mm256_sub_pd(_t45_293, _t45_60);
  ...
  // 1x1 -> 1x4
  _t45_294 = _mm256_blend_pd(_mm256_setzero_pd(), _t41_28, 1);

  // 4-BLAC: sqrt(1x4)
  _t45_295 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_294)));

  // AVX Storer:
  _t45_32 = _t45_295;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 8), U[12,12],h(1, 12, 8)) ),h(1, 12, 8))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_296 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_298 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_296), _mm256_castpd256_pd128(_t45_297)));

  // AVX Storer:
  _t45_33 = _t45_298;

  // Generating : U[12,12] = S(h(1, 12, 8), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 8)) Kro G(h(1, 12, 8), U[12,12],h(3, 12, 9)) ),h(3, 12, 9))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_299 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_33, _t45_33, 32), _mm256_permute2f128_pd(_t45_33, _t45_33, 32), 0);

  // AVX Loader:

  // 1x3 -> 1x4
  _t45_300 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t41_28, 14), _mm256_permute2f128_pd(_t41_28, _t41_28, 129), 5);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_301 = _mm256_mul_pd(_t45_299, _t45_300);
  ...
  // 1x1 -> 1x4
  _t45_302 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t41_29, 2), _mm256_setzero_pd());

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_303 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_34, 1);
  ...
  // 1x1 -> 1x4
  _t45_305 = _mm256_blend_pd(_mm256_setzero_pd(), _t45_34, 1);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_306 = _mm256_mul_pd(_t45_304, _t45_305);

  // 4-BLAC: 1x4 - 1x4
  _t45_307 = _mm256_sub_pd(_t45_302, _t45_306);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_309 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_308)));

  // AVX Storer:
  _t45_35 = _t45_309;

  // Generating : U[12,12] = S(h(1, 12, 9), ( G(h(1, 12, 9), U[12,12],h(2, 12, 10)) - ( T( G(h(1, 12, 8), U[12,12],h(1, 12, 9)) ) Kro G(h(1, 12, 8), U[12,12],h(2, 12, 10)) ) ),h(2, 12, 10))

  // AVX Loader:

  // 1x2 -> 1x4
  _t45_310 = _mm256_permute2f128_pd(_t41_29, _t41_29, 129);

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_311 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_34, _t45_34, 32), _mm256_permute2f128_pd(_t45_34, _t45_34, 32), 0);
  ...
  // 1x2 -> 1x4
  _t45_313 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t45_34, 6), _mm256_permute2f128_pd(_t45_34, _t45_34, 129), 5);

  // 4-BLAC: 1x4 Kro 1x4
  _t45_314 = _mm256_mul_pd(_t45_312, _t45_313);

  // 4-BLAC: 1x4 - 1x4
  _t45_315 = _mm256_sub_pd(_t45_310, _t45_314);

  // AVX Storer:
  _t45_36 = _t45_315;

  // Generating : T2338[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 9), U[12,12],h(1, 12, 9)) ),h(1, 12, 9))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t45_316 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_318 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_316), _mm256_castpd256_pd128(_t45_317)));

  // AVX Storer:
  _t45_37 = _t45_318;

  // Generating : U[12,12] = S(h(1, 12, 9), ( G(h(1, 1, 0), T2338[1,12],h(1, 12, 9)) Kro G(h(1, 12, 9), U[12,12],h(2, 12, 10)) ),h(2, 12, 10))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_319 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_37, _t45_37, 32), _mm256_permute2f128_pd(_t45_37, _t45_37, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t45_321 = _mm256_mul_pd(_t45_319, _t45_320);
  ...
  // 1x1 -> 1x4
  _t45_322 = _mm256_permute2f128_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t41_30, 4), _mm256_blend_pd(_mm256_setzero_pd(), _t41_30, 4), 129);

  // AVX Loader:

  // 2x1 -> 4x1
  _t45_323 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_34, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_36, _mm256_setzero_pd(), 12), 1);
  ...
  // 2x1 -> 4x1
  _t45_325 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_34, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_36, _mm256_setzero_pd(), 12), 1);

  // 4-BLAC: 1x4 * 4x1
  _t45_326 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_324, _t45_325), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_324, _t45_325), _mm256_mul_pd(_t45_324, _t45_325), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_324, _t45_325), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_324, _t45_325), _mm256_mul_pd(_t45_324, _t45_325), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_324, _t45_325), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_324, _t45_325), _mm256_mul_pd(_t45_324, _t45_325), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_327 = _mm256_sub_pd(_t45_322, _t45_326);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_329 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_328)));

  // AVX Storer:
  _t45_38 = _t45_329;

  // Generating : U[12,12] = S(h(1, 12, 10), ( G(h(1, 12, 10), U[12,12],h(1, 12, 11)) - ( T( G(h(2, 12, 8), U[12,12],h(1, 12, 10)) ) * G(h(2, 12, 8), U[12,12],h(1, 12, 11)) ) ),h(1, 12, 11))

  // AVX Loader:

  // 1x1 -> 1x4
  _t45_330 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t41_30, _t41_30, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 2x1 -> 4x1
  _t45_331 = _mm256_shuffle_pd(_mm256_blend_pd(_t45_34, _mm256_setzero_pd(), 12), _mm256_blend_pd(_t45_36, _mm256_setzero_pd(), 12), 1);
  ...
  // 2x1 -> 4x1
  _t45_333 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_34, _t45_34, 129), _t45_36, 2);

  // 4-BLAC: 1x4 * 4x1
  _t45_334 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_332, _t45_333), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_332, _t45_333), _mm256_mul_pd(_t45_332, _t45_333), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_332, _t45_333), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_332, _t45_333), _mm256_mul_pd(_t45_332, _t45_333), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_332, _t45_333), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_332, _t45_333), _mm256_mul_pd(_t45_332, _t45_333), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_335 = _mm256_sub_pd(_t45_330, _t45_334);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t45_338 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t45_336), _mm256_castpd256_pd128(_t45_337)));
  ...
  // 1x1 -> 1x4
  _t45_339 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t41_31, _t41_31, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 3x1 -> 4x1
  _t45_340 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_34, _t45_39, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_36, 2), 10);
  ...
  // 3x1 -> 4x1
  _t45_342 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_34, _t45_39, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_36, 2), 10);

  // 4-BLAC: 1x4 * 4x1
  _t45_343 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t45_341, _t45_342), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_341, _t45_342), _mm256_mul_pd(_t45_341, _t45_342), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t45_341, _t45_342), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_341, _t45_342), _mm256_mul_pd(_t45_341, _t45_342), 129)), _mm256_add_pd(_mm256_mul_pd(_t45_341, _t45_342), _mm256_permute2f128_pd(_mm256_mul_pd(_t45_341, _t45_342), _mm256_mul_pd(_t45_341, _t45_342), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t45_344 = _mm256_sub_pd(_t45_339, _t45_343);
  ...
  // 4-BLAC: sqrt(1x4)
  _t45_346 = _mm256_castpd128_pd256(_mm_sqrt_pd(_mm256_castpd256_pd128(_t45_345)));
  ...
  _mm256_maskstore_pd(M3 + 14, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t45_4);
  _mm_store_sd(&(M3[26]), _mm256_castpd256_pd128(_t45_6));
  _mm_store_sd(&(M3[27]), _mm256_castpd256_pd128(_t45_7));
  _mm_store_sd(&(M3[39]), _mm256_castpd256_pd128(_t45_8));
  _asm256_storeu_pd(M3 + 4, _t45_41);
  _asm256_storeu_pd(M3 + 16, _t45_11);
  _asm256_storeu_pd(M3 + 28, _t45_12);
  _asm256_storeu_pd(M3 + 40, _t45_13);
  _asm256_storeu_pd(M3 + 8, _t45_42);
  _asm256_storeu_pd(M3 + 20, _t45_14);
  _asm256_storeu_pd(M3 + 32, _t45_15);
  _asm256_storeu_pd(M3 + 44, _t45_16);
  _mm_store_sd(&(M3[52]), _mm256_castpd256_pd128(_t45_21));
  _mm256_maskstore_pd(M3 + 53, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t45_23);
  _mm_store_sd(&(M3[65]), _mm256_castpd256_pd128(_t45_24));
  _mm256_maskstore_pd(M3 + 66, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t45_25);
  _mm_store_sd(&(M3[78]), _mm256_castpd256_pd128(_t45_27));
  _mm_store_sd(&(M3[79]), _mm256_castpd256_pd128(_t45_28));
  _mm_store_sd(&(M3[91]), _mm256_castpd256_pd128(_t45_29));
  _asm256_storeu_pd(M3 + 56, _t45_65);
  _asm256_storeu_pd(M3 + 68, _t45_66);
  _asm256_storeu_pd(M3 + 80, _t45_67);
  _asm256_storeu_pd(M3 + 92, _t45_68);

  for( int fi1304 = 0; fi1304 <= 7; fi1304+=4 ) {
    _t46_7 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[fi1304])));
    _t46_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304])));
    _t46_8 = _mm256_maskload_pd(v0 + fi1304 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t46_5 = _mm256_maskload_pd(M3 + 13*fi1304 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t46_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 13])));
    _t46_3 = _mm256_maskload_pd(M3 + 13*fi1304 + 14, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t46_2 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 26])));
    _t46_1 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 27])));
    _t46_0 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 39])));

    // Generating : v2[12,1] = S(h(1, 12, fi1304), ( G(h(1, 12, fi1304), v2[12,1],h(1, 1, 0)) Div G(h(1, 12, fi1304), U0[12,12],h(1, 12, fi1304)) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = S(h(3, 12, fi1304 + 1), ( G(h(3, 12, fi1304 + 1), v2[12,1],h(1, 1, 0)) - ( T( G(h(1, 12, fi1304), U0[12,12],h(3, 12, fi1304 + 1)) ) Kro G(h(1, 12, fi1304), v2[12,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = S(h(1, 12, fi1304 + 1), ( G(h(1, 12, fi1304 + 1), v2[12,1],h(1, 1, 0)) Div G(h(1, 12, fi1304 + 1), U0[12,12],h(1, 12, fi1304 + 1)) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = S(h(2, 12, fi1304 + 2), ( G(h(2, 12, fi1304 + 2), v2[12,1],h(1, 1, 0)) - ( T( G(h(1, 12, fi1304 + 1), U0[12,12],h(2, 12, fi1304 + 2)) ) Kro G(h(1, 12, fi1304 + 1), v2[12,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = S(h(1, 12, fi1304 + 2), ( G(h(1, 12, fi1304 + 2), v2[12,1],h(1, 1, 0)) Div G(h(1, 12, fi1304 + 2), U0[12,12],h(1, 12, fi1304 + 2)) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = S(h(1, 12, fi1304 + 3), ( G(h(1, 12, fi1304 + 3), v2[12,1],h(1, 1, 0)) - ( T( G(h(1, 12, fi1304 + 2), U0[12,12],h(1, 12, fi1304 + 3)) ) Kro G(h(1, 12, fi1304 + 2), v2[12,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = S(h(1, 12, fi1304 + 3), ( G(h(1, 12, fi1304 + 3), v2[12,1],h(1, 1, 0)) Div G(h(1, 12, fi1304 + 3), U0[12,12],h(1, 12, fi1304 + 3)) ),h(1, 1, 0))
    ...
    // Generating : v2[12,1] = Sum_{k3} ( S(h(4, 12, fi1304 + k3 + 4), ( G(h(4, 12, fi1304 + k3 + 4), v2[12,1],h(1, 1, 0)) - ( T( G(h(4, 12, fi1304), U0[12,12],h(4, 12, fi1304 + k3 + 4)) ) * G(h(4, 12, fi1304), v2[12,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    // AVX Loader:
    _mm_store_sd(&(v0[fi1304]), _mm256_castpd256_pd128(_t46_7));
    _mm_store_sd(&(v0[fi1304 + 1]), _mm256_castpd256_pd128(_t46_9));
    _mm_store_sd(&(v0[fi1304 + 2]), _mm256_castpd256_pd128(_t46_11));
    _mm_store_sd(&(v0[fi1304 + 3]), _mm256_castpd256_pd128(_t46_12));

    for( int k3 = 0; k3 <= -fi1304 + 7; k3+=4 ) {
      _t47_9 = _asm256_loadu_pd(v0 + fi1304 + k3 + 4);
      _t47_7 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 4);
      _t47_6 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 16);
      _t47_5 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 28);
      _t47_4 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 40);
      _t47_3 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[fi1304])));
      _t47_2 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[fi1304 + 1])));
      _t47_1 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[fi1304 + 2])));
      _t47_0 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[fi1304 + 3])));
      ...
      // AVX Storer:
      _asm256_storeu_pd(v0 + fi1304 + k3 + 4, _t47_9);
    }
  }
  ...
  _mm_store_sd(&(M3[104]), _mm256_castpd256_pd128(_t45_32));
  _mm256_maskstore_pd(M3 + 105, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t45_34);
  _mm_store_sd(&(M3[117]), _mm256_castpd256_pd128(_t45_35));
  _mm256_maskstore_pd(M3 + 118, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t45_36);
  _mm_store_sd(&(M3[130]), _mm256_castpd256_pd128(_t45_38));
  _mm_store_sd(&(M3[131]), _mm256_castpd256_pd128(_t45_39));
  _mm_store_sd(&(M3[143]), _mm256_castpd256_pd128(_t45_40));
  ...
  for( int fi1304 = 0; fi1304 <= 7; fi1304+=4 ) {
    _t49_7 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi1304 + 11])));
    _t49_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 143])));
    _t49_8 = _mm256_maskload_pd(v0 + -fi1304 + 8, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t49_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 107)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 119))), _mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 131)), 32);
    _t49_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 130])));
    _t49_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 106)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 118)), 0);
    _t49_2 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 117])));
    _t49_1 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 105])));
    _t49_0 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 104])));

    // Generating : v4[12,1] = S(h(1, 12, -fi1304 + 11), ( G(h(1, 12, -fi1304 + 11), v4[12,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 11), U0[12,12],h(1, 12, -fi1304 + 11)) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = S(h(3, 12, -fi1304 + 8), ( G(h(3, 12, -fi1304 + 8), v4[12,1],h(1, 1, 0)) - ( G(h(3, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 11)) Kro G(h(1, 12, -fi1304 + 11), v4[12,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = S(h(1, 12, -fi1304 + 10), ( G(h(1, 12, -fi1304 + 10), v4[12,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 10), U0[12,12],h(1, 12, -fi1304 + 10)) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = S(h(2, 12, -fi1304 + 8), ( G(h(2, 12, -fi1304 + 8), v4[12,1],h(1, 1, 0)) - ( G(h(2, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 10)) Kro G(h(1, 12, -fi1304 + 10), v4[12,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = S(h(1, 12, -fi1304 + 9), ( G(h(1, 12, -fi1304 + 9), v4[12,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 9), U0[12,12],h(1, 12, -fi1304 + 9)) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = S(h(1, 12, -fi1304 + 8), ( G(h(1, 12, -fi1304 + 8), v4[12,1],h(1, 1, 0)) - ( G(h(1, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 9)) Kro G(h(1, 12, -fi1304 + 9), v4[12,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = S(h(1, 12, -fi1304 + 8), ( G(h(1, 12, -fi1304 + 8), v4[12,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 8)) ),h(1, 1, 0))
    ...
    // Generating : v4[12,1] = Sum_{k3} ( S(h(4, 12, k3), ( G(h(4, 12, k3), v4[12,1],h(1, 1, 0)) - ( G(h(4, 12, k3), U0[12,12],h(4, 12, -fi1304 + 8)) * G(h(4, 12, -fi1304 + 8), v4[12,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    // AVX Loader:
    _mm_store_sd(&(v0[-fi1304 + 11]), _mm256_castpd256_pd128(_t49_7));
    _mm_store_sd(&(v0[-fi1304 + 10]), _mm256_castpd256_pd128(_t49_9));
    _mm_store_sd(&(v0[-fi1304 + 9]), _mm256_castpd256_pd128(_t49_11));
    _mm_store_sd(&(v0[-fi1304 + 8]), _mm256_castpd256_pd128(_t49_12));

    for( int k3 = 0; k3 <= -fi1304 + 7; k3+=4 ) {
      _t50_9 = _asm256_loadu_pd(v0 + k3);
      _t50_7 = _asm256_loadu_pd(M3 + -fi1304 + 12*k3 + 8);
      _t50_6 = _asm256_loadu_pd(M3 + -fi1304 + 12*k3 + 20);
      _t50_5 = _asm256_loadu_pd(M3 + -fi1304 + 12*k3 + 32);
      _t50_4 = _asm256_loadu_pd(M3 + -fi1304 + 12*k3 + 44);
      _t50_3 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi1304 + 11])));
      _t50_2 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi1304 + 10])));
      _t50_1 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi1304 + 9])));
      _t50_0 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi1304 + 8])));
  ...
  // 3x1 -> 4x1
  _t51_10 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_2, _t45_7, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_4, 2), 10);
  ...
  for( int fi1304 = 0; fi1304 <= 7; fi1304+=4 ) {
    _t52_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304])));
    _t52_5 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 13])));
    _t52_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 26])));
    _t52_3 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[13*fi1304 + 39])));
    _t52_14 = _asm256_loadu_pd(M1 + 12*fi1304);
    _t52_11 = _asm256_loadu_pd(M1 + 12*fi1304 + 12);
    _t52_12 = _asm256_loadu_pd(M1 + 12*fi1304 + 24);
    _t52_13 = _asm256_loadu_pd(M1 + 12*fi1304 + 36);
    _t52_2 = _mm256_maskload_pd(M3 + 13*fi1304 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t52_1 = _mm256_maskload_pd(M3 + 13*fi1304 + 14, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t52_0 = _mm256_broadcast_sd(&(M3[13*fi1304 + 27]));

    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, fi1304), U0[12,12],h(1, 12, fi1304)) ),h(1, 12, fi1304))
    ...
    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, fi1304 + 1), U0[12,12],h(1, 12, fi1304 + 1)) ),h(1, 12, fi1304 + 1))
    ...
    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, fi1304 + 2), U0[12,12],h(1, 12, fi1304 + 2)) ),h(1, 12, fi1304 + 2))
    ...
    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, fi1304 + 3), U0[12,12],h(1, 12, fi1304 + 3)) ),h(1, 12, fi1304 + 3))
    ...
    // Generating : M6[12,12] = S(h(1, 12, fi1304), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1304)) Kro G(h(1, 12, fi1304), M6[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    // Generating : M6[12,12] = S(h(3, 12, fi1304 + 1), ( G(h(3, 12, fi1304 + 1), M6[12,12],h(4, 12, fi1721)) - ( T( G(h(1, 12, fi1304), U0[12,12],h(3, 12, fi1304 + 1)) ) * G(h(1, 12, fi1304), M6[12,12],h(4, 12, fi1721)) ) ),h(4, 12, fi1721))
    ...
    // Generating : M6[12,12] = S(h(1, 12, fi1304 + 1), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1304 + 1)) Kro G(h(1, 12, fi1304 + 1), M6[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    // Generating : M6[12,12] = S(h(2, 12, fi1304 + 2), ( G(h(2, 12, fi1304 + 2), M6[12,12],h(4, 12, fi1721)) - ( T( G(h(1, 12, fi1304 + 1), U0[12,12],h(2, 12, fi1304 + 2)) ) * G(h(1, 12, fi1304 + 1), M6[12,12],h(4, 12, fi1721)) ) ),h(4, 12, fi1721))
    ...
    // Generating : M6[12,12] = S(h(1, 12, fi1304 + 2), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1304 + 2)) Kro G(h(1, 12, fi1304 + 2), M6[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    // Generating : M6[12,12] = S(h(1, 12, fi1304 + 3), ( G(h(1, 12, fi1304 + 3), M6[12,12],h(4, 12, fi1721)) - ( T( G(h(1, 12, fi1304 + 2), U0[12,12],h(1, 12, fi1304 + 3)) ) Kro G(h(1, 12, fi1304 + 2), M6[12,12],h(4, 12, fi1721)) ) ),h(4, 12, fi1721))
    ...
    // Generating : M6[12,12] = S(h(1, 12, fi1304 + 3), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, fi1304 + 3)) Kro G(h(1, 12, fi1304 + 3), M6[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    for( int fi1721 = 4; fi1721 <= 8; fi1721+=4 ) {
      _t53_3 = _asm256_loadu_pd(M1 + 12*fi1304 + fi1721);
      _t53_0 = _asm256_loadu_pd(M1 + 12*fi1304 + fi1721 + 12);
      _t53_1 = _asm256_loadu_pd(M1 + 12*fi1304 + fi1721 + 24);
      _t53_2 = _asm256_loadu_pd(M1 + 12*fi1304 + fi1721 + 36);
      ...
      // AVX Storer:
      _asm256_storeu_pd(M1 + 12*fi1304 + fi1721, _t53_3);
      _asm256_storeu_pd(M1 + 12*fi1304 + fi1721 + 12, _t53_0);
      _asm256_storeu_pd(M1 + 12*fi1304 + fi1721 + 24, _t53_1);
      _asm256_storeu_pd(M1 + 12*fi1304 + fi1721 + 36, _t53_2);
    }

    // Generating : M6[12,12] = Sum_{k3} ( Sum_{k2} ( S(h(4, 12, fi1304 + k3 + 4), ( G(h(4, 12, fi1304 + k3 + 4), M6[12,12],h(4, 12, k2)) - ( T( G(h(4, 12, fi1304), U0[12,12],h(4, 12, fi1304 + k3 + 4)) ) * G(h(4, 12, fi1304), M6[12,12],h(4, 12, k2)) ) ),h(4, 12, k2)) ) )
    _asm256_storeu_pd(M1 + 12*fi1304, _t52_14);
    _asm256_storeu_pd(M1 + 12*fi1304 + 12, _t52_11);
    _asm256_storeu_pd(M1 + 12*fi1304 + 24, _t52_12);
    _asm256_storeu_pd(M1 + 12*fi1304 + 36, _t52_13);

    for( int k3 = 0; k3 <= -fi1304 + 7; k3+=4 ) {

      for( int k2 = 0; k2 <= 11; k2+=4 ) {
        _t54_12 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 48);
        _t54_13 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 60);
        _t54_14 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 72);
        _t54_15 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 84);
        _t54_7 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 4);
        _t54_6 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 16);
        _t54_5 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 28);
        _t54_4 = _asm256_loadu_pd(M3 + 13*fi1304 + k3 + 40);
        _t54_3 = _asm256_loadu_pd(M1 + 12*fi1304 + k2);
        _t54_2 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 12);
        _t54_1 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 24);
        _t54_0 = _asm256_loadu_pd(M1 + 12*fi1304 + k2 + 36);
        ...
        // AVX Storer:
        _asm256_storeu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 48, _t54_12);
        _asm256_storeu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 60, _t54_13);
        _asm256_storeu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 72, _t54_14);
        _asm256_storeu_pd(M1 + 12*fi1304 + k2 + 12*k3 + 84, _t54_15);
      }
    }
  }

  _t45_34 = _mm256_maskload_pd(M3 + 105, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t45_35 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[117])));
  _t45_38 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[130])));
  _t45_39 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[131])));
  _t45_40 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[143])));
  _t45_36 = _mm256_maskload_pd(M3 + 118, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t45_32 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[104])));
  _t55_7 = _asm256_loadu_pd(M1 + 96);
  _t55_4 = _asm256_loadu_pd(M1 + 108);
  _t55_5 = _asm256_loadu_pd(M1 + 120);
  _t55_6 = _asm256_loadu_pd(M1 + 132);

  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 8), U0[12,12],h(1, 12, 8)) ),h(1, 12, 8))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t55_28 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t55_30 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t55_28), _mm256_castpd256_pd128(_t55_29)));

  // AVX Storer:
  _t55_0 = _t55_30;

  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 9), U0[12,12],h(1, 12, 9)) ),h(1, 12, 9))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t55_31 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t55_33 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t55_31), _mm256_castpd256_pd128(_t55_32)));

  // AVX Storer:
  _t55_1 = _t55_33;

  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 10), U0[12,12],h(1, 12, 10)) ),h(1, 12, 10))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t55_34 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t55_36 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t55_34), _mm256_castpd256_pd128(_t55_35)));

  // AVX Storer:
  _t55_2 = _t55_36;

  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 11), U0[12,12],h(1, 12, 11)) ),h(1, 12, 11))

  // AVX Loader:

  // Constant 1x1 -> 1x4
  _t55_37 = _mm256_set_pd(0, 0, 0, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t55_39 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t55_37), _mm256_castpd256_pd128(_t55_38)));

  // AVX Storer:
  _t55_3 = _t55_39;

  // Generating : M6[12,12] = S(h(1, 12, 8), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 8)) Kro G(h(1, 12, 8), M6[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))

  // AVX Loader:

  // 1x1 -> 1x4
  _t55_40 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_0, _t55_0, 32), _mm256_permute2f128_pd(_t55_0, _t55_0, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t55_7 = _mm256_mul_pd(_t55_40, _t55_7);

  // AVX Storer:

  // Generating : M6[12,12] = S(h(3, 12, 9), ( G(h(3, 12, 9), M6[12,12],h(4, 12, fi1304)) - ( T( G(h(1, 12, 8), U0[12,12],h(3, 12, 9)) ) * G(h(1, 12, 8), M6[12,12],h(4, 12, fi1304)) ) ),h(4, 12, fi1304))
  ...
  // 4-BLAC: 4x1 * 1x4
  _t55_47 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 32), _mm256_permute2f128_pd(_t55_46, _t55_46, 32), 0), _t55_7);
  _t55_48 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 32), _mm256_permute2f128_pd(_t55_46, _t55_46, 32), 15), _t55_7);
  _t55_49 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 49), _mm256_permute2f128_pd(_t55_46, _t55_46, 49), 0), _t55_7);
  _t55_50 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 49), _mm256_permute2f128_pd(_t55_46, _t55_46, 49), 15), _t55_7);

  // 4-BLAC: 4x4 - 4x4
  _t55_51 = _mm256_sub_pd(_t55_41, _t55_47);
  _t55_52 = _mm256_sub_pd(_t55_42, _t55_48);
  _t55_53 = _mm256_sub_pd(_t55_43, _t55_49);
  _t55_54 = _mm256_sub_pd(_t55_44, _t55_50);
  ...
  // Generating : M6[12,12] = S(h(1, 12, 9), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 9)) Kro G(h(1, 12, 9), M6[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))

  // AVX Loader:

  // 1x1 -> 1x4
  _t55_9 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_1, _t55_1, 32), _mm256_permute2f128_pd(_t55_1, _t55_1, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t55_4 = _mm256_mul_pd(_t55_9, _t55_4);

  // AVX Storer:

  // Generating : M6[12,12] = S(h(2, 12, 10), ( G(h(2, 12, 10), M6[12,12],h(4, 12, fi1304)) - ( T( G(h(1, 12, 9), U0[12,12],h(2, 12, 10)) ) * G(h(1, 12, 9), M6[12,12],h(4, 12, fi1304)) ) ),h(4, 12, fi1304))
  ...
  _t55_10 = _t55_5;
  _t55_11 = _t55_6;
  _t55_12 = _mm256_setzero_pd();
  _t55_13 = _mm256_setzero_pd();
  ...
  // 4-BLAC: 4x1 * 1x4
  _t55_16 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 32), _mm256_permute2f128_pd(_t55_15, _t55_15, 32), 0), _t55_4);
  _t55_17 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 32), _mm256_permute2f128_pd(_t55_15, _t55_15, 32), 15), _t55_4);
  _t55_18 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 49), _mm256_permute2f128_pd(_t55_15, _t55_15, 49), 0), _t55_4);
  _t55_19 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 49), _mm256_permute2f128_pd(_t55_15, _t55_15, 49), 15), _t55_4);

  // 4-BLAC: 4x4 - 4x4
  _t55_20 = _mm256_sub_pd(_t55_10, _t55_16);
  _t55_21 = _mm256_sub_pd(_t55_11, _t55_17);
  _t55_22 = _mm256_sub_pd(_t55_12, _t55_18);
  _t55_23 = _mm256_sub_pd(_t55_13, _t55_19);

  // AVX Storer:
  _t55_5 = _t55_20;
  _t55_6 = _t55_21;

  // Generating : M6[12,12] = S(h(1, 12, 10), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 10)) Kro G(h(1, 12, 10), M6[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))

  // AVX Loader:

  // 1x1 -> 1x4
  _t55_24 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_2, _t55_2, 32), _mm256_permute2f128_pd(_t55_2, _t55_2, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t55_5 = _mm256_mul_pd(_t55_24, _t55_5);

  // AVX Storer:

  // Generating : M6[12,12] = S(h(1, 12, 11), ( G(h(1, 12, 11), M6[12,12],h(4, 12, fi1304)) - ( T( G(h(1, 12, 10), U0[12,12],h(1, 12, 11)) ) Kro G(h(1, 12, 10), M6[12,12],h(4, 12, fi1304)) ) ),h(4, 12, fi1304))
  ...
  // 1x1 -> 1x4
  _t55_25 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_39, _t45_39, 32), _mm256_permute2f128_pd(_t45_39, _t45_39, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t55_8 = _mm256_mul_pd(_t55_26, _t55_5);
  ...
  // Generating : M6[12,12] = S(h(1, 12, 11), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 11)) Kro G(h(1, 12, 11), M6[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))

  // AVX Loader:

  // 1x1 -> 1x4
  _t55_27 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_3, _t55_3, 32), _mm256_permute2f128_pd(_t55_3, _t55_3, 32), 0);

  // AVX Loader:

  // 4-BLAC: 1x4 Kro 1x4
  _t55_6 = _mm256_mul_pd(_t55_27, _t55_6);

  // AVX Storer:


  for( int fi1304 = 4; fi1304 <= 8; fi1304+=4 ) {
    _t56_3 = _asm256_loadu_pd(M1 + fi1304 + 96);
    _t56_0 = _asm256_loadu_pd(M1 + fi1304 + 108);
    _t56_1 = _asm256_loadu_pd(M1 + fi1304 + 120);
    _t56_2 = _asm256_loadu_pd(M1 + fi1304 + 132);
    ...
    // 4-BLAC: 4x1 * 1x4
    _t55_47 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 32), _mm256_permute2f128_pd(_t55_46, _t55_46, 32), 0), _t56_3);
    _t55_48 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 32), _mm256_permute2f128_pd(_t55_46, _t55_46, 32), 15), _t56_3);
    _t55_49 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 49), _mm256_permute2f128_pd(_t55_46, _t55_46, 49), 0), _t56_3);
    _t55_50 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_46, _t55_46, 49), _mm256_permute2f128_pd(_t55_46, _t55_46, 49), 15), _t56_3);

    // 4-BLAC: 4x4 - 4x4
    _t56_10 = _mm256_sub_pd(_t56_5, _t55_47);
    _t56_11 = _mm256_sub_pd(_t56_6, _t55_48);
    _t56_12 = _mm256_sub_pd(_t56_7, _t55_49);
    _t56_13 = _mm256_sub_pd(_t56_8, _t55_50);
    ...
    // 4-BLAC: 4x1 * 1x4
    _t55_16 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 32), _mm256_permute2f128_pd(_t55_15, _t55_15, 32), 0), _t56_0);
    _t55_17 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 32), _mm256_permute2f128_pd(_t55_15, _t55_15, 32), 15), _t56_0);
    _t55_18 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 49), _mm256_permute2f128_pd(_t55_15, _t55_15, 49), 0), _t56_0);
    _t55_19 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t55_15, _t55_15, 49), _mm256_permute2f128_pd(_t55_15, _t55_15, 49), 15), _t56_0);

    // 4-BLAC: 4x4 - 4x4
    _t56_20 = _mm256_sub_pd(_t56_15, _t55_16);
    _t56_21 = _mm256_sub_pd(_t56_16, _t55_17);
    _t56_22 = _mm256_sub_pd(_t56_17, _t55_18);
    _t56_23 = _mm256_sub_pd(_t56_18, _t55_19);
    ...
    // 1x1 -> 1x4
    _t56_25 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t45_39, _t45_39, 32), _mm256_permute2f128_pd(_t45_39, _t45_39, 32), 0);
    ...
    // 4-BLAC: 1x4 Kro 1x4
    _t55_8 = _mm256_mul_pd(_t55_26, _t56_1);
    ...
    // AVX Storer:
    _asm256_storeu_pd(M1 + fi1304 + 96, _t56_3);
    _asm256_storeu_pd(M1 + fi1304 + 108, _t56_0);
    _asm256_storeu_pd(M1 + fi1304 + 120, _t56_1);
    _asm256_storeu_pd(M1 + fi1304 + 132, _t56_2);
  }
  ...
  for( int fi1304 = 0; fi1304 <= 7; fi1304+=4 ) {
    _t57_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 143])));
    _t57_5 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 130])));
    _t57_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 117])));
    _t57_3 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-13*fi1304 + 104])));
    _t57_14 = _asm256_loadu_pd(M1 + -12*fi1304 + 132);
    _t57_11 = _asm256_loadu_pd(M1 + -12*fi1304 + 96);
    _t57_12 = _asm256_loadu_pd(M1 + -12*fi1304 + 108);
    _t57_13 = _asm256_loadu_pd(M1 + -12*fi1304 + 120);
    _t57_2 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 107)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 119))), _mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 131)), 32);
    _t57_1 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 106)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -13*fi1304 + 118)), 0);
    _t57_0 = _mm256_broadcast_sd(&(M3[-13*fi1304 + 105]));

    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 11), U0[12,12],h(1, 12, -fi1304 + 11)) ),h(1, 12, -fi1304 + 11))
    ...
    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 10), U0[12,12],h(1, 12, -fi1304 + 10)) ),h(1, 12, -fi1304 + 10))
    ...
    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 9), U0[12,12],h(1, 12, -fi1304 + 9)) ),h(1, 12, -fi1304 + 9))
    ...
    // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 8)) ),h(1, 12, -fi1304 + 8))
    ...
    // Generating : M8[12,12] = S(h(1, 12, -fi1304 + 11), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1304 + 11)) Kro G(h(1, 12, -fi1304 + 11), M8[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    // Generating : M8[12,12] = S(h(3, 12, -fi1304 + 8), ( G(h(3, 12, -fi1304 + 8), M8[12,12],h(4, 12, fi1721)) - ( G(h(3, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 11)) * G(h(1, 12, -fi1304 + 11), M8[12,12],h(4, 12, fi1721)) ) ),h(4, 12, fi1721))
    ...
    // Generating : M8[12,12] = S(h(1, 12, -fi1304 + 10), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1304 + 10)) Kro G(h(1, 12, -fi1304 + 10), M8[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    // Generating : M8[12,12] = S(h(2, 12, -fi1304 + 8), ( G(h(2, 12, -fi1304 + 8), M8[12,12],h(4, 12, fi1721)) - ( G(h(2, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 10)) * G(h(1, 12, -fi1304 + 10), M8[12,12],h(4, 12, fi1721)) ) ),h(4, 12, fi1721))
    ...
    // Generating : M8[12,12] = S(h(1, 12, -fi1304 + 9), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1304 + 9)) Kro G(h(1, 12, -fi1304 + 9), M8[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    // Generating : M8[12,12] = S(h(1, 12, -fi1304 + 8), ( G(h(1, 12, -fi1304 + 8), M8[12,12],h(4, 12, fi1721)) - ( G(h(1, 12, -fi1304 + 8), U0[12,12],h(1, 12, -fi1304 + 9)) Kro G(h(1, 12, -fi1304 + 9), M8[12,12],h(4, 12, fi1721)) ) ),h(4, 12, fi1721))
    ...
    // Generating : M8[12,12] = S(h(1, 12, -fi1304 + 8), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, -fi1304 + 8)) Kro G(h(1, 12, -fi1304 + 8), M8[12,12],h(4, 12, fi1721)) ),h(4, 12, fi1721))
    ...
    for( int fi1721 = 4; fi1721 <= 8; fi1721+=4 ) {
      _t58_3 = _asm256_loadu_pd(M1 + -12*fi1304 + fi1721 + 132);
      _t58_0 = _asm256_loadu_pd(M1 + -12*fi1304 + fi1721 + 96);
      _t58_1 = _asm256_loadu_pd(M1 + -12*fi1304 + fi1721 + 108);
      _t58_2 = _asm256_loadu_pd(M1 + -12*fi1304 + fi1721 + 120);
      ...
      // AVX Storer:
      _asm256_storeu_pd(M1 + -12*fi1304 + fi1721 + 132, _t58_3);
      _asm256_storeu_pd(M1 + -12*fi1304 + fi1721 + 120, _t58_2);
      _asm256_storeu_pd(M1 + -12*fi1304 + fi1721 + 108, _t58_1);
      _asm256_storeu_pd(M1 + -12*fi1304 + fi1721 + 96, _t58_0);
    }

    // Generating : M8[12,12] = Sum_{k3} ( Sum_{k2} ( S(h(4, 12, k3), ( G(h(4, 12, k3), M8[12,12],h(4, 12, k2)) - ( G(h(4, 12, k3), U0[12,12],h(4, 12, -fi1304 + 8)) * G(h(4, 12, -fi1304 + 8), M8[12,12],h(4, 12, k2)) ) ),h(4, 12, k2)) ) )
    _asm256_storeu_pd(M1 + -12*fi1304 + 132, _t57_14);
    _asm256_storeu_pd(M1 + -12*fi1304 + 120, _t57_13);
    _asm256_storeu_pd(M1 + -12*fi1304 + 108, _t57_12);
    _asm256_storeu_pd(M1 + -12*fi1304 + 96, _t57_11);
    ...
    for( int k3 = 0; k3 <= -fi1304 + 7; k3+=4 ) {
      ...
      for( int k2 = 0; k2 <= 11; k2+=4 ) {
        ...
        _t59_19 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 8);
        _t59_18 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 9);
        _t59_17 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 10);
        _t59_16 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 11);
        _t59_15 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 20);
        _t59_14 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 21);
        _t59_13 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 22);
        _t59_12 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 23);
        _t59_11 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 32);
        _t59_10 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 33);
        _t59_9 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 34);
        _t59_8 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 35);
        _t59_7 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 44);
        _t59_6 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 45);
        _t59_5 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 46);
        _t59_4 = _mm256_broadcast_sd(M3 + -fi1304 + 12*k3 + 47);
        _t59_3 = _asm256_loadu_pd(M1 + -12*fi1304 + k2 + 96);
        _t59_2 = _asm256_loadu_pd(M1 + -12*fi1304 + k2 + 108);
        _t59_1 = _asm256_loadu_pd(M1 + -12*fi1304 + k2 + 120);
        _t59_0 = _asm256_loadu_pd(M1 + -12*fi1304 + k2 + 132);
  ...
  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 3), U0[12,12],h(1, 12, 3)) ),h(1, 12, 3))
  ...
  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 2), U0[12,12],h(1, 12, 2)) ),h(1, 12, 2))
  ...
  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 1), U0[12,12],h(1, 12, 1)) ),h(1, 12, 1))
  ...
  // Generating : T2401[1,12] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 12, 0), U0[12,12],h(1, 12, 0)) ),h(1, 12, 0))
  ...
  // Generating : M8[12,12] = S(h(1, 12, 3), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 3)) Kro G(h(1, 12, 3), M8[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))
  ...
  // Generating : M8[12,12] = S(h(3, 12, 0), ( G(h(3, 12, 0), M8[12,12],h(4, 12, fi1304)) - ( G(h(3, 12, 0), U0[12,12],h(1, 12, 3)) * G(h(1, 12, 3), M8[12,12],h(4, 12, fi1304)) ) ),h(4, 12, fi1304))
  ...
  // 3x1 -> 4x1
  _t60_26 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_2, _t45_7, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_4, 2), 10);
  ...
  // Generating : M8[12,12] = S(h(1, 12, 2), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 2)) Kro G(h(1, 12, 2), M8[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))
  ...
  // Generating : M8[12,12] = S(h(2, 12, 0), ( G(h(2, 12, 0), M8[12,12],h(4, 12, fi1304)) - ( G(h(2, 12, 0), U0[12,12],h(1, 12, 2)) * G(h(1, 12, 2), M8[12,12],h(4, 12, fi1304)) ) ),h(4, 12, fi1304))
  ...
  // Generating : M8[12,12] = S(h(1, 12, 1), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 1)) Kro G(h(1, 12, 1), M8[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))
  ...
  // Generating : M8[12,12] = S(h(1, 12, 0), ( G(h(1, 12, 0), M8[12,12],h(4, 12, fi1304)) - ( G(h(1, 12, 0), U0[12,12],h(1, 12, 1)) Kro G(h(1, 12, 1), M8[12,12],h(4, 12, fi1304)) ) ),h(4, 12, fi1304))
  ...
  // Generating : M8[12,12] = S(h(1, 12, 0), ( G(h(1, 1, 0), T2401[1,12],h(1, 12, 0)) Kro G(h(1, 12, 0), M8[12,12],h(4, 12, fi1304)) ),h(4, 12, fi1304))
  ...
  for( int fi1304 = 4; fi1304 <= 8; fi1304+=4 ) {
    _t61_3 = _asm256_loadu_pd(M1 + fi1304 + 36);
    _t61_0 = _asm256_loadu_pd(M1 + fi1304);
    _t61_1 = _asm256_loadu_pd(M1 + fi1304 + 12);
    _t61_2 = _asm256_loadu_pd(M1 + fi1304 + 24);
    ...
    // 3x1 -> 4x1
    _t61_9 = _mm256_blend_pd(_mm256_permute2f128_pd(_t45_2, _t45_7, 33), _mm256_blend_pd(_mm256_setzero_pd(), _t45_4, 2), 10);
    ...
    // AVX Storer:
    _asm256_storeu_pd(M1 + fi1304 + 36, _t61_3);
    _asm256_storeu_pd(M1 + fi1304 + 24, _t61_2);
    _asm256_storeu_pd(M1 + fi1304 + 12, _t61_1);
    _asm256_storeu_pd(M1 + fi1304, _t61_0);
  }
