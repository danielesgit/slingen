 ...
 * kf_kernel.h
 *
Decl { {'T2019': Matrix[T2019, (1, 28), GenMatAccess], u'B': SquaredMatrix[B, (28, 28), GenMatAccess], u'F': SquaredMatrix[F, (28, 28), GenMatAccess], 'T1982': Matrix[T1982, (1, 28), GenMatAccess], u'H': SquaredMatrix[H, (28, 28), GenMatAccess], u'U0': UpperTriangular[U0, (28, 28), GenMatAccess], u'M5': SquaredMatrix[M5, (28, 28), GenMatAccess], u'M4': Symmetric[M4, (28, 28), USMatAccess], u'M7': SquaredMatrix[M7, (28, 28), GenMatAccess], u'M6': SquaredMatrix[M6, (28, 28), GenMatAccess], u'v4': Matrix[v4, (28, 1), GenMatAccess], u'M0': SquaredMatrix[M0, (28, 28), GenMatAccess], u'M3': Symmetric[M3, (28, 28), USMatAccess], u'M2': SquaredMatrix[M2, (28, 28), GenMatAccess], u'Y': Symmetric[Y, (28, 28), USMatAccess], u'R': Symmetric[R, (28, 28), USMatAccess], u'U': UpperTriangular[U, (28, 28), GenMatAccess], u'M8': SquaredMatrix[M8, (28, 28), GenMatAccess], u'v0': Matrix[v0, (28, 1), GenMatAccess], u'u': Matrix[u, (28, 1), GenMatAccess], u'P': Symmetric[P, (28, 28), USMatAccess], u'v2': Matrix[v2, (28, 1), GenMatAccess], u'v1': Matrix[v1, (28, 1), GenMatAccess], u'v3': Matrix[v3, (28, 1), GenMatAccess], u'Q': Symmetric[Q, (28, 28), USMatAccess], u'x': Matrix[x, (28, 1), GenMatAccess], u'y': Matrix[y, (28, 1), GenMatAccess], u'M1': SquaredMatrix[M1, (28, 28), GenMatAccess], u'z': Matrix[z, (28, 1), GenMatAccess]} }
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Eq.ann: {}
Entry 7:
For_{fi35;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, fi35), U[28,28],h(1, 28, fi35)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi35), U[28,28],h(1, 28, fi35)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi35), U[28,28],h(1, 28, fi35)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi35 + 1), U[28,28],h(3, 28, fi35 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi35 + 1), U[28,28],h(3, 28, fi35 + 1)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, fi35 + 1), U[28,28],h(1, 28, fi35 + 1)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi35 + 1), U[28,28],h(1, 28, fi35 + 1)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi35 + 1), U[28,28],h(1, 28, fi35 + 1)) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi35 + 2), U[28,28],h(2, 28, fi35 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi35 + 2), U[28,28],h(2, 28, fi35 + 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) ) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) = ( Tile( (1, 1), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) Div Tile( (1, 1), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ) )
Eq.ann: {}
Entry 14:
For_{fi96;0;-fi35 + 20;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 3), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 3), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 3), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi35 + 3), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ) )
Eq.ann: {}
 )Entry 15:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi35 + 24, 28, fi35 + 4), U[28,28],h(-fi35 + 24, 28, fi35 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi35 + 24, 28, fi35 + 4), U[28,28],h(-fi35 + 24, 28, fi35 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi35), U[28,28],h(-fi35 + 24, 28, fi35 + 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi35), U[28,28],h(-fi35 + 24, 28, fi35 + 4)) ) ) ) )
Eq.ann: {}
 )Entry 8:
Eq: Tile( (1, 1), G(h(1, 28, 24), U[28,28],h(1, 28, 24)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, 24), U[28,28],h(1, 28, 24)) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1982[1,28],h(1, 28, 24)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 24), U[28,28],h(1, 28, 24)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, 24)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), U[28,28],h(3, 28, 25)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), U[28,28],h(3, 28, 25)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ) ) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), G(h(1, 28, 25), U[28,28],h(1, 28, 25)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, 25), U[28,28],h(1, 28, 25)) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1982[1,28],h(1, 28, 25)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 25), U[28,28],h(1, 28, 25)) ) )
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1982[1,28],h(1, 28, 25)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ) ) )
Eq.ann: {}
Entry 15:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), U[28,28],h(2, 28, 26)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), U[28,28],h(2, 28, 26)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ) ) ) )
Eq.ann: {}
Entry 16:
...
Eq.ann: {}
Entry 18:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), U[28,28],h(1, 28, 27)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), U[28,28],h(1, 28, 27)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 26), U[28,28],h(1, 28, 27)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 26), U[28,28],h(1, 28, 27)) ) ) ) )
Eq.ann: {}
Entry 19:
Eq: Tile( (1, 1), G(h(1, 28, 27), U[28,28],h(1, 28, 27)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, 27), U[28,28],h(1, 28, 27)) ) )
Eq.ann: {}
Entry 20:
For_{fi182;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, fi182), v2[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi182), v2[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi182), U0[28,28],h(1, 28, fi182)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi182 + 1), v2[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi182 + 1), v2[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182), U0[28,28],h(3, 28, fi182 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182), v2[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 28, fi182 + 1), v2[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi182 + 1), v2[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi182 + 1), U0[28,28],h(1, 28, fi182 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi182 + 2), v2[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi182 + 2), v2[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182 + 1), U0[28,28],h(2, 28, fi182 + 2)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182 + 1), v2[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, fi182 + 2), v2[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi182 + 2), v2[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi182 + 2), U0[28,28],h(1, 28, fi182 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182 + 3), v2[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182 + 3), v2[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182 + 2), U0[28,28],h(1, 28, fi182 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi182 + 2), v2[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 28, fi182 + 3), v2[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi182 + 3), v2[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi182 + 3), U0[28,28],h(1, 28, fi182 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi182 + 24, 28, fi182 + 4), v2[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi182 + 24, 28, fi182 + 4), v2[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi182), U0[28,28],h(-fi182 + 24, 28, fi182 + 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi182), v2[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 21:
...
Eq.ann: {}
Entry 28:
For_{fi259;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, -fi259 + 27), v4[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi259 + 27), v4[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi259 + 27), U0[28,28],h(1, 28, -fi259 + 27)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi259 + 24), U0[28,28],h(1, 28, -fi259 + 27)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi259 + 27), v4[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 28, -fi259 + 26), v4[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi259 + 26), v4[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi259 + 26), U0[28,28],h(1, 28, -fi259 + 26)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi259 + 24), U0[28,28],h(1, 28, -fi259 + 26)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi259 + 26), v4[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, -fi259 + 25), v4[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi259 + 25), v4[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi259 + 25), U0[28,28],h(1, 28, -fi259 + 25)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi259 + 24), U0[28,28],h(1, 28, -fi259 + 25)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi259 + 25), v4[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi259 + 24), U0[28,28],h(1, 28, -fi259 + 24)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi259 + 24, 28, 0), v4[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi259 + 24, 28, 0), v4[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi259 + 24, 28, 0), U0[28,28],h(4, 28, -fi259 + 24)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, -fi259 + 24), v4[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 29:
...
Eq.ann: {}
Entry 36:
For_{fi336;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi336), U0[28,28],h(1, 28, fi336)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi336 + 1), U0[28,28],h(1, 28, fi336 + 1)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336 + 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi336 + 2), U0[28,28],h(1, 28, fi336 + 2)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336 + 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi336 + 3), U0[28,28],h(1, 28, fi336 + 3)) ) )
Eq.ann: {}
Entry 4:
For_{fi355;0;24;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336), M6[28,28],h(4, 28, fi355)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi336 + 1), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi336 + 1), M6[28,28],h(4, 28, fi355)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336), U0[28,28],h(3, 28, fi336 + 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336), M6[28,28],h(4, 28, fi355)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 1), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 1), M6[28,28],h(4, 28, fi355)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi336 + 2), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi336 + 2), M6[28,28],h(4, 28, fi355)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 1), U0[28,28],h(2, 28, fi336 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 1), M6[28,28],h(4, 28, fi355)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 2), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 2), M6[28,28],h(4, 28, fi355)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 3), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 3), M6[28,28],h(4, 28, fi355)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 2), U0[28,28],h(1, 28, fi336 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 2), M6[28,28],h(4, 28, fi355)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 3), M6[28,28],h(4, 28, fi355)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, fi336 + 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi336 + 3), M6[28,28],h(4, 28, fi355)) ) ) )
Eq.ann: {}
 )Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi336 + 24, 28, fi336 + 4), M6[28,28],h(28, 28, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi336 + 24, 28, fi336 + 4), M6[28,28],h(28, 28, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi336), U0[28,28],h(-fi336 + 24, 28, fi336 + 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi336), M6[28,28],h(28, 28, 0)) ) ) ) )
Eq.ann: {}
 )Entry 37:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 24)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 24), U0[28,28],h(1, 28, 24)) ) )
Eq.ann: {}
Entry 38:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 25)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 25), U0[28,28],h(1, 28, 25)) ) )
Eq.ann: {}
Entry 39:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 26)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 26), U0[28,28],h(1, 28, 26)) ) )
Eq.ann: {}
Entry 40:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 27)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 27), U0[28,28],h(1, 28, 27)) ) )
Eq.ann: {}
Entry 41:
For_{fi402;0;24;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 24)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), M6[28,28],h(4, 28, fi402)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), M6[28,28],h(4, 28, fi402)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), U0[28,28],h(3, 28, 25)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 24), M6[28,28],h(4, 28, fi402)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 25)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), M6[28,28],h(4, 28, fi402)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), M6[28,28],h(4, 28, fi402)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), U0[28,28],h(2, 28, 26)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 25), M6[28,28],h(4, 28, fi402)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 26), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 26)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 26), M6[28,28],h(4, 28, fi402)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), M6[28,28],h(4, 28, fi402)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 26), U0[28,28],h(1, 28, 27)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 26), M6[28,28],h(4, 28, fi402)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), M6[28,28],h(4, 28, fi402)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 27)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), M6[28,28],h(4, 28, fi402)) ) ) )
Eq.ann: {}
 )Entry 42:
For_{fi449;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 27)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, -fi449 + 27), U0[28,28],h(1, 28, -fi449 + 27)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 26)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, -fi449 + 26), U0[28,28],h(1, 28, -fi449 + 26)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 25)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, -fi449 + 25), U0[28,28],h(1, 28, -fi449 + 25)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 24)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, -fi449 + 24), U0[28,28],h(1, 28, -fi449 + 24)) ) )
Eq.ann: {}
Entry 4:
For_{fi468;0;24;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 27), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 27)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 27), M8[28,28],h(4, 28, fi468)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi449 + 24), U0[28,28],h(1, 28, -fi449 + 27)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 27), M8[28,28],h(4, 28, fi468)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 26), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 26)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 26), M8[28,28],h(4, 28, fi468)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi449 + 24), U0[28,28],h(1, 28, -fi449 + 26)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 26), M8[28,28],h(4, 28, fi468)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 25), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 25)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 25), M8[28,28],h(4, 28, fi468)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 24), U0[28,28],h(1, 28, -fi449 + 25)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 25), M8[28,28],h(4, 28, fi468)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi449 + 24)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi449 + 24), M8[28,28],h(4, 28, fi468)) ) ) )
Eq.ann: {}
 )Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi449 + 24, 28, 0), M8[28,28],h(28, 28, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi449 + 24, 28, 0), M8[28,28],h(28, 28, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi449 + 24, 28, 0), U0[28,28],h(4, 28, -fi449 + 24)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, -fi449 + 24), M8[28,28],h(28, 28, 0)) ) ) ) )
Eq.ann: {}
 )Entry 43:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 3), U0[28,28],h(1, 28, 3)) ) )
Eq.ann: {}
Entry 44:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 2), U0[28,28],h(1, 28, 2)) ) )
Eq.ann: {}
Entry 45:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 1), U0[28,28],h(1, 28, 1)) ) )
Eq.ann: {}
Entry 46:
Eq: Tile( (1, 1), G(h(1, 1, 0), T2019[1,28],h(1, 28, 0)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 0), U0[28,28],h(1, 28, 0)) ) )
Eq.ann: {}
Entry 47:
For_{fi515;0;24;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 3), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 3), M8[28,28],h(4, 28, fi515)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 0), U0[28,28],h(1, 28, 3)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 3), M8[28,28],h(4, 28, fi515)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 2), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 2), M8[28,28],h(4, 28, fi515)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 0), U0[28,28],h(1, 28, 2)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 2), M8[28,28],h(4, 28, fi515)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 1), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 1), M8[28,28],h(4, 28, fi515)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 0), U0[28,28],h(1, 28, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 1), M8[28,28],h(4, 28, fi515)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T2019[1,28],h(1, 28, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 0), M8[28,28],h(4, 28, fi515)) ) ) )
Eq.ann: {}
 )Entry 48:
...
static __attribute__((noinline)) void kernel(double const * F, double const * B, double const * u, double const * Q, double const * z, double const * H, double const * R, double * y, double * x, double * M0, double * P, double * Y, double * v0, double * M1, double * M2, double * M3)
{
  ...
  for( int fi35 = 0; fi35 <= 19; fi35+=4 ) {
    _t48_0 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35])));
    _t48_2 = _mm256_maskload_pd(M3 + 29*fi35 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t48_3 = _mm256_maskload_pd(M3 + 29*fi35 + 29, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t48_4 = _mm256_maskload_pd(M3 + 29*fi35 + 57, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t48_5 = _mm256_maskload_pd(M3 + 29*fi35 + 85, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, 0));
    ...
    // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35), U[28,28],h(1, 28, fi35)) ),h(1, 28, fi35))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35)) Kro G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ),h(3, 28, fi35 + 1))
    ...
    // Generating : U[28,28] = S(h(3, 28, fi35 + 1), ( G(h(3, 28, fi35 + 1), U[28,28],h(3, 28, fi35 + 1)) - ( T( G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) * G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) ),h(3, 28, fi35 + 1))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35 + 1), Sqrt( G(h(1, 28, fi35 + 1), U[28,28],h(1, 28, fi35 + 1)) ),h(1, 28, fi35 + 1))
    ...
    // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 1), U[28,28],h(1, 28, fi35 + 1)) ),h(1, 28, fi35 + 1))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35 + 1), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 1)) Kro G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ),h(2, 28, fi35 + 2))
    ...
    // Generating : U[28,28] = S(h(2, 28, fi35 + 2), ( G(h(2, 28, fi35 + 2), U[28,28],h(2, 28, fi35 + 2)) - ( T( G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) * G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) ),h(2, 28, fi35 + 2))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35 + 2), Sqrt( G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ),h(1, 28, fi35 + 2))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35 + 2), ( G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) Div G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ),h(1, 28, fi35 + 3))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35 + 3), ( G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) - ( T( G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) Kro G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) ),h(1, 28, fi35 + 3))
    ...
    // Generating : U[28,28] = S(h(1, 28, fi35 + 3), Sqrt( G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ),h(1, 28, fi35 + 3))
    ...
    // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 2)) ),h(1, 28, fi35 + 2))
    ...
    // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 3), U[28,28],h(1, 28, fi35 + 3)) ),h(1, 28, fi35 + 3))
    ...
    // AVX Storer:
    _t48_15 = _t48_80;
    _mm256_maskstore_pd(M3 + 29*fi35 + 29, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t48_3);
    _mm256_maskstore_pd(M3 + 29*fi35 + 58, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t48_9);

    for( int fi96 = 0; fi96 <= -fi35 + 20; fi96+=4 ) {
      _t49_3 = _asm256_loadu_pd(M3 + 29*fi35 + fi96 + 4);
      _t49_0 = _asm256_loadu_pd(M3 + 29*fi35 + fi96 + 32);
      _t49_1 = _asm256_loadu_pd(M3 + 29*fi35 + fi96 + 60);
      _t49_2 = _asm256_loadu_pd(M3 + 29*fi35 + fi96 + 88);

      // Generating : U[28,28] = S(h(1, 28, fi35), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35)) Kro G(h(1, 28, fi35), U[28,28],h(4, 28, fi35 + fi96 + 4)) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // Generating : U[28,28] = S(h(3, 28, fi35 + 1), ( G(h(3, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) - ( T( G(h(1, 28, fi35), U[28,28],h(3, 28, fi35 + 1)) ) * G(h(1, 28, fi35), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // Generating : U[28,28] = S(h(1, 28, fi35 + 1), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 1)) Kro G(h(1, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // Generating : U[28,28] = S(h(2, 28, fi35 + 2), ( G(h(2, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) - ( T( G(h(1, 28, fi35 + 1), U[28,28],h(2, 28, fi35 + 2)) ) * G(h(1, 28, fi35 + 1), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // Generating : U[28,28] = S(h(1, 28, fi35 + 2), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 2)) Kro G(h(1, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // Generating : U[28,28] = S(h(1, 28, fi35 + 3), ( G(h(1, 28, fi35 + 3), U[28,28],h(4, 28, fi35 + fi96 + 4)) - ( T( G(h(1, 28, fi35 + 2), U[28,28],h(1, 28, fi35 + 3)) ) Kro G(h(1, 28, fi35 + 2), U[28,28],h(4, 28, fi35 + fi96 + 4)) ) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // Generating : U[28,28] = S(h(1, 28, fi35 + 3), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, fi35 + 3)) Kro G(h(1, 28, fi35 + 3), U[28,28],h(4, 28, fi35 + fi96 + 4)) ),h(4, 28, fi35 + fi96 + 4))
      ...
      // AVX Storer:
      _asm256_storeu_pd(M3 + 29*fi35 + fi96 + 4, _t49_3);
      _asm256_storeu_pd(M3 + 29*fi35 + fi96 + 32, _t49_0);
      _asm256_storeu_pd(M3 + 29*fi35 + fi96 + 60, _t49_1);
      _asm256_storeu_pd(M3 + 29*fi35 + fi96 + 88, _t49_2);
    }

    // Generating : U[28,28] = ( Sum_{k3} ( ( S(h(4, 28, fi35 + k3 + 4), ( G(h(4, 28, fi35 + k3 + 4), U[28,28],h(4, 28, fi35 + k3 + 4)) - ( T( G(h(4, 28, fi35), U[28,28],h(4, 28, fi35 + k3 + 4)) ) * G(h(4, 28, fi35), U[28,28],h(4, 28, fi35 + k3 + 4)) ) ),h(4, 28, fi35 + k3 + 4)) + Sum_{k2} ( S(h(4, 28, fi35 + k3 + 4), ( G(h(4, 28, fi35 + k3 + 4), U[28,28],h(4, 28, fi35 + k2 + 4)) - ( T( G(h(4, 28, fi35), U[28,28],h(4, 28, fi35 + k3 + 4)) ) * G(h(4, 28, fi35), U[28,28],h(4, 28, fi35 + k2 + 4)) ) ),h(4, 28, fi35 + k2 + 4)) ) ) ) + S(h(4, 28, 24), ( G(h(4, 28, 24), U[28,28],h(4, 28, 24)) - ( T( G(h(4, 28, fi35), U[28,28],h(4, 28, 24)) ) * G(h(4, 28, fi35), U[28,28],h(4, 28, 24)) ) ),h(4, 28, 24)) )
    _mm_store_sd(&(M3[29*fi35]), _mm256_castpd256_pd128(_t48_0));
    _mm256_maskstore_pd(M3 + 29*fi35 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t48_2);
    _mm_store_sd(&(M3[29*fi35 + 29]), _mm256_castpd256_pd128(_t48_6));
    _mm256_maskstore_pd(M3 + 29*fi35 + 30, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t48_8);
    _mm_store_sd(&(M3[29*fi35 + 58]), _mm256_castpd256_pd128(_t48_11));
    _mm_store_sd(&(M3[29*fi35 + 59]), _mm256_castpd256_pd128(_t48_12));
    _mm_store_sd(&(M3[29*fi35 + 87]), _mm256_castpd256_pd128(_t48_13));

    for( int k3 = 0; k3 <= -fi35 + 16; k3+=4 ) {
      _t50_4 = _asm256_loadu_pd(M3 + 29*fi35 + 29*k3 + 116);
      _t50_5 = _mm256_maskload_pd(M3 + 29*fi35 + 29*k3 + 144, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
      _t50_6 = _mm256_maskload_pd(M3 + 29*fi35 + 29*k3 + 172, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
      _t50_7 = _mm256_maskload_pd(M3 + 29*fi35 + 29*k3 + 200, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
      _t50_3 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 4);
      _t50_2 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 32);
      _t50_1 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 60);
      _t50_0 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 88);
      ...
      for( int k2 = 4*floord(k3 - 1, 4) + 8; k2 <= -fi35 + 23; k2+=4 ) {
        _t51_8 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 28*k3 + 116);
        _t51_9 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 28*k3 + 144);
        _t51_10 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 28*k3 + 172);
        _t51_11 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 28*k3 + 200);
        _t51_3 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 4);
        _t51_2 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 32);
        _t51_1 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 60);
        _t51_0 = _asm256_loadu_pd(M3 + 29*fi35 + k2 + 88);
        ...
        // AVX Storer:
        _asm256_storeu_pd(M3 + 29*fi35 + k2 + 28*k3 + 116, _t51_8);
        _asm256_storeu_pd(M3 + 29*fi35 + k2 + 28*k3 + 144, _t51_9);
        _asm256_storeu_pd(M3 + 29*fi35 + k2 + 28*k3 + 172, _t51_10);
        _asm256_storeu_pd(M3 + 29*fi35 + k2 + 28*k3 + 200, _t51_11);
      }
      _asm256_storeu_pd(M3 + 29*fi35 + 29*k3 + 116, _t50_4);
      _mm256_maskstore_pd(M3 + 29*fi35 + 29*k3 + 144, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t50_5);
      _mm256_maskstore_pd(M3 + 29*fi35 + 29*k3 + 172, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t50_6);
      _mm256_maskstore_pd(M3 + 29*fi35 + 29*k3 + 200, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t50_7);
    }
    _t52_3 = _asm256_loadu_pd(M3 + 28*fi35 + 24);
    _t52_2 = _asm256_loadu_pd(M3 + 28*fi35 + 52);
    _t52_1 = _asm256_loadu_pd(M3 + 28*fi35 + 80);
    _t52_0 = _asm256_loadu_pd(M3 + 28*fi35 + 108);
  ...
  _t53_0 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[580])));
  _t53_2 = _mm256_maskload_pd(M3 + 581, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t53_3 = _mm256_maskload_pd(M3 + 609, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t53_4 = _mm256_maskload_pd(M3 + 637, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t53_5 = _mm256_maskload_pd(M3 + 665, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, 0));
  _t53_33 = _asm256_loadu_pd(M3 + 584);
  _t53_16 = _asm256_loadu_pd(M3 + 612);
  _t53_17 = _asm256_loadu_pd(M3 + 640);
  _t53_18 = _asm256_loadu_pd(M3 + 668);

  // Generating : U[28,28] = S(h(1, 28, 20), Sqrt( G(h(1, 28, 20), U[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 20), U[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : U[28,28] = S(h(1, 28, 20), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 20)) Kro G(h(1, 28, 20), U[28,28],h(3, 28, 21)) ),h(3, 28, 21))
  ...
  // Generating : U[28,28] = S(h(3, 28, 21), ( G(h(3, 28, 21), U[28,28],h(3, 28, 21)) - ( T( G(h(1, 28, 20), U[28,28],h(3, 28, 21)) ) * G(h(1, 28, 20), U[28,28],h(3, 28, 21)) ) ),h(3, 28, 21))
  ...
  // Generating : U[28,28] = S(h(1, 28, 21), Sqrt( G(h(1, 28, 21), U[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 21), U[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : U[28,28] = S(h(1, 28, 21), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 21)) Kro G(h(1, 28, 21), U[28,28],h(2, 28, 22)) ),h(2, 28, 22))
  ...
  // Generating : U[28,28] = S(h(2, 28, 22), ( G(h(2, 28, 22), U[28,28],h(2, 28, 22)) - ( T( G(h(1, 28, 21), U[28,28],h(2, 28, 22)) ) * G(h(1, 28, 21), U[28,28],h(2, 28, 22)) ) ),h(2, 28, 22))
  ...
  // Generating : U[28,28] = S(h(1, 28, 22), Sqrt( G(h(1, 28, 22), U[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : U[28,28] = S(h(1, 28, 22), ( G(h(1, 28, 22), U[28,28],h(1, 28, 23)) Div G(h(1, 28, 22), U[28,28],h(1, 28, 22)) ),h(1, 28, 23))
  ...
  // Generating : U[28,28] = S(h(1, 28, 23), ( G(h(1, 28, 23), U[28,28],h(1, 28, 23)) - ( T( G(h(1, 28, 22), U[28,28],h(1, 28, 23)) ) Kro G(h(1, 28, 22), U[28,28],h(1, 28, 23)) ) ),h(1, 28, 23))
  ...
  // Generating : U[28,28] = S(h(1, 28, 23), Sqrt( G(h(1, 28, 23), U[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 22), U[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 23), U[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : U[28,28] = S(h(1, 28, 20), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 20)) Kro G(h(1, 28, 20), U[28,28],h(4, 28, 24)) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(3, 28, 21), ( G(h(3, 28, 21), U[28,28],h(4, 28, 24)) - ( T( G(h(1, 28, 20), U[28,28],h(3, 28, 21)) ) * G(h(1, 28, 20), U[28,28],h(4, 28, 24)) ) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(1, 28, 21), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 21)) Kro G(h(1, 28, 21), U[28,28],h(4, 28, 24)) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(2, 28, 22), ( G(h(2, 28, 22), U[28,28],h(4, 28, 24)) - ( T( G(h(1, 28, 21), U[28,28],h(2, 28, 22)) ) * G(h(1, 28, 21), U[28,28],h(4, 28, 24)) ) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(1, 28, 22), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 22)) Kro G(h(1, 28, 22), U[28,28],h(4, 28, 24)) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(1, 28, 23), ( G(h(1, 28, 23), U[28,28],h(4, 28, 24)) - ( T( G(h(1, 28, 22), U[28,28],h(1, 28, 23)) ) Kro G(h(1, 28, 22), U[28,28],h(4, 28, 24)) ) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(1, 28, 23), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 23)) Kro G(h(1, 28, 23), U[28,28],h(4, 28, 24)) ),h(4, 28, 24))
  ...
  // Generating : U[28,28] = S(h(4, 28, 24), ( G(h(4, 28, 24), U[28,28],h(4, 28, 24)) - ( T( G(h(4, 28, 20), U[28,28],h(4, 28, 24)) ) * G(h(4, 28, 20), U[28,28],h(4, 28, 24)) ) ),h(4, 28, 24))
  ...
  // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 24), U[28,28],h(1, 28, 24)) ),h(1, 28, 24))
  ...
  // Generating : U[28,28] = S(h(1, 28, 24), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 24)) Kro G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ),h(3, 28, 25))
  ...
  // Generating : U[28,28] = S(h(3, 28, 25), ( G(h(3, 28, 25), U[28,28],h(3, 28, 25)) - ( T( G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ) * G(h(1, 28, 24), U[28,28],h(3, 28, 25)) ) ),h(3, 28, 25))
  ...
  // Generating : T1982[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 25), U[28,28],h(1, 28, 25)) ),h(1, 28, 25))
  ...
  // Generating : U[28,28] = S(h(1, 28, 25), ( G(h(1, 1, 0), T1982[1,28],h(1, 28, 25)) Kro G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ),h(2, 28, 26))
  ...
  // Generating : U[28,28] = S(h(2, 28, 26), ( G(h(2, 28, 26), U[28,28],h(2, 28, 26)) - ( T( G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ) * G(h(1, 28, 25), U[28,28],h(2, 28, 26)) ) ),h(2, 28, 26))
  ...
  // Generating : U[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), U[28,28],h(1, 28, 27)) - ( T( G(h(1, 28, 26), U[28,28],h(1, 28, 27)) ) Kro G(h(1, 28, 26), U[28,28],h(1, 28, 27)) ) ),h(1, 28, 27))
  ...
  _mm_store_sd(&(M3[580]), _mm256_castpd256_pd128(_t53_0));
  _mm256_maskstore_pd(M3 + 581, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t53_2);
  _mm_store_sd(&(M3[609]), _mm256_castpd256_pd128(_t53_6));
  _mm256_maskstore_pd(M3 + 610, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t53_8);
  _mm_store_sd(&(M3[638]), _mm256_castpd256_pd128(_t53_11));
  _mm_store_sd(&(M3[639]), _mm256_castpd256_pd128(_t53_12));
  _mm_store_sd(&(M3[667]), _mm256_castpd256_pd128(_t53_13));
  _asm256_storeu_pd(M3 + 584, _t53_33);
  _asm256_storeu_pd(M3 + 612, _t53_16);
  _asm256_storeu_pd(M3 + 640, _t53_17);
  _asm256_storeu_pd(M3 + 668, _t53_18);

  for( int fi35 = 0; fi35 <= 23; fi35+=4 ) {
    _t54_0 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 87])));
    _t54_2 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 58])));
    _t54_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 29])));
    _t54_5 = _mm256_maskload_pd(M3 + 29*fi35 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t54_1 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 59])));
    _t54_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35])));
    _t54_3 = _mm256_maskload_pd(M3 + 29*fi35 + 30, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    ...
    // Generating : v2[28,1] = S(h(3, 28, fi35 + 1), ( G(h(3, 28, fi35 + 1), v2[28,1],h(1, 1, 0)) - ( T( G(h(1, 28, fi35), U0[28,28],h(3, 28, fi35 + 1)) ) Kro G(h(1, 28, fi35), v2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v2[28,1] = S(h(1, 28, fi35 + 1), ( G(h(1, 28, fi35 + 1), v2[28,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 1), U0[28,28],h(1, 28, fi35 + 1)) ),h(1, 1, 0))
    ...
    // Generating : v2[28,1] = S(h(2, 28, fi35 + 2), ( G(h(2, 28, fi35 + 2), v2[28,1],h(1, 1, 0)) - ( T( G(h(1, 28, fi35 + 1), U0[28,28],h(2, 28, fi35 + 2)) ) Kro G(h(1, 28, fi35 + 1), v2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v2[28,1] = S(h(1, 28, fi35 + 2), ( G(h(1, 28, fi35 + 2), v2[28,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 2), U0[28,28],h(1, 28, fi35 + 2)) ),h(1, 1, 0))
    ...
    // Generating : v2[28,1] = S(h(1, 28, fi35 + 3), ( G(h(1, 28, fi35 + 3), v2[28,1],h(1, 1, 0)) - ( T( G(h(1, 28, fi35 + 2), U0[28,28],h(1, 28, fi35 + 3)) ) Kro G(h(1, 28, fi35 + 2), v2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v2[28,1] = S(h(1, 28, fi35 + 3), ( G(h(1, 28, fi35 + 3), v2[28,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 3), U0[28,28],h(1, 28, fi35 + 3)) ),h(1, 1, 0))
    ...
    // Generating : v2[28,1] = Sum_{k3} ( S(h(4, 28, fi35 + k3 + 4), ( G(h(4, 28, fi35 + k3 + 4), v2[28,1],h(1, 1, 0)) - ( T( G(h(4, 28, fi35), U0[28,28],h(4, 28, fi35 + k3 + 4)) ) * G(h(4, 28, fi35), v2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
    ...
    for( int k3 = 0; k3 <= -fi35 + 23; k3+=4 ) {
      _t55_9 = _asm256_loadu_pd(v0 + fi35 + k3 + 4);
      _t55_7 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 4);
      _t55_6 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 32);
      _t55_5 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 60);
      _t55_4 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 88);
  ...
  _mm_store_sd(&(M3[696]), _mm256_castpd256_pd128(_t53_19));
  _mm256_maskstore_pd(M3 + 697, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t53_21);
  _mm_store_sd(&(M3[725]), _mm256_castpd256_pd128(_t53_25));
  _mm256_maskstore_pd(M3 + 726, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t53_27);
  _mm_store_sd(&(M3[754]), _mm256_castpd256_pd128(_t53_30));
  _mm_store_sd(&(M3[755]), _mm256_castpd256_pd128(_t53_31));
  _mm_store_sd(&(M3[783]), _mm256_castpd256_pd128(_t53_32));
  ...
  for( int fi35 = 0; fi35 <= 23; fi35+=4 ) {
    _t57_7 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi35 + 27])));
    _t57_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 783])));
    _t57_8 = _mm256_maskload_pd(v0 + -fi35 + 24, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t57_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 699)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 727))), _mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 755)), 32);
    _t57_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 754])));
    _t57_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 698)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 726)), 0);
    _t57_2 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 725])));
    _t57_1 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 697])));
    _t57_0 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 696])));
    ...
    // Generating : v4[28,1] = S(h(3, 28, -fi35 + 24), ( G(h(3, 28, -fi35 + 24), v4[28,1],h(1, 1, 0)) - ( G(h(3, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 27)) Kro G(h(1, 28, -fi35 + 27), v4[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v4[28,1] = S(h(1, 28, -fi35 + 26), ( G(h(1, 28, -fi35 + 26), v4[28,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 26), U0[28,28],h(1, 28, -fi35 + 26)) ),h(1, 1, 0))
    ...
    // Generating : v4[28,1] = S(h(2, 28, -fi35 + 24), ( G(h(2, 28, -fi35 + 24), v4[28,1],h(1, 1, 0)) - ( G(h(2, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 26)) Kro G(h(1, 28, -fi35 + 26), v4[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v4[28,1] = S(h(1, 28, -fi35 + 25), ( G(h(1, 28, -fi35 + 25), v4[28,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 25), U0[28,28],h(1, 28, -fi35 + 25)) ),h(1, 1, 0))
    ...
    // Generating : v4[28,1] = S(h(1, 28, -fi35 + 24), ( G(h(1, 28, -fi35 + 24), v4[28,1],h(1, 1, 0)) - ( G(h(1, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 25)) Kro G(h(1, 28, -fi35 + 25), v4[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v4[28,1] = S(h(1, 28, -fi35 + 24), ( G(h(1, 28, -fi35 + 24), v4[28,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 24)) ),h(1, 1, 0))
    ...
    // Generating : v4[28,1] = Sum_{k3} ( S(h(4, 28, k3), ( G(h(4, 28, k3), v4[28,1],h(1, 1, 0)) - ( G(h(4, 28, k3), U0[28,28],h(4, 28, -fi35 + 24)) * G(h(4, 28, -fi35 + 24), v4[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    // AVX Loader:
    _mm_store_sd(&(v0[-fi35 + 27]), _mm256_castpd256_pd128(_t57_7));
    _mm_store_sd(&(v0[-fi35 + 26]), _mm256_castpd256_pd128(_t57_9));
    _mm_store_sd(&(v0[-fi35 + 25]), _mm256_castpd256_pd128(_t57_11));
    _mm_store_sd(&(v0[-fi35 + 24]), _mm256_castpd256_pd128(_t57_12));

    for( int k3 = 0; k3 <= -fi35 + 23; k3+=4 ) {
      _t58_9 = _asm256_loadu_pd(v0 + k3);
      _t58_7 = _asm256_loadu_pd(M3 + -fi35 + 28*k3 + 24);
      _t58_6 = _asm256_loadu_pd(M3 + -fi35 + 28*k3 + 52);
      _t58_5 = _asm256_loadu_pd(M3 + -fi35 + 28*k3 + 80);
      _t58_4 = _asm256_loadu_pd(M3 + -fi35 + 28*k3 + 108);
      _t58_3 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi35 + 27])));
      _t58_2 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi35 + 26])));
      _t58_1 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi35 + 25])));
      _t58_0 = _mm256_castpd128_pd256(_mm_load_sd(&(v0[-fi35 + 24])));
  ...
  _t59_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[87])));
  _t59_8 = _mm256_maskload_pd(v0, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t59_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + 3)), _mm256_castpd128_pd256(_mm_load_sd(M3 + 31))), _mm256_castpd128_pd256(_mm_load_sd(M3 + 59)), 32);
  _t59_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[58])));
  _t59_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + 2)), _mm256_castpd128_pd256(_mm_load_sd(M3 + 30)), 0);
  _t59_2 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29])));
  ...
  for( int fi35 = 0; fi35 <= 23; fi35+=4 ) {
    _t60_1 = _mm256_maskload_pd(M3 + 29*fi35 + 30, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t60_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35])));
    _t60_3 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 87])));
    _t60_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 58])));
    _t60_5 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 29])));
    _t60_2 = _mm256_maskload_pd(M3 + 29*fi35 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t60_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35])));
    _t60_5 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 29])));
    _t60_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 58])));
    _t60_3 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[29*fi35 + 87])));
    _t60_14 = _asm256_loadu_pd(M1 + 28*fi35);
    _t60_11 = _asm256_loadu_pd(M1 + 28*fi35 + 28);
    _t60_12 = _asm256_loadu_pd(M1 + 28*fi35 + 56);
    _t60_13 = _asm256_loadu_pd(M1 + 28*fi35 + 84);
    _t60_2 = _mm256_maskload_pd(M3 + 29*fi35 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t60_1 = _mm256_maskload_pd(M3 + 29*fi35 + 30, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t60_0 = _mm256_broadcast_sd(&(M3[29*fi35 + 59]));

    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35), U0[28,28],h(1, 28, fi35)) ),h(1, 28, fi35))
    ...
    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 1), U0[28,28],h(1, 28, fi35 + 1)) ),h(1, 28, fi35 + 1))
    ...
    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 2), U0[28,28],h(1, 28, fi35 + 2)) ),h(1, 28, fi35 + 2))
    ...
    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi35 + 3), U0[28,28],h(1, 28, fi35 + 3)) ),h(1, 28, fi35 + 3))
    ...
    // Generating : M6[28,28] = S(h(1, 28, fi35), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, fi35)) Kro G(h(1, 28, fi35), M6[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    // Generating : M6[28,28] = S(h(3, 28, fi35 + 1), ( G(h(3, 28, fi35 + 1), M6[28,28],h(4, 28, fi96)) - ( T( G(h(1, 28, fi35), U0[28,28],h(3, 28, fi35 + 1)) ) * G(h(1, 28, fi35), M6[28,28],h(4, 28, fi96)) ) ),h(4, 28, fi96))
    ...
    // Generating : M6[28,28] = S(h(1, 28, fi35 + 1), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, fi35 + 1)) Kro G(h(1, 28, fi35 + 1), M6[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    // Generating : M6[28,28] = S(h(2, 28, fi35 + 2), ( G(h(2, 28, fi35 + 2), M6[28,28],h(4, 28, fi96)) - ( T( G(h(1, 28, fi35 + 1), U0[28,28],h(2, 28, fi35 + 2)) ) * G(h(1, 28, fi35 + 1), M6[28,28],h(4, 28, fi96)) ) ),h(4, 28, fi96))
    ...
    // Generating : M6[28,28] = S(h(1, 28, fi35 + 2), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, fi35 + 2)) Kro G(h(1, 28, fi35 + 2), M6[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    // Generating : M6[28,28] = S(h(1, 28, fi35 + 3), ( G(h(1, 28, fi35 + 3), M6[28,28],h(4, 28, fi96)) - ( T( G(h(1, 28, fi35 + 2), U0[28,28],h(1, 28, fi35 + 3)) ) Kro G(h(1, 28, fi35 + 2), M6[28,28],h(4, 28, fi96)) ) ),h(4, 28, fi96))
    ...
    // Generating : M6[28,28] = S(h(1, 28, fi35 + 3), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, fi35 + 3)) Kro G(h(1, 28, fi35 + 3), M6[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    for( int fi96 = 4; fi96 <= 24; fi96+=4 ) {
      _t61_3 = _asm256_loadu_pd(M1 + 28*fi35 + fi96);
      _t61_0 = _asm256_loadu_pd(M1 + 28*fi35 + fi96 + 28);
      _t61_1 = _asm256_loadu_pd(M1 + 28*fi35 + fi96 + 56);
      _t61_2 = _asm256_loadu_pd(M1 + 28*fi35 + fi96 + 84);
      ...
      // AVX Storer:
      _asm256_storeu_pd(M1 + 28*fi35 + fi96, _t61_3);
      _asm256_storeu_pd(M1 + 28*fi35 + fi96 + 28, _t61_0);
      _asm256_storeu_pd(M1 + 28*fi35 + fi96 + 56, _t61_1);
      _asm256_storeu_pd(M1 + 28*fi35 + fi96 + 84, _t61_2);
    }

    // Generating : M6[28,28] = Sum_{k3} ( Sum_{k2} ( S(h(4, 28, fi35 + k3 + 4), ( G(h(4, 28, fi35 + k3 + 4), M6[28,28],h(4, 28, k2)) - ( T( G(h(4, 28, fi35), U0[28,28],h(4, 28, fi35 + k3 + 4)) ) * G(h(4, 28, fi35), M6[28,28],h(4, 28, k2)) ) ),h(4, 28, k2)) ) )
    _asm256_storeu_pd(M1 + 28*fi35, _t60_14);
    _asm256_storeu_pd(M1 + 28*fi35 + 28, _t60_11);
    _asm256_storeu_pd(M1 + 28*fi35 + 56, _t60_12);
    _asm256_storeu_pd(M1 + 28*fi35 + 84, _t60_13);

    for( int k3 = 0; k3 <= -fi35 + 23; k3+=4 ) {

      for( int k2 = 0; k2 <= 27; k2+=4 ) {
        _t62_12 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 28*k3 + 112);
        _t62_13 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 28*k3 + 140);
        _t62_14 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 28*k3 + 168);
        _t62_15 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 28*k3 + 196);
        _t62_7 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 4);
        _t62_6 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 32);
        _t62_5 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 60);
        _t62_4 = _asm256_loadu_pd(M3 + 29*fi35 + k3 + 88);
        _t62_3 = _asm256_loadu_pd(M1 + 28*fi35 + k2);
        _t62_2 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 28);
        _t62_1 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 56);
        _t62_0 = _asm256_loadu_pd(M1 + 28*fi35 + k2 + 84);
        ...
        // AVX Storer:
        _asm256_storeu_pd(M1 + 28*fi35 + k2 + 28*k3 + 112, _t62_12);
        _asm256_storeu_pd(M1 + 28*fi35 + k2 + 28*k3 + 140, _t62_13);
        _asm256_storeu_pd(M1 + 28*fi35 + k2 + 28*k3 + 168, _t62_14);
        _asm256_storeu_pd(M1 + 28*fi35 + k2 + 28*k3 + 196, _t62_15);
      }
    }
  }

  _t53_21 = _mm256_maskload_pd(M3 + 697, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t53_31 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[755])));
  _t53_30 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[754])));
  _t53_25 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[725])));
  _t53_32 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[783])));
  _t53_19 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[696])));
  _t53_27 = _mm256_maskload_pd(M3 + 726, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t63_7 = _asm256_loadu_pd(M1 + 672);
  _t63_4 = _asm256_loadu_pd(M1 + 700);
  _t63_5 = _asm256_loadu_pd(M1 + 728);
  _t63_6 = _asm256_loadu_pd(M1 + 756);

  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 24), U0[28,28],h(1, 28, 24)) ),h(1, 28, 24))
  ...
  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 25), U0[28,28],h(1, 28, 25)) ),h(1, 28, 25))
  ...
  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 26), U0[28,28],h(1, 28, 26)) ),h(1, 28, 26))
  ...
  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 27), U0[28,28],h(1, 28, 27)) ),h(1, 28, 27))
  ...
  // Generating : M6[28,28] = S(h(1, 28, 24), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 24)) Kro G(h(1, 28, 24), M6[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  // Generating : M6[28,28] = S(h(3, 28, 25), ( G(h(3, 28, 25), M6[28,28],h(4, 28, fi35)) - ( T( G(h(1, 28, 24), U0[28,28],h(3, 28, 25)) ) * G(h(1, 28, 24), M6[28,28],h(4, 28, fi35)) ) ),h(4, 28, fi35))
  ...
  // Generating : M6[28,28] = S(h(1, 28, 25), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 25)) Kro G(h(1, 28, 25), M6[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  // Generating : M6[28,28] = S(h(2, 28, 26), ( G(h(2, 28, 26), M6[28,28],h(4, 28, fi35)) - ( T( G(h(1, 28, 25), U0[28,28],h(2, 28, 26)) ) * G(h(1, 28, 25), M6[28,28],h(4, 28, fi35)) ) ),h(4, 28, fi35))
  ...
  // Generating : M6[28,28] = S(h(1, 28, 26), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 26)) Kro G(h(1, 28, 26), M6[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  // Generating : M6[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), M6[28,28],h(4, 28, fi35)) - ( T( G(h(1, 28, 26), U0[28,28],h(1, 28, 27)) ) Kro G(h(1, 28, 26), M6[28,28],h(4, 28, fi35)) ) ),h(4, 28, fi35))
  ...
  // Generating : M6[28,28] = S(h(1, 28, 27), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 27)) Kro G(h(1, 28, 27), M6[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  for( int fi35 = 4; fi35 <= 24; fi35+=4 ) {
    _t64_3 = _asm256_loadu_pd(M1 + fi35 + 672);
    _t64_0 = _asm256_loadu_pd(M1 + fi35 + 700);
    _t64_1 = _asm256_loadu_pd(M1 + fi35 + 728);
    _t64_2 = _asm256_loadu_pd(M1 + fi35 + 756);
    ...
    // AVX Storer:
    _asm256_storeu_pd(M1 + fi35 + 672, _t64_3);
    _asm256_storeu_pd(M1 + fi35 + 700, _t64_0);
    _asm256_storeu_pd(M1 + fi35 + 728, _t64_1);
    _asm256_storeu_pd(M1 + fi35 + 756, _t64_2);
  }
  ...
  for( int fi35 = 0; fi35 <= 23; fi35+=4 ) {
    _t65_6 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 783])));
    _t65_5 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 754])));
    _t65_4 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 725])));
    _t65_3 = _mm256_castpd128_pd256(_mm_load_sd(&(M3[-29*fi35 + 696])));
    _t65_14 = _asm256_loadu_pd(M1 + -28*fi35 + 756);
    _t65_11 = _asm256_loadu_pd(M1 + -28*fi35 + 672);
    _t65_12 = _asm256_loadu_pd(M1 + -28*fi35 + 700);
    _t65_13 = _asm256_loadu_pd(M1 + -28*fi35 + 728);
    _t65_2 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 699)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 727))), _mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 755)), 32);
    _t65_1 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 698)), _mm256_castpd128_pd256(_mm_load_sd(M3 + -29*fi35 + 726)), 0);
    _t65_0 = _mm256_broadcast_sd(&(M3[-29*fi35 + 697]));

    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 27), U0[28,28],h(1, 28, -fi35 + 27)) ),h(1, 28, -fi35 + 27))
    ...
    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 26), U0[28,28],h(1, 28, -fi35 + 26)) ),h(1, 28, -fi35 + 26))
    ...
    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 25), U0[28,28],h(1, 28, -fi35 + 25)) ),h(1, 28, -fi35 + 25))
    ...
    // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 24)) ),h(1, 28, -fi35 + 24))
    ...
    // Generating : M8[28,28] = S(h(1, 28, -fi35 + 27), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi35 + 27)) Kro G(h(1, 28, -fi35 + 27), M8[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    // Generating : M8[28,28] = S(h(3, 28, -fi35 + 24), ( G(h(3, 28, -fi35 + 24), M8[28,28],h(4, 28, fi96)) - ( G(h(3, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 27)) * G(h(1, 28, -fi35 + 27), M8[28,28],h(4, 28, fi96)) ) ),h(4, 28, fi96))
    ...
    // Generating : M8[28,28] = S(h(1, 28, -fi35 + 26), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi35 + 26)) Kro G(h(1, 28, -fi35 + 26), M8[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    // Generating : M8[28,28] = S(h(2, 28, -fi35 + 24), ( G(h(2, 28, -fi35 + 24), M8[28,28],h(4, 28, fi96)) - ( G(h(2, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 26)) * G(h(1, 28, -fi35 + 26), M8[28,28],h(4, 28, fi96)) ) ),h(4, 28, fi96))
    ...
    // Generating : M8[28,28] = S(h(1, 28, -fi35 + 25), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi35 + 25)) Kro G(h(1, 28, -fi35 + 25), M8[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    // Generating : M8[28,28] = S(h(1, 28, -fi35 + 24), ( G(h(1, 28, -fi35 + 24), M8[28,28],h(4, 28, fi96)) - ( G(h(1, 28, -fi35 + 24), U0[28,28],h(1, 28, -fi35 + 25)) Kro G(h(1, 28, -fi35 + 25), M8[28,28],h(4, 28, fi96)) ) ),h(4, 28, fi96))
    ...
    // Generating : M8[28,28] = S(h(1, 28, -fi35 + 24), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, -fi35 + 24)) Kro G(h(1, 28, -fi35 + 24), M8[28,28],h(4, 28, fi96)) ),h(4, 28, fi96))
    ...
    for( int fi96 = 4; fi96 <= 24; fi96+=4 ) {
      _t66_3 = _asm256_loadu_pd(M1 + -28*fi35 + fi96 + 756);
      _t66_0 = _asm256_loadu_pd(M1 + -28*fi35 + fi96 + 672);
      _t66_1 = _asm256_loadu_pd(M1 + -28*fi35 + fi96 + 700);
      _t66_2 = _asm256_loadu_pd(M1 + -28*fi35 + fi96 + 728);
      ...
      // AVX Storer:
      _asm256_storeu_pd(M1 + -28*fi35 + fi96 + 756, _t66_3);
      _asm256_storeu_pd(M1 + -28*fi35 + fi96 + 728, _t66_2);
      _asm256_storeu_pd(M1 + -28*fi35 + fi96 + 700, _t66_1);
      _asm256_storeu_pd(M1 + -28*fi35 + fi96 + 672, _t66_0);
    }

    // Generating : M8[28,28] = Sum_{k3} ( Sum_{k2} ( S(h(4, 28, k3), ( G(h(4, 28, k3), M8[28,28],h(4, 28, k2)) - ( G(h(4, 28, k3), U0[28,28],h(4, 28, -fi35 + 24)) * G(h(4, 28, -fi35 + 24), M8[28,28],h(4, 28, k2)) ) ),h(4, 28, k2)) ) )
    _asm256_storeu_pd(M1 + -28*fi35 + 756, _t65_14);
    _asm256_storeu_pd(M1 + -28*fi35 + 728, _t65_13);
    _asm256_storeu_pd(M1 + -28*fi35 + 700, _t65_12);
    _asm256_storeu_pd(M1 + -28*fi35 + 672, _t65_11);
    ...
    for( int k3 = 0; k3 <= -fi35 + 23; k3+=4 ) {
      ...
      for( int k2 = 0; k2 <= 27; k2+=4 ) {
        ...
        _t67_19 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 24);
        _t67_18 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 25);
        _t67_17 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 26);
        _t67_16 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 27);
        _t67_15 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 52);
        _t67_14 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 53);
        _t67_13 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 54);
        _t67_12 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 55);
        _t67_11 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 80);
        _t67_10 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 81);
        _t67_9 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 82);
        _t67_8 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 83);
        _t67_7 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 108);
        _t67_6 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 109);
        _t67_5 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 110);
        _t67_4 = _mm256_broadcast_sd(M3 + -fi35 + 28*k3 + 111);
        _t67_3 = _asm256_loadu_pd(M1 + -28*fi35 + k2 + 672);
        _t67_2 = _asm256_loadu_pd(M1 + -28*fi35 + k2 + 700);
        _t67_1 = _asm256_loadu_pd(M1 + -28*fi35 + k2 + 728);
        _t67_0 = _asm256_loadu_pd(M1 + -28*fi35 + k2 + 756);
  ...
  _t68_8 = _asm256_loadu_pd(M1 + 84);
  _t68_5 = _asm256_loadu_pd(M1);
  _t68_6 = _asm256_loadu_pd(M1 + 28);
  _t68_7 = _asm256_loadu_pd(M1 + 56);
  _t68_0 = _mm256_broadcast_sd(&(M3[1]));

  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 3), U0[28,28],h(1, 28, 3)) ),h(1, 28, 3))
  ...
  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 2), U0[28,28],h(1, 28, 2)) ),h(1, 28, 2))
  ...
  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 1), U0[28,28],h(1, 28, 1)) ),h(1, 28, 1))
  ...
  // Generating : T2019[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 0), U0[28,28],h(1, 28, 0)) ),h(1, 28, 0))
  ...
  // Generating : M8[28,28] = S(h(1, 28, 3), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 3)) Kro G(h(1, 28, 3), M8[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  // Generating : M8[28,28] = S(h(3, 28, 0), ( G(h(3, 28, 0), M8[28,28],h(4, 28, fi35)) - ( G(h(3, 28, 0), U0[28,28],h(1, 28, 3)) * G(h(1, 28, 3), M8[28,28],h(4, 28, fi35)) ) ),h(4, 28, fi35))
  ...
  // Generating : M8[28,28] = S(h(1, 28, 2), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 2)) Kro G(h(1, 28, 2), M8[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  // Generating : M8[28,28] = S(h(2, 28, 0), ( G(h(2, 28, 0), M8[28,28],h(4, 28, fi35)) - ( G(h(2, 28, 0), U0[28,28],h(1, 28, 2)) * G(h(1, 28, 2), M8[28,28],h(4, 28, fi35)) ) ),h(4, 28, fi35))
  ...
  // Generating : M8[28,28] = S(h(1, 28, 1), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 1)) Kro G(h(1, 28, 1), M8[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  // Generating : M8[28,28] = S(h(1, 28, 0), ( G(h(1, 28, 0), M8[28,28],h(4, 28, fi35)) - ( G(h(1, 28, 0), U0[28,28],h(1, 28, 1)) Kro G(h(1, 28, 1), M8[28,28],h(4, 28, fi35)) ) ),h(4, 28, fi35))
  ...
  // Generating : M8[28,28] = S(h(1, 28, 0), ( G(h(1, 1, 0), T2019[1,28],h(1, 28, 0)) Kro G(h(1, 28, 0), M8[28,28],h(4, 28, fi35)) ),h(4, 28, fi35))
  ...
  for( int fi35 = 4; fi35 <= 24; fi35+=4 ) {
    _t69_3 = _asm256_loadu_pd(M1 + fi35 + 84);
    _t69_0 = _asm256_loadu_pd(M1 + fi35);
    _t69_1 = _asm256_loadu_pd(M1 + fi35 + 28);
    _t69_2 = _asm256_loadu_pd(M1 + fi35 + 56);
    ...
    // AVX Storer:
    _asm256_storeu_pd(M1 + fi35 + 84, _t69_3);
    _asm256_storeu_pd(M1 + fi35 + 56, _t69_2);
    _asm256_storeu_pd(M1 + fi35 + 28, _t69_1);
  ...
  _asm256_storeu_pd(M1 + 84, _t68_8);
  _asm256_storeu_pd(M1 + 56, _t68_7);
  _asm256_storeu_pd(M1 + 28, _t68_6);
