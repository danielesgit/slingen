 ...
 * upotrf_kernel.h
 *
Decl { {u'A': Symmetric[A, (52, 52), USMatAccess], 'T789': Matrix[T789, (1, 52), GenMatAccess]} }
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, 0)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, 0), A[52,52],h(1, 52, 0)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(3, 52, 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(3, 52, 1)) ) ) )
Eq.ann: {}
Entry 3:
...
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(2, 52, 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(2, 52, 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(1, 52, 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(2, 52, 2)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, 1), A[52,52],h(1, 52, 1)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(2, 52, 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(2, 52, 2)) ) ) )
Eq.ann: {}
Entry 8:
...
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 2), A[52,52],h(1, 52, 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 2), A[52,52],h(1, 52, 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 0), A[52,52],h(1, 52, 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 0), A[52,52],h(1, 52, 3)) ) ) ) )
Eq.ann: {}
Entry 11:
...
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, 2), A[52,52],h(1, 52, 2)) ) )
Eq.ann: {}
Entry 15:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, 3), A[52,52],h(1, 52, 3)) ) )
Eq.ann: {}
Entry 16:
For_{fi127;0;44;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(4, 52, fi127 + 4)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 52, 1), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 52, 1), A[52,52],h(4, 52, fi127 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(3, 52, 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 0), A[52,52],h(4, 52, fi127 + 4)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(4, 52, fi127 + 4)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 2), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 2), A[52,52],h(4, 52, fi127 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(2, 52, 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 1), A[52,52],h(4, 52, fi127 + 4)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 2), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 2), A[52,52],h(4, 52, fi127 + 4)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 3), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 3), A[52,52],h(4, 52, fi127 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 2), A[52,52],h(1, 52, 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 2), A[52,52],h(4, 52, fi127 + 4)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 3), A[52,52],h(4, 52, fi127 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 3), A[52,52],h(4, 52, fi127 + 4)) ) ) )
Eq.ann: {}
 )Entry 17:
For_{fi2;4;47;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 52, fi2), A[52,52],h(4, 52, fi2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 52, fi2), A[52,52],h(4, 52, fi2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(fi2, 52, 0), A[52,52],h(4, 52, fi2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(fi2, 52, 0), A[52,52],h(4, 52, fi2)) ) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 52, fi2), A[52,52],h(1, 52, fi2)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, fi2), A[52,52],h(1, 52, fi2)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, fi2), A[52,52],h(1, 52, fi2)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(3, 52, fi2 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(3, 52, fi2 + 1)) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(1, 52, fi2 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(1, 52, fi2 + 1)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(1, 52, fi2 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(1, 52, fi2 + 1)) ) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), G(h(1, 52, fi2 + 1), A[52,52],h(1, 52, fi2 + 1)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, fi2 + 1), A[52,52],h(1, 52, fi2 + 1)) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(2, 52, fi2 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(2, 52, fi2 + 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(1, 52, fi2 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(2, 52, fi2 + 2)) ) ) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, fi2 + 1), A[52,52],h(1, 52, fi2 + 1)) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(2, 52, fi2 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(2, 52, fi2 + 2)) ) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, fi2), A[52,52],h(1, 52, fi2 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 52, fi2), A[52,52],h(1, 52, fi2 + 2)) ) ) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 2)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 2)) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, fi2), A[52,52],h(1, 52, fi2 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 52, fi2), A[52,52],h(1, 52, fi2 + 3)) ) ) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 3)) ) = ( Tile( (1, 1), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 3)) ) Div Tile( (1, 1), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 2)) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 3), A[52,52],h(1, 52, fi2 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 3), A[52,52],h(1, 52, fi2 + 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(3, 52, fi2), A[52,52],h(1, 52, fi2 + 3)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(3, 52, fi2), A[52,52],h(1, 52, fi2 + 3)) ) ) ) )
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), G(h(1, 52, fi2 + 3), A[52,52],h(1, 52, fi2 + 3)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, fi2 + 3), A[52,52],h(1, 52, fi2 + 3)) ) )
Eq.ann: {}
Entry 15:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 52, fi2), A[52,52],h(-fi2 + 48, 52, fi2 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 52, fi2), A[52,52],h(-fi2 + 48, 52, fi2 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(fi2, 52, 0), A[52,52],h(4, 52, fi2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(fi2, 52, 0), A[52,52],h(-fi2 + 48, 52, fi2 + 4)) ) ) ) )
Eq.ann: {}
Entry 16:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 2)) ) )
Eq.ann: {}
Entry 17:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, fi2 + 3), A[52,52],h(1, 52, fi2 + 3)) ) )
Eq.ann: {}
Entry 18:
For_{fi252;0;-fi2 + 44;4} ( Entry 0:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 52, fi2 + 1), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 52, fi2 + 1), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(3, 52, fi2 + 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 52, fi2 + 2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, fi2 + 2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(2, 52, fi2 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 1), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 3), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 3), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(1, 52, fi2 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 2), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 3), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, fi2 + 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, fi2 + 3), A[52,52],h(4, 52, fi2 + fi252 + 4)) ) ) )
Eq.ann: {}
 ) )Entry 18:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 52, 48), A[52,52],h(4, 52, 48)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 52, 48), A[52,52],h(4, 52, 48)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(48, 52, 0), A[52,52],h(4, 52, 48)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(48, 52, 0), A[52,52],h(4, 52, 48)) ) ) ) )
Eq.ann: {}
Entry 19:
Eq: Tile( (1, 1), G(h(1, 52, 48), A[52,52],h(1, 52, 48)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, 48), A[52,52],h(1, 52, 48)) ) )
Eq.ann: {}
Entry 20:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, 48)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, 48), A[52,52],h(1, 52, 48)) ) )
Eq.ann: {}
Entry 21:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 48), A[52,52],h(3, 52, 49)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 48)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 48), A[52,52],h(3, 52, 49)) ) ) )
Eq.ann: {}
Entry 22:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 49), A[52,52],h(1, 52, 49)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 49), A[52,52],h(1, 52, 49)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 48), A[52,52],h(1, 52, 49)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 48), A[52,52],h(1, 52, 49)) ) ) ) )
Eq.ann: {}
Entry 23:
Eq: Tile( (1, 1), G(h(1, 52, 49), A[52,52],h(1, 52, 49)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, 49), A[52,52],h(1, 52, 49)) ) )
Eq.ann: {}
Entry 24:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 49), A[52,52],h(2, 52, 50)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 49), A[52,52],h(2, 52, 50)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 48), A[52,52],h(1, 52, 49)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 48), A[52,52],h(2, 52, 50)) ) ) ) )
Eq.ann: {}
Entry 25:
Eq: Tile( (1, 1), G(h(1, 1, 0), T789[1,52],h(1, 52, 49)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 52, 49), A[52,52],h(1, 52, 49)) ) )
Eq.ann: {}
Entry 26:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 49), A[52,52],h(2, 52, 50)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T789[1,52],h(1, 52, 49)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 49), A[52,52],h(2, 52, 50)) ) ) )
Eq.ann: {}
Entry 27:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 50), A[52,52],h(1, 52, 50)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 50), A[52,52],h(1, 52, 50)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 48), A[52,52],h(1, 52, 50)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 48), A[52,52],h(1, 52, 50)) ) ) ) )
Eq.ann: {}
Entry 28:
Eq: Tile( (1, 1), G(h(1, 52, 50), A[52,52],h(1, 52, 50)) ) = Sqrt( Tile( (1, 1), G(h(1, 52, 50), A[52,52],h(1, 52, 50)) ) )
Eq.ann: {}
Entry 29:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 50), A[52,52],h(1, 52, 51)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 50), A[52,52],h(1, 52, 51)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 48), A[52,52],h(1, 52, 50)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 52, 48), A[52,52],h(1, 52, 51)) ) ) ) )
Eq.ann: {}
Entry 30:
...
Eq.ann: {}
Entry 31:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 51), A[52,52],h(1, 52, 51)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 52, 51), A[52,52],h(1, 52, 51)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(3, 52, 48), A[52,52],h(1, 52, 51)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(3, 52, 48), A[52,52],h(1, 52, 51)) ) ) ) )
Eq.ann: {}
Entry 32:
...
static __attribute__((noinline)) void kernel(double * A)
{
  ...
  _t0_4 = _mm256_maskload_pd(A + 54, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t0_6 = _mm256_maskload_pd(A + 106, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_7 = _mm256_maskload_pd(A + 107, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_8 = _mm256_maskload_pd(A + 159, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  ...
  for( int fi127 = 4; fi127 <= 44; fi127+=4 ) {
    _t1_3 = _mm256_loadu_pd(A + fi127 + 4);
    _t1_0 = _mm256_loadu_pd(A + fi127 + 56);
    _t1_1 = _mm256_loadu_pd(A + fi127 + 108);
    _t1_2 = _mm256_loadu_pd(A + fi127 + 160);
    ...
    _mm256_storeu_pd(A + fi127 + 56, _t1_0);
    _mm256_storeu_pd(A + fi127 + 108, _t1_1);
    _mm256_storeu_pd(A + fi127 + 160, _t1_2);
  }

  _t2_0 = _mm256_loadu_pd(A + 212);
  _t2_1 = _mm256_maskload_pd(A + 264, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t2_2 = _mm256_maskload_pd(A + 316, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t2_3 = _mm256_maskload_pd(A + 368, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  ...
  for( int k81 = 0; k81 <= 43; k81+=4 ) {
    _t3_8 = _mm256_loadu_pd(A + k81 + 216);
    _t3_9 = _mm256_loadu_pd(A + k81 + 268);
    _t3_10 = _mm256_loadu_pd(A + k81 + 320);
    _t3_11 = _mm256_loadu_pd(A + k81 + 372);
    _t3_3 = _mm256_loadu_pd(A + k81 + 8);
    _t3_2 = _mm256_loadu_pd(A + k81 + 60);
    _t3_1 = _mm256_loadu_pd(A + k81 + 112);
    _t3_0 = _mm256_loadu_pd(A + k81 + 164);
    ...
    _mm256_storeu_pd(A + k81 + 216, _t3_8);
    _mm256_storeu_pd(A + k81 + 268, _t3_9);
    _mm256_storeu_pd(A + k81 + 320, _t3_10);
    _mm256_storeu_pd(A + k81 + 372, _t3_11);
  }

  _t4_5 = _mm256_loadu_pd(A + 216);
  _t4_2 = _mm256_loadu_pd(A + 268);
  _t4_3 = _mm256_loadu_pd(A + 320);
  _t4_4 = _mm256_loadu_pd(A + 372);
  ...
  _mm256_storeu_pd(A + 212, _t2_0);
  _mm256_maskstore_pd(A + 264, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t2_1);
  _mm256_maskstore_pd(A + 316, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t2_2);

  for( int fi252 = 4; fi252 <= 40; fi252+=4 ) {
    _t5_3 = _mm256_loadu_pd(A + fi252 + 216);
    _t5_0 = _mm256_loadu_pd(A + fi252 + 268);
    _t5_1 = _mm256_loadu_pd(A + fi252 + 320);
    _t5_2 = _mm256_loadu_pd(A + fi252 + 372);
    ...
    _mm256_storeu_pd(A + fi252 + 216, _t5_3);
    _mm256_storeu_pd(A + fi252 + 268, _t5_0);
    _mm256_storeu_pd(A + fi252 + 320, _t5_1);
    _mm256_storeu_pd(A + fi252 + 372, _t5_2);
  }

  _t6_4 = _mm256_loadu_pd(A + 424);
  _t6_5 = _mm256_maskload_pd(A + 476, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t6_6 = _mm256_maskload_pd(A + 528, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t6_7 = _mm256_maskload_pd(A + 580, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  _t6_3 = _mm256_loadu_pd(A + 8);
  _t6_2 = _mm256_loadu_pd(A + 60);
  _t6_1 = _mm256_loadu_pd(A + 112);
  _t6_0 = _mm256_loadu_pd(A + 164);
  ...
  for( int k81 = 0; k81 <= 39; k81+=4 ) {
    _t7_16 = _mm256_loadu_pd(A + k81 + 428);
    _t7_17 = _mm256_loadu_pd(A + k81 + 480);
    _t7_18 = _mm256_loadu_pd(A + k81 + 532);
    _t7_19 = _mm256_loadu_pd(A + k81 + 584);
    _t7_7 = _mm256_loadu_pd(A + k81 + 12);
    _t7_6 = _mm256_loadu_pd(A + k81 + 64);
    _t7_5 = _mm256_loadu_pd(A + k81 + 116);
    _t7_4 = _mm256_loadu_pd(A + k81 + 168);
    _t7_3 = _mm256_loadu_pd(A + k81 + 220);
    _t7_2 = _mm256_loadu_pd(A + k81 + 272);
    _t7_1 = _mm256_loadu_pd(A + k81 + 324);
    _t7_0 = _mm256_loadu_pd(A + k81 + 376);
    ...
    _mm256_storeu_pd(A + k81 + 428, _t7_16);
    _mm256_storeu_pd(A + k81 + 480, _t7_17);
    _mm256_storeu_pd(A + k81 + 532, _t7_18);
    _mm256_storeu_pd(A + k81 + 584, _t7_19);
  }

  _t8_5 = _mm256_loadu_pd(A + 428);
  _t8_2 = _mm256_loadu_pd(A + 480);
  _t8_3 = _mm256_loadu_pd(A + 532);
  _t8_4 = _mm256_loadu_pd(A + 584);
  ...
  _mm256_storeu_pd(A + 424, _t6_4);
  _mm256_maskstore_pd(A + 476, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t6_5);
  _mm256_maskstore_pd(A + 528, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t6_6);

  for( int fi252 = 4; fi252 <= 36; fi252+=4 ) {
    _t9_3 = _mm256_loadu_pd(A + fi252 + 428);
    _t9_0 = _mm256_loadu_pd(A + fi252 + 480);
    _t9_1 = _mm256_loadu_pd(A + fi252 + 532);
    _t9_2 = _mm256_loadu_pd(A + fi252 + 584);
    ...
    _mm256_storeu_pd(A + fi252 + 428, _t9_3);
    _mm256_storeu_pd(A + fi252 + 480, _t9_0);
    _mm256_storeu_pd(A + fi252 + 532, _t9_1);
    _mm256_storeu_pd(A + fi252 + 584, _t9_2);
  }

  _mm256_storeu_pd(A + 428, _t8_5);
  _mm256_storeu_pd(A + 480, _t8_2);
  _mm256_storeu_pd(A + 532, _t8_3);
  _mm256_storeu_pd(A + 584, _t8_4);

  for( int fi127 = 12; fi127 <= 44; fi127+=4 ) {
    _t10_4 = _mm256_loadu_pd(A + 53*fi127);
    _t10_5 = _mm256_maskload_pd(A + 53*fi127 + 52, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
    _t10_6 = _mm256_maskload_pd(A + 53*fi127 + 104, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
    _t10_7 = _mm256_maskload_pd(A + 53*fi127 + 156, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
    _t10_3 = _mm256_loadu_pd(A + fi127);
    _t10_2 = _mm256_loadu_pd(A + fi127 + 52);
    _t10_1 = _mm256_loadu_pd(A + fi127 + 104);
    _t10_0 = _mm256_loadu_pd(A + fi127 + 156);
    ...
    for( int k81 = 4; k81 <= fi127 - 1; k81+=4 ) {
      _t11_3 = _mm256_loadu_pd(A + fi127 + 52*k81);
      _t11_2 = _mm256_loadu_pd(A + fi127 + 52*k81 + 52);
      _t11_1 = _mm256_loadu_pd(A + fi127 + 52*k81 + 104);
      _t11_0 = _mm256_loadu_pd(A + fi127 + 52*k81 + 156);
    ...
    for( int k81 = 0; k81 <= -fi127 + 47; k81+=4 ) {
      _t13_8 = _mm256_loadu_pd(A + 53*fi127 + k81 + 4);
      _t13_9 = _mm256_loadu_pd(A + 53*fi127 + k81 + 56);
      _t13_10 = _mm256_loadu_pd(A + 53*fi127 + k81 + 108);
      _t13_11 = _mm256_loadu_pd(A + 53*fi127 + k81 + 160);
      _t13_3 = _mm256_loadu_pd(A + fi127 + k81 + 4);
      _t13_2 = _mm256_loadu_pd(A + fi127 + k81 + 56);
      _t13_1 = _mm256_loadu_pd(A + fi127 + k81 + 108);
      _t13_0 = _mm256_loadu_pd(A + fi127 + k81 + 160);
      ...
      _mm256_storeu_pd(A + 53*fi127 + k81 + 4, _t13_8);
      _mm256_storeu_pd(A + 53*fi127 + k81 + 56, _t13_9);
      _mm256_storeu_pd(A + 53*fi127 + k81 + 108, _t13_10);
      _mm256_storeu_pd(A + 53*fi127 + k81 + 160, _t13_11);

      for( int j128 = 4; j128 <= fi127 - 1; j128+=4 ) {
        _t14_7 = _mm256_loadu_pd(A + fi127 + 52*j128);
        _t14_6 = _mm256_loadu_pd(A + fi127 + 52*j128 + 52);
        _t14_5 = _mm256_loadu_pd(A + fi127 + 52*j128 + 104);
        _t14_4 = _mm256_loadu_pd(A + fi127 + 52*j128 + 156);
        _t14_3 = _mm256_loadu_pd(A + fi127 + 52*j128 + k81 + 4);
        _t14_2 = _mm256_loadu_pd(A + fi127 + 52*j128 + k81 + 56);
        _t14_1 = _mm256_loadu_pd(A + fi127 + 52*j128 + k81 + 108);
        _t14_0 = _mm256_loadu_pd(A + fi127 + 52*j128 + k81 + 160);
        _t14_8 = _mm256_loadu_pd(A + 53*fi127 + k81 + 4);
        _t14_9 = _mm256_loadu_pd(A + 53*fi127 + k81 + 56);
        _t14_10 = _mm256_loadu_pd(A + 53*fi127 + k81 + 108);
        _t14_11 = _mm256_loadu_pd(A + 53*fi127 + k81 + 160);
        ...
        _mm256_storeu_pd(A + 53*fi127 + k81 + 4, _t14_8);
        _mm256_storeu_pd(A + 53*fi127 + k81 + 56, _t14_9);
        _mm256_storeu_pd(A + 53*fi127 + k81 + 108, _t14_10);
        _mm256_storeu_pd(A + 53*fi127 + k81 + 160, _t14_11);
      }
    }
    ...
    _t15_1 = _t15_7;
    _mm256_storeu_pd(A + 53*fi127, _t10_4);
    _mm256_maskstore_pd(A + 53*fi127 + 52, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t10_5);
    _mm256_maskstore_pd(A + 53*fi127 + 104, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t10_6);

    for( int fi252 = 0; fi252 <= -fi127 + 44; fi252+=4 ) {
      _t16_3 = _mm256_loadu_pd(A + 53*fi127 + fi252 + 4);
      _t16_0 = _mm256_loadu_pd(A + 53*fi127 + fi252 + 56);
      _t16_1 = _mm256_loadu_pd(A + 53*fi127 + fi252 + 108);
      _t16_2 = _mm256_loadu_pd(A + 53*fi127 + fi252 + 160);
      ...
      _mm256_storeu_pd(A + 53*fi127 + fi252 + 4, _t16_3);
      _mm256_storeu_pd(A + 53*fi127 + fi252 + 56, _t16_0);
      _mm256_storeu_pd(A + 53*fi127 + fi252 + 108, _t16_1);
      _mm256_storeu_pd(A + 53*fi127 + fi252 + 160, _t16_2);
    }
    _mm256_maskstore_pd(A + 53*fi127 + 156, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t10_7);
    _mm256_maskstore_pd(A + 53*fi127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_0);
    _mm256_maskstore_pd(A + 53*fi127 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t12_2);
    _mm256_maskstore_pd(A + 53*fi127 + 53, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_3);
    _mm256_maskstore_pd(A + 53*fi127 + 54, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t12_4);
    _mm256_maskstore_pd(A + 53*fi127 + 106, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_6);
    _mm256_maskstore_pd(A + 53*fi127 + 107, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_7);
    _mm256_maskstore_pd(A + 53*fi127 + 159, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_8);
  }

  _t17_4 = _mm256_loadu_pd(A + 2544);
  _t17_5 = _mm256_maskload_pd(A + 2596, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t17_6 = _mm256_maskload_pd(A + 2648, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t17_7 = _mm256_maskload_pd(A + 2700, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  _t17_3 = _mm256_loadu_pd(A + 48);
  _t17_2 = _mm256_loadu_pd(A + 100);
  _t17_1 = _mm256_loadu_pd(A + 152);
  _t17_0 = _mm256_loadu_pd(A + 204);
  ...
  for( int k81 = 4; k81 <= 47; k81+=4 ) {
    _t18_3 = _mm256_loadu_pd(A + 52*k81 + 48);
    _t18_2 = _mm256_loadu_pd(A + 52*k81 + 100);
    _t18_1 = _mm256_loadu_pd(A + 52*k81 + 152);
    _t18_0 = _mm256_loadu_pd(A + 52*k81 + 204);
  ...
  _mm256_maskstore_pd(A + 54, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_4);
  _mm256_maskstore_pd(A + 106, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_6);
  _mm256_maskstore_pd(A + 107, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_7);
  _mm256_maskstore_pd(A + 159, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_8);
  _mm256_storeu_pd(A + 4, _t0_14);
  _mm256_storeu_pd(A + 56, _t0_11);
  _mm256_storeu_pd(A + 108, _t0_12);
  _mm256_storeu_pd(A + 160, _t0_13);
  _mm256_maskstore_pd(A + 368, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t2_3);
  _mm256_maskstore_pd(A + 212, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_4);
  _mm256_maskstore_pd(A + 213, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t2_6);
  _mm256_maskstore_pd(A + 265, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_7);
  _mm256_maskstore_pd(A + 266, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t2_8);
  _mm256_maskstore_pd(A + 318, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_10);
  _mm256_maskstore_pd(A + 319, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_11);
  _mm256_maskstore_pd(A + 371, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_12);
  _mm256_storeu_pd(A + 216, _t4_5);
  _mm256_storeu_pd(A + 268, _t4_2);
  _mm256_storeu_pd(A + 320, _t4_3);
  _mm256_storeu_pd(A + 372, _t4_4);
  _mm256_maskstore_pd(A + 580, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t6_7);
  _mm256_maskstore_pd(A + 424, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_8);
  _mm256_maskstore_pd(A + 425, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t6_10);
  _mm256_maskstore_pd(A + 477, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_11);
  _mm256_maskstore_pd(A + 478, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t6_12);
  _mm256_maskstore_pd(A + 530, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_14);
  _mm256_maskstore_pd(A + 531, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_15);
  _mm256_maskstore_pd(A + 583, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_16);
  _mm256_storeu_pd(A + 2544, _t17_4);
  _mm256_maskstore_pd(A + 2596, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t17_5);
  _mm256_maskstore_pd(A + 2648, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t17_6);
  _mm256_maskstore_pd(A + 2700, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t17_7);
  _mm256_maskstore_pd(A + 2544, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_0);
  _mm256_maskstore_pd(A + 2545, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t19_2);
  _mm256_maskstore_pd(A + 2597, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_3);
  _mm256_maskstore_pd(A + 2598, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t19_4);
  _mm256_maskstore_pd(A + 2650, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_6);
  _mm256_maskstore_pd(A + 2651, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_7);
  _mm256_maskstore_pd(A + 2703, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_8);
