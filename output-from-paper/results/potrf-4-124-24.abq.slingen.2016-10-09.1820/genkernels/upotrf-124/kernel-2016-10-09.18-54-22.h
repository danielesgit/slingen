 ...
 * upotrf_kernel.h
 *
Decl { {u'A': Symmetric[A, (124, 124), USMatAccess], 'T925': Matrix[T925, (1, 124), GenMatAccess]} }
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, 0)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, 0), A[124,124],h(1, 124, 0)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 0), A[124,124],h(2, 124, 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, 0)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 0), A[124,124],h(2, 124, 1)) ) ) )
Eq.ann: {}
Entry 3:
...
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 1), A[124,124],h(1, 124, 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 1), A[124,124],h(1, 124, 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 0), A[124,124],h(1, 124, 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 0), A[124,124],h(1, 124, 2)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 124, 1), A[124,124],h(1, 124, 2)) ) = ( Tile( (1, 1), G(h(1, 124, 1), A[124,124],h(1, 124, 2)) ) Div Tile( (1, 1), G(h(1, 124, 1), A[124,124],h(1, 124, 1)) ) )
Eq.ann: {}
Entry 7:
...
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 124, 0), A[124,124],h(1, 124, 3)) ) = ( Tile( (1, 1), G(h(1, 124, 0), A[124,124],h(1, 124, 3)) ) Div Tile( (1, 1), G(h(1, 124, 0), A[124,124],h(1, 124, 0)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 124, 1), A[124,124],h(1, 124, 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 124, 1), A[124,124],h(1, 124, 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 0), A[124,124],h(2, 124, 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 0), A[124,124],h(1, 124, 3)) ) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), G(h(1, 124, 1), A[124,124],h(1, 124, 3)) ) = ( Tile( (1, 1), G(h(1, 124, 1), A[124,124],h(1, 124, 3)) ) Div Tile( (1, 1), G(h(1, 124, 1), A[124,124],h(1, 124, 1)) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 2), A[124,124],h(1, 124, 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 2), A[124,124],h(1, 124, 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 1), A[124,124],h(1, 124, 2)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, 1), A[124,124],h(1, 124, 3)) ) ) ) )
Eq.ann: {}
Entry 13:
...
Eq.ann: {}
Entry 16:
For_{fi524;4;120;4} ( Entry 0:
For_{fi603;0;fi524 - 5;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi603), A[124,124],h(1, 124, fi603)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 124, fi603 + 1), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 124, fi603 + 1), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603), A[124,124],h(3, 124, fi603 + 1)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi603 + 1), A[124,124],h(1, 124, fi603 + 1)) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 1), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 1), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi603 + 2), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi603 + 2), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 1), A[124,124],h(2, 124, fi603 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 1), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603 + 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi603 + 2), A[124,124],h(1, 124, fi603 + 2)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 2), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 2), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 3), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 3), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 2), A[124,124],h(1, 124, fi603 + 3)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 2), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603 + 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi603 + 3), A[124,124],h(1, 124, fi603 + 3)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 3), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi603 + 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi603 + 3), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(fi524 - fi603 - 4, 124, fi603 + 4), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(fi524 - fi603 - 4, 124, fi603 + 4), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 124, fi603), A[124,124],h(fi524 - fi603 - 4, 124, fi603 + 4)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 124, fi603), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
 )Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 4)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi524 - 4), A[124,124],h(1, 124, fi524 - 4)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 4), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 4)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 4), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 124, fi524 - 3), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 124, fi524 - 3), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 4), A[124,124],h(3, 124, fi524 - 3)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 4), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 3)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi524 - 3), A[124,124],h(1, 124, fi524 - 3)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 3), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 3)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 3), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi524 - 2), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi524 - 2), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 3), A[124,124],h(2, 124, fi524 - 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 3), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 2)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi524 - 2), A[124,124],h(1, 124, fi524 - 2)) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 2), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 2), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 1), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 1), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 2), A[124,124],h(1, 124, fi524 - 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 2), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi524 - 1), A[124,124],h(1, 124, fi524 - 1)) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 1), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524 - 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 - 1), A[124,124],h(4, 124, fi524)) ) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(4, 124, fi524), A[124,124],h(4, 124, fi524)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(4, 124, fi524), A[124,124],h(4, 124, fi524)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(fi524, 124, 0), A[124,124],h(4, 124, fi524)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(fi524, 124, 0), A[124,124],h(4, 124, fi524)) ) ) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524)) ) = Sqrt( Tile( (1, 1), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524)) ) )
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524)) ) )
Eq.ann: {}
Entry 15:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(2, 124, fi524 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T925[1,124],h(1, 124, fi524)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(2, 124, fi524 + 1)) ) ) )
Eq.ann: {}
Entry 16:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 1)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 1)) ) ) ) )
Eq.ann: {}
Entry 17:
Eq: Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 1)) ) = Sqrt( Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 1)) ) )
Eq.ann: {}
Entry 18:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 2)) ) ) ) )
Eq.ann: {}
Entry 19:
Eq: Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 2)) ) = ( Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 2)) ) Div Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 1)) ) )
Eq.ann: {}
Entry 20:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 2)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi524), A[124,124],h(1, 124, fi524 + 2)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi524), A[124,124],h(1, 124, fi524 + 2)) ) ) ) )
Eq.ann: {}
Entry 21:
Eq: Tile( (1, 1), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 2)) ) = Sqrt( Tile( (1, 1), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 2)) ) )
Eq.ann: {}
Entry 22:
Eq: Tile( (1, 1), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 3)) ) = ( Tile( (1, 1), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 3)) ) Div Tile( (1, 1), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524)) ) )
Eq.ann: {}
Entry 23:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(2, 124, fi524 + 1)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524), A[124,124],h(1, 124, fi524 + 3)) ) ) ) )
Eq.ann: {}
Entry 24:
Eq: Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 3)) ) = ( Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 3)) ) Div Tile( (1, 1), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 1)) ) )
Eq.ann: {}
Entry 25:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 2)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 1), A[124,124],h(1, 124, fi524 + 3)) ) ) ) )
Eq.ann: {}
Entry 26:
Eq: Tile( (1, 1), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 3)) ) = ( Tile( (1, 1), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 3)) ) Div Tile( (1, 1), G(h(1, 124, fi524 + 2), A[124,124],h(1, 124, fi524 + 2)) ) )
Eq.ann: {}
Entry 27:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 3), A[124,124],h(1, 124, fi524 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 124, fi524 + 3), A[124,124],h(1, 124, fi524 + 3)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(3, 124, fi524), A[124,124],h(1, 124, fi524 + 3)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(3, 124, fi524), A[124,124],h(1, 124, fi524 + 3)) ) ) ) )
Eq.ann: {}
Entry 28:
Eq: Tile( (1, 1), G(h(1, 124, fi524 + 3), A[124,124],h(1, 124, fi524 + 3)) ) = Sqrt( Tile( (1, 1), G(h(1, 124, fi524 + 3), A[124,124],h(1, 124, fi524 + 3)) ) )
Eq.ann: {}
 ) *
...
static __attribute__((noinline)) void kernel(double * A)
{
  ...
  _t0_4 = _mm256_maskload_pd(A + 126, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_5 = _mm256_maskload_pd(A + 250, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_6 = _mm256_maskload_pd(A + 3, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_7 = _mm256_shuffle_pd(_mm256_maskload_pd(A + 127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0)), _mm256_maskload_pd(A + 251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0)), 0);
  _t0_10 = _mm256_maskload_pd(A + 375, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_53 = _mm256_loadu_pd(A + 4);
  _t0_11 = _mm256_loadu_pd(A + 128);
  _t0_12 = _mm256_loadu_pd(A + 252);
  _t0_13 = _mm256_loadu_pd(A + 376);
  _t0_17 = _mm256_loadu_pd(A + 500);
  _t0_18 = _mm256_maskload_pd(A + 624, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t0_19 = _mm256_maskload_pd(A + 748, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t0_20 = _mm256_maskload_pd(A + 872, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  _t0_55 = _mm256_loadu_pd(A + 8);
  _t0_32 = _mm256_loadu_pd(A + 132);
  _t0_33 = _mm256_loadu_pd(A + 256);
  _t0_34 = _mm256_loadu_pd(A + 380);
  _t0_78 = _mm256_loadu_pd(A + 504);
  _t0_79 = _mm256_loadu_pd(A + 628);
  _t0_80 = _mm256_loadu_pd(A + 752);
  _t0_81 = _mm256_loadu_pd(A + 876);
  _t0_38 = _mm256_loadu_pd(A + 1000);
  _t0_39 = _mm256_maskload_pd(A + 1124, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t0_40 = _mm256_maskload_pd(A + 1248, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t0_41 = _mm256_maskload_pd(A + 1372, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  ...
  _mm256_maskstore_pd(A + 126, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_4);
  _mm256_maskstore_pd(A + 250, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_5);
  _mm256_maskstore_pd(A + 3, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_6);
  _mm256_maskstore_pd(A + 127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_7);
  _mm256_maskstore_pd(A + 251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_7, _t0_7, 1));
  _mm256_maskstore_pd(A + 127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_8);
  _mm256_maskstore_pd(A + 251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_9);
  _mm256_maskstore_pd(A + 375, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_10);
  _mm256_storeu_pd(A + 4, _t0_53);
  _mm256_storeu_pd(A + 128, _t0_11);
  _mm256_storeu_pd(A + 252, _t0_12);
  _mm256_storeu_pd(A + 376, _t0_13);
  _mm256_storeu_pd(A + 500, _t0_17);
  _mm256_maskstore_pd(A + 624, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t0_18);
  _mm256_maskstore_pd(A + 748, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t0_19);
  _mm256_maskstore_pd(A + 872, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t0_20);
  _mm256_maskstore_pd(A + 500, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_21);
  _mm256_maskstore_pd(A + 501, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_23);
  _mm256_maskstore_pd(A + 625, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_24);
  _mm256_maskstore_pd(A + 626, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_25);
  _mm256_maskstore_pd(A + 750, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_26);
  _mm256_maskstore_pd(A + 503, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_27);
  _mm256_maskstore_pd(A + 627, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_28);
  _mm256_maskstore_pd(A + 751, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_28, _t0_28, 1));
  _mm256_maskstore_pd(A + 627, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_29);
  _mm256_maskstore_pd(A + 751, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_30);
  _mm256_maskstore_pd(A + 875, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_31);
  _mm256_storeu_pd(A + 8, _t0_55);
  _mm256_storeu_pd(A + 132, _t0_32);
  _mm256_storeu_pd(A + 256, _t0_33);
  _mm256_storeu_pd(A + 380, _t0_34);
  _mm256_storeu_pd(A + 504, _t0_78);
  _mm256_storeu_pd(A + 628, _t0_79);
  _mm256_storeu_pd(A + 752, _t0_80);
  _mm256_storeu_pd(A + 876, _t0_81);
  _mm256_storeu_pd(A + 1000, _t0_38);
  _mm256_maskstore_pd(A + 1124, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t0_39);
  _mm256_maskstore_pd(A + 1248, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t0_40);
  _mm256_maskstore_pd(A + 1372, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t0_41);
  _mm256_maskstore_pd(A + 1000, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_42);
  _mm256_maskstore_pd(A + 1001, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_44);
  _mm256_maskstore_pd(A + 1125, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_45);
  _mm256_maskstore_pd(A + 1126, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_46);
  _mm256_maskstore_pd(A + 1250, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_47);
  _mm256_maskstore_pd(A + 1003, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_48);
  _mm256_maskstore_pd(A + 1127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_49);
  _mm256_maskstore_pd(A + 1251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_49, _t0_49, 1));
  _mm256_maskstore_pd(A + 1127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_50);
  _mm256_maskstore_pd(A + 1251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_51);
  _mm256_maskstore_pd(A + 1375, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_52);

  for( int fi524 = 12; fi524 <= 120; fi524+=4 ) {

    for( int fi603 = 0; fi603 <= fi524 - 5; fi603+=4 ) {
      _t1_6 = _mm256_maskload_pd(A + 125*fi603, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
      _t1_14 = _mm256_loadu_pd(A + fi524 + 124*fi603);
      _t1_8 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 124);
      _t1_9 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 248);
      _t1_10 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 372);
      _t1_5 = _mm256_maskload_pd(A + 125*fi603 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_4 = _mm256_maskload_pd(A + 125*fi603 + 125, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
      _t1_3 = _mm256_maskload_pd(A + 125*fi603 + 126, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
      _t1_2 = _mm256_maskload_pd(A + 125*fi603 + 250, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
      _t1_1 = _mm256_broadcast_sd(&(A[125*fi603 + 251]));
      _t1_0 = _mm256_maskload_pd(A + 125*fi603 + 375, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
      ...
      _mm256_storeu_pd(A + fi524 + 124*fi603, _t1_14);
      _mm256_storeu_pd(A + fi524 + 124*fi603 + 124, _t1_8);
      _mm256_storeu_pd(A + fi524 + 124*fi603 + 248, _t1_9);
      _mm256_storeu_pd(A + fi524 + 124*fi603 + 372, _t1_10);

      for( int i96 = 0; i96 <= fi524 - fi603 - 5; i96+=4 ) {
        _t2_8 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 124*i96 + 496);
        _t2_9 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 124*i96 + 620);
        _t2_10 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 124*i96 + 744);
        _t2_11 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 124*i96 + 868);
        _t2_7 = _mm256_loadu_pd(A + 125*fi603 + i96 + 4);
        _t2_6 = _mm256_loadu_pd(A + 125*fi603 + i96 + 128);
        _t2_5 = _mm256_loadu_pd(A + 125*fi603 + i96 + 252);
        _t2_4 = _mm256_loadu_pd(A + 125*fi603 + i96 + 376);
        _t2_3 = _mm256_loadu_pd(A + fi524 + 124*fi603);
        _t2_2 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 124);
        _t2_1 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 248);
        _t2_0 = _mm256_loadu_pd(A + fi524 + 124*fi603 + 372);
        ...
        _mm256_storeu_pd(A + fi524 + 124*fi603 + 124*i96 + 496, _t2_8);
        _mm256_storeu_pd(A + fi524 + 124*fi603 + 124*i96 + 620, _t2_9);
        _mm256_storeu_pd(A + fi524 + 124*fi603 + 124*i96 + 744, _t2_10);
        _mm256_storeu_pd(A + fi524 + 124*fi603 + 124*i96 + 868, _t2_11);
      }
    }
    _t3_10 = _mm256_maskload_pd(A + 125*fi524 - 500, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
    _t3_22 = _mm256_loadu_pd(A + 125*fi524 - 496);
    _t3_12 = _mm256_loadu_pd(A + 125*fi524 - 372);
    _t3_13 = _mm256_loadu_pd(A + 125*fi524 - 248);
    _t3_14 = _mm256_loadu_pd(A + 125*fi524 - 124);
    _t3_9 = _mm256_maskload_pd(A + 125*fi524 - 499, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t3_8 = _mm256_maskload_pd(A + 125*fi524 - 375, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
    _t3_7 = _mm256_maskload_pd(A + 125*fi524 - 374, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t3_6 = _mm256_maskload_pd(A + 125*fi524 - 250, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
    _t3_5 = _mm256_broadcast_sd(&(A[125*fi524 - 249]));
    _t3_4 = _mm256_maskload_pd(A + 125*fi524 - 125, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
    _t3_18 = _mm256_loadu_pd(A + 125*fi524);
    _t3_19 = _mm256_maskload_pd(A + 125*fi524 + 124, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
    _t3_20 = _mm256_maskload_pd(A + 125*fi524 + 248, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
    _t3_21 = _mm256_maskload_pd(A + 125*fi524 + 372, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
    _t3_3 = _mm256_loadu_pd(A + fi524);
    _t3_2 = _mm256_loadu_pd(A + fi524 + 124);
    _t3_1 = _mm256_loadu_pd(A + fi524 + 248);
    _t3_0 = _mm256_loadu_pd(A + fi524 + 372);
    ...
    _t3_20 = _t0_84;
    _t3_21 = _t0_85;
    _mm256_storeu_pd(A + 125*fi524 - 496, _t3_22);
    _mm256_storeu_pd(A + 125*fi524 - 372, _t3_12);
    _mm256_storeu_pd(A + 125*fi524 - 248, _t3_13);
    _mm256_storeu_pd(A + 125*fi524 - 124, _t3_14);

    for( int i96 = 4; i96 <= fi524 - 1; i96+=4 ) {
      _t4_3 = _mm256_loadu_pd(A + fi524 + 124*i96);
      _t4_2 = _mm256_loadu_pd(A + fi524 + 124*i96 + 124);
      _t4_1 = _mm256_loadu_pd(A + fi524 + 124*i96 + 248);
      _t4_0 = _mm256_loadu_pd(A + fi524 + 124*i96 + 372);
    ...
    _t5_10 = _t5_60;
    _mm256_storeu_pd(A + 125*fi524, _t3_18);
    _mm256_maskstore_pd(A + 125*fi524 + 124, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t3_19);
    _mm256_maskstore_pd(A + 125*fi524 + 248, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t3_20);
    _mm256_maskstore_pd(A + 125*fi524 + 372, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t3_21);
    _mm256_maskstore_pd(A + 125*fi524, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_0);
    _mm256_maskstore_pd(A + 125*fi524 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t5_2);
    _mm256_maskstore_pd(A + 125*fi524 + 125, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_3);
    _mm256_maskstore_pd(A + 125*fi524 + 126, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_4);
    _mm256_maskstore_pd(A + 125*fi524 + 250, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_5);
    _mm256_maskstore_pd(A + 125*fi524 + 3, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_6);
    _mm256_maskstore_pd(A + 125*fi524 + 127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_7);
    _mm256_maskstore_pd(A + 125*fi524 + 251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_7, _t5_7, 1));
    _mm256_maskstore_pd(A + 125*fi524 + 127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_8);
    _mm256_maskstore_pd(A + 125*fi524 + 251, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_9);
    _mm256_maskstore_pd(A + 125*fi524 + 375, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_10);
  }
