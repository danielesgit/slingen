...
static __attribute__((noinline)) void kernel(double * A)
{
  ...
  _t0_4 = _mm256_maskload_pd(A + 78, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t0_6 = _mm256_maskload_pd(A + 154, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_7 = _mm256_maskload_pd(A + 155, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  _t0_8 = _mm256_maskload_pd(A + 231, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0));
  ...
  for( int fi127 = 4; fi127 <= 68; fi127+=4 ) {
    _t1_3 = _mm256_loadu_pd(A + fi127 + 4);
    _t1_0 = _mm256_loadu_pd(A + fi127 + 80);
    _t1_1 = _mm256_loadu_pd(A + fi127 + 156);
    _t1_2 = _mm256_loadu_pd(A + fi127 + 232);
    ...
    _mm256_storeu_pd(A + fi127 + 80, _t1_0);
    _mm256_storeu_pd(A + fi127 + 156, _t1_1);
    _mm256_storeu_pd(A + fi127 + 232, _t1_2);
  }

  _t2_0 = _mm256_loadu_pd(A + 308);
  _t2_1 = _mm256_maskload_pd(A + 384, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t2_2 = _mm256_maskload_pd(A + 460, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t2_3 = _mm256_maskload_pd(A + 536, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  ...
  for( int k81 = 0; k81 <= 67; k81+=4 ) {
    _t3_8 = _mm256_loadu_pd(A + k81 + 312);
    _t3_9 = _mm256_loadu_pd(A + k81 + 388);
    _t3_10 = _mm256_loadu_pd(A + k81 + 464);
    _t3_11 = _mm256_loadu_pd(A + k81 + 540);
    _t3_3 = _mm256_loadu_pd(A + k81 + 8);
    _t3_2 = _mm256_loadu_pd(A + k81 + 84);
    _t3_1 = _mm256_loadu_pd(A + k81 + 160);
    _t3_0 = _mm256_loadu_pd(A + k81 + 236);
    ...
    _mm256_storeu_pd(A + k81 + 312, _t3_8);
    _mm256_storeu_pd(A + k81 + 388, _t3_9);
    _mm256_storeu_pd(A + k81 + 464, _t3_10);
    _mm256_storeu_pd(A + k81 + 540, _t3_11);
  }

  _t4_5 = _mm256_loadu_pd(A + 312);
  _t4_2 = _mm256_loadu_pd(A + 388);
  _t4_3 = _mm256_loadu_pd(A + 464);
  _t4_4 = _mm256_loadu_pd(A + 540);
  ...
  _mm256_storeu_pd(A + 308, _t2_0);
  _mm256_maskstore_pd(A + 384, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t2_1);
  _mm256_maskstore_pd(A + 460, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t2_2);

  for( int fi252 = 4; fi252 <= 64; fi252+=4 ) {
    _t5_3 = _mm256_loadu_pd(A + fi252 + 312);
    _t5_0 = _mm256_loadu_pd(A + fi252 + 388);
    _t5_1 = _mm256_loadu_pd(A + fi252 + 464);
    _t5_2 = _mm256_loadu_pd(A + fi252 + 540);
    ...
    _mm256_storeu_pd(A + fi252 + 312, _t5_3);
    _mm256_storeu_pd(A + fi252 + 388, _t5_0);
    _mm256_storeu_pd(A + fi252 + 464, _t5_1);
    _mm256_storeu_pd(A + fi252 + 540, _t5_2);
  }

  _t6_4 = _mm256_loadu_pd(A + 616);
  _t6_5 = _mm256_maskload_pd(A + 692, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t6_6 = _mm256_maskload_pd(A + 768, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t6_7 = _mm256_maskload_pd(A + 844, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  _t6_3 = _mm256_loadu_pd(A + 8);
  _t6_2 = _mm256_loadu_pd(A + 84);
  _t6_1 = _mm256_loadu_pd(A + 160);
  _t6_0 = _mm256_loadu_pd(A + 236);
  ...
  for( int k81 = 0; k81 <= 63; k81+=4 ) {
    _t7_16 = _mm256_loadu_pd(A + k81 + 620);
    _t7_17 = _mm256_loadu_pd(A + k81 + 696);
    _t7_18 = _mm256_loadu_pd(A + k81 + 772);
    _t7_19 = _mm256_loadu_pd(A + k81 + 848);
    _t7_7 = _mm256_loadu_pd(A + k81 + 12);
    _t7_6 = _mm256_loadu_pd(A + k81 + 88);
    _t7_5 = _mm256_loadu_pd(A + k81 + 164);
    _t7_4 = _mm256_loadu_pd(A + k81 + 240);
    _t7_3 = _mm256_loadu_pd(A + k81 + 316);
    _t7_2 = _mm256_loadu_pd(A + k81 + 392);
    _t7_1 = _mm256_loadu_pd(A + k81 + 468);
    _t7_0 = _mm256_loadu_pd(A + k81 + 544);
    ...
    _mm256_storeu_pd(A + k81 + 620, _t7_16);
    _mm256_storeu_pd(A + k81 + 696, _t7_17);
    _mm256_storeu_pd(A + k81 + 772, _t7_18);
    _mm256_storeu_pd(A + k81 + 848, _t7_19);
  }

  _t8_5 = _mm256_loadu_pd(A + 620);
  _t8_2 = _mm256_loadu_pd(A + 696);
  _t8_3 = _mm256_loadu_pd(A + 772);
  _t8_4 = _mm256_loadu_pd(A + 848);
  ...
  _mm256_storeu_pd(A + 616, _t6_4);
  _mm256_maskstore_pd(A + 692, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t6_5);
  _mm256_maskstore_pd(A + 768, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t6_6);

  for( int fi252 = 4; fi252 <= 60; fi252+=4 ) {
    _t9_3 = _mm256_loadu_pd(A + fi252 + 620);
    _t9_0 = _mm256_loadu_pd(A + fi252 + 696);
    _t9_1 = _mm256_loadu_pd(A + fi252 + 772);
    _t9_2 = _mm256_loadu_pd(A + fi252 + 848);
    ...
    _mm256_storeu_pd(A + fi252 + 620, _t9_3);
    _mm256_storeu_pd(A + fi252 + 696, _t9_0);
    _mm256_storeu_pd(A + fi252 + 772, _t9_1);
    _mm256_storeu_pd(A + fi252 + 848, _t9_2);
  }

  _mm256_storeu_pd(A + 620, _t8_5);
  _mm256_storeu_pd(A + 696, _t8_2);
  _mm256_storeu_pd(A + 772, _t8_3);
  _mm256_storeu_pd(A + 848, _t8_4);

  for( int fi127 = 12; fi127 <= 68; fi127+=4 ) {
    _t10_4 = _mm256_loadu_pd(A + 77*fi127);
    _t10_5 = _mm256_maskload_pd(A + 77*fi127 + 76, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
    _t10_6 = _mm256_maskload_pd(A + 77*fi127 + 152, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
    _t10_7 = _mm256_maskload_pd(A + 77*fi127 + 228, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
    _t10_3 = _mm256_loadu_pd(A + fi127);
    _t10_2 = _mm256_loadu_pd(A + fi127 + 76);
    _t10_1 = _mm256_loadu_pd(A + fi127 + 152);
    _t10_0 = _mm256_loadu_pd(A + fi127 + 228);
    ...
    for( int k81 = 4; k81 <= fi127 - 1; k81+=4 ) {
      _t11_3 = _mm256_loadu_pd(A + fi127 + 76*k81);
      _t11_2 = _mm256_loadu_pd(A + fi127 + 76*k81 + 76);
      _t11_1 = _mm256_loadu_pd(A + fi127 + 76*k81 + 152);
      _t11_0 = _mm256_loadu_pd(A + fi127 + 76*k81 + 228);
    ...
    for( int k81 = 0; k81 <= -fi127 + 71; k81+=4 ) {
      _t13_8 = _mm256_loadu_pd(A + 77*fi127 + k81 + 4);
      _t13_9 = _mm256_loadu_pd(A + 77*fi127 + k81 + 80);
      _t13_10 = _mm256_loadu_pd(A + 77*fi127 + k81 + 156);
      _t13_11 = _mm256_loadu_pd(A + 77*fi127 + k81 + 232);
      _t13_3 = _mm256_loadu_pd(A + fi127 + k81 + 4);
      _t13_2 = _mm256_loadu_pd(A + fi127 + k81 + 80);
      _t13_1 = _mm256_loadu_pd(A + fi127 + k81 + 156);
      _t13_0 = _mm256_loadu_pd(A + fi127 + k81 + 232);
      ...
      _mm256_storeu_pd(A + 77*fi127 + k81 + 4, _t13_8);
      _mm256_storeu_pd(A + 77*fi127 + k81 + 80, _t13_9);
      _mm256_storeu_pd(A + 77*fi127 + k81 + 156, _t13_10);
      _mm256_storeu_pd(A + 77*fi127 + k81 + 232, _t13_11);

      for( int j128 = 4; j128 <= fi127 - 1; j128+=4 ) {
        _t14_7 = _mm256_loadu_pd(A + fi127 + 76*j128);
        _t14_6 = _mm256_loadu_pd(A + fi127 + 76*j128 + 76);
        _t14_5 = _mm256_loadu_pd(A + fi127 + 76*j128 + 152);
        _t14_4 = _mm256_loadu_pd(A + fi127 + 76*j128 + 228);
        _t14_3 = _mm256_loadu_pd(A + fi127 + 76*j128 + k81 + 4);
        _t14_2 = _mm256_loadu_pd(A + fi127 + 76*j128 + k81 + 80);
        _t14_1 = _mm256_loadu_pd(A + fi127 + 76*j128 + k81 + 156);
        _t14_0 = _mm256_loadu_pd(A + fi127 + 76*j128 + k81 + 232);
        _t14_8 = _mm256_loadu_pd(A + 77*fi127 + k81 + 4);
        _t14_9 = _mm256_loadu_pd(A + 77*fi127 + k81 + 80);
        _t14_10 = _mm256_loadu_pd(A + 77*fi127 + k81 + 156);
        _t14_11 = _mm256_loadu_pd(A + 77*fi127 + k81 + 232);
        ...
        _mm256_storeu_pd(A + 77*fi127 + k81 + 4, _t14_8);
        _mm256_storeu_pd(A + 77*fi127 + k81 + 80, _t14_9);
        _mm256_storeu_pd(A + 77*fi127 + k81 + 156, _t14_10);
        _mm256_storeu_pd(A + 77*fi127 + k81 + 232, _t14_11);
      }
    }
    ...
    _t15_1 = _t15_7;
    _mm256_storeu_pd(A + 77*fi127, _t10_4);
    _mm256_maskstore_pd(A + 77*fi127 + 76, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t10_5);
    _mm256_maskstore_pd(A + 77*fi127 + 152, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t10_6);

    for( int fi252 = 0; fi252 <= -fi127 + 68; fi252+=4 ) {
      _t16_3 = _mm256_loadu_pd(A + 77*fi127 + fi252 + 4);
      _t16_0 = _mm256_loadu_pd(A + 77*fi127 + fi252 + 80);
      _t16_1 = _mm256_loadu_pd(A + 77*fi127 + fi252 + 156);
      _t16_2 = _mm256_loadu_pd(A + 77*fi127 + fi252 + 232);
      ...
      _mm256_storeu_pd(A + 77*fi127 + fi252 + 4, _t16_3);
      _mm256_storeu_pd(A + 77*fi127 + fi252 + 80, _t16_0);
      _mm256_storeu_pd(A + 77*fi127 + fi252 + 156, _t16_1);
      _mm256_storeu_pd(A + 77*fi127 + fi252 + 232, _t16_2);
    }
    _mm256_maskstore_pd(A + 77*fi127 + 228, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t10_7);
    _mm256_maskstore_pd(A + 77*fi127, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_0);
    _mm256_maskstore_pd(A + 77*fi127 + 1, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t12_2);
    _mm256_maskstore_pd(A + 77*fi127 + 77, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_3);
    _mm256_maskstore_pd(A + 77*fi127 + 78, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t12_4);
    _mm256_maskstore_pd(A + 77*fi127 + 154, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_6);
    _mm256_maskstore_pd(A + 77*fi127 + 155, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_7);
    _mm256_maskstore_pd(A + 77*fi127 + 231, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t12_8);
  }

  _t17_4 = _mm256_loadu_pd(A + 5544);
  _t17_5 = _mm256_maskload_pd(A + 5620, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63));
  _t17_6 = _mm256_maskload_pd(A + 5696, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63));
  _t17_7 = _mm256_maskload_pd(A + 5772, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63));
  _t17_3 = _mm256_loadu_pd(A + 72);
  _t17_2 = _mm256_loadu_pd(A + 148);
  _t17_1 = _mm256_loadu_pd(A + 224);
  _t17_0 = _mm256_loadu_pd(A + 300);
  ...
  for( int k81 = 4; k81 <= 71; k81+=4 ) {
    _t18_3 = _mm256_loadu_pd(A + 76*k81 + 72);
    _t18_2 = _mm256_loadu_pd(A + 76*k81 + 148);
    _t18_1 = _mm256_loadu_pd(A + 76*k81 + 224);
    _t18_0 = _mm256_loadu_pd(A + 76*k81 + 300);
  ...
  _mm256_maskstore_pd(A + 78, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_4);
  _mm256_maskstore_pd(A + 154, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_6);
  _mm256_maskstore_pd(A + 155, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_7);
  _mm256_maskstore_pd(A + 231, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_8);
  _mm256_storeu_pd(A + 4, _t0_14);
  _mm256_storeu_pd(A + 80, _t0_11);
  _mm256_storeu_pd(A + 156, _t0_12);
  _mm256_storeu_pd(A + 232, _t0_13);
  _mm256_maskstore_pd(A + 536, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t2_3);
  _mm256_maskstore_pd(A + 308, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_4);
  _mm256_maskstore_pd(A + 309, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t2_6);
  _mm256_maskstore_pd(A + 385, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_7);
  _mm256_maskstore_pd(A + 386, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t2_8);
  _mm256_maskstore_pd(A + 462, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_10);
  _mm256_maskstore_pd(A + 463, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_11);
  _mm256_maskstore_pd(A + 539, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t2_12);
  _mm256_storeu_pd(A + 312, _t4_5);
  _mm256_storeu_pd(A + 388, _t4_2);
  _mm256_storeu_pd(A + 464, _t4_3);
  _mm256_storeu_pd(A + 540, _t4_4);
  _mm256_maskstore_pd(A + 844, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t6_7);
  _mm256_maskstore_pd(A + 616, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_8);
  _mm256_maskstore_pd(A + 617, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t6_10);
  _mm256_maskstore_pd(A + 693, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_11);
  _mm256_maskstore_pd(A + 694, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t6_12);
  _mm256_maskstore_pd(A + 770, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_14);
  _mm256_maskstore_pd(A + 771, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_15);
  _mm256_maskstore_pd(A + 847, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t6_16);
  _mm256_storeu_pd(A + 5544, _t17_4);
  _mm256_maskstore_pd(A + 5620, _mm256_setr_epi64x(0, (__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63), _t17_5);
  _mm256_maskstore_pd(A + 5696, _mm256_setr_epi64x(0, 0, (__int64)1 << 63, (__int64)1 << 63), _t17_6);
  _mm256_maskstore_pd(A + 5772, _mm256_setr_epi64x(0, 0, 0, (__int64)1 << 63), _t17_7);
  _mm256_maskstore_pd(A + 5544, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_0);
  _mm256_maskstore_pd(A + 5545, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t19_2);
  _mm256_maskstore_pd(A + 5621, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_3);
  _mm256_maskstore_pd(A + 5622, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t19_4);
  _mm256_maskstore_pd(A + 5698, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_6);
  _mm256_maskstore_pd(A + 5699, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_7);
  _mm256_maskstore_pd(A + 5775, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t19_8);
