...
static __attribute__((noinline)) void kernel(double a, double t, double const * W, double const * A, double const * x0, double b, double const * y, double * y1, double * v1, double * z1, double * y2, double * v2, double * z2, double * x1, double * x)
{
  ...
  // Generating : y1[28,1] = Sum_{i0} ( S(h(4, 28, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), v1[28,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), z1[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : y2[28,1] = Sum_{i0} ( S(h(4, 28, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), v2[28,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), z2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : x1[28,1] = ( ( Sum_{k15} ( S(h(4, 28, k15), ( ( T( G(h(4, 28, 0), W[28,28],h(4, 28, k15)) ) * G(h(4, 28, 0), y1[28,1],h(1, 1, 0)) ) - ( T( G(h(4, 28, 0), A[28,28],h(4, 28, k15)) ) * G(h(4, 28, 0), y2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i6} ( Sum_{k15} ( $(h(4, 28, k15), ( T( G(h(4, 28, i6), W[28,28],h(4, 28, k15)) ) * G(h(4, 28, i6), y1[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{i0} ( Sum_{k15} ( -$(h(4, 28, k15), ( T( G(h(4, 28, i0), A[28,28],h(4, 28, k15)) ) * G(h(4, 28, i0), y2[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int k15 = 0; k15 <= 27; k15+=4 ) {
    _t4_9 = _asm256_loadu_pd(W + k15);
    _t4_8 = _asm256_loadu_pd(W + k15 + 28);
    _t4_7 = _asm256_loadu_pd(W + k15 + 56);
    _t4_6 = _asm256_loadu_pd(W + k15 + 84);
    _t4_5 = _asm256_loadu_pd(y1);
    _t4_4 = _asm256_loadu_pd(A + k15);
    _t4_3 = _asm256_loadu_pd(A + k15 + 28);
    _t4_2 = _asm256_loadu_pd(A + k15 + 56);
    _t4_1 = _asm256_loadu_pd(A + k15 + 84);
  ...
  for( int i6 = 4; i6 <= 27; i6+=4 ) {

    // AVX Loader:

    for( int k15 = 0; k15 <= 27; k15+=4 ) {
      _t5_4 = _asm256_loadu_pd(W + 28*i6 + k15);
      _t5_3 = _asm256_loadu_pd(W + 28*i6 + k15 + 28);
      _t5_2 = _asm256_loadu_pd(W + 28*i6 + k15 + 56);
      _t5_1 = _asm256_loadu_pd(W + 28*i6 + k15 + 84);
  ...
  for( int i0 = 4; i0 <= 27; i0+=4 ) {
    ...
    for( int k15 = 0; k15 <= 27; k15+=4 ) {
      _t6_4 = _asm256_loadu_pd(A + 28*i0 + k15);
      _t6_3 = _asm256_loadu_pd(A + 28*i0 + k15 + 28);
      _t6_2 = _asm256_loadu_pd(A + 28*i0 + k15 + 56);
      _t6_1 = _asm256_loadu_pd(A + 28*i0 + k15 + 84);
  ...
  // Generating : x[28,1] = Sum_{i0} ( S(h(4, 28, i0), ( G(h(4, 28, i0), x0[28,1],h(1, 1, 0)) + ( G(h(1, 1, 0), b[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), x1[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : z1[28,1] = ( Sum_{i6} ( S(h(4, 28, i6), ( G(h(4, 28, i6), y1[28,1],h(1, 1, 0)) - ( G(h(4, 28, i6), W[28,28],h(4, 28, 0)) * G(h(4, 28, 0), x[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( -$(h(4, 28, i6), ( G(h(4, 28, i6), W[28,28],h(4, 28, i0)) * G(h(4, 28, i0), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )

  // AVX Loader:


  for( int i6 = 0; i6 <= 27; i6+=4 ) {
    _t9_5 = _asm256_loadu_pd(y1 + i6);
    _t9_4 = _asm256_loadu_pd(W + 28*i6);
    _t9_3 = _asm256_loadu_pd(W + 28*i6 + 28);
    _t9_2 = _asm256_loadu_pd(W + 28*i6 + 56);
    _t9_1 = _asm256_loadu_pd(W + 28*i6 + 84);
  ...
  for( int i0 = 4; i0 <= 27; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 27; i6+=4 ) {
      _t10_4 = _asm256_loadu_pd(W + i0 + 28*i6);
      _t10_3 = _asm256_loadu_pd(W + i0 + 28*i6 + 28);
      _t10_2 = _asm256_loadu_pd(W + i0 + 28*i6 + 56);
      _t10_1 = _asm256_loadu_pd(W + i0 + 28*i6 + 84);
  ...
  // Generating : z2[28,1] = ( Sum_{i6} ( S(h(4, 28, i6), ( G(h(4, 28, i6), y2[28,1],h(1, 1, 0)) - ( G(h(4, 28, i6), y[28,1],h(1, 1, 0)) - ( G(h(4, 28, i6), A[28,28],h(4, 28, 0)) * G(h(4, 28, 0), x[28,1],h(1, 1, 0)) ) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( $(h(4, 28, i6), ( G(h(4, 28, i6), A[28,28],h(4, 28, i0)) * G(h(4, 28, i0), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int i6 = 0; i6 <= 27; i6+=4 ) {
    ...
    _t11_4 = _asm256_loadu_pd(A + 28*i6);
    _t11_3 = _asm256_loadu_pd(A + 28*i6 + 28);
    _t11_2 = _asm256_loadu_pd(A + 28*i6 + 56);
    _t11_1 = _asm256_loadu_pd(A + 28*i6 + 84);
  ...
  for( int i0 = 4; i0 <= 27; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 27; i6+=4 ) {
      _t12_4 = _asm256_loadu_pd(A + i0 + 28*i6);
      _t12_3 = _asm256_loadu_pd(A + i0 + 28*i6 + 28);
      _t12_2 = _asm256_loadu_pd(A + i0 + 28*i6 + 56);
      _t12_1 = _asm256_loadu_pd(A + i0 + 28*i6 + 84);
  ...
  // Generating : v1[28,1] = Sum_{i0} ( S(h(4, 28, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), v1[28,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), z1[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : v2[28,1] = Sum_{i0} ( S(h(4, 28, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), v2[28,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 28, i0), z2[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
