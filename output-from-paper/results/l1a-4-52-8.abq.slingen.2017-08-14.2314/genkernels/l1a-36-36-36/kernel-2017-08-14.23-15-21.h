...
static __attribute__((noinline)) void kernel(double a, double t, double const * W, double const * A, double const * x0, double b, double const * y, double * y1, double * v1, double * z1, double * y2, double * v2, double * z2, double * x1, double * x)
{
  ...
  // Generating : y1[36,1] = Sum_{i0} ( S(h(4, 36, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), v1[36,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), z1[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : y2[36,1] = Sum_{i0} ( S(h(4, 36, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), v2[36,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), z2[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : x1[36,1] = ( ( Sum_{k15} ( S(h(4, 36, k15), ( ( T( G(h(4, 36, 0), W[36,36],h(4, 36, k15)) ) * G(h(4, 36, 0), y1[36,1],h(1, 1, 0)) ) - ( T( G(h(4, 36, 0), A[36,36],h(4, 36, k15)) ) * G(h(4, 36, 0), y2[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i6} ( Sum_{k15} ( $(h(4, 36, k15), ( T( G(h(4, 36, i6), W[36,36],h(4, 36, k15)) ) * G(h(4, 36, i6), y1[36,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{i0} ( Sum_{k15} ( -$(h(4, 36, k15), ( T( G(h(4, 36, i0), A[36,36],h(4, 36, k15)) ) * G(h(4, 36, i0), y2[36,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int k15 = 0; k15 <= 35; k15+=4 ) {
    _t4_9 = _asm256_loadu_pd(W + k15);
    _t4_8 = _asm256_loadu_pd(W + k15 + 36);
    _t4_7 = _asm256_loadu_pd(W + k15 + 72);
    _t4_6 = _asm256_loadu_pd(W + k15 + 108);
    _t4_5 = _asm256_loadu_pd(y1);
    _t4_4 = _asm256_loadu_pd(A + k15);
    _t4_3 = _asm256_loadu_pd(A + k15 + 36);
    _t4_2 = _asm256_loadu_pd(A + k15 + 72);
    _t4_1 = _asm256_loadu_pd(A + k15 + 108);
  ...
  for( int i6 = 4; i6 <= 35; i6+=4 ) {

    // AVX Loader:

    for( int k15 = 0; k15 <= 35; k15+=4 ) {
      _t5_4 = _asm256_loadu_pd(W + 36*i6 + k15);
      _t5_3 = _asm256_loadu_pd(W + 36*i6 + k15 + 36);
      _t5_2 = _asm256_loadu_pd(W + 36*i6 + k15 + 72);
      _t5_1 = _asm256_loadu_pd(W + 36*i6 + k15 + 108);
  ...
  for( int i0 = 4; i0 <= 35; i0+=4 ) {

    // AVX Loader:

    for( int k15 = 0; k15 <= 35; k15+=4 ) {
      _t6_4 = _asm256_loadu_pd(A + 36*i0 + k15);
      _t6_3 = _asm256_loadu_pd(A + 36*i0 + k15 + 36);
      _t6_2 = _asm256_loadu_pd(A + 36*i0 + k15 + 72);
      _t6_1 = _asm256_loadu_pd(A + 36*i0 + k15 + 108);
  ...
  // Generating : x[36,1] = Sum_{i0} ( S(h(4, 36, i0), ( G(h(4, 36, i0), x0[36,1],h(1, 1, 0)) + ( G(h(1, 1, 0), b[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), x1[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : z1[36,1] = ( Sum_{i6} ( S(h(4, 36, i6), ( G(h(4, 36, i6), y1[36,1],h(1, 1, 0)) - ( G(h(4, 36, i6), W[36,36],h(4, 36, 0)) * G(h(4, 36, 0), x[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( -$(h(4, 36, i6), ( G(h(4, 36, i6), W[36,36],h(4, 36, i0)) * G(h(4, 36, i0), x[36,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )

  // AVX Loader:


  for( int i6 = 0; i6 <= 35; i6+=4 ) {
    _t9_5 = _asm256_loadu_pd(y1 + i6);
    _t9_4 = _asm256_loadu_pd(W + 36*i6);
    _t9_3 = _asm256_loadu_pd(W + 36*i6 + 36);
    _t9_2 = _asm256_loadu_pd(W + 36*i6 + 72);
    _t9_1 = _asm256_loadu_pd(W + 36*i6 + 108);
  ...
  for( int i0 = 4; i0 <= 35; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 35; i6+=4 ) {
      _t10_4 = _asm256_loadu_pd(W + i0 + 36*i6);
      _t10_3 = _asm256_loadu_pd(W + i0 + 36*i6 + 36);
      _t10_2 = _asm256_loadu_pd(W + i0 + 36*i6 + 72);
      _t10_1 = _asm256_loadu_pd(W + i0 + 36*i6 + 108);
  ...
  // Generating : z2[36,1] = ( Sum_{i6} ( S(h(4, 36, i6), ( G(h(4, 36, i6), y2[36,1],h(1, 1, 0)) - ( G(h(4, 36, i6), y[36,1],h(1, 1, 0)) - ( G(h(4, 36, i6), A[36,36],h(4, 36, 0)) * G(h(4, 36, 0), x[36,1],h(1, 1, 0)) ) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( $(h(4, 36, i6), ( G(h(4, 36, i6), A[36,36],h(4, 36, i0)) * G(h(4, 36, i0), x[36,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int i6 = 0; i6 <= 35; i6+=4 ) {
    ...
    _t11_4 = _asm256_loadu_pd(A + 36*i6);
    _t11_3 = _asm256_loadu_pd(A + 36*i6 + 36);
    _t11_2 = _asm256_loadu_pd(A + 36*i6 + 72);
    _t11_1 = _asm256_loadu_pd(A + 36*i6 + 108);
  ...
  for( int i0 = 4; i0 <= 35; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 35; i6+=4 ) {
      _t12_4 = _asm256_loadu_pd(A + i0 + 36*i6);
      _t12_3 = _asm256_loadu_pd(A + i0 + 36*i6 + 36);
      _t12_2 = _asm256_loadu_pd(A + i0 + 36*i6 + 72);
      _t12_1 = _asm256_loadu_pd(A + i0 + 36*i6 + 108);
  ...
  // Generating : v1[36,1] = Sum_{i0} ( S(h(4, 36, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), v1[36,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), z1[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : v2[36,1] = Sum_{i0} ( S(h(4, 36, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), v2[36,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 36, i0), z2[36,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
