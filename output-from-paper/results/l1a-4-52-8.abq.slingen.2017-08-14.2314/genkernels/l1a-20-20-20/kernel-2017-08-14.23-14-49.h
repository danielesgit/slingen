...
static __attribute__((noinline)) void kernel(double a, double t, double const * W, double const * A, double const * x0, double b, double const * y, double * y1, double * v1, double * z1, double * y2, double * v2, double * z2, double * x1, double * x)
{
  ...
  // Generating : y1[20,1] = Sum_{i0} ( S(h(4, 20, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), v1[20,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), z1[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : y2[20,1] = Sum_{i0} ( S(h(4, 20, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), v2[20,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), z2[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : x1[20,1] = ( ( Sum_{k15} ( S(h(4, 20, k15), ( ( T( G(h(4, 20, 0), W[20,20],h(4, 20, k15)) ) * G(h(4, 20, 0), y1[20,1],h(1, 1, 0)) ) - ( T( G(h(4, 20, 0), A[20,20],h(4, 20, k15)) ) * G(h(4, 20, 0), y2[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i6} ( Sum_{k15} ( $(h(4, 20, k15), ( T( G(h(4, 20, i6), W[20,20],h(4, 20, k15)) ) * G(h(4, 20, i6), y1[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{i0} ( Sum_{k15} ( -$(h(4, 20, k15), ( T( G(h(4, 20, i0), A[20,20],h(4, 20, k15)) ) * G(h(4, 20, i0), y2[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int k15 = 0; k15 <= 19; k15+=4 ) {
    _t4_9 = _asm256_loadu_pd(W + k15);
    _t4_8 = _asm256_loadu_pd(W + k15 + 20);
    _t4_7 = _asm256_loadu_pd(W + k15 + 40);
    _t4_6 = _asm256_loadu_pd(W + k15 + 60);
    _t4_5 = _asm256_loadu_pd(y1);
    _t4_4 = _asm256_loadu_pd(A + k15);
    _t4_3 = _asm256_loadu_pd(A + k15 + 20);
    _t4_2 = _asm256_loadu_pd(A + k15 + 40);
    _t4_1 = _asm256_loadu_pd(A + k15 + 60);
  ...
  for( int i6 = 4; i6 <= 19; i6+=4 ) {

    // AVX Loader:

    for( int k15 = 0; k15 <= 19; k15+=4 ) {
      _t5_4 = _asm256_loadu_pd(W + 20*i6 + k15);
      _t5_3 = _asm256_loadu_pd(W + 20*i6 + k15 + 20);
      _t5_2 = _asm256_loadu_pd(W + 20*i6 + k15 + 40);
      _t5_1 = _asm256_loadu_pd(W + 20*i6 + k15 + 60);
  ...
  for( int i0 = 4; i0 <= 19; i0+=4 ) {
    ...
    for( int k15 = 0; k15 <= 19; k15+=4 ) {
      _t6_4 = _asm256_loadu_pd(A + 20*i0 + k15);
      _t6_3 = _asm256_loadu_pd(A + 20*i0 + k15 + 20);
      _t6_2 = _asm256_loadu_pd(A + 20*i0 + k15 + 40);
      _t6_1 = _asm256_loadu_pd(A + 20*i0 + k15 + 60);
  ...
  // Generating : x[20,1] = Sum_{i0} ( S(h(4, 20, i0), ( G(h(4, 20, i0), x0[20,1],h(1, 1, 0)) + ( G(h(1, 1, 0), b[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), x1[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : z1[20,1] = ( Sum_{i6} ( S(h(4, 20, i6), ( G(h(4, 20, i6), y1[20,1],h(1, 1, 0)) - ( G(h(4, 20, i6), W[20,20],h(4, 20, 0)) * G(h(4, 20, 0), x[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( -$(h(4, 20, i6), ( G(h(4, 20, i6), W[20,20],h(4, 20, i0)) * G(h(4, 20, i0), x[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )

  // AVX Loader:


  for( int i6 = 0; i6 <= 19; i6+=4 ) {
    _t9_5 = _asm256_loadu_pd(y1 + i6);
    _t9_4 = _asm256_loadu_pd(W + 20*i6);
    _t9_3 = _asm256_loadu_pd(W + 20*i6 + 20);
    _t9_2 = _asm256_loadu_pd(W + 20*i6 + 40);
    _t9_1 = _asm256_loadu_pd(W + 20*i6 + 60);
  ...
  for( int i0 = 4; i0 <= 19; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 19; i6+=4 ) {
      _t10_4 = _asm256_loadu_pd(W + i0 + 20*i6);
      _t10_3 = _asm256_loadu_pd(W + i0 + 20*i6 + 20);
      _t10_2 = _asm256_loadu_pd(W + i0 + 20*i6 + 40);
      _t10_1 = _asm256_loadu_pd(W + i0 + 20*i6 + 60);
  ...
  // Generating : z2[20,1] = ( Sum_{i6} ( S(h(4, 20, i6), ( G(h(4, 20, i6), y2[20,1],h(1, 1, 0)) - ( G(h(4, 20, i6), y[20,1],h(1, 1, 0)) - ( G(h(4, 20, i6), A[20,20],h(4, 20, 0)) * G(h(4, 20, 0), x[20,1],h(1, 1, 0)) ) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( $(h(4, 20, i6), ( G(h(4, 20, i6), A[20,20],h(4, 20, i0)) * G(h(4, 20, i0), x[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int i6 = 0; i6 <= 19; i6+=4 ) {
    ...
    _t11_4 = _asm256_loadu_pd(A + 20*i6);
    _t11_3 = _asm256_loadu_pd(A + 20*i6 + 20);
    _t11_2 = _asm256_loadu_pd(A + 20*i6 + 40);
    _t11_1 = _asm256_loadu_pd(A + 20*i6 + 60);
  ...
  for( int i0 = 4; i0 <= 19; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 19; i6+=4 ) {
      _t12_4 = _asm256_loadu_pd(A + i0 + 20*i6);
      _t12_3 = _asm256_loadu_pd(A + i0 + 20*i6 + 20);
      _t12_2 = _asm256_loadu_pd(A + i0 + 20*i6 + 40);
      _t12_1 = _asm256_loadu_pd(A + i0 + 20*i6 + 60);
  ...
  // Generating : v1[20,1] = Sum_{i0} ( S(h(4, 20, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), v1[20,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), z1[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  // Generating : v2[20,1] = Sum_{i0} ( S(h(4, 20, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), v2[20,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 20, i0), z2[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
