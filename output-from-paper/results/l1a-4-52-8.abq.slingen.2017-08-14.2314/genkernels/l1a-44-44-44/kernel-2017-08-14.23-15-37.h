...
static __attribute__((noinline)) void kernel(double a, double t, double const * W, double const * A, double const * x0, double b, double const * y, double * y1, double * v1, double * z1, double * y2, double * v2, double * z2, double * x1, double * x)
{
  ...
  // Generating : y1[44,1] = Sum_{i0} ( S(h(4, 44, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), v1[44,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), z1[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  for( int i0 = 0; i0 <= 43; i0+=4 ) {
    ...
    // 4-BLAC: 1x4 Kro 4x1
    _t1_3 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t0_0, 15), 15), _t1_1);

    // AVX Loader:

    // 4-BLAC: 1x4 Kro 4x1
    _t1_4 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t0_1, 15), 15), _t1_0);
  ...
  // Generating : y2[44,1] = Sum_{i0} ( S(h(4, 44, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), v2[44,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), z2[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  for( int i0 = 0; i0 <= 43; i0+=4 ) {
    ...
    // 4-BLAC: 1x4 Kro 4x1
    _t3_3 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t2_0, 15), 15), _t3_1);

    // AVX Loader:

    // 4-BLAC: 1x4 Kro 4x1
    _t3_4 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t2_1, 15), 15), _t3_0);
  ...
  // Generating : x1[44,1] = ( ( Sum_{k15} ( S(h(4, 44, k15), ( ( T( G(h(4, 44, 0), W[44,44],h(4, 44, k15)) ) * G(h(4, 44, 0), y1[44,1],h(1, 1, 0)) ) - ( T( G(h(4, 44, 0), A[44,44],h(4, 44, k15)) ) * G(h(4, 44, 0), y2[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i6} ( Sum_{k15} ( $(h(4, 44, k15), ( T( G(h(4, 44, i6), W[44,44],h(4, 44, k15)) ) * G(h(4, 44, i6), y1[44,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) ) + Sum_{i0} ( Sum_{k15} ( -$(h(4, 44, k15), ( T( G(h(4, 44, i0), A[44,44],h(4, 44, k15)) ) * G(h(4, 44, i0), y2[44,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int k15 = 0; k15 <= 43; k15+=4 ) {
    _t4_9 = _asm256_loadu_pd(W + k15);
    _t4_8 = _asm256_loadu_pd(W + k15 + 44);
    _t4_7 = _asm256_loadu_pd(W + k15 + 88);
    _t4_6 = _asm256_loadu_pd(W + k15 + 132);
    _t4_5 = _asm256_loadu_pd(y1);
    _t4_4 = _asm256_loadu_pd(A + k15);
    _t4_3 = _asm256_loadu_pd(A + k15 + 44);
    _t4_2 = _asm256_loadu_pd(A + k15 + 88);
    _t4_1 = _asm256_loadu_pd(A + k15 + 132);
  ...
  for( int i6 = 4; i6 <= 43; i6+=4 ) {

    // AVX Loader:

    for( int k15 = 0; k15 <= 43; k15+=4 ) {
      _t5_4 = _asm256_loadu_pd(W + 44*i6 + k15);
      _t5_3 = _asm256_loadu_pd(W + 44*i6 + k15 + 44);
      _t5_2 = _asm256_loadu_pd(W + 44*i6 + k15 + 88);
      _t5_1 = _asm256_loadu_pd(W + 44*i6 + k15 + 132);
  ...
  for( int i0 = 4; i0 <= 43; i0+=4 ) {

    // AVX Loader:

    for( int k15 = 0; k15 <= 43; k15+=4 ) {
      _t6_4 = _asm256_loadu_pd(A + 44*i0 + k15);
      _t6_3 = _asm256_loadu_pd(A + 44*i0 + k15 + 44);
      _t6_2 = _asm256_loadu_pd(A + 44*i0 + k15 + 88);
      _t6_1 = _asm256_loadu_pd(A + 44*i0 + k15 + 132);
  ...
  // Generating : x[44,1] = Sum_{i0} ( S(h(4, 44, i0), ( G(h(4, 44, i0), x0[44,1],h(1, 1, 0)) + ( G(h(1, 1, 0), b[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), x1[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  for( int i0 = 0; i0 <= 43; i0+=4 ) {
    ...
    // 4-BLAC: 1x4 Kro 4x1
    _t8_3 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t7_0, 15), 15), _t8_0);
  ...
  // Generating : z1[44,1] = ( Sum_{i6} ( S(h(4, 44, i6), ( G(h(4, 44, i6), y1[44,1],h(1, 1, 0)) - ( G(h(4, 44, i6), W[44,44],h(4, 44, 0)) * G(h(4, 44, 0), x[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( -$(h(4, 44, i6), ( G(h(4, 44, i6), W[44,44],h(4, 44, i0)) * G(h(4, 44, i0), x[44,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )

  // AVX Loader:


  for( int i6 = 0; i6 <= 43; i6+=4 ) {
    _t9_5 = _asm256_loadu_pd(y1 + i6);
    _t9_4 = _asm256_loadu_pd(W + 44*i6);
    _t9_3 = _asm256_loadu_pd(W + 44*i6 + 44);
    _t9_2 = _asm256_loadu_pd(W + 44*i6 + 88);
    _t9_1 = _asm256_loadu_pd(W + 44*i6 + 132);
  ...
  for( int i0 = 4; i0 <= 43; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 43; i6+=4 ) {
      _t10_4 = _asm256_loadu_pd(W + i0 + 44*i6);
      _t10_3 = _asm256_loadu_pd(W + i0 + 44*i6 + 44);
      _t10_2 = _asm256_loadu_pd(W + i0 + 44*i6 + 88);
      _t10_1 = _asm256_loadu_pd(W + i0 + 44*i6 + 132);
  ...
  // Generating : z2[44,1] = ( Sum_{i6} ( S(h(4, 44, i6), ( G(h(4, 44, i6), y2[44,1],h(1, 1, 0)) - ( G(h(4, 44, i6), y[44,1],h(1, 1, 0)) - ( G(h(4, 44, i6), A[44,44],h(4, 44, 0)) * G(h(4, 44, 0), x[44,1],h(1, 1, 0)) ) ) ),h(1, 1, 0)) ) + Sum_{i0} ( Sum_{i6} ( $(h(4, 44, i6), ( G(h(4, 44, i6), A[44,44],h(4, 44, i0)) * G(h(4, 44, i0), x[44,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )
  ...
  for( int i6 = 0; i6 <= 43; i6+=4 ) {
    ...
    _t11_4 = _asm256_loadu_pd(A + 44*i6);
    _t11_3 = _asm256_loadu_pd(A + 44*i6 + 44);
    _t11_2 = _asm256_loadu_pd(A + 44*i6 + 88);
    _t11_1 = _asm256_loadu_pd(A + 44*i6 + 132);
  ...
  for( int i0 = 4; i0 <= 43; i0+=4 ) {
    ...
    for( int i6 = 0; i6 <= 43; i6+=4 ) {
      _t12_4 = _asm256_loadu_pd(A + i0 + 44*i6);
      _t12_3 = _asm256_loadu_pd(A + i0 + 44*i6 + 44);
      _t12_2 = _asm256_loadu_pd(A + i0 + 44*i6 + 88);
      _t12_1 = _asm256_loadu_pd(A + i0 + 44*i6 + 132);
  ...
  // Generating : v1[44,1] = Sum_{i0} ( S(h(4, 44, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), v1[44,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), z1[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  for( int i0 = 0; i0 <= 43; i0+=4 ) {
    ...
    // 4-BLAC: 1x4 Kro 4x1
    _t14_2 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t13_0, 15), 15), _t14_1);

    // AVX Loader:

    // 4-BLAC: 1x4 Kro 4x1
    _t14_3 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t13_1, 15), 15), _t14_0);
  ...
  // Generating : v2[44,1] = Sum_{i0} ( S(h(4, 44, i0), ( ( G(h(1, 1, 0), a[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), v2[44,1],h(1, 1, 0)) ) + ( G(h(1, 1, 0), t[1,1],h(1, 1, 0)) Kro G(h(4, 44, i0), z2[44,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
  ...
  for( int i0 = 0; i0 <= 43; i0+=4 ) {
    ...
    // 4-BLAC: 1x4 Kro 4x1
    _t16_2 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t15_0, 15), 15), _t16_1);

    // AVX Loader:

    // 4-BLAC: 1x4 Kro 4x1
    _t16_3 = _mm256_mul_pd(_mm256_blend_pd(_mm256_setzero_pd(), _mm256_blend_pd(_mm256_setzero_pd(), _t15_1, 15), 15), _t16_0);
