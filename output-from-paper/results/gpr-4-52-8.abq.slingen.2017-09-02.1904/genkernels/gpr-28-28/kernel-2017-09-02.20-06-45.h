 ...
 * gpr_kernel.h
 *
Decl { {u'K': Symmetric[K, (28, 28), LSMatAccess], u'L': LowerTriangular[L, (28, 28), GenMatAccess], u'var': Scalar[var, (1, 1), GenMatAccess], u'L0': LowerTriangular[L0, (28, 28), GenMatAccess], u'X': SquaredMatrix[X, (28, 28), GenMatAccess], 'T1448': Matrix[T1448, (1, 28), GenMatAccess], u'a': Matrix[a, (28, 1), GenMatAccess], u'f': Scalar[f, (1, 1), GenMatAccess], u't2': Matrix[t2, (28, 1), GenMatAccess], u't0': Matrix[t0, (28, 1), GenMatAccess], u't1': Matrix[t1, (28, 1), GenMatAccess], u'lp': Scalar[lp, (1, 1), GenMatAccess], u'v': Matrix[v, (28, 1), GenMatAccess], u'y': Matrix[y, (28, 1), GenMatAccess], u'x': Matrix[x, (28, 1), GenMatAccess], u'kx': Matrix[kx, (28, 1), GenMatAccess]} }
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Entry 0:
For_{fi18;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,28],h(1, 28, fi18)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,28],h(1, 28, fi18)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(3, 28, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(3, 28, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,28],h(1, 28, fi18 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,28],h(1, 28, fi18 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(2, 28, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(2, 28, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) )
Eq.ann: {}
Entry 12:
For_{fi79;0;-fi18 + 20;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18)) ) Div Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(3, 28, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(3, 28, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(2, 28, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(2, 28, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18)) ) Div Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(3, 28, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(3, 28, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(2, 28, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(2, 28, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) )
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18)) ) Div Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) )
Eq.ann: {}
Entry 15:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(3, 28, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(3, 28, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 16:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) )
Eq.ann: {}
Entry 17:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(2, 28, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(2, 28, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 18:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) )
Eq.ann: {}
Entry 19:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 20:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) )
Eq.ann: {}
Entry 21:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18)) ) Div Tile( (1, 1), G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ) )
Eq.ann: {}
Entry 22:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(3, 28, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(3, 28, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 23:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ) )
Eq.ann: {}
Entry 24:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(2, 28, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(2, 28, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 25:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ) )
Eq.ann: {}
Entry 26:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 27:
Eq: Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ) )
Eq.ann: {}
 )Entry 13:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 24, 28, fi18 + 4), L[28,28],h(-fi18 + 24, 28, fi18 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 24, 28, fi18 + 4), L[28,28],h(-fi18 + 24, 28, fi18 + 4)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 24, 28, fi18 + 4), L[28,28],h(4, 28, fi18)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 24, 28, fi18 + 4), L[28,28],h(4, 28, fi18)) ) ) ) ) )
Eq.ann: {}
 )Entry 1:
Eq: Tile( (1, 1), G(h(1, 28, 24), L[28,28],h(1, 28, 24)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, 24), L[28,28],h(1, 28, 24)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,28],h(1, 28, 24)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 24), L[28,28],h(1, 28, 24)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), L[28,28],h(1, 28, 24)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,28],h(1, 28, 24)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), L[28,28],h(1, 28, 24)) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), L[28,28],h(3, 28, 25)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), L[28,28],h(3, 28, 25)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), L[28,28],h(1, 28, 24)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, 25), L[28,28],h(1, 28, 24)) ) ) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), G(h(1, 28, 25), L[28,28],h(1, 28, 25)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, 25), L[28,28],h(1, 28, 25)) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,28],h(1, 28, 25)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 28, 25), L[28,28],h(1, 28, 25)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), L[28,28],h(1, 28, 25)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,28],h(1, 28, 25)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), L[28,28],h(1, 28, 25)) ) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), L[28,28],h(2, 28, 26)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), L[28,28],h(2, 28, 26)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), L[28,28],h(1, 28, 25)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, 26), L[28,28],h(1, 28, 25)) ) ) ) ) )
Eq.ann: {}
Entry 9:
...
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), L[28,28],h(1, 28, 27)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), L[28,28],h(1, 28, 27)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), L[28,28],h(1, 28, 26)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, 27), L[28,28],h(1, 28, 26)) ) ) ) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), G(h(1, 28, 27), L[28,28],h(1, 28, 27)) ) = Sqrt( Tile( (1, 1), G(h(1, 28, 27), L[28,28],h(1, 28, 27)) ) )
Eq.ann: {}
Entry 13:
For_{fi159;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, fi159), t0[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi159), t0[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi159), L0[28,28],h(1, 28, fi159)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi159 + 1), t0[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi159 + 1), t0[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi159 + 1), L0[28,28],h(1, 28, fi159)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi159), t0[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 28, fi159 + 1), t0[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi159 + 1), t0[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi159 + 1), L0[28,28],h(1, 28, fi159 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi159 + 2), t0[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi159 + 2), t0[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi159 + 2), L0[28,28],h(1, 28, fi159 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi159 + 1), t0[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, fi159 + 2), t0[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi159 + 2), t0[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi159 + 2), L0[28,28],h(1, 28, fi159 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi159 + 3), t0[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi159 + 3), t0[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi159 + 3), L0[28,28],h(1, 28, fi159 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi159 + 2), t0[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 28, fi159 + 3), t0[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi159 + 3), t0[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi159 + 3), L0[28,28],h(1, 28, fi159 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi159 + 24, 28, fi159 + 4), t0[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi159 + 24, 28, fi159 + 4), t0[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi159 + 24, 28, fi159 + 4), L0[28,28],h(4, 28, fi159)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi159), t0[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 14:
...
Eq.ann: {}
Entry 21:
For_{fi236;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, -fi236 + 27), a[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi236 + 27), a[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi236 + 27), L0[28,28],h(1, 28, -fi236 + 27)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 27), L0[28,28],h(3, 28, -fi236 + 24)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 27), a[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 28, -fi236 + 26), a[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi236 + 26), a[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi236 + 26), L0[28,28],h(1, 28, -fi236 + 26)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 26), L0[28,28],h(2, 28, -fi236 + 24)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 26), a[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, -fi236 + 25), a[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi236 + 25), a[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi236 + 25), L0[28,28],h(1, 28, -fi236 + 25)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 25), L0[28,28],h(1, 28, -fi236 + 24)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, -fi236 + 25), a[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, -fi236 + 24), L0[28,28],h(1, 28, -fi236 + 24)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi236 + 24, 28, 0), a[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi236 + 24, 28, 0), a[28,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 28, -fi236 + 24), L0[28,28],h(-fi236 + 24, 28, 0)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, -fi236 + 24), a[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 22:
...
Eq.ann: {}
Entry 31:
For_{fi313;0;23;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 28, fi313), v[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi313), v[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi313), L0[28,28],h(1, 28, fi313)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi313 + 1), v[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi313 + 1), v[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 28, fi313 + 1), L0[28,28],h(1, 28, fi313)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi313), v[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 28, fi313 + 1), v[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi313 + 1), v[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi313 + 1), L0[28,28],h(1, 28, fi313 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi313 + 2), v[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi313 + 2), v[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 28, fi313 + 2), L0[28,28],h(1, 28, fi313 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi313 + 1), v[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 28, fi313 + 2), v[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi313 + 2), v[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi313 + 2), L0[28,28],h(1, 28, fi313 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi313 + 3), v[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi313 + 3), v[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi313 + 3), L0[28,28],h(1, 28, fi313 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 28, fi313 + 2), v[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 28, fi313 + 3), v[28,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 28, fi313 + 3), v[28,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 28, fi313 + 3), L0[28,28],h(1, 28, fi313 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi313 + 24, 28, fi313 + 4), v[28,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi313 + 24, 28, fi313 + 4), v[28,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi313 + 24, 28, fi313 + 4), L0[28,28],h(4, 28, fi313)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 28, fi313), v[28,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 32:
...
static __attribute__((noinline)) void kernel(double const * X, double const * x, double * K, double * y, double * kx, double * f, double * var, double * lp)
{
  ...
  for( int fi18 = 0; fi18 <= 19; fi18+=4 ) {
    _t0_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18])));
    _t0_2 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 28)), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 56))), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 84)), 32);
    _t0_3 = _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 29));
    _t0_4 = _mm256_maskload_pd(K + 29*fi18 + 57, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t0_5 = _mm256_maskload_pd(K + 29*fi18 + 85, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    ...
    // Generating : T1448[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ),h(1, 28, fi18))
    ...
    // Generating : L[28,28] = S(h(3, 28, fi18 + 1), ( G(h(1, 1, 0), T1448[1,28],h(1, 28, fi18)) Kro G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ),h(1, 28, fi18))
    ...
    // Generating : L[28,28] = S(h(3, 28, fi18 + 1), ( G(h(3, 28, fi18 + 1), L[28,28],h(3, 28, fi18 + 1)) - ( G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) * T( G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ),h(3, 28, fi18 + 1))
    ...
    // Generating : L[28,28] = S(h(1, 28, fi18 + 1), Sqrt( G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
    ...
    // Generating : T1448[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
    ...
    // Generating : L[28,28] = S(h(2, 28, fi18 + 2), ( G(h(1, 1, 0), T1448[1,28],h(1, 28, fi18 + 1)) Kro G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
    ...
    // Generating : L[28,28] = S(h(2, 28, fi18 + 2), ( G(h(2, 28, fi18 + 2), L[28,28],h(2, 28, fi18 + 2)) - ( G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) * T( G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ),h(2, 28, fi18 + 2))
    ...
    // Generating : L[28,28] = S(h(1, 28, fi18 + 2), Sqrt( G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ),h(1, 28, fi18 + 2))
    ...
    // Generating : L[28,28] = S(h(1, 28, fi18 + 3), ( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) Div G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ),h(1, 28, fi18 + 2))
    ...
    // Generating : L[28,28] = S(h(1, 28, fi18 + 3), ( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) - ( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) Kro T( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ),h(1, 28, fi18 + 3))
    ...
    // Generating : L[28,28] = S(h(1, 28, fi18 + 3), Sqrt( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ),h(1, 28, fi18 + 3))
    ...
    // AVX Storer:
    _t0_11 = _t0_19;
    _mm256_maskstore_pd(K + 29*fi18 + 57, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_4);
    _mm256_maskstore_pd(K + 29*fi18 + 85, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t0_5);
    _mm256_maskstore_pd(K + 29*fi18 + 86, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_9);

    for( int fi79 = 0; fi79 <= -fi18 + 20; fi79+=4 ) {
      _t1_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 28*fi79 + 112])));
      _t1_1 = _mm256_maskload_pd(K + 29*fi18 + 28*fi79 + 113, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 28*fi79 + 140])));
      _t1_7 = _mm256_maskload_pd(K + 29*fi18 + 28*fi79 + 141, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_12 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 28*fi79 + 168])));
      _t1_13 = _mm256_maskload_pd(K + 29*fi18 + 28*fi79 + 169, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_18 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 28*fi79 + 196])));
      _t1_19 = _mm256_maskload_pd(K + 29*fi18 + 28*fi79 + 197, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));

      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18)) Div G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ),h(1, 28, fi18))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(3, 28, fi18 + 1)) - ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18)) Kro T( G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ),h(3, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 1)) Div G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(2, 28, fi18 + 2)) - ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 1)) Kro T( G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ),h(2, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 2)) Div G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ),h(1, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 3)) - ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 2)) Kro T( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 4), ( G(h(1, 28, fi18 + fi79 + 4), L[28,28],h(1, 28, fi18 + 3)) Div G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18)) Div G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ),h(1, 28, fi18))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(3, 28, fi18 + 1)) - ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18)) Kro T( G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ),h(3, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 1)) Div G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(2, 28, fi18 + 2)) - ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 1)) Kro T( G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ),h(2, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 2)) Div G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ),h(1, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 3)) - ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 2)) Kro T( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 5), ( G(h(1, 28, fi18 + fi79 + 5), L[28,28],h(1, 28, fi18 + 3)) Div G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18)) Div G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ),h(1, 28, fi18))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(3, 28, fi18 + 1)) - ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18)) Kro T( G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ),h(3, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 1)) Div G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(2, 28, fi18 + 2)) - ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 1)) Kro T( G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ),h(2, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 2)) Div G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ),h(1, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 3)) - ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 2)) Kro T( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 6), ( G(h(1, 28, fi18 + fi79 + 6), L[28,28],h(1, 28, fi18 + 3)) Div G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18)) Div G(h(1, 28, fi18), L[28,28],h(1, 28, fi18)) ),h(1, 28, fi18))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(3, 28, fi18 + 1)) - ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18)) Kro T( G(h(3, 28, fi18 + 1), L[28,28],h(1, 28, fi18)) ) ) ),h(3, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 1)) Div G(h(1, 28, fi18 + 1), L[28,28],h(1, 28, fi18 + 1)) ),h(1, 28, fi18 + 1))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(2, 28, fi18 + 2)) - ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 1)) Kro T( G(h(2, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 1)) ) ) ),h(2, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 2)) Div G(h(1, 28, fi18 + 2), L[28,28],h(1, 28, fi18 + 2)) ),h(1, 28, fi18 + 2))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 3)) - ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 2)) Kro T( G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 2)) ) ) ),h(1, 28, fi18 + 3))
      ...
      // Generating : L[28,28] = S(h(1, 28, fi18 + fi79 + 7), ( G(h(1, 28, fi18 + fi79 + 7), L[28,28],h(1, 28, fi18 + 3)) Div G(h(1, 28, fi18 + 3), L[28,28],h(1, 28, fi18 + 3)) ),h(1, 28, fi18 + 3))
      ...
      // AVX Storer:
      _t1_23 = _t1_143;
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 112]), _mm256_castpd256_pd128(_t1_0));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 113]), _mm256_castpd256_pd128(_t1_2));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 114]), _mm256_castpd256_pd128(_t1_4));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 115]), _mm256_castpd256_pd128(_t1_5));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 140]), _mm256_castpd256_pd128(_t1_6));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 141]), _mm256_castpd256_pd128(_t1_8));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 142]), _mm256_castpd256_pd128(_t1_10));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 143]), _mm256_castpd256_pd128(_t1_11));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 168]), _mm256_castpd256_pd128(_t1_12));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 169]), _mm256_castpd256_pd128(_t1_14));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 170]), _mm256_castpd256_pd128(_t1_16));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 171]), _mm256_castpd256_pd128(_t1_17));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 196]), _mm256_castpd256_pd128(_t1_18));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 197]), _mm256_castpd256_pd128(_t1_20));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 198]), _mm256_castpd256_pd128(_t1_22));
      _mm_store_sd(&(K[29*fi18 + 28*fi79 + 199]), _mm256_castpd256_pd128(_t1_23));
    }
    _t2_20 = _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 116));
    _t2_21 = _mm256_maskload_pd(K + 29*fi18 + 144, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t2_22 = _mm256_maskload_pd(K + 29*fi18 + 172, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t2_23 = _mm256_loadu_pd(K + 29*fi18 + 200);
    _t2_19 = _mm256_broadcast_sd(K + 29*fi18 + 112);
    _t2_18 = _mm256_broadcast_sd(K + 29*fi18 + 113);
    _t2_17 = _mm256_broadcast_sd(K + 29*fi18 + 114);
    _t2_16 = _mm256_broadcast_sd(K + 29*fi18 + 115);
    _t2_15 = _mm256_broadcast_sd(K + 29*fi18 + 140);
    _t2_14 = _mm256_broadcast_sd(K + 29*fi18 + 141);
    _t2_13 = _mm256_broadcast_sd(K + 29*fi18 + 142);
    _t2_12 = _mm256_broadcast_sd(K + 29*fi18 + 143);
    _t2_11 = _mm256_broadcast_sd(K + 29*fi18 + 168);
    _t2_10 = _mm256_broadcast_sd(K + 29*fi18 + 169);
    _t2_9 = _mm256_broadcast_sd(K + 29*fi18 + 170);
    _t2_8 = _mm256_broadcast_sd(K + 29*fi18 + 171);
    _t2_7 = _mm256_broadcast_sd(K + 29*fi18 + 196);
    _t2_6 = _mm256_broadcast_sd(K + 29*fi18 + 197);
    _t2_5 = _mm256_broadcast_sd(K + 29*fi18 + 198);
    _t2_4 = _mm256_broadcast_sd(K + 29*fi18 + 199);
    _t2_3 = _mm256_loadu_pd(K + 29*fi18 + 112);
    _t2_2 = _mm256_loadu_pd(K + 29*fi18 + 140);
    _t2_1 = _mm256_loadu_pd(K + 29*fi18 + 168);
    _t2_0 = _mm256_loadu_pd(K + 29*fi18 + 196);

    // Generating : L[28,28] = ( S(h(4, 28, fi18 + 4), ( G(h(4, 28, fi18 + 4), L[28,28],h(4, 28, fi18 + 4)) - ( G(h(4, 28, fi18 + 4), L[28,28],h(4, 28, fi18)) * T( G(h(4, 28, fi18 + 4), L[28,28],h(4, 28, fi18)) ) ) ),h(4, 28, fi18 + 4)) + Sum_{i150} ( ( Sum_{j151} ( S(h(4, 28, fi18 + i150 + 4), ( G(h(4, 28, fi18 + i150 + 4), L[28,28],h(4, 28, fi18 + j151 + 4)) - ( G(h(4, 28, fi18 + i150 + 4), L[28,28],h(4, 28, fi18)) * T( G(h(4, 28, fi18 + j151 + 4), L[28,28],h(4, 28, fi18)) ) ) ),h(4, 28, fi18 + j151 + 4)) ) + S(h(4, 28, fi18 + i150 + 4), ( G(h(4, 28, fi18 + i150 + 4), L[28,28],h(4, 28, fi18 + i150 + 4)) - ( G(h(4, 28, fi18 + i150 + 4), L[28,28],h(4, 28, fi18)) * T( G(h(4, 28, fi18 + i150 + 4), L[28,28],h(4, 28, fi18)) ) ) ),h(4, 28, fi18 + i150 + 4)) ) ) )
    ...
    _t2_22 = _t2_30;
    _t2_23 = _t2_31;
    _mm_store_sd(&(K[29*fi18]), _mm256_castpd256_pd128(_t0_0));
    _mm256_maskstore_pd(K + 29*fi18 + 28, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_2);
    _mm256_maskstore_pd(K + 29*fi18 + 56, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_2, _t0_2, 1));
    _mm256_maskstore_pd(K + 29*fi18 + 84, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_permute2f128_pd(_t0_2, _t0_2, 129));
    _mm_store_sd(K + 29*fi18 + 29, _mm256_castpd256_pd128(_t0_3));
    _mm256_maskstore_pd(K + 29*fi18 + 57, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_7);
    _mm256_maskstore_pd(K + 29*fi18 + 85, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_7, _t0_7, 1));
    _mm_store_sd(K + 29*fi18 + 58, _mm256_castpd256_pd128(_t0_8));
    _mm_store_sd(&(K[29*fi18 + 86]), _mm256_castpd256_pd128(_t0_10));
    _mm_store_sd(&(K[29*fi18 + 87]), _mm256_castpd256_pd128(_t0_11));
    _mm_store_sd(K + 29*fi18 + 116, _mm256_castpd256_pd128(_t2_20));
    _mm256_maskstore_pd(K + 29*fi18 + 144, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t2_21);
    _mm256_maskstore_pd(K + 29*fi18 + 172, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t2_22);
    _mm256_storeu_pd(K + 29*fi18 + 200, _t2_23);

    for( int i150 = 4; i150 <= -fi18 + 23; i150+=4 ) {

      for( int j151 = 0; j151 <= i150 - 4; j151+=4 ) {
        _t3_24 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + j151 + 116);
        _t3_25 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + j151 + 144);
        _t3_26 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + j151 + 172);
        _t3_27 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + j151 + 200);
        _t3_19 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 112);
        _t3_18 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 113);
        _t3_17 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 114);
        _t3_16 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 115);
        _t3_15 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 140);
        _t3_14 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 141);
        _t3_13 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 142);
        _t3_12 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 143);
        _t3_11 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 168);
        _t3_10 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 169);
        _t3_9 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 170);
        _t3_8 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 171);
        _t3_7 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 196);
        _t3_6 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 197);
        _t3_5 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 198);
        _t3_4 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 199);
        _t3_3 = _mm256_loadu_pd(K + 29*fi18 + 28*j151 + 112);
        _t3_2 = _mm256_loadu_pd(K + 29*fi18 + 28*j151 + 140);
        _t3_1 = _mm256_loadu_pd(K + 29*fi18 + 28*j151 + 168);
        _t3_0 = _mm256_loadu_pd(K + 29*fi18 + 28*j151 + 196);
        ...
        // AVX Storer:
        _mm256_storeu_pd(K + 29*fi18 + 28*i150 + j151 + 116, _t3_24);
        _mm256_storeu_pd(K + 29*fi18 + 28*i150 + j151 + 144, _t3_25);
        _mm256_storeu_pd(K + 29*fi18 + 28*i150 + j151 + 172, _t3_26);
        _mm256_storeu_pd(K + 29*fi18 + 28*i150 + j151 + 200, _t3_27);
      }
      _t4_20 = _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 29*i150 + 116));
      _t4_21 = _mm256_maskload_pd(K + 29*fi18 + 29*i150 + 144, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
      _t4_22 = _mm256_maskload_pd(K + 29*fi18 + 29*i150 + 172, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t4_23 = _mm256_loadu_pd(K + 29*fi18 + 29*i150 + 200);
      _t4_19 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 112);
      _t4_18 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 113);
      _t4_17 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 114);
      _t4_16 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 115);
      _t4_15 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 140);
      _t4_14 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 141);
      _t4_13 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 142);
      _t4_12 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 143);
      _t4_11 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 168);
      _t4_10 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 169);
      _t4_9 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 170);
      _t4_8 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 171);
      _t4_7 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 196);
      _t4_6 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 197);
      _t4_5 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 198);
      _t4_4 = _mm256_broadcast_sd(K + 29*fi18 + 28*i150 + 199);
      _t4_3 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 112);
      _t4_2 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 140);
      _t4_1 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 168);
      _t4_0 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 196);
      ...
      _t4_22 = _t4_30;
      _t4_23 = _t4_31;
      _mm_store_sd(K + 29*fi18 + 29*i150 + 116, _mm256_castpd256_pd128(_t4_20));
      _mm256_maskstore_pd(K + 29*fi18 + 29*i150 + 144, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t4_21);
      _mm256_maskstore_pd(K + 29*fi18 + 29*i150 + 172, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t4_22);
      _mm256_storeu_pd(K + 29*fi18 + 29*i150 + 200, _t4_23);
    }
  }

  _t5_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[580])));
  _t5_2 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 608)), _mm256_castpd128_pd256(_mm_load_sd(K + 636))), _mm256_castpd128_pd256(_mm_load_sd(K + 664)), 32);
  _t5_3 = _mm256_castpd128_pd256(_mm_load_sd(K + 609));
  _t5_4 = _mm256_maskload_pd(K + 637, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t5_5 = _mm256_maskload_pd(K + 665, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_12 = _mm256_castpd128_pd256(_mm_load_sd(&(K[692])));
  _t5_13 = _mm256_maskload_pd(K + 693, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_18 = _mm256_castpd128_pd256(_mm_load_sd(&(K[720])));
  _t5_19 = _mm256_maskload_pd(K + 721, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_24 = _mm256_castpd128_pd256(_mm_load_sd(&(K[748])));
  _t5_25 = _mm256_maskload_pd(K + 749, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_30 = _mm256_castpd128_pd256(_mm_load_sd(&(K[776])));
  _t5_31 = _mm256_maskload_pd(K + 777, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_36 = _mm256_castpd128_pd256(_mm_load_sd(K + 696));
  _t5_37 = _mm256_maskload_pd(K + 724, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t5_38 = _mm256_maskload_pd(K + 752, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_39 = _mm256_loadu_pd(K + 780);

  // Generating : L[28,28] = S(h(1, 28, 20), Sqrt( G(h(1, 28, 20), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : T1448[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 20), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : L[28,28] = S(h(3, 28, 21), ( G(h(1, 1, 0), T1448[1,28],h(1, 28, 20)) Kro G(h(3, 28, 21), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : L[28,28] = S(h(3, 28, 21), ( G(h(3, 28, 21), L[28,28],h(3, 28, 21)) - ( G(h(3, 28, 21), L[28,28],h(1, 28, 20)) * T( G(h(3, 28, 21), L[28,28],h(1, 28, 20)) ) ) ),h(3, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 21), Sqrt( G(h(1, 28, 21), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : T1448[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 21), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : L[28,28] = S(h(2, 28, 22), ( G(h(1, 1, 0), T1448[1,28],h(1, 28, 21)) Kro G(h(2, 28, 22), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : L[28,28] = S(h(2, 28, 22), ( G(h(2, 28, 22), L[28,28],h(2, 28, 22)) - ( G(h(2, 28, 22), L[28,28],h(1, 28, 21)) * T( G(h(2, 28, 22), L[28,28],h(1, 28, 21)) ) ) ),h(2, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 22), Sqrt( G(h(1, 28, 22), L[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 23), ( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) Div G(h(1, 28, 22), L[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 23), ( G(h(1, 28, 23), L[28,28],h(1, 28, 23)) - ( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) Kro T( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) ) ) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 23), Sqrt( G(h(1, 28, 23), L[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(1, 28, 20)) Div G(h(1, 28, 20), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(3, 28, 21)) - ( G(h(1, 28, 24), L[28,28],h(1, 28, 20)) Kro T( G(h(3, 28, 21), L[28,28],h(1, 28, 20)) ) ) ),h(3, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(1, 28, 21)) Div G(h(1, 28, 21), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(2, 28, 22)) - ( G(h(1, 28, 24), L[28,28],h(1, 28, 21)) Kro T( G(h(2, 28, 22), L[28,28],h(1, 28, 21)) ) ) ),h(2, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(1, 28, 22)) Div G(h(1, 28, 22), L[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(1, 28, 23)) - ( G(h(1, 28, 24), L[28,28],h(1, 28, 22)) Kro T( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) ) ) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 24), ( G(h(1, 28, 24), L[28,28],h(1, 28, 23)) Div G(h(1, 28, 23), L[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(1, 28, 20)) Div G(h(1, 28, 20), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(3, 28, 21)) - ( G(h(1, 28, 25), L[28,28],h(1, 28, 20)) Kro T( G(h(3, 28, 21), L[28,28],h(1, 28, 20)) ) ) ),h(3, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(1, 28, 21)) Div G(h(1, 28, 21), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(2, 28, 22)) - ( G(h(1, 28, 25), L[28,28],h(1, 28, 21)) Kro T( G(h(2, 28, 22), L[28,28],h(1, 28, 21)) ) ) ),h(2, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(1, 28, 22)) Div G(h(1, 28, 22), L[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(1, 28, 23)) - ( G(h(1, 28, 25), L[28,28],h(1, 28, 22)) Kro T( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) ) ) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 25), ( G(h(1, 28, 25), L[28,28],h(1, 28, 23)) Div G(h(1, 28, 23), L[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(1, 28, 20)) Div G(h(1, 28, 20), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(3, 28, 21)) - ( G(h(1, 28, 26), L[28,28],h(1, 28, 20)) Kro T( G(h(3, 28, 21), L[28,28],h(1, 28, 20)) ) ) ),h(3, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(1, 28, 21)) Div G(h(1, 28, 21), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(2, 28, 22)) - ( G(h(1, 28, 26), L[28,28],h(1, 28, 21)) Kro T( G(h(2, 28, 22), L[28,28],h(1, 28, 21)) ) ) ),h(2, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(1, 28, 22)) Div G(h(1, 28, 22), L[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(1, 28, 23)) - ( G(h(1, 28, 26), L[28,28],h(1, 28, 22)) Kro T( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) ) ) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 26), ( G(h(1, 28, 26), L[28,28],h(1, 28, 23)) Div G(h(1, 28, 23), L[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(1, 28, 20)) Div G(h(1, 28, 20), L[28,28],h(1, 28, 20)) ),h(1, 28, 20))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(3, 28, 21)) - ( G(h(1, 28, 27), L[28,28],h(1, 28, 20)) Kro T( G(h(3, 28, 21), L[28,28],h(1, 28, 20)) ) ) ),h(3, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(1, 28, 21)) Div G(h(1, 28, 21), L[28,28],h(1, 28, 21)) ),h(1, 28, 21))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(2, 28, 22)) - ( G(h(1, 28, 27), L[28,28],h(1, 28, 21)) Kro T( G(h(2, 28, 22), L[28,28],h(1, 28, 21)) ) ) ),h(2, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(1, 28, 22)) Div G(h(1, 28, 22), L[28,28],h(1, 28, 22)) ),h(1, 28, 22))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(1, 28, 23)) - ( G(h(1, 28, 27), L[28,28],h(1, 28, 22)) Kro T( G(h(1, 28, 23), L[28,28],h(1, 28, 22)) ) ) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(1, 28, 23)) Div G(h(1, 28, 23), L[28,28],h(1, 28, 23)) ),h(1, 28, 23))
  ...
  // Generating : L[28,28] = S(h(4, 28, 24), ( G(h(4, 28, 24), L[28,28],h(4, 28, 24)) - ( G(h(4, 28, 24), L[28,28],h(4, 28, 20)) * T( G(h(4, 28, 24), L[28,28],h(4, 28, 20)) ) ) ),h(4, 28, 24))
  ...
  // Generating : T1448[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 24), L[28,28],h(1, 28, 24)) ),h(1, 28, 24))
  ...
  // Generating : L[28,28] = S(h(3, 28, 25), ( G(h(1, 1, 0), T1448[1,28],h(1, 28, 24)) Kro G(h(3, 28, 25), L[28,28],h(1, 28, 24)) ),h(1, 28, 24))
  ...
  // Generating : L[28,28] = S(h(3, 28, 25), ( G(h(3, 28, 25), L[28,28],h(3, 28, 25)) - ( G(h(3, 28, 25), L[28,28],h(1, 28, 24)) * T( G(h(3, 28, 25), L[28,28],h(1, 28, 24)) ) ) ),h(3, 28, 25))
  ...
  // Generating : T1448[1,28] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 28, 25), L[28,28],h(1, 28, 25)) ),h(1, 28, 25))
  ...
  // Generating : L[28,28] = S(h(2, 28, 26), ( G(h(1, 1, 0), T1448[1,28],h(1, 28, 25)) Kro G(h(2, 28, 26), L[28,28],h(1, 28, 25)) ),h(1, 28, 25))
  ...
  // Generating : L[28,28] = S(h(2, 28, 26), ( G(h(2, 28, 26), L[28,28],h(2, 28, 26)) - ( G(h(2, 28, 26), L[28,28],h(1, 28, 25)) * T( G(h(2, 28, 26), L[28,28],h(1, 28, 25)) ) ) ),h(2, 28, 26))
  ...
  // Generating : L[28,28] = S(h(1, 28, 27), ( G(h(1, 28, 27), L[28,28],h(1, 28, 27)) - ( G(h(1, 28, 27), L[28,28],h(1, 28, 26)) Kro T( G(h(1, 28, 27), L[28,28],h(1, 28, 26)) ) ) ),h(1, 28, 27))
  ...
  _mm_store_sd(&(K[580]), _mm256_castpd256_pd128(_t5_0));
  _mm256_maskstore_pd(K + 608, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_2);
  _mm256_maskstore_pd(K + 636, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_2, _t5_2, 1));
  _mm256_maskstore_pd(K + 664, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_permute2f128_pd(_t5_2, _t5_2, 129));
  _mm_store_sd(K + 609, _mm256_castpd256_pd128(_t5_3));
  _mm256_maskstore_pd(K + 637, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_7);
  _mm256_maskstore_pd(K + 665, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_7, _t5_7, 1));
  _mm_store_sd(K + 638, _mm256_castpd256_pd128(_t5_8));
  _mm_store_sd(&(K[666]), _mm256_castpd256_pd128(_t5_10));
  _mm_store_sd(&(K[667]), _mm256_castpd256_pd128(_t5_11));
  _mm_store_sd(&(K[692]), _mm256_castpd256_pd128(_t5_12));
  _mm_store_sd(&(K[693]), _mm256_castpd256_pd128(_t5_14));
  _mm_store_sd(&(K[694]), _mm256_castpd256_pd128(_t5_16));
  _mm_store_sd(&(K[695]), _mm256_castpd256_pd128(_t5_17));
  _mm_store_sd(&(K[720]), _mm256_castpd256_pd128(_t5_18));
  _mm_store_sd(&(K[721]), _mm256_castpd256_pd128(_t5_20));
  _mm_store_sd(&(K[722]), _mm256_castpd256_pd128(_t5_22));
  _mm_store_sd(&(K[723]), _mm256_castpd256_pd128(_t5_23));
  _mm_store_sd(&(K[748]), _mm256_castpd256_pd128(_t5_24));
  _mm_store_sd(&(K[749]), _mm256_castpd256_pd128(_t5_26));
  _mm_store_sd(&(K[750]), _mm256_castpd256_pd128(_t5_28));
  _mm_store_sd(&(K[751]), _mm256_castpd256_pd128(_t5_29));
  _mm_store_sd(&(K[776]), _mm256_castpd256_pd128(_t5_30));
  _mm_store_sd(&(K[777]), _mm256_castpd256_pd128(_t5_32));
  _mm_store_sd(&(K[778]), _mm256_castpd256_pd128(_t5_34));
  _mm_store_sd(&(K[779]), _mm256_castpd256_pd128(_t5_35));

  for( int fi18 = 0; fi18 <= 23; fi18+=4 ) {
    _t6_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 57)), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 85)), 0);
    _t6_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 86])));
    _t6_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 29])));
    _t6_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 87])));
    _t6_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18])));
    _t6_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 58])));
    _t6_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 28)), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 56))), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 84)), 32);
    ...
    // Generating : t0[28,1] = S(h(3, 28, fi18 + 1), ( G(h(3, 28, fi18 + 1), t0[28,1],h(1, 1, 0)) - ( G(h(3, 28, fi18 + 1), L0[28,28],h(1, 28, fi18)) Kro G(h(1, 28, fi18), t0[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : t0[28,1] = S(h(1, 28, fi18 + 1), ( G(h(1, 28, fi18 + 1), t0[28,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 1), L0[28,28],h(1, 28, fi18 + 1)) ),h(1, 1, 0))
    ...
    // Generating : t0[28,1] = S(h(2, 28, fi18 + 2), ( G(h(2, 28, fi18 + 2), t0[28,1],h(1, 1, 0)) - ( G(h(2, 28, fi18 + 2), L0[28,28],h(1, 28, fi18 + 1)) Kro G(h(1, 28, fi18 + 1), t0[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : t0[28,1] = S(h(1, 28, fi18 + 2), ( G(h(1, 28, fi18 + 2), t0[28,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 2), L0[28,28],h(1, 28, fi18 + 2)) ),h(1, 1, 0))
    ...
    // Generating : t0[28,1] = S(h(1, 28, fi18 + 3), ( G(h(1, 28, fi18 + 3), t0[28,1],h(1, 1, 0)) - ( G(h(1, 28, fi18 + 3), L0[28,28],h(1, 28, fi18 + 2)) Kro G(h(1, 28, fi18 + 2), t0[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : t0[28,1] = S(h(1, 28, fi18 + 3), ( G(h(1, 28, fi18 + 3), t0[28,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 3), L0[28,28],h(1, 28, fi18 + 3)) ),h(1, 1, 0))
    ...
    // Generating : t0[28,1] = Sum_{i150} ( S(h(4, 28, fi18 + i150 + 4), ( G(h(4, 28, fi18 + i150 + 4), t0[28,1],h(1, 1, 0)) - ( G(h(4, 28, fi18 + i150 + 4), L0[28,28],h(4, 28, fi18)) * G(h(4, 28, fi18), t0[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
    ...
    for( int i150 = 0; i150 <= -fi18 + 23; i150+=4 ) {
      _t7_9 = _mm256_loadu_pd(y + fi18 + i150 + 4);
      _t7_7 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 112);
      _t7_6 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 140);
      _t7_5 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 168);
      _t7_4 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 196);
  ...
  _t8_0 = _mm256_castpd128_pd256(_mm_load_sd(&(y[24])));
  _t8_1 = _mm256_maskload_pd(y + 25, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  ...
  _mm_store_sd(K + 696, _mm256_castpd256_pd128(_t5_36));
  _mm256_maskstore_pd(K + 724, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_41);
  _mm256_maskstore_pd(K + 752, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_41, _t5_41, 1));
  _mm256_maskstore_pd(K + 780, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_permute2f128_pd(_t5_41, _t5_41, 129));
  _mm_store_sd(K + 725, _mm256_castpd256_pd128(_t5_42));
  _mm256_maskstore_pd(K + 753, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_46);
  _mm256_maskstore_pd(K + 781, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_46, _t5_46, 1));
  _mm_store_sd(K + 754, _mm256_castpd256_pd128(_t5_47));
  _mm_store_sd(&(K[782]), _mm256_castpd256_pd128(_t5_49));
  _mm_store_sd(&(K[783]), _mm256_castpd256_pd128(_t5_50));
  _mm_store_sd(&(y[24]), _mm256_castpd256_pd128(_t8_0));
  _mm_store_sd(&(y[25]), _mm256_castpd256_pd128(_t8_2));
  _mm_store_sd(&(y[26]), _mm256_castpd256_pd128(_t8_4));
  _mm_store_sd(&(y[27]), _mm256_castpd256_pd128(_t8_5));

  for( int fi18 = 0; fi18 <= 23; fi18+=4 ) {
    _t9_7 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 27])));
    _t9_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-29*fi18 + 783])));
    _t9_8 = _mm256_maskload_pd(y + -fi18 + 24, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t9_5 = _mm256_maskload_pd(K + -29*fi18 + 780, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t9_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-29*fi18 + 754])));
    _t9_3 = _mm256_maskload_pd(K + -29*fi18 + 752, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t9_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-29*fi18 + 725])));
    _t9_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-29*fi18 + 724])));
    _t9_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-29*fi18 + 696])));
    ...
    // Generating : a[28,1] = S(h(3, 28, -fi18 + 24), ( G(h(3, 28, -fi18 + 24), a[28,1],h(1, 1, 0)) - ( T( G(h(1, 28, -fi18 + 27), L0[28,28],h(3, 28, -fi18 + 24)) ) Kro G(h(1, 28, -fi18 + 27), a[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : a[28,1] = S(h(1, 28, -fi18 + 26), ( G(h(1, 28, -fi18 + 26), a[28,1],h(1, 1, 0)) Div G(h(1, 28, -fi18 + 26), L0[28,28],h(1, 28, -fi18 + 26)) ),h(1, 1, 0))
    ...
    // Generating : a[28,1] = S(h(2, 28, -fi18 + 24), ( G(h(2, 28, -fi18 + 24), a[28,1],h(1, 1, 0)) - ( T( G(h(1, 28, -fi18 + 26), L0[28,28],h(2, 28, -fi18 + 24)) ) Kro G(h(1, 28, -fi18 + 26), a[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : a[28,1] = S(h(1, 28, -fi18 + 25), ( G(h(1, 28, -fi18 + 25), a[28,1],h(1, 1, 0)) Div G(h(1, 28, -fi18 + 25), L0[28,28],h(1, 28, -fi18 + 25)) ),h(1, 1, 0))
    ...
    // Generating : a[28,1] = S(h(1, 28, -fi18 + 24), ( G(h(1, 28, -fi18 + 24), a[28,1],h(1, 1, 0)) - ( T( G(h(1, 28, -fi18 + 25), L0[28,28],h(1, 28, -fi18 + 24)) ) Kro G(h(1, 28, -fi18 + 25), a[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : a[28,1] = S(h(1, 28, -fi18 + 24), ( G(h(1, 28, -fi18 + 24), a[28,1],h(1, 1, 0)) Div G(h(1, 28, -fi18 + 24), L0[28,28],h(1, 28, -fi18 + 24)) ),h(1, 1, 0))
    ...
    // Generating : a[28,1] = Sum_{i150} ( S(h(4, 28, i150), ( G(h(4, 28, i150), a[28,1],h(1, 1, 0)) - ( T( G(h(4, 28, -fi18 + 24), L0[28,28],h(4, 28, i150)) ) * G(h(4, 28, -fi18 + 24), a[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    // AVX Loader:
    _mm_store_sd(&(y[-fi18 + 27]), _mm256_castpd256_pd128(_t9_7));
    _mm_store_sd(&(y[-fi18 + 26]), _mm256_castpd256_pd128(_t9_9));
    _mm_store_sd(&(y[-fi18 + 25]), _mm256_castpd256_pd128(_t9_11));
    _mm_store_sd(&(y[-fi18 + 24]), _mm256_castpd256_pd128(_t9_12));

    for( int i150 = 0; i150 <= -fi18 + 23; i150+=4 ) {
      _t10_9 = _mm256_loadu_pd(y + i150);
      _t10_7 = _mm256_loadu_pd(K + -28*fi18 + i150 + 672);
      _t10_6 = _mm256_loadu_pd(K + -28*fi18 + i150 + 700);
      _t10_5 = _mm256_loadu_pd(K + -28*fi18 + i150 + 728);
      _t10_4 = _mm256_loadu_pd(K + -28*fi18 + i150 + 756);
      _t10_3 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 27])));
      _t10_2 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 26])));
      _t10_1 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 25])));
      _t10_0 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 24])));
  ...
  _t11_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[87])));
  _t11_8 = _mm256_maskload_pd(y, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t11_5 = _mm256_maskload_pd(K + 84, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t11_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[58])));
  _t11_3 = _mm256_maskload_pd(K + 56, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t11_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29])));
  _t11_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[28])));
  ...
  // Generating : kx[28,1] = ( Sum_{j151} ( S(h(4, 28, j151), ( G(h(4, 28, j151), X[28,28],h(4, 28, 0)) * G(h(4, 28, 0), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) + Sum_{i150} ( Sum_{j151} ( $(h(4, 28, j151), ( G(h(4, 28, j151), X[28,28],h(4, 28, i150)) * G(h(4, 28, i150), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )

  // AVX Loader:


  for( int j151 = 0; j151 <= 27; j151+=4 ) {
    _t12_4 = _mm256_loadu_pd(X + 28*j151);
    _t12_3 = _mm256_loadu_pd(X + 28*j151 + 28);
    _t12_2 = _mm256_loadu_pd(X + 28*j151 + 56);
    _t12_1 = _mm256_loadu_pd(X + 28*j151 + 84);
  ...
  for( int i150 = 4; i150 <= 27; i150+=4 ) {

    // AVX Loader:

    for( int j151 = 0; j151 <= 27; j151+=4 ) {
      _t13_4 = _mm256_loadu_pd(X + i150 + 28*j151);
      _t13_3 = _mm256_loadu_pd(X + i150 + 28*j151 + 28);
      _t13_2 = _mm256_loadu_pd(X + i150 + 28*j151 + 56);
      _t13_1 = _mm256_loadu_pd(X + i150 + 28*j151 + 84);
  ...
  // Generating : f[1,1] = ( S(h(1, 1, 0), ( T( G(h(4, 28, 0), kx[28,1],h(1, 1, 0)) ) * G(h(4, 28, 0), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) + Sum_{i150} ( $(h(1, 1, 0), ( T( G(h(4, 28, i150), kx[28,1],h(1, 1, 0)) ) * G(h(4, 28, i150), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) )
  ...
  for( int fi18 = 0; fi18 <= 23; fi18+=4 ) {
    _t16_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 29])));
    _t16_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 28)), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 56))), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 84)), 32);
    _t16_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 87])));
    _t16_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 57)), _mm256_castpd128_pd256(_mm_load_sd(K + 29*fi18 + 85)), 0);
    _t16_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18])));
    _t16_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 58])));
    _t16_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[29*fi18 + 86])));
    ...
    // Generating : v[28,1] = S(h(3, 28, fi18 + 1), ( G(h(3, 28, fi18 + 1), v[28,1],h(1, 1, 0)) - ( G(h(3, 28, fi18 + 1), L0[28,28],h(1, 28, fi18)) Kro G(h(1, 28, fi18), v[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v[28,1] = S(h(1, 28, fi18 + 1), ( G(h(1, 28, fi18 + 1), v[28,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 1), L0[28,28],h(1, 28, fi18 + 1)) ),h(1, 1, 0))
    ...
    // Generating : v[28,1] = S(h(2, 28, fi18 + 2), ( G(h(2, 28, fi18 + 2), v[28,1],h(1, 1, 0)) - ( G(h(2, 28, fi18 + 2), L0[28,28],h(1, 28, fi18 + 1)) Kro G(h(1, 28, fi18 + 1), v[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v[28,1] = S(h(1, 28, fi18 + 2), ( G(h(1, 28, fi18 + 2), v[28,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 2), L0[28,28],h(1, 28, fi18 + 2)) ),h(1, 1, 0))
    ...
    // Generating : v[28,1] = S(h(1, 28, fi18 + 3), ( G(h(1, 28, fi18 + 3), v[28,1],h(1, 1, 0)) - ( G(h(1, 28, fi18 + 3), L0[28,28],h(1, 28, fi18 + 2)) Kro G(h(1, 28, fi18 + 2), v[28,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v[28,1] = S(h(1, 28, fi18 + 3), ( G(h(1, 28, fi18 + 3), v[28,1],h(1, 1, 0)) Div G(h(1, 28, fi18 + 3), L0[28,28],h(1, 28, fi18 + 3)) ),h(1, 1, 0))
    ...
    // Generating : v[28,1] = Sum_{i150} ( S(h(4, 28, fi18 + i150 + 4), ( G(h(4, 28, fi18 + i150 + 4), v[28,1],h(1, 1, 0)) - ( G(h(4, 28, fi18 + i150 + 4), L0[28,28],h(4, 28, fi18)) * G(h(4, 28, fi18), v[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
    ...
    for( int i150 = 0; i150 <= -fi18 + 23; i150+=4 ) {
      ...
      _t17_7 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 112);
      _t17_6 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 140);
      _t17_5 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 168);
      _t17_4 = _mm256_loadu_pd(K + 29*fi18 + 28*i150 + 196);
  ...
  _t5_41 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 724)), _mm256_castpd128_pd256(_mm_load_sd(K + 752))), _mm256_castpd128_pd256(_mm_load_sd(K + 780)), 32);
  _t5_46 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 753)), _mm256_castpd128_pd256(_mm_load_sd(K + 781)), 0);
  _t5_42 = _mm256_castpd128_pd256(_mm_load_sd(&(K[725])));
  _t5_36 = _mm256_castpd128_pd256(_mm_load_sd(&(K[696])));
  _t5_49 = _mm256_castpd128_pd256(_mm_load_sd(&(K[782])));
  _t5_50 = _mm256_castpd128_pd256(_mm_load_sd(&(K[783])));
  _t5_47 = _mm256_castpd128_pd256(_mm_load_sd(&(K[754])));
  ...
  // Generating : var[1,1] = ( ( S(h(1, 1, 0), ( ( T( G(h(4, 28, 0), x[28,1],h(1, 1, 0)) ) * G(h(4, 28, 0), x[28,1],h(1, 1, 0)) ) - ( T( G(h(4, 28, 0), kx[28,1],h(1, 1, 0)) ) * G(h(4, 28, 0), kx[28,1],h(1, 1, 0)) ) ),h(1, 1, 0)) + Sum_{j151} ( $(h(1, 1, 0), ( T( G(h(4, 28, j151), x[28,1],h(1, 1, 0)) ) * G(h(4, 28, j151), x[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) + Sum_{i150} ( -$(h(1, 1, 0), ( T( G(h(4, 28, i150), kx[28,1],h(1, 1, 0)) ) * G(h(4, 28, i150), kx[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) )
  ...
  // Generating : lp[1,1] = ( S(h(1, 1, 0), ( T( G(h(4, 28, 0), y[28,1],h(1, 1, 0)) ) * G(h(4, 28, 0), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) + Sum_{i150} ( $(h(1, 1, 0), ( T( G(h(4, 28, i150), y[28,1],h(1, 1, 0)) ) * G(h(4, 28, i150), y[28,1],h(1, 1, 0)) ),h(1, 1, 0)) ) )
