 ...
 * gpr_kernel.h
 *
Decl { {u'K': Symmetric[K, (20, 20), LSMatAccess], u'L': LowerTriangular[L, (20, 20), GenMatAccess], u'var': Scalar[var, (1, 1), GenMatAccess], u'L0': LowerTriangular[L0, (20, 20), GenMatAccess], u'X': SquaredMatrix[X, (20, 20), GenMatAccess], 'T1448': Matrix[T1448, (1, 20), GenMatAccess], u'a': Matrix[a, (20, 1), GenMatAccess], u'f': Scalar[f, (1, 1), GenMatAccess], u't2': Matrix[t2, (20, 1), GenMatAccess], u't0': Matrix[t0, (20, 1), GenMatAccess], u't1': Matrix[t1, (20, 1), GenMatAccess], u'lp': Scalar[lp, (1, 1), GenMatAccess], u'v': Matrix[v, (20, 1), GenMatAccess], u'y': Matrix[y, (20, 1), GenMatAccess], u'x': Matrix[x, (20, 1), GenMatAccess], u'kx': Matrix[kx, (20, 1), GenMatAccess]} }
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Entry 0:
For_{fi18;0;15;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,20],h(1, 20, fi18)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,20],h(1, 20, fi18)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(3, 20, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(3, 20, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,20],h(1, 20, fi18 + 1)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,20],h(1, 20, fi18 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(2, 20, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(2, 20, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) )
Eq.ann: {}
Entry 12:
For_{fi79;0;-fi18 + 12;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18)) ) Div Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(3, 20, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(3, 20, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(2, 20, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(2, 20, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18)) ) Div Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(3, 20, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(3, 20, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 9:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) )
Eq.ann: {}
Entry 10:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(2, 20, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(2, 20, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 13:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) )
Eq.ann: {}
Entry 14:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18)) ) Div Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) )
Eq.ann: {}
Entry 15:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(3, 20, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(3, 20, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 16:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) )
Eq.ann: {}
Entry 17:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(2, 20, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(2, 20, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 18:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) )
Eq.ann: {}
Entry 19:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 20:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) )
Eq.ann: {}
Entry 21:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18)) ) Div Tile( (1, 1), G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ) )
Eq.ann: {}
Entry 22:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(3, 20, fi18 + 1)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(3, 20, fi18 + 1)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ) ) )
Eq.ann: {}
Entry 23:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 1)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 1)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ) )
Eq.ann: {}
Entry 24:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(2, 20, fi18 + 2)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(2, 20, fi18 + 2)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 1)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ) ) )
Eq.ann: {}
Entry 25:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 2)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 2)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ) )
Eq.ann: {}
Entry 26:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 3)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 3)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 2)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ) ) )
Eq.ann: {}
Entry 27:
Eq: Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 3)) ) = ( Tile( (1, 1), G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 3)) ) Div Tile( (1, 1), G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ) )
Eq.ann: {}
 )Entry 13:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 16, 20, fi18 + 4), L[20,20],h(-fi18 + 16, 20, fi18 + 4)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 16, 20, fi18 + 4), L[20,20],h(-fi18 + 16, 20, fi18 + 4)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 16, 20, fi18 + 4), L[20,20],h(4, 20, fi18)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(-fi18 + 16, 20, fi18 + 4), L[20,20],h(4, 20, fi18)) ) ) ) ) )
Eq.ann: {}
 )Entry 1:
Eq: Tile( (1, 1), G(h(1, 20, 16), L[20,20],h(1, 20, 16)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, 16), L[20,20],h(1, 20, 16)) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,20],h(1, 20, 16)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 20, 16), L[20,20],h(1, 20, 16)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, 17), L[20,20],h(1, 20, 16)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,20],h(1, 20, 16)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(3, 20, 17), L[20,20],h(1, 20, 16)) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, 17), L[20,20],h(3, 20, 17)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, 17), L[20,20],h(3, 20, 17)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, 17), L[20,20],h(1, 20, 16)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, 17), L[20,20],h(1, 20, 16)) ) ) ) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), G(h(1, 20, 17), L[20,20],h(1, 20, 17)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, 17), L[20,20],h(1, 20, 17)) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 1, 0), T1448[1,20],h(1, 20, 17)) ) = ( Tile( (1, 1), 1[1,1] ) Div Tile( (1, 1), G(h(1, 20, 17), L[20,20],h(1, 20, 17)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, 18), L[20,20],h(1, 20, 17)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 1, 0), T1448[1,20],h(1, 20, 17)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(2, 20, 18), L[20,20],h(1, 20, 17)) ) ) )
Eq.ann: {}
Entry 8:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, 18), L[20,20],h(2, 20, 18)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, 18), L[20,20],h(2, 20, 18)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, 18), L[20,20],h(1, 20, 17)) ) ) * T( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, 18), L[20,20],h(1, 20, 17)) ) ) ) ) )
Eq.ann: {}
Entry 9:
...
Eq.ann: {}
Entry 11:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, 19), L[20,20],h(1, 20, 19)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, 19), L[20,20],h(1, 20, 19)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, 19), L[20,20],h(1, 20, 18)) ) ) Kro T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, 19), L[20,20],h(1, 20, 18)) ) ) ) ) )
Eq.ann: {}
Entry 12:
Eq: Tile( (1, 1), G(h(1, 20, 19), L[20,20],h(1, 20, 19)) ) = Sqrt( Tile( (1, 1), G(h(1, 20, 19), L[20,20],h(1, 20, 19)) ) )
Eq.ann: {}
Entry 13:
For_{fi159;0;15;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 20, fi159), t0[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi159), t0[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi159), L0[20,20],h(1, 20, fi159)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi159 + 1), t0[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi159 + 1), t0[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi159 + 1), L0[20,20],h(1, 20, fi159)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi159), t0[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 20, fi159 + 1), t0[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi159 + 1), t0[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi159 + 1), L0[20,20],h(1, 20, fi159 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi159 + 2), t0[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi159 + 2), t0[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi159 + 2), L0[20,20],h(1, 20, fi159 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi159 + 1), t0[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 20, fi159 + 2), t0[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi159 + 2), t0[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi159 + 2), L0[20,20],h(1, 20, fi159 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi159 + 3), t0[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi159 + 3), t0[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi159 + 3), L0[20,20],h(1, 20, fi159 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi159 + 2), t0[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 20, fi159 + 3), t0[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi159 + 3), t0[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi159 + 3), L0[20,20],h(1, 20, fi159 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi159 + 16, 20, fi159 + 4), t0[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi159 + 16, 20, fi159 + 4), t0[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi159 + 16, 20, fi159 + 4), L0[20,20],h(4, 20, fi159)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 20, fi159), t0[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 14:
...
Eq.ann: {}
Entry 21:
For_{fi236;0;15;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 20, -fi236 + 19), a[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, -fi236 + 19), a[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, -fi236 + 19), L0[20,20],h(1, 20, -fi236 + 19)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 19), L0[20,20],h(3, 20, -fi236 + 16)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 19), a[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 20, -fi236 + 18), a[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, -fi236 + 18), a[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, -fi236 + 18), L0[20,20],h(1, 20, -fi236 + 18)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 18), L0[20,20],h(2, 20, -fi236 + 16)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 18), a[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 20, -fi236 + 17), a[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, -fi236 + 17), a[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, -fi236 + 17), L0[20,20],h(1, 20, -fi236 + 17)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 17), L0[20,20],h(1, 20, -fi236 + 16)) ) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, -fi236 + 17), a[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, -fi236 + 16), L0[20,20],h(1, 20, -fi236 + 16)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi236 + 16, 20, 0), a[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi236 + 16, 20, 0), a[20,1],h(1, 1, 0)) ) ) - ( T( Tile( (1, 1), Tile( (4, 4), G(h(4, 20, -fi236 + 16), L0[20,20],h(-fi236 + 16, 20, 0)) ) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 20, -fi236 + 16), a[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 22:
...
Eq.ann: {}
Entry 31:
For_{fi313;0;15;4} ( Entry 0:
Eq: Tile( (1, 1), G(h(1, 20, fi313), v[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi313), v[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi313), L0[20,20],h(1, 20, fi313)) ) )
Eq.ann: {}
Entry 1:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi313 + 1), v[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi313 + 1), v[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(3, 20, fi313 + 1), L0[20,20],h(1, 20, fi313)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi313), v[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 2:
Eq: Tile( (1, 1), G(h(1, 20, fi313 + 1), v[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi313 + 1), v[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi313 + 1), L0[20,20],h(1, 20, fi313 + 1)) ) )
Eq.ann: {}
Entry 3:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi313 + 2), v[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi313 + 2), v[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(2, 20, fi313 + 2), L0[20,20],h(1, 20, fi313 + 1)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi313 + 1), v[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 4:
Eq: Tile( (1, 1), G(h(1, 20, fi313 + 2), v[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi313 + 2), v[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi313 + 2), L0[20,20],h(1, 20, fi313 + 2)) ) )
Eq.ann: {}
Entry 5:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi313 + 3), v[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi313 + 3), v[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi313 + 3), L0[20,20],h(1, 20, fi313 + 2)) ) ) Kro Tile( (1, 1), Tile( (4, 4), G(h(1, 20, fi313 + 2), v[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
Entry 6:
Eq: Tile( (1, 1), G(h(1, 20, fi313 + 3), v[20,1],h(1, 1, 0)) ) = ( Tile( (1, 1), G(h(1, 20, fi313 + 3), v[20,1],h(1, 1, 0)) ) Div Tile( (1, 1), G(h(1, 20, fi313 + 3), L0[20,20],h(1, 20, fi313 + 3)) ) )
Eq.ann: {}
Entry 7:
Eq: Tile( (1, 1), Tile( (4, 4), G(h(-fi313 + 16, 20, fi313 + 4), v[20,1],h(1, 1, 0)) ) ) = ( Tile( (1, 1), Tile( (4, 4), G(h(-fi313 + 16, 20, fi313 + 4), v[20,1],h(1, 1, 0)) ) ) - ( Tile( (1, 1), Tile( (4, 4), G(h(-fi313 + 16, 20, fi313 + 4), L0[20,20],h(4, 20, fi313)) ) ) * Tile( (1, 1), Tile( (4, 4), G(h(4, 20, fi313), v[20,1],h(1, 1, 0)) ) ) ) )
Eq.ann: {}
 )Entry 32:
...
static __attribute__((noinline)) void kernel(double const * X, double const * x, double * K, double * y, double * kx, double * f, double * var, double * lp)
{
  ...
  for( int fi18 = 0; fi18 <= 11; fi18+=4 ) {
    _t0_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18])));
    _t0_2 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 20)), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 40))), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 60)), 32);
    _t0_3 = _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 21));
    _t0_4 = _mm256_maskload_pd(K + 21*fi18 + 41, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t0_5 = _mm256_maskload_pd(K + 21*fi18 + 61, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    ...
    // Generating : T1448[1,20] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ),h(1, 20, fi18))
    ...
    // Generating : L[20,20] = S(h(3, 20, fi18 + 1), ( G(h(1, 1, 0), T1448[1,20],h(1, 20, fi18)) Kro G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ),h(1, 20, fi18))
    ...
    // Generating : L[20,20] = S(h(3, 20, fi18 + 1), ( G(h(3, 20, fi18 + 1), L[20,20],h(3, 20, fi18 + 1)) - ( G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) * T( G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ),h(3, 20, fi18 + 1))
    ...
    // Generating : L[20,20] = S(h(1, 20, fi18 + 1), Sqrt( G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
    ...
    // Generating : T1448[1,20] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
    ...
    // Generating : L[20,20] = S(h(2, 20, fi18 + 2), ( G(h(1, 1, 0), T1448[1,20],h(1, 20, fi18 + 1)) Kro G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
    ...
    // Generating : L[20,20] = S(h(2, 20, fi18 + 2), ( G(h(2, 20, fi18 + 2), L[20,20],h(2, 20, fi18 + 2)) - ( G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) * T( G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ),h(2, 20, fi18 + 2))
    ...
    // Generating : L[20,20] = S(h(1, 20, fi18 + 2), Sqrt( G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ),h(1, 20, fi18 + 2))
    ...
    // Generating : L[20,20] = S(h(1, 20, fi18 + 3), ( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) Div G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ),h(1, 20, fi18 + 2))
    ...
    // Generating : L[20,20] = S(h(1, 20, fi18 + 3), ( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) - ( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) Kro T( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ),h(1, 20, fi18 + 3))
    ...
    // Generating : L[20,20] = S(h(1, 20, fi18 + 3), Sqrt( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ),h(1, 20, fi18 + 3))
    ...
    // AVX Storer:
    _t0_11 = _t0_19;
    _mm256_maskstore_pd(K + 21*fi18 + 41, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_4);
    _mm256_maskstore_pd(K + 21*fi18 + 61, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t0_5);
    _mm256_maskstore_pd(K + 21*fi18 + 62, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t0_9);

    for( int fi79 = 0; fi79 <= -fi18 + 12; fi79+=4 ) {
      _t1_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 20*fi79 + 80])));
      _t1_1 = _mm256_maskload_pd(K + 21*fi18 + 20*fi79 + 81, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 20*fi79 + 100])));
      _t1_7 = _mm256_maskload_pd(K + 21*fi18 + 20*fi79 + 101, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_12 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 20*fi79 + 120])));
      _t1_13 = _mm256_maskload_pd(K + 21*fi18 + 20*fi79 + 121, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t1_18 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 20*fi79 + 140])));
      _t1_19 = _mm256_maskload_pd(K + 21*fi18 + 20*fi79 + 141, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));

      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18)) Div G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ),h(1, 20, fi18))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(3, 20, fi18 + 1)) - ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18)) Kro T( G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ),h(3, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 1)) Div G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(2, 20, fi18 + 2)) - ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 1)) Kro T( G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ),h(2, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 2)) Div G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ),h(1, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 3)) - ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 2)) Kro T( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 4), ( G(h(1, 20, fi18 + fi79 + 4), L[20,20],h(1, 20, fi18 + 3)) Div G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18)) Div G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ),h(1, 20, fi18))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(3, 20, fi18 + 1)) - ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18)) Kro T( G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ),h(3, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 1)) Div G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(2, 20, fi18 + 2)) - ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 1)) Kro T( G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ),h(2, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 2)) Div G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ),h(1, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 3)) - ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 2)) Kro T( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 5), ( G(h(1, 20, fi18 + fi79 + 5), L[20,20],h(1, 20, fi18 + 3)) Div G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18)) Div G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ),h(1, 20, fi18))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(3, 20, fi18 + 1)) - ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18)) Kro T( G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ),h(3, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 1)) Div G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(2, 20, fi18 + 2)) - ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 1)) Kro T( G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ),h(2, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 2)) Div G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ),h(1, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 3)) - ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 2)) Kro T( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 6), ( G(h(1, 20, fi18 + fi79 + 6), L[20,20],h(1, 20, fi18 + 3)) Div G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18)) Div G(h(1, 20, fi18), L[20,20],h(1, 20, fi18)) ),h(1, 20, fi18))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(3, 20, fi18 + 1)) - ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18)) Kro T( G(h(3, 20, fi18 + 1), L[20,20],h(1, 20, fi18)) ) ) ),h(3, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 1)) Div G(h(1, 20, fi18 + 1), L[20,20],h(1, 20, fi18 + 1)) ),h(1, 20, fi18 + 1))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(2, 20, fi18 + 2)) - ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 1)) Kro T( G(h(2, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 1)) ) ) ),h(2, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 2)) Div G(h(1, 20, fi18 + 2), L[20,20],h(1, 20, fi18 + 2)) ),h(1, 20, fi18 + 2))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 3)) - ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 2)) Kro T( G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 2)) ) ) ),h(1, 20, fi18 + 3))
      ...
      // Generating : L[20,20] = S(h(1, 20, fi18 + fi79 + 7), ( G(h(1, 20, fi18 + fi79 + 7), L[20,20],h(1, 20, fi18 + 3)) Div G(h(1, 20, fi18 + 3), L[20,20],h(1, 20, fi18 + 3)) ),h(1, 20, fi18 + 3))
      ...
      // AVX Storer:
      _t1_23 = _t1_143;
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 80]), _mm256_castpd256_pd128(_t1_0));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 81]), _mm256_castpd256_pd128(_t1_2));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 82]), _mm256_castpd256_pd128(_t1_4));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 83]), _mm256_castpd256_pd128(_t1_5));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 100]), _mm256_castpd256_pd128(_t1_6));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 101]), _mm256_castpd256_pd128(_t1_8));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 102]), _mm256_castpd256_pd128(_t1_10));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 103]), _mm256_castpd256_pd128(_t1_11));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 120]), _mm256_castpd256_pd128(_t1_12));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 121]), _mm256_castpd256_pd128(_t1_14));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 122]), _mm256_castpd256_pd128(_t1_16));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 123]), _mm256_castpd256_pd128(_t1_17));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 140]), _mm256_castpd256_pd128(_t1_18));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 141]), _mm256_castpd256_pd128(_t1_20));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 142]), _mm256_castpd256_pd128(_t1_22));
      _mm_store_sd(&(K[21*fi18 + 20*fi79 + 143]), _mm256_castpd256_pd128(_t1_23));
    }
    _t2_20 = _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 84));
    _t2_21 = _mm256_maskload_pd(K + 21*fi18 + 104, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t2_22 = _mm256_maskload_pd(K + 21*fi18 + 124, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t2_23 = _mm256_loadu_pd(K + 21*fi18 + 144);
    _t2_19 = _mm256_broadcast_sd(K + 21*fi18 + 80);
    _t2_18 = _mm256_broadcast_sd(K + 21*fi18 + 81);
    _t2_17 = _mm256_broadcast_sd(K + 21*fi18 + 82);
    _t2_16 = _mm256_broadcast_sd(K + 21*fi18 + 83);
    _t2_15 = _mm256_broadcast_sd(K + 21*fi18 + 100);
    _t2_14 = _mm256_broadcast_sd(K + 21*fi18 + 101);
    _t2_13 = _mm256_broadcast_sd(K + 21*fi18 + 102);
    _t2_12 = _mm256_broadcast_sd(K + 21*fi18 + 103);
    _t2_11 = _mm256_broadcast_sd(K + 21*fi18 + 120);
    _t2_10 = _mm256_broadcast_sd(K + 21*fi18 + 121);
    _t2_9 = _mm256_broadcast_sd(K + 21*fi18 + 122);
    _t2_8 = _mm256_broadcast_sd(K + 21*fi18 + 123);
    _t2_7 = _mm256_broadcast_sd(K + 21*fi18 + 140);
    _t2_6 = _mm256_broadcast_sd(K + 21*fi18 + 141);
    _t2_5 = _mm256_broadcast_sd(K + 21*fi18 + 142);
    _t2_4 = _mm256_broadcast_sd(K + 21*fi18 + 143);
    _t2_3 = _mm256_loadu_pd(K + 21*fi18 + 80);
    _t2_2 = _mm256_loadu_pd(K + 21*fi18 + 100);
    _t2_1 = _mm256_loadu_pd(K + 21*fi18 + 120);
    _t2_0 = _mm256_loadu_pd(K + 21*fi18 + 140);

    // Generating : L[20,20] = ( S(h(4, 20, fi18 + 4), ( G(h(4, 20, fi18 + 4), L[20,20],h(4, 20, fi18 + 4)) - ( G(h(4, 20, fi18 + 4), L[20,20],h(4, 20, fi18)) * T( G(h(4, 20, fi18 + 4), L[20,20],h(4, 20, fi18)) ) ) ),h(4, 20, fi18 + 4)) + Sum_{i150} ( ( Sum_{j151} ( S(h(4, 20, fi18 + i150 + 4), ( G(h(4, 20, fi18 + i150 + 4), L[20,20],h(4, 20, fi18 + j151 + 4)) - ( G(h(4, 20, fi18 + i150 + 4), L[20,20],h(4, 20, fi18)) * T( G(h(4, 20, fi18 + j151 + 4), L[20,20],h(4, 20, fi18)) ) ) ),h(4, 20, fi18 + j151 + 4)) ) + S(h(4, 20, fi18 + i150 + 4), ( G(h(4, 20, fi18 + i150 + 4), L[20,20],h(4, 20, fi18 + i150 + 4)) - ( G(h(4, 20, fi18 + i150 + 4), L[20,20],h(4, 20, fi18)) * T( G(h(4, 20, fi18 + i150 + 4), L[20,20],h(4, 20, fi18)) ) ) ),h(4, 20, fi18 + i150 + 4)) ) ) )
    ...
    _t2_22 = _t2_30;
    _t2_23 = _t2_31;
    _mm_store_sd(&(K[21*fi18]), _mm256_castpd256_pd128(_t0_0));
    _mm256_maskstore_pd(K + 21*fi18 + 20, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_2);
    _mm256_maskstore_pd(K + 21*fi18 + 40, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_2, _t0_2, 1));
    _mm256_maskstore_pd(K + 21*fi18 + 60, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_permute2f128_pd(_t0_2, _t0_2, 129));
    _mm_store_sd(K + 21*fi18 + 21, _mm256_castpd256_pd128(_t0_3));
    _mm256_maskstore_pd(K + 21*fi18 + 41, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t0_7);
    _mm256_maskstore_pd(K + 21*fi18 + 61, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t0_7, _t0_7, 1));
    _mm_store_sd(K + 21*fi18 + 42, _mm256_castpd256_pd128(_t0_8));
    _mm_store_sd(&(K[21*fi18 + 62]), _mm256_castpd256_pd128(_t0_10));
    _mm_store_sd(&(K[21*fi18 + 63]), _mm256_castpd256_pd128(_t0_11));
    _mm_store_sd(K + 21*fi18 + 84, _mm256_castpd256_pd128(_t2_20));
    _mm256_maskstore_pd(K + 21*fi18 + 104, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t2_21);
    _mm256_maskstore_pd(K + 21*fi18 + 124, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t2_22);
    _mm256_storeu_pd(K + 21*fi18 + 144, _t2_23);

    for( int i150 = 4; i150 <= -fi18 + 15; i150+=4 ) {

      for( int j151 = 0; j151 <= i150 - 4; j151+=4 ) {
        _t3_24 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + j151 + 84);
        _t3_25 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + j151 + 104);
        _t3_26 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + j151 + 124);
        _t3_27 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + j151 + 144);
        _t3_19 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 80);
        _t3_18 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 81);
        _t3_17 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 82);
        _t3_16 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 83);
        _t3_15 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 100);
        _t3_14 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 101);
        _t3_13 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 102);
        _t3_12 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 103);
        _t3_11 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 120);
        _t3_10 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 121);
        _t3_9 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 122);
        _t3_8 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 123);
        _t3_7 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 140);
        _t3_6 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 141);
        _t3_5 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 142);
        _t3_4 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 143);
        _t3_3 = _mm256_loadu_pd(K + 21*fi18 + 20*j151 + 80);
        _t3_2 = _mm256_loadu_pd(K + 21*fi18 + 20*j151 + 100);
        _t3_1 = _mm256_loadu_pd(K + 21*fi18 + 20*j151 + 120);
        _t3_0 = _mm256_loadu_pd(K + 21*fi18 + 20*j151 + 140);
        ...
        // AVX Storer:
        _mm256_storeu_pd(K + 21*fi18 + 20*i150 + j151 + 84, _t3_24);
        _mm256_storeu_pd(K + 21*fi18 + 20*i150 + j151 + 104, _t3_25);
        _mm256_storeu_pd(K + 21*fi18 + 20*i150 + j151 + 124, _t3_26);
        _mm256_storeu_pd(K + 21*fi18 + 20*i150 + j151 + 144, _t3_27);
      }
      _t4_20 = _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 21*i150 + 84));
      _t4_21 = _mm256_maskload_pd(K + 21*fi18 + 21*i150 + 104, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
      _t4_22 = _mm256_maskload_pd(K + 21*fi18 + 21*i150 + 124, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
      _t4_23 = _mm256_loadu_pd(K + 21*fi18 + 21*i150 + 144);
      _t4_19 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 80);
      _t4_18 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 81);
      _t4_17 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 82);
      _t4_16 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 83);
      _t4_15 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 100);
      _t4_14 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 101);
      _t4_13 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 102);
      _t4_12 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 103);
      _t4_11 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 120);
      _t4_10 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 121);
      _t4_9 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 122);
      _t4_8 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 123);
      _t4_7 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 140);
      _t4_6 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 141);
      _t4_5 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 142);
      _t4_4 = _mm256_broadcast_sd(K + 21*fi18 + 20*i150 + 143);
      _t4_3 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 80);
      _t4_2 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 100);
      _t4_1 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 120);
      _t4_0 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 140);
      ...
      _t4_22 = _t4_30;
      _t4_23 = _t4_31;
      _mm_store_sd(K + 21*fi18 + 21*i150 + 84, _mm256_castpd256_pd128(_t4_20));
      _mm256_maskstore_pd(K + 21*fi18 + 21*i150 + 104, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0), _t4_21);
      _mm256_maskstore_pd(K + 21*fi18 + 21*i150 + 124, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0), _t4_22);
      _mm256_storeu_pd(K + 21*fi18 + 21*i150 + 144, _t4_23);
    }
  }

  _t5_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[252])));
  _t5_2 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 272)), _mm256_castpd128_pd256(_mm_load_sd(K + 292))), _mm256_castpd128_pd256(_mm_load_sd(K + 312)), 32);
  _t5_3 = _mm256_castpd128_pd256(_mm_load_sd(K + 273));
  _t5_4 = _mm256_maskload_pd(K + 293, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t5_5 = _mm256_maskload_pd(K + 313, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_12 = _mm256_castpd128_pd256(_mm_load_sd(&(K[332])));
  _t5_13 = _mm256_maskload_pd(K + 333, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_18 = _mm256_castpd128_pd256(_mm_load_sd(&(K[352])));
  _t5_19 = _mm256_maskload_pd(K + 353, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_24 = _mm256_castpd128_pd256(_mm_load_sd(&(K[372])));
  _t5_25 = _mm256_maskload_pd(K + 373, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_30 = _mm256_castpd128_pd256(_mm_load_sd(&(K[392])));
  _t5_31 = _mm256_maskload_pd(K + 393, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_36 = _mm256_castpd128_pd256(_mm_load_sd(K + 336));
  _t5_37 = _mm256_maskload_pd(K + 356, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t5_38 = _mm256_maskload_pd(K + 376, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t5_39 = _mm256_loadu_pd(K + 396);

  // Generating : L[20,20] = S(h(1, 20, 12), Sqrt( G(h(1, 20, 12), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : T1448[1,20] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 20, 12), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : L[20,20] = S(h(3, 20, 13), ( G(h(1, 1, 0), T1448[1,20],h(1, 20, 12)) Kro G(h(3, 20, 13), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : L[20,20] = S(h(3, 20, 13), ( G(h(3, 20, 13), L[20,20],h(3, 20, 13)) - ( G(h(3, 20, 13), L[20,20],h(1, 20, 12)) * T( G(h(3, 20, 13), L[20,20],h(1, 20, 12)) ) ) ),h(3, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 13), Sqrt( G(h(1, 20, 13), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : T1448[1,20] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 20, 13), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : L[20,20] = S(h(2, 20, 14), ( G(h(1, 1, 0), T1448[1,20],h(1, 20, 13)) Kro G(h(2, 20, 14), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : L[20,20] = S(h(2, 20, 14), ( G(h(2, 20, 14), L[20,20],h(2, 20, 14)) - ( G(h(2, 20, 14), L[20,20],h(1, 20, 13)) * T( G(h(2, 20, 14), L[20,20],h(1, 20, 13)) ) ) ),h(2, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 14), Sqrt( G(h(1, 20, 14), L[20,20],h(1, 20, 14)) ),h(1, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 15), ( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) Div G(h(1, 20, 14), L[20,20],h(1, 20, 14)) ),h(1, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 15), ( G(h(1, 20, 15), L[20,20],h(1, 20, 15)) - ( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) Kro T( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) ) ) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 15), Sqrt( G(h(1, 20, 15), L[20,20],h(1, 20, 15)) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(1, 20, 12)) Div G(h(1, 20, 12), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(3, 20, 13)) - ( G(h(1, 20, 16), L[20,20],h(1, 20, 12)) Kro T( G(h(3, 20, 13), L[20,20],h(1, 20, 12)) ) ) ),h(3, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(1, 20, 13)) Div G(h(1, 20, 13), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(2, 20, 14)) - ( G(h(1, 20, 16), L[20,20],h(1, 20, 13)) Kro T( G(h(2, 20, 14), L[20,20],h(1, 20, 13)) ) ) ),h(2, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(1, 20, 14)) Div G(h(1, 20, 14), L[20,20],h(1, 20, 14)) ),h(1, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(1, 20, 15)) - ( G(h(1, 20, 16), L[20,20],h(1, 20, 14)) Kro T( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) ) ) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 16), ( G(h(1, 20, 16), L[20,20],h(1, 20, 15)) Div G(h(1, 20, 15), L[20,20],h(1, 20, 15)) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(1, 20, 12)) Div G(h(1, 20, 12), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(3, 20, 13)) - ( G(h(1, 20, 17), L[20,20],h(1, 20, 12)) Kro T( G(h(3, 20, 13), L[20,20],h(1, 20, 12)) ) ) ),h(3, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(1, 20, 13)) Div G(h(1, 20, 13), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(2, 20, 14)) - ( G(h(1, 20, 17), L[20,20],h(1, 20, 13)) Kro T( G(h(2, 20, 14), L[20,20],h(1, 20, 13)) ) ) ),h(2, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(1, 20, 14)) Div G(h(1, 20, 14), L[20,20],h(1, 20, 14)) ),h(1, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(1, 20, 15)) - ( G(h(1, 20, 17), L[20,20],h(1, 20, 14)) Kro T( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) ) ) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 17), ( G(h(1, 20, 17), L[20,20],h(1, 20, 15)) Div G(h(1, 20, 15), L[20,20],h(1, 20, 15)) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(1, 20, 12)) Div G(h(1, 20, 12), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(3, 20, 13)) - ( G(h(1, 20, 18), L[20,20],h(1, 20, 12)) Kro T( G(h(3, 20, 13), L[20,20],h(1, 20, 12)) ) ) ),h(3, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(1, 20, 13)) Div G(h(1, 20, 13), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(2, 20, 14)) - ( G(h(1, 20, 18), L[20,20],h(1, 20, 13)) Kro T( G(h(2, 20, 14), L[20,20],h(1, 20, 13)) ) ) ),h(2, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(1, 20, 14)) Div G(h(1, 20, 14), L[20,20],h(1, 20, 14)) ),h(1, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(1, 20, 15)) - ( G(h(1, 20, 18), L[20,20],h(1, 20, 14)) Kro T( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) ) ) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 18), ( G(h(1, 20, 18), L[20,20],h(1, 20, 15)) Div G(h(1, 20, 15), L[20,20],h(1, 20, 15)) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(1, 20, 12)) Div G(h(1, 20, 12), L[20,20],h(1, 20, 12)) ),h(1, 20, 12))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(3, 20, 13)) - ( G(h(1, 20, 19), L[20,20],h(1, 20, 12)) Kro T( G(h(3, 20, 13), L[20,20],h(1, 20, 12)) ) ) ),h(3, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(1, 20, 13)) Div G(h(1, 20, 13), L[20,20],h(1, 20, 13)) ),h(1, 20, 13))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(2, 20, 14)) - ( G(h(1, 20, 19), L[20,20],h(1, 20, 13)) Kro T( G(h(2, 20, 14), L[20,20],h(1, 20, 13)) ) ) ),h(2, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(1, 20, 14)) Div G(h(1, 20, 14), L[20,20],h(1, 20, 14)) ),h(1, 20, 14))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(1, 20, 15)) - ( G(h(1, 20, 19), L[20,20],h(1, 20, 14)) Kro T( G(h(1, 20, 15), L[20,20],h(1, 20, 14)) ) ) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(1, 20, 15)) Div G(h(1, 20, 15), L[20,20],h(1, 20, 15)) ),h(1, 20, 15))
  ...
  // Generating : L[20,20] = S(h(4, 20, 16), ( G(h(4, 20, 16), L[20,20],h(4, 20, 16)) - ( G(h(4, 20, 16), L[20,20],h(4, 20, 12)) * T( G(h(4, 20, 16), L[20,20],h(4, 20, 12)) ) ) ),h(4, 20, 16))
  ...
  // Generating : T1448[1,20] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 20, 16), L[20,20],h(1, 20, 16)) ),h(1, 20, 16))
  ...
  // Generating : L[20,20] = S(h(3, 20, 17), ( G(h(1, 1, 0), T1448[1,20],h(1, 20, 16)) Kro G(h(3, 20, 17), L[20,20],h(1, 20, 16)) ),h(1, 20, 16))
  ...
  // Generating : L[20,20] = S(h(3, 20, 17), ( G(h(3, 20, 17), L[20,20],h(3, 20, 17)) - ( G(h(3, 20, 17), L[20,20],h(1, 20, 16)) * T( G(h(3, 20, 17), L[20,20],h(1, 20, 16)) ) ) ),h(3, 20, 17))
  ...
  // Generating : T1448[1,20] = S(h(1, 1, 0), ( G(h(1, 1, 0), 1[1,1],h(1, 1, 0)) Div G(h(1, 20, 17), L[20,20],h(1, 20, 17)) ),h(1, 20, 17))
  ...
  // Generating : L[20,20] = S(h(2, 20, 18), ( G(h(1, 1, 0), T1448[1,20],h(1, 20, 17)) Kro G(h(2, 20, 18), L[20,20],h(1, 20, 17)) ),h(1, 20, 17))
  ...
  // Generating : L[20,20] = S(h(2, 20, 18), ( G(h(2, 20, 18), L[20,20],h(2, 20, 18)) - ( G(h(2, 20, 18), L[20,20],h(1, 20, 17)) * T( G(h(2, 20, 18), L[20,20],h(1, 20, 17)) ) ) ),h(2, 20, 18))
  ...
  // Generating : L[20,20] = S(h(1, 20, 19), ( G(h(1, 20, 19), L[20,20],h(1, 20, 19)) - ( G(h(1, 20, 19), L[20,20],h(1, 20, 18)) Kro T( G(h(1, 20, 19), L[20,20],h(1, 20, 18)) ) ) ),h(1, 20, 19))
  ...
  _mm_store_sd(&(K[252]), _mm256_castpd256_pd128(_t5_0));
  _mm256_maskstore_pd(K + 272, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_2);
  _mm256_maskstore_pd(K + 292, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_2, _t5_2, 1));
  _mm256_maskstore_pd(K + 312, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_permute2f128_pd(_t5_2, _t5_2, 129));
  _mm_store_sd(K + 273, _mm256_castpd256_pd128(_t5_3));
  _mm256_maskstore_pd(K + 293, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_7);
  _mm256_maskstore_pd(K + 313, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_7, _t5_7, 1));
  _mm_store_sd(K + 294, _mm256_castpd256_pd128(_t5_8));
  _mm_store_sd(&(K[314]), _mm256_castpd256_pd128(_t5_10));
  _mm_store_sd(&(K[315]), _mm256_castpd256_pd128(_t5_11));
  _mm_store_sd(&(K[332]), _mm256_castpd256_pd128(_t5_12));
  _mm_store_sd(&(K[333]), _mm256_castpd256_pd128(_t5_14));
  _mm_store_sd(&(K[334]), _mm256_castpd256_pd128(_t5_16));
  _mm_store_sd(&(K[335]), _mm256_castpd256_pd128(_t5_17));
  _mm_store_sd(&(K[352]), _mm256_castpd256_pd128(_t5_18));
  _mm_store_sd(&(K[353]), _mm256_castpd256_pd128(_t5_20));
  _mm_store_sd(&(K[354]), _mm256_castpd256_pd128(_t5_22));
  _mm_store_sd(&(K[355]), _mm256_castpd256_pd128(_t5_23));
  _mm_store_sd(&(K[372]), _mm256_castpd256_pd128(_t5_24));
  _mm_store_sd(&(K[373]), _mm256_castpd256_pd128(_t5_26));
  _mm_store_sd(&(K[374]), _mm256_castpd256_pd128(_t5_28));
  _mm_store_sd(&(K[375]), _mm256_castpd256_pd128(_t5_29));
  _mm_store_sd(&(K[392]), _mm256_castpd256_pd128(_t5_30));
  _mm_store_sd(&(K[393]), _mm256_castpd256_pd128(_t5_32));
  _mm_store_sd(&(K[394]), _mm256_castpd256_pd128(_t5_34));
  _mm_store_sd(&(K[395]), _mm256_castpd256_pd128(_t5_35));

  for( int fi18 = 0; fi18 <= 15; fi18+=4 ) {
    _t6_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 41)), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 61)), 0);
    _t6_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 62])));
    _t6_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 21])));
    _t6_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 63])));
    _t6_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18])));
    _t6_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 42])));
    _t6_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 20)), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 40))), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 60)), 32);
    ...
    // Generating : t0[20,1] = S(h(3, 20, fi18 + 1), ( G(h(3, 20, fi18 + 1), t0[20,1],h(1, 1, 0)) - ( G(h(3, 20, fi18 + 1), L0[20,20],h(1, 20, fi18)) Kro G(h(1, 20, fi18), t0[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : t0[20,1] = S(h(1, 20, fi18 + 1), ( G(h(1, 20, fi18 + 1), t0[20,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 1), L0[20,20],h(1, 20, fi18 + 1)) ),h(1, 1, 0))
    ...
    // Generating : t0[20,1] = S(h(2, 20, fi18 + 2), ( G(h(2, 20, fi18 + 2), t0[20,1],h(1, 1, 0)) - ( G(h(2, 20, fi18 + 2), L0[20,20],h(1, 20, fi18 + 1)) Kro G(h(1, 20, fi18 + 1), t0[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : t0[20,1] = S(h(1, 20, fi18 + 2), ( G(h(1, 20, fi18 + 2), t0[20,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 2), L0[20,20],h(1, 20, fi18 + 2)) ),h(1, 1, 0))
    ...
    // Generating : t0[20,1] = S(h(1, 20, fi18 + 3), ( G(h(1, 20, fi18 + 3), t0[20,1],h(1, 1, 0)) - ( G(h(1, 20, fi18 + 3), L0[20,20],h(1, 20, fi18 + 2)) Kro G(h(1, 20, fi18 + 2), t0[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : t0[20,1] = S(h(1, 20, fi18 + 3), ( G(h(1, 20, fi18 + 3), t0[20,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 3), L0[20,20],h(1, 20, fi18 + 3)) ),h(1, 1, 0))
    ...
    // Generating : t0[20,1] = Sum_{i150} ( S(h(4, 20, fi18 + i150 + 4), ( G(h(4, 20, fi18 + i150 + 4), t0[20,1],h(1, 1, 0)) - ( G(h(4, 20, fi18 + i150 + 4), L0[20,20],h(4, 20, fi18)) * G(h(4, 20, fi18), t0[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
    ...
    for( int i150 = 0; i150 <= -fi18 + 15; i150+=4 ) {
      _t7_9 = _mm256_loadu_pd(y + fi18 + i150 + 4);
      _t7_7 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 80);
      _t7_6 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 100);
      _t7_5 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 120);
      _t7_4 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 140);
  ...
  _t8_0 = _mm256_castpd128_pd256(_mm_load_sd(&(y[16])));
  _t8_1 = _mm256_maskload_pd(y + 17, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  ...
  _mm_store_sd(K + 336, _mm256_castpd256_pd128(_t5_36));
  _mm256_maskstore_pd(K + 356, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_41);
  _mm256_maskstore_pd(K + 376, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_41, _t5_41, 1));
  _mm256_maskstore_pd(K + 396, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_permute2f128_pd(_t5_41, _t5_41, 129));
  _mm_store_sd(K + 357, _mm256_castpd256_pd128(_t5_42));
  _mm256_maskstore_pd(K + 377, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _t5_46);
  _mm256_maskstore_pd(K + 397, _mm256_setr_epi64x((__int64)1 << 63, 0, 0, 0), _mm256_shuffle_pd(_t5_46, _t5_46, 1));
  _mm_store_sd(K + 378, _mm256_castpd256_pd128(_t5_47));
  _mm_store_sd(&(K[398]), _mm256_castpd256_pd128(_t5_49));
  _mm_store_sd(&(K[399]), _mm256_castpd256_pd128(_t5_50));
  _mm_store_sd(&(y[16]), _mm256_castpd256_pd128(_t8_0));
  _mm_store_sd(&(y[17]), _mm256_castpd256_pd128(_t8_2));
  _mm_store_sd(&(y[18]), _mm256_castpd256_pd128(_t8_4));
  _mm_store_sd(&(y[19]), _mm256_castpd256_pd128(_t8_5));

  for( int fi18 = 0; fi18 <= 15; fi18+=4 ) {
    _t9_7 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 19])));
    _t9_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-21*fi18 + 399])));
    _t9_8 = _mm256_maskload_pd(y + -fi18 + 16, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t9_5 = _mm256_maskload_pd(K + -21*fi18 + 396, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
    _t9_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-21*fi18 + 378])));
    _t9_3 = _mm256_maskload_pd(K + -21*fi18 + 376, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
    _t9_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-21*fi18 + 357])));
    _t9_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-21*fi18 + 356])));
    _t9_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[-21*fi18 + 336])));
    ...
    // Generating : a[20,1] = S(h(3, 20, -fi18 + 16), ( G(h(3, 20, -fi18 + 16), a[20,1],h(1, 1, 0)) - ( T( G(h(1, 20, -fi18 + 19), L0[20,20],h(3, 20, -fi18 + 16)) ) Kro G(h(1, 20, -fi18 + 19), a[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : a[20,1] = S(h(1, 20, -fi18 + 18), ( G(h(1, 20, -fi18 + 18), a[20,1],h(1, 1, 0)) Div G(h(1, 20, -fi18 + 18), L0[20,20],h(1, 20, -fi18 + 18)) ),h(1, 1, 0))
    ...
    // Generating : a[20,1] = S(h(2, 20, -fi18 + 16), ( G(h(2, 20, -fi18 + 16), a[20,1],h(1, 1, 0)) - ( T( G(h(1, 20, -fi18 + 18), L0[20,20],h(2, 20, -fi18 + 16)) ) Kro G(h(1, 20, -fi18 + 18), a[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : a[20,1] = S(h(1, 20, -fi18 + 17), ( G(h(1, 20, -fi18 + 17), a[20,1],h(1, 1, 0)) Div G(h(1, 20, -fi18 + 17), L0[20,20],h(1, 20, -fi18 + 17)) ),h(1, 1, 0))
    ...
    // Generating : a[20,1] = S(h(1, 20, -fi18 + 16), ( G(h(1, 20, -fi18 + 16), a[20,1],h(1, 1, 0)) - ( T( G(h(1, 20, -fi18 + 17), L0[20,20],h(1, 20, -fi18 + 16)) ) Kro G(h(1, 20, -fi18 + 17), a[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : a[20,1] = S(h(1, 20, -fi18 + 16), ( G(h(1, 20, -fi18 + 16), a[20,1],h(1, 1, 0)) Div G(h(1, 20, -fi18 + 16), L0[20,20],h(1, 20, -fi18 + 16)) ),h(1, 1, 0))
    ...
    // Generating : a[20,1] = Sum_{i150} ( S(h(4, 20, i150), ( G(h(4, 20, i150), a[20,1],h(1, 1, 0)) - ( T( G(h(4, 20, -fi18 + 16), L0[20,20],h(4, 20, i150)) ) * G(h(4, 20, -fi18 + 16), a[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )

    // AVX Loader:
    _mm_store_sd(&(y[-fi18 + 19]), _mm256_castpd256_pd128(_t9_7));
    _mm_store_sd(&(y[-fi18 + 18]), _mm256_castpd256_pd128(_t9_9));
    _mm_store_sd(&(y[-fi18 + 17]), _mm256_castpd256_pd128(_t9_11));
    _mm_store_sd(&(y[-fi18 + 16]), _mm256_castpd256_pd128(_t9_12));

    for( int i150 = 0; i150 <= -fi18 + 15; i150+=4 ) {
      _t10_9 = _mm256_loadu_pd(y + i150);
      _t10_7 = _mm256_loadu_pd(K + -20*fi18 + i150 + 320);
      _t10_6 = _mm256_loadu_pd(K + -20*fi18 + i150 + 340);
      _t10_5 = _mm256_loadu_pd(K + -20*fi18 + i150 + 360);
      _t10_4 = _mm256_loadu_pd(K + -20*fi18 + i150 + 380);
      _t10_3 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 19])));
      _t10_2 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 18])));
      _t10_1 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 17])));
      _t10_0 = _mm256_castpd128_pd256(_mm_load_sd(&(y[-fi18 + 16])));
  ...
  _t11_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[63])));
  _t11_8 = _mm256_maskload_pd(y, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t11_5 = _mm256_maskload_pd(K + 60, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, (__int64)1 << 63, 0));
  _t11_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[42])));
  _t11_3 = _mm256_maskload_pd(K + 40, _mm256_setr_epi64x((__int64)1 << 63, (__int64)1 << 63, 0, 0));
  _t11_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21])));
  _t11_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[20])));
  ...
  // Generating : kx[20,1] = ( Sum_{j151} ( S(h(4, 20, j151), ( G(h(4, 20, j151), X[20,20],h(4, 20, 0)) * G(h(4, 20, 0), x[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) + Sum_{i150} ( Sum_{j151} ( $(h(4, 20, j151), ( G(h(4, 20, j151), X[20,20],h(4, 20, i150)) * G(h(4, 20, i150), x[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) )

  // AVX Loader:


  for( int j151 = 0; j151 <= 19; j151+=4 ) {
    _t12_4 = _mm256_loadu_pd(X + 20*j151);
    _t12_3 = _mm256_loadu_pd(X + 20*j151 + 20);
    _t12_2 = _mm256_loadu_pd(X + 20*j151 + 40);
    _t12_1 = _mm256_loadu_pd(X + 20*j151 + 60);
  ...
  for( int i150 = 4; i150 <= 19; i150+=4 ) {

    // AVX Loader:

    for( int j151 = 0; j151 <= 19; j151+=4 ) {
      _t13_4 = _mm256_loadu_pd(X + i150 + 20*j151);
      _t13_3 = _mm256_loadu_pd(X + i150 + 20*j151 + 20);
      _t13_2 = _mm256_loadu_pd(X + i150 + 20*j151 + 40);
      _t13_1 = _mm256_loadu_pd(X + i150 + 20*j151 + 60);
  ...
  // Generating : f[1,1] = ( S(h(1, 1, 0), ( T( G(h(4, 20, 0), kx[20,1],h(1, 1, 0)) ) * G(h(4, 20, 0), y[20,1],h(1, 1, 0)) ),h(1, 1, 0)) + Sum_{i150} ( $(h(1, 1, 0), ( T( G(h(4, 20, i150), kx[20,1],h(1, 1, 0)) ) * G(h(4, 20, i150), y[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) )
  ...
  for( int fi18 = 0; fi18 <= 15; fi18+=4 ) {
    _t16_4 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 21])));
    _t16_1 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 62])));
    _t16_0 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 63])));
    _t16_3 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 41)), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 61)), 0);
    _t16_6 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18])));
    _t16_2 = _mm256_castpd128_pd256(_mm_load_sd(&(K[21*fi18 + 42])));
    _t16_5 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 20)), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 40))), _mm256_castpd128_pd256(_mm_load_sd(K + 21*fi18 + 60)), 32);
    ...
    // Generating : v[20,1] = S(h(3, 20, fi18 + 1), ( G(h(3, 20, fi18 + 1), v[20,1],h(1, 1, 0)) - ( G(h(3, 20, fi18 + 1), L0[20,20],h(1, 20, fi18)) Kro G(h(1, 20, fi18), v[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v[20,1] = S(h(1, 20, fi18 + 1), ( G(h(1, 20, fi18 + 1), v[20,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 1), L0[20,20],h(1, 20, fi18 + 1)) ),h(1, 1, 0))
    ...
    // Generating : v[20,1] = S(h(2, 20, fi18 + 2), ( G(h(2, 20, fi18 + 2), v[20,1],h(1, 1, 0)) - ( G(h(2, 20, fi18 + 2), L0[20,20],h(1, 20, fi18 + 1)) Kro G(h(1, 20, fi18 + 1), v[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v[20,1] = S(h(1, 20, fi18 + 2), ( G(h(1, 20, fi18 + 2), v[20,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 2), L0[20,20],h(1, 20, fi18 + 2)) ),h(1, 1, 0))
    ...
    // Generating : v[20,1] = S(h(1, 20, fi18 + 3), ( G(h(1, 20, fi18 + 3), v[20,1],h(1, 1, 0)) - ( G(h(1, 20, fi18 + 3), L0[20,20],h(1, 20, fi18 + 2)) Kro G(h(1, 20, fi18 + 2), v[20,1],h(1, 1, 0)) ) ),h(1, 1, 0))
    ...
    // Generating : v[20,1] = S(h(1, 20, fi18 + 3), ( G(h(1, 20, fi18 + 3), v[20,1],h(1, 1, 0)) Div G(h(1, 20, fi18 + 3), L0[20,20],h(1, 20, fi18 + 3)) ),h(1, 1, 0))
    ...
    // Generating : v[20,1] = Sum_{i150} ( S(h(4, 20, fi18 + i150 + 4), ( G(h(4, 20, fi18 + i150 + 4), v[20,1],h(1, 1, 0)) - ( G(h(4, 20, fi18 + i150 + 4), L0[20,20],h(4, 20, fi18)) * G(h(4, 20, fi18), v[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) )
    ...
    for( int i150 = 0; i150 <= -fi18 + 15; i150+=4 ) {
      ...
      _t17_7 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 80);
      _t17_6 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 100);
      _t17_5 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 120);
      _t17_4 = _mm256_loadu_pd(K + 21*fi18 + 20*i150 + 140);
  ...
  _t5_41 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 356)), _mm256_castpd128_pd256(_mm_load_sd(K + 376))), _mm256_castpd128_pd256(_mm_load_sd(K + 396)), 32);
  _t5_49 = _mm256_castpd128_pd256(_mm_load_sd(&(K[398])));
  _t5_47 = _mm256_castpd128_pd256(_mm_load_sd(&(K[378])));
  _t5_36 = _mm256_castpd128_pd256(_mm_load_sd(&(K[336])));
  _t5_50 = _mm256_castpd128_pd256(_mm_load_sd(&(K[399])));
  _t5_46 = _mm256_shuffle_pd(_mm256_castpd128_pd256(_mm_load_sd(K + 377)), _mm256_castpd128_pd256(_mm_load_sd(K + 397)), 0);
  _t5_42 = _mm256_castpd128_pd256(_mm_load_sd(&(K[357])));
  ...
  // Generating : var[1,1] = ( ( S(h(1, 1, 0), ( ( T( G(h(4, 20, 0), x[20,1],h(1, 1, 0)) ) * G(h(4, 20, 0), x[20,1],h(1, 1, 0)) ) - ( T( G(h(4, 20, 0), kx[20,1],h(1, 1, 0)) ) * G(h(4, 20, 0), kx[20,1],h(1, 1, 0)) ) ),h(1, 1, 0)) + Sum_{j151} ( $(h(1, 1, 0), ( T( G(h(4, 20, j151), x[20,1],h(1, 1, 0)) ) * G(h(4, 20, j151), x[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) ) + Sum_{i150} ( -$(h(1, 1, 0), ( T( G(h(4, 20, i150), kx[20,1],h(1, 1, 0)) ) * G(h(4, 20, i150), kx[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) )
  ...
  // Generating : lp[1,1] = ( S(h(1, 1, 0), ( T( G(h(4, 20, 0), y[20,1],h(1, 1, 0)) ) * G(h(4, 20, 0), y[20,1],h(1, 1, 0)) ),h(1, 1, 0)) + Sum_{i150} ( $(h(1, 1, 0), ( T( G(h(4, 20, i150), y[20,1],h(1, 1, 0)) ) * G(h(4, 20, i150), y[20,1],h(1, 1, 0)) ),h(1, 1, 0)) ) )
