...
static __attribute__((noinline)) void kernel(double const * L, double const * U, double * C)
{
  ...
  _t0_18 = _asm256_loadu_pd(C + 4);
  _t0_19 = _asm256_loadu_pd(C + 8);
  _t0_20 = _asm256_loadu_pd(C + 12);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_69 = _mm256_add_pd(_t0_48, _t0_54);

  // 4-BLAC: 1x4 / 1x4
  _t0_92 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_42), _mm256_castpd256_pd128(_t0_69)));
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_133 = _mm256_mul_pd(_t0_112, _t0_117);

  // 4-BLAC: 1x4 - 1x4
  _t0_148 = _mm256_sub_pd(_t0_107, _t0_133);
  ...
  // 1x2 -> 1x4
  _t0_167 = _mm256_blend_pd(_mm256_unpacklo_pd(_t0_14, _t0_15), _mm256_setzero_pd(), 12);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_169 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_167, _t0_168), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_167, _t0_168), _mm256_mul_pd(_t0_167, _t0_168), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_167, _t0_168), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_167, _t0_168), _mm256_mul_pd(_t0_167, _t0_168), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_167, _t0_168), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_167, _t0_168), _mm256_mul_pd(_t0_167, _t0_168), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t0_170 = _mm256_sub_pd(_t0_166, _t0_169);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_174 = _mm256_add_pd(_t0_172, _t0_173);

  // 4-BLAC: 1x4 / 1x4
  _t0_175 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_171), _mm256_castpd256_pd128(_t0_174)));
  ...
  // 1x3 -> 1x4
  _t0_177 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_15), _mm256_unpacklo_pd(_t0_16, _mm256_setzero_pd()), 32);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_179 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_177, _t0_178), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_177, _t0_178), _mm256_mul_pd(_t0_177, _t0_178), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_177, _t0_178), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_177, _t0_178), _mm256_mul_pd(_t0_177, _t0_178), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_177, _t0_178), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_177, _t0_178), _mm256_mul_pd(_t0_177, _t0_178), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t0_180 = _mm256_sub_pd(_t0_176, _t0_179);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_184 = _mm256_add_pd(_t0_182, _t0_183);

  // 4-BLAC: 1x4 / 1x4
  _t0_185 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_181), _mm256_castpd256_pd128(_t0_184)));
  ...
  // 4-BLAC: 4x1 * 1x4
  _t0_191 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_190, _t0_190, 32), _mm256_permute2f128_pd(_t0_190, _t0_190, 32), 0), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_15), _mm256_unpacklo_pd(_t0_16, _t0_17), 32));
  _t0_192 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_190, _t0_190, 32), _mm256_permute2f128_pd(_t0_190, _t0_190, 32), 15), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_15), _mm256_unpacklo_pd(_t0_16, _t0_17), 32));
  _t0_193 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_190, _t0_190, 49), _mm256_permute2f128_pd(_t0_190, _t0_190, 49), 0), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_15), _mm256_unpacklo_pd(_t0_16, _t0_17), 32));
  _t0_194 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_190, _t0_190, 49), _mm256_permute2f128_pd(_t0_190, _t0_190, 49), 15), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_15), _mm256_unpacklo_pd(_t0_16, _t0_17), 32));

  // 4-BLAC: 4x4 - 4x4
  _t0_195 = _mm256_sub_pd(_t0_186, _t0_191);
  _t0_196 = _mm256_sub_pd(_t0_187, _t0_192);
  _t0_197 = _mm256_sub_pd(_t0_188, _t0_193);
  _t0_198 = _mm256_sub_pd(_t0_189, _t0_194);
  ...
  // 1x1 -> 1x4
  _t0_199 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_18, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_35 = _mm256_add_pd(_t0_200, _t0_34);

  // 4-BLAC: 1x4 / 1x4
  _t0_36 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_199), _mm256_castpd256_pd128(_t0_35)));
  ...
  // 1x1 -> 1x4
  _t0_37 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_18, 2), _mm256_setzero_pd());
  ...
  // 4-BLAC: 1x4 / 1x4
  _t0_47 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_43), _mm256_castpd256_pd128(_t0_46)));
  ...
  // 1x1 -> 1x4
  _t0_49 = _mm256_permute2f128_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_18, 4), _mm256_blend_pd(_mm256_setzero_pd(), _t0_18, 4), 129);

  // AVX Loader:

  // 1x2 -> 1x4
  _t0_50 = _mm256_blend_pd(_mm256_unpacklo_pd(_t0_21, _t0_22), _mm256_setzero_pd(), 12);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_58 = _mm256_add_pd(_t0_56, _t0_57);

  // 4-BLAC: 1x4 / 1x4
  _t0_59 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_55), _mm256_castpd256_pd128(_t0_58)));
  ...
  // 1x1 -> 1x4
  _t0_60 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t0_18, _t0_18, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 1x3 -> 1x4
  _t0_61 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_21, _t0_22), _mm256_unpacklo_pd(_t0_23, _mm256_setzero_pd()), 32);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_63 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_61, _t0_62), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_61, _t0_62), _mm256_mul_pd(_t0_61, _t0_62), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_61, _t0_62), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_61, _t0_62), _mm256_mul_pd(_t0_61, _t0_62), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_61, _t0_62), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_61, _t0_62), _mm256_mul_pd(_t0_61, _t0_62), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t0_64 = _mm256_sub_pd(_t0_60, _t0_63);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_68 = _mm256_add_pd(_t0_66, _t0_67);

  // 4-BLAC: 1x4 / 1x4
  _t0_70 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_65), _mm256_castpd256_pd128(_t0_68)));
  ...
  // 4-BLAC: 4x1 * 1x4
  _t0_76 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_75, _t0_75, 32), _mm256_permute2f128_pd(_t0_75, _t0_75, 32), 0), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_21, _t0_22), _mm256_unpacklo_pd(_t0_23, _t0_24), 32));
  _t0_77 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_75, _t0_75, 32), _mm256_permute2f128_pd(_t0_75, _t0_75, 32), 15), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_21, _t0_22), _mm256_unpacklo_pd(_t0_23, _t0_24), 32));
  _t0_78 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_75, _t0_75, 49), _mm256_permute2f128_pd(_t0_75, _t0_75, 49), 0), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_21, _t0_22), _mm256_unpacklo_pd(_t0_23, _t0_24), 32));
  _t0_79 = _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_75, _t0_75, 49), _mm256_permute2f128_pd(_t0_75, _t0_75, 49), 15), _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_21, _t0_22), _mm256_unpacklo_pd(_t0_23, _t0_24), 32));

  // 4-BLAC: 4x4 - 4x4
  _t0_80 = _mm256_sub_pd(_t0_71, _t0_76);
  _t0_81 = _mm256_sub_pd(_t0_72, _t0_77);
  _t0_82 = _mm256_sub_pd(_t0_73, _t0_78);
  _t0_83 = _mm256_sub_pd(_t0_74, _t0_79);
  ...
  // 1x1 -> 1x4
  _t0_84 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_19, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_87 = _mm256_add_pd(_t0_85, _t0_86);

  // 4-BLAC: 1x4 / 1x4
  _t0_88 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_84), _mm256_castpd256_pd128(_t0_87)));
  ...
  // 1x1 -> 1x4
  _t0_89 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_19, 2), _mm256_setzero_pd());
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_93 = _mm256_mul_pd(_t0_90, _t0_91);

  // 4-BLAC: 1x4 - 1x4
  _t0_94 = _mm256_sub_pd(_t0_89, _t0_93);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_98 = _mm256_add_pd(_t0_96, _t0_97);

  // 4-BLAC: 1x4 / 1x4
  _t0_99 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_95), _mm256_castpd256_pd128(_t0_98)));
  ...
  // 1x1 -> 1x4
  _t0_100 = _mm256_permute2f128_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_19, 4), _mm256_blend_pd(_mm256_setzero_pd(), _t0_19, 4), 129);

  // AVX Loader:

  // 1x2 -> 1x4
  _t0_101 = _mm256_blend_pd(_mm256_unpacklo_pd(_t0_25, _t0_26), _mm256_setzero_pd(), 12);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_103 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_101, _t0_102), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_101, _t0_102), _mm256_mul_pd(_t0_101, _t0_102), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_101, _t0_102), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_101, _t0_102), _mm256_mul_pd(_t0_101, _t0_102), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_101, _t0_102), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_101, _t0_102), _mm256_mul_pd(_t0_101, _t0_102), 129)), 1));
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_109 = _mm256_add_pd(_t0_106, _t0_108);

  // 4-BLAC: 1x4 / 1x4
  _t0_110 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_105), _mm256_castpd256_pd128(_t0_109)));
  ...
  // 1x1 -> 1x4
  _t0_111 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t0_19, _t0_19, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 1x3 -> 1x4
  _t0_113 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_25, _t0_26), _mm256_unpacklo_pd(_t0_27, _mm256_setzero_pd()), 32);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_115 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_113, _t0_114), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_113, _t0_114), _mm256_mul_pd(_t0_113, _t0_114), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_113, _t0_114), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_113, _t0_114), _mm256_mul_pd(_t0_113, _t0_114), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_113, _t0_114), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_113, _t0_114), _mm256_mul_pd(_t0_113, _t0_114), 129)), 1));
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_121 = _mm256_add_pd(_t0_119, _t0_120);

  // 4-BLAC: 1x4 / 1x4
  _t0_122 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_118), _mm256_castpd256_pd128(_t0_121)));
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_33 = _mm256_mul_pd(_t0_123, _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_25, _t0_26), _mm256_unpacklo_pd(_t0_27, _t0_28), 32));

  // 4-BLAC: 1x4 - 1x4
  _t0_20 = _mm256_sub_pd(_t0_20, _t0_33);
  ...
  // 1x1 -> 1x4
  _t0_124 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_20, 1);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_132 = _mm256_mul_pd(_t0_130, _t0_131);

  // 4-BLAC: 1x4 - 1x4
  _t0_134 = _mm256_sub_pd(_t0_129, _t0_132);
  ...
  // 1x1 -> 1x4
  _t0_140 = _mm256_permute2f128_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_20, 4), _mm256_blend_pd(_mm256_setzero_pd(), _t0_20, 4), 129);

  // AVX Loader:

  // 1x2 -> 1x4
  _t0_141 = _mm256_blend_pd(_mm256_unpacklo_pd(_t0_29, _t0_30), _mm256_setzero_pd(), 12);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_143 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_141, _t0_142), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_141, _t0_142), _mm256_mul_pd(_t0_141, _t0_142), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_141, _t0_142), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_141, _t0_142), _mm256_mul_pd(_t0_141, _t0_142), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_141, _t0_142), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_141, _t0_142), _mm256_mul_pd(_t0_141, _t0_142), 129)), 1));

  // 4-BLAC: 1x4 - 1x4
  _t0_144 = _mm256_sub_pd(_t0_140, _t0_143);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_149 = _mm256_add_pd(_t0_146, _t0_147);

  // 4-BLAC: 1x4 / 1x4
  _t0_150 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_145), _mm256_castpd256_pd128(_t0_149)));
  ...
  // 1x1 -> 1x4
  _t0_151 = _mm256_unpackhi_pd(_mm256_permute2f128_pd(_t0_20, _t0_20, 129), _mm256_setzero_pd());

  // AVX Loader:

  // 1x3 -> 1x4
  _t0_152 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_29, _t0_30), _mm256_unpacklo_pd(_t0_31, _mm256_setzero_pd()), 32);
  ...
  // 4-BLAC: 1x4 * 4x1
  _t0_154 = _mm256_add_pd(_mm256_blend_pd(_mm256_add_pd(_mm256_mul_pd(_t0_152, _t0_153), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_152, _t0_153), _mm256_mul_pd(_t0_152, _t0_153), 129)), _mm256_setzero_pd(), 14), _mm256_shuffle_pd(_mm256_add_pd(_mm256_mul_pd(_t0_152, _t0_153), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_152, _t0_153), _mm256_mul_pd(_t0_152, _t0_153), 129)), _mm256_add_pd(_mm256_mul_pd(_t0_152, _t0_153), _mm256_permute2f128_pd(_mm256_mul_pd(_t0_152, _t0_153), _mm256_mul_pd(_t0_152, _t0_153), 129)), 1));
  ...
  _mm_store_sd(&(C[4]), _mm256_castpd256_pd128(_t0_21));
  _mm_store_sd(&(C[5]), _mm256_castpd256_pd128(_t0_22));
  _mm_store_sd(&(C[6]), _mm256_castpd256_pd128(_t0_23));
  _mm_store_sd(&(C[7]), _mm256_castpd256_pd128(_t0_24));
  _mm_store_sd(&(C[8]), _mm256_castpd256_pd128(_t0_25));
  _mm_store_sd(&(C[9]), _mm256_castpd256_pd128(_t0_26));
  _mm_store_sd(&(C[10]), _mm256_castpd256_pd128(_t0_27));
  _mm_store_sd(&(C[11]), _mm256_castpd256_pd128(_t0_28));
  _mm_store_sd(&(C[12]), _mm256_castpd256_pd128(_t0_29));
  _mm_store_sd(&(C[13]), _mm256_castpd256_pd128(_t0_30));
  _mm_store_sd(&(C[14]), _mm256_castpd256_pd128(_t0_31));
  _mm_store_sd(&(C[15]), _mm256_castpd256_pd128(_t0_32));
