...
static __attribute__((noinline)) void kernel(double const * L, double const * U, double * C)
{
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_189 = _mm256_add_pd(_t0_169, _t0_174);

  // 4-BLAC: 1x4 / 1x4
  _t0_53 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_164), _mm256_castpd256_pd128(_t0_189)));
  ...
  // 1x1 -> 1x4
  _t0_77 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_14, _t0_14, 32), _mm256_permute2f128_pd(_t0_14, _t0_14, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_97 = _mm256_mul_pd(_t0_77, _t0_82);

  // 4-BLAC: 1x4 - 1x4
  _t0_110 = _mm256_sub_pd(_t0_67, _t0_97);
  ...
  // 1x1 -> 1x4
  _t0_129 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_15, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_154 = _mm256_add_pd(_t0_135, _t0_140);

  // 4-BLAC: 1x4 / 1x4
  _t0_160 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_129), _mm256_castpd256_pd128(_t0_154)));
  ...
  // 1x2 -> 1x4
  _t0_161 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_15, 6), _mm256_permute2f128_pd(_t0_15, _t0_15, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_162 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_16, _t0_16, 32), _mm256_permute2f128_pd(_t0_16, _t0_16, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_165 = _mm256_mul_pd(_t0_162, _t0_163);
  ...
  // 1x1 -> 1x4
  _t0_167 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_17, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_171 = _mm256_add_pd(_t0_168, _t0_170);

  // 4-BLAC: 1x4 / 1x4
  _t0_172 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_167), _mm256_castpd256_pd128(_t0_171)));
  ...
  // 1x1 -> 1x4
  _t0_173 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_17, 2), _mm256_setzero_pd());
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_177 = _mm256_mul_pd(_t0_175, _t0_176);

  // 4-BLAC: 1x4 - 1x4
  _t0_178 = _mm256_sub_pd(_t0_173, _t0_177);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_182 = _mm256_add_pd(_t0_180, _t0_181);

  // 4-BLAC: 1x4 / 1x4
  _t0_183 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_179), _mm256_castpd256_pd128(_t0_182)));
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_38 = _mm256_mul_pd(_t0_184, _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_16), _mm256_unpacklo_pd(_t0_18, _t0_19), 32));
  ...
  // 1x1 -> 1x4
  _t0_185 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_41, 1);
  ...
  // 4-BLAC: 1x4 / 1x4
  _t0_190 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_185), _mm256_castpd256_pd128(_t0_188)));
  ...
  // 1x3 -> 1x4
  _t0_191 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_41, 14), _mm256_permute2f128_pd(_t0_41, _t0_41, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_192 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_20, _t0_20, 32), _mm256_permute2f128_pd(_t0_20, _t0_20, 32), 0);
  ...
  // 4-BLAC: 1x4 - 1x4
  _t0_44 = _mm256_sub_pd(_t0_191, _t0_194);
  ...
  // 1x1 -> 1x4
  _t0_45 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_21, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_48 = _mm256_add_pd(_t0_46, _t0_47);

  // 4-BLAC: 1x4 / 1x4
  _t0_49 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_45), _mm256_castpd256_pd128(_t0_48)));
  ...
  // 1x2 -> 1x4
  _t0_50 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_21, 6), _mm256_permute2f128_pd(_t0_21, _t0_21, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_51 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_22, _t0_22, 32), _mm256_permute2f128_pd(_t0_22, _t0_22, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_54 = _mm256_mul_pd(_t0_51, _t0_52);

  // 4-BLAC: 1x4 - 1x4
  _t0_55 = _mm256_sub_pd(_t0_50, _t0_54);
  ...
  // 1x1 -> 1x4
  _t0_56 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_23, 1);
  ...
  // 1x1 -> 1x4
  _t0_61 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_23, 2), _mm256_setzero_pd());
  ...
  // 4-BLAC: 1x4 / 1x4
  _t0_71 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_66), _mm256_castpd256_pd128(_t0_70)));
  ...
  // 2x4 -> 4x4
  _t0_73 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_16), _mm256_unpacklo_pd(_t0_18, _t0_19), 32);
  _t0_74 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_20, _t0_22), _mm256_unpacklo_pd(_t0_24, _t0_25), 32);
  _t0_75 = _mm256_setzero_pd();
  _t0_76 = _mm256_setzero_pd();

  // 4-BLAC: 1x4 * 4x4
  _t0_39 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_72, _t0_72, 32), _mm256_permute2f128_pd(_t0_72, _t0_72, 32), 0), _t0_73), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_72, _t0_72, 32), _mm256_permute2f128_pd(_t0_72, _t0_72, 32), 15), _t0_74)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_72, _t0_72, 49), _mm256_permute2f128_pd(_t0_72, _t0_72, 49), 0), _t0_75), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_72, _t0_72, 49), _mm256_permute2f128_pd(_t0_72, _t0_72, 49), 15), _t0_76)));
  ...
  // 1x1 -> 1x4
  _t0_78 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_42, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_81 = _mm256_add_pd(_t0_79, _t0_80);

  // 4-BLAC: 1x4 / 1x4
  _t0_83 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_78), _mm256_castpd256_pd128(_t0_81)));
  ...
  // 1x3 -> 1x4
  _t0_84 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_42, 14), _mm256_permute2f128_pd(_t0_42, _t0_42, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_85 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_26, _t0_26, 32), _mm256_permute2f128_pd(_t0_26, _t0_26, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_87 = _mm256_mul_pd(_t0_85, _t0_86);

  // 4-BLAC: 1x4 - 1x4
  _t0_88 = _mm256_sub_pd(_t0_84, _t0_87);
  ...
  // 1x1 -> 1x4
  _t0_89 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_27, 1);
  ...
  // 1x2 -> 1x4
  _t0_94 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_27, 6), _mm256_permute2f128_pd(_t0_27, _t0_27, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_95 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_28, _t0_28, 32), _mm256_permute2f128_pd(_t0_28, _t0_28, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_98 = _mm256_mul_pd(_t0_95, _t0_96);

  // 4-BLAC: 1x4 - 1x4
  _t0_99 = _mm256_sub_pd(_t0_94, _t0_98);
  ...
  // 1x1 -> 1x4
  _t0_100 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_29, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_103 = _mm256_add_pd(_t0_101, _t0_102);

  // 4-BLAC: 1x4 / 1x4
  _t0_104 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_100), _mm256_castpd256_pd128(_t0_103)));
  ...
  // 1x1 -> 1x4
  _t0_105 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_29, 2), _mm256_setzero_pd());
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_114 = _mm256_add_pd(_t0_112, _t0_113);

  // 4-BLAC: 1x4 / 1x4
  _t0_115 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_111), _mm256_castpd256_pd128(_t0_114)));
  ...
  // 3x4 -> 4x4
  _t0_117 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_14, _t0_16), _mm256_unpacklo_pd(_t0_18, _t0_19), 32);
  _t0_118 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_20, _t0_22), _mm256_unpacklo_pd(_t0_24, _t0_25), 32);
  _t0_119 = _mm256_permute2f128_pd(_mm256_unpacklo_pd(_t0_26, _t0_28), _mm256_unpacklo_pd(_t0_30, _t0_31), 32);
  _t0_120 = _mm256_setzero_pd();

  // 4-BLAC: 1x4 * 4x4
  _t0_40 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_116, _t0_116, 32), _mm256_permute2f128_pd(_t0_116, _t0_116, 32), 0), _t0_117), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_116, _t0_116, 32), _mm256_permute2f128_pd(_t0_116, _t0_116, 32), 15), _t0_118)), _mm256_add_pd(_mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_116, _t0_116, 49), _mm256_permute2f128_pd(_t0_116, _t0_116, 49), 0), _t0_119), _mm256_mul_pd(_mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_116, _t0_116, 49), _mm256_permute2f128_pd(_t0_116, _t0_116, 49), 15), _t0_120)));
  ...
  // 1x1 -> 1x4
  _t0_121 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_43, 1);
  ...
  // 1x3 -> 1x4
  _t0_126 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_43, 14), _mm256_permute2f128_pd(_t0_43, _t0_43, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_127 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_32, _t0_32, 32), _mm256_permute2f128_pd(_t0_32, _t0_32, 32), 0);
  ...
  // 4-BLAC: 1x4 Kro 1x4
  _t0_130 = _mm256_mul_pd(_t0_127, _t0_128);

  // 4-BLAC: 1x4 - 1x4
  _t0_131 = _mm256_sub_pd(_t0_126, _t0_130);
  ...
  // 1x1 -> 1x4
  _t0_132 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_33, 1);
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_136 = _mm256_add_pd(_t0_133, _t0_134);

  // 4-BLAC: 1x4 / 1x4
  _t0_137 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_132), _mm256_castpd256_pd128(_t0_136)));
  ...
  // 1x2 -> 1x4
  _t0_138 = _mm256_shuffle_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_33, 6), _mm256_permute2f128_pd(_t0_33, _t0_33, 129), 5);

  // AVX Loader:

  // 1x1 -> 1x4
  _t0_139 = _mm256_shuffle_pd(_mm256_permute2f128_pd(_t0_34, _t0_34, 32), _mm256_permute2f128_pd(_t0_34, _t0_34, 32), 0);
  ...
  // 1x1 -> 1x4
  _t0_144 = _mm256_blend_pd(_mm256_setzero_pd(), _t0_35, 1);
  ...
  // 1x1 -> 1x4
  _t0_149 = _mm256_unpackhi_pd(_mm256_blend_pd(_mm256_setzero_pd(), _t0_35, 2), _mm256_setzero_pd());
  ...
  // 4-BLAC: 1x4 + 1x4
  _t0_158 = _mm256_add_pd(_t0_156, _t0_157);

  // 4-BLAC: 1x4 / 1x4
  _t0_159 = _mm256_castpd128_pd256(_mm_div_pd(_mm256_castpd256_pd128(_t0_155), _mm256_castpd256_pd128(_t0_158)));
  ...
  _mm_store_sd(&(C[4]), _mm256_castpd256_pd128(_t0_20));
  _mm_store_sd(&(C[5]), _mm256_castpd256_pd128(_t0_22));
  _mm_store_sd(&(C[6]), _mm256_castpd256_pd128(_t0_24));
  _mm_store_sd(&(C[7]), _mm256_castpd256_pd128(_t0_25));
  _mm_store_sd(&(C[8]), _mm256_castpd256_pd128(_t0_26));
  _mm_store_sd(&(C[9]), _mm256_castpd256_pd128(_t0_28));
  _mm_store_sd(&(C[10]), _mm256_castpd256_pd128(_t0_30));
  _mm_store_sd(&(C[11]), _mm256_castpd256_pd128(_t0_31));
  _mm_store_sd(&(C[12]), _mm256_castpd256_pd128(_t0_32));
  _mm_store_sd(&(C[13]), _mm256_castpd256_pd128(_t0_34));
  _mm_store_sd(&(C[14]), _mm256_castpd256_pd128(_t0_36));
  _mm_store_sd(&(C[15]), _mm256_castpd256_pd128(_t0_37));
