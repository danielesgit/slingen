...
inline void build_paper(FLOAT ** F, FLOAT ** B, FLOAT ** u, FLOAT ** Q, FLOAT ** z, FLOAT ** H, FLOAT ** HT, FLOAT ** R,
...
inline void build_wiki(FLOAT ** F, FLOAT ** B, FLOAT ** u, FLOAT ** Q, FLOAT ** z, FLOAT ** H, FLOAT ** HT, FLOAT ** R,
		FLOAT ** y, FLOAT ** init_x, FLOAT ** x, FLOAT ** M0, FLOAT ** init_P, FLOAT ** P, FLOAT ** Y, FLOAT ** v0, FLOAT ** M1, FLOAT ** M2, FLOAT ** M3)
{
  srand(time(NULL));
...
void kernel_paper(FLOAT const * F, FLOAT const * B, FLOAT const * u, FLOAT const * Q, FLOAT const * z, FLOAT const * H, FLOAT * HT, FLOAT const * R,
...
//	FAXBY(PARAM1, 1., z, 1, 1., v0, 1);
	...
	FGEMM(CblasRowMajor, CblasNoTrans, CblasTrans, PARAM1, PARAM1, PARAM2, 1., M1, PARAM2, H, PARAM2, 1., M3, PARAM1);
...
void kernel_wiki(FLOAT const * F, FLOAT const * B, FLOAT const * u, FLOAT const * Q, FLOAT const * z, FLOAT const * H, FLOAT * HT, FLOAT const * R,
		FLOAT * y, FLOAT * x, FLOAT * M0, FLOAT * P, FLOAT * Y, FLOAT * v0, FLOAT * M1, FLOAT * M2, FLOAT * M3)
{
	// y = F*x + B*u;
	FGEMV(CblasRowMajor, CblasNoTrans, PARAM2, PARAM0, 1., B, PARAM0, u, 1, 0., y, 1);
...
//	FSYMM(CblasRowMajor, CblasRight, CblasUpper, PARAM1, PARAM2, 1., Y, PARAM2, H, PARAM2, 0., M1, PARAM2);
	...
	// M1 = Y*H^T;
	FTRAN('r', 't', PARAM1, PARAM2, 1., H, PARAM2, HT, PARAM1);
	FSYMM(CblasRowMajor, CblasLeft, CblasUpper, PARAM2, PARAM1, 1., Y, PARAM2, HT, PARAM1, 0., M1, PARAM1);

	// M2 = H*M1 + R;
	FMCPY('R', 'N', PARAM1, PARAM1, 1., R, PARAM1, M2, PARAM1);
	FGEMM(CblasRowMajor, CblasNoTrans, CblasNoTrans, PARAM1, PARAM1, PARAM2, 1., H, PARAM2, M1, PARAM1, 1., M2, PARAM1);

	// M2^T*M2 = M2;
	FCHOL(LAPACK_ROW_MAJOR, 'U', PARAM1, M2, PARAM1);

	// M1 = M1*M2^-1;
	// M1 = M1*M2^-T;
	FTRSM(CblasRowMajor, CblasRight, CblasUpper, CblasNoTrans, CblasNonUnit, PARAM2, PARAM1, 1., M2, PARAM1, M1, PARAM1);
	FTRSM(CblasRowMajor, CblasRight, CblasUpper, CblasTrans, CblasNonUnit,   PARAM2, PARAM1, 1., M2, PARAM1, M1, PARAM1);

	// x = y + M1*v0;
	FVCPY(PARAM2, y, 1, x, 1);
	FGEMV(CblasRowMajor, CblasNoTrans, PARAM2, PARAM1, 1., M1, PARAM1, v0, 1, 1., x, 1);

	// P = Y - M1*H*Y;
	FMCPY('R', 'N', PARAM2, PARAM2, 1., Y, PARAM2, P, PARAM2);
	FGEMM(CblasRowMajor, CblasNoTrans, CblasNoTrans, PARAM2, PARAM2, PARAM1, 1., M1, PARAM1, H, PARAM2, 0., M3, PARAM2);
	FSYMM(CblasRowMajor, CblasRight, CblasUpper, PARAM2, PARAM2, -1., Y, PARAM2, M3, PARAM2, 1., P, PARAM2);

}

#define kernel kernel_paper
