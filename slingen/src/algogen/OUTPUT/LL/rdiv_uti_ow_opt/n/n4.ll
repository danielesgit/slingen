...
%% Equal( NL[ B_1 ], rdiv_uti_ow( U_11, B_1 ) )
@out0@[h(@m@,@m@,0), h(@nb@,@n@,@n@-(max(@n@-@nb@, 0)+@nb@))] = rdiv_uti_ow_opt(@m@, @nb@; @op0@[h(@nb@,@n@,@n@-(max(@n@-@nb@, 0)+@nb@)), h(@nb@,@n@,@n@-(max(@n@-@nb@, 0)+@nb@))]#UpperTriangular#, @out0@[h(@m@,@m@,0), h(@nb@,@n@,@n@-(max(@n@-@nb@, 0)+@nb@))]);
